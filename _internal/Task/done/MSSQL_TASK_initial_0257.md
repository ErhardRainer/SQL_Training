---
task_id: MSSQL_TASK_initial_0257
repository: SQL_Training
domain: MSSQL
title: "Script ListConstraintCoverage.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 744
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:28:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0257"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ListConstraintCoverage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ListConstraintCoverage.md"
...
# MSSQL_TASK_initial_0257 - Script ListConstraintCoverage.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Erstellt eine Uebersicht ueber PK-, FK-, CHECK- und DEFAULT-Abdeckung je Tabelle.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ListConstraintCoverage.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ListConstraintCoverage.md

## Umsetzungsauftrag

Erzeuge `ListConstraintCoverage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine Uebersicht ueber PK-, FK-, CHECK- und DEFAULT-Abdeckung je Tabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
