---
task_id: MSSQL_TASK_initial_0230
repository: SQL_Training
domain: MSSQL
title: "Script UnpivotAuditTrailPattern.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 771
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:53:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0230"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotAuditTrailPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotAuditTrailPattern.md"
...
# MSSQL_TASK_initial_0230 - Script UnpivotAuditTrailPattern.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Wandelt breite Audit- oder Delta-Tabellen in ein zeilenorientiertes Aenderungsformat um.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotAuditTrailPattern.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotAuditTrailPattern.md

## Umsetzungsauftrag

Erzeuge `UnpivotAuditTrailPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Wandelt breite Audit- oder Delta-Tabellen in ein zeilenorientiertes Aenderungsformat um. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
