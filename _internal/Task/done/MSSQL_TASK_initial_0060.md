---
task_id: MSSQL_TASK_initial_0060
repository: SQL_Training
domain: MSSQL
title: "Script SargableDateFilterPatterns.sql fuer 04_Where erstellen"
status: done
priority: 941
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T00:48:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0060"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/SargableDateFilterPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/SargableDateFilterPatterns.md"
...
# MSSQL_TASK_initial_0060 - Script SargableDateFilterPatterns.sql fuer 04_Where erstellen

## Anlass und Relevanz

Demonstriert sargierbare Datumsfilter ohne Funktionsaufruf auf der Spalte.
...
- T-SQL/04_Where/SQLScripts/SargableDateFilterPatterns.sql
- T-SQL/04_Where/SQLScripts/SargableDateFilterPatterns.md

## Umsetzungsauftrag

Erzeuge `SargableDateFilterPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert sargierbare Datumsfilter ohne Funktionsaufruf auf der Spalte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
