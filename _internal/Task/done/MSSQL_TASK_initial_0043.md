---
task_id: MSSQL_TASK_initial_0043
repository: SQL_Training
domain: MSSQL
title: "Script JoinSelectivityEstimator.sql fuer 03_JOIN erstellen"
status: done
priority: 958
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T00:19:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0043"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinSelectivityEstimator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinSelectivityEstimator.md"
...
# MSSQL_TASK_initial_0043 - Script JoinSelectivityEstimator.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Schaetzt die Selektivitaet typischer Join-Pfade ueber Rowcounts und Distinct-Werte.
...
- T-SQL/03_JOIN/SQLScripts/JoinSelectivityEstimator.sql
- T-SQL/03_JOIN/SQLScripts/JoinSelectivityEstimator.md

## Umsetzungsauftrag

Erzeuge `JoinSelectivityEstimator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Schaetzt die Selektivitaet typischer Join-Pfade ueber Rowcounts und Distinct-Werte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
