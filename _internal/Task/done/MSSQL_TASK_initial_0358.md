---
task_id: MSSQL_TASK_initial_0358
repository: SQL_Training
domain: MSSQL
title: "Script SchemaOwnershipDriftAudit.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 643
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:30:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0358"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipDriftAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipDriftAudit.md"
...
# MSSQL_TASK_initial_0358 - Script SchemaOwnershipDriftAudit.sql fuer 22_Views_Schemata erstellen
...
- T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipDriftAudit.sql
- T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipDriftAudit.md

## Umsetzungsauftrag

Erzeuge `SchemaOwnershipDriftAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Drift in der Eigentuemerschaft von Schemas. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
