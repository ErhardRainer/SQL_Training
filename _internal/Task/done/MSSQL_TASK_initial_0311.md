---
task_id: MSSQL_TASK_initial_0311
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseCollationBootstrap.sql fuer 20_Create_Database erstellen"
status: done
priority: 690
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:32:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0311"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseCollationBootstrap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseCollationBootstrap.md"
...
# MSSQL_TASK_initial_0311 - Script DatabaseCollationBootstrap.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Startskript fuer konsistente Datenbank-Kollationen.
...
- T-SQL/20_Create_Database/SQLScripts/DatabaseCollationBootstrap.sql
- T-SQL/20_Create_Database/SQLScripts/DatabaseCollationBootstrap.md

## Umsetzungsauftrag

Erzeuge `DatabaseCollationBootstrap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Startskript fuer konsistente Datenbank-Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
