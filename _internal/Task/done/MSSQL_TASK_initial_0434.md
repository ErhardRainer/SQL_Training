---
task_id: MSSQL_TASK_initial_0434
repository: SQL_Training
domain: MSSQL
title: "Script HeapTablesInventory.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 567
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T02:13:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0434"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/HeapTablesInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/HeapTablesInventory.md"
...
# MSSQL_TASK_initial_0434 - Script HeapTablesInventory.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Inventarisiert Heaps und markiert moegliche Indexierungs-Kandidaten.
...
- T-SQL/26_Indexes_Basics/SQLScripts/HeapTablesInventory.sql
- T-SQL/26_Indexes_Basics/SQLScripts/HeapTablesInventory.md

## Umsetzungsauftrag

Erzeuge `HeapTablesInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Heaps und markiert moegliche Indexierungs-Kandidaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
