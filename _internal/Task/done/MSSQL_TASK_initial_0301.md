---
task_id: MSSQL_TASK_initial_0301
repository: SQL_Training
domain: MSSQL
title: "Script OpenTransactionByDatabase.sql fuer 19_Transaktions erstellen"
status: done
priority: 700
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T05:23:52Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0301"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/OpenTransactionByDatabase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/OpenTransactionByDatabase.md"
...
# MSSQL_TASK_initial_0301 - Script OpenTransactionByDatabase.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Zeigt offene Transaktionen pro Datenbank mit Basiskennzahlen.
...
- T-SQL/19_Transaktions/SQLScripts/OpenTransactionByDatabase.sql
- T-SQL/19_Transaktions/SQLScripts/OpenTransactionByDatabase.md

## Umsetzungsauftrag

Erzeuge `OpenTransactionByDatabase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt offene Transaktionen pro Datenbank mit Basiskennzahlen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
