---
task_id: MSSQL_TASK_initial_0352
repository: SQL_Training
domain: MSSQL
title: "Script CrossDatabaseViewReferenceAudit.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 649
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:58:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0352"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossDatabaseViewReferenceAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossDatabaseViewReferenceAudit.md"
...
# MSSQL_TASK_initial_0352 - Script CrossDatabaseViewReferenceAudit.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Zeigt Views mit datenbankuebergreifenden Referenzen.
...
- T-SQL/22_Views_Schemata/SQLScripts/CrossDatabaseViewReferenceAudit.sql
- T-SQL/22_Views_Schemata/SQLScripts/CrossDatabaseViewReferenceAudit.md

## Umsetzungsauftrag

Erzeuge `CrossDatabaseViewReferenceAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Views mit datenbankuebergreifenden Referenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
