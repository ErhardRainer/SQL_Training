---
task_id: MSSQL_TASK_initial_0204
repository: SQL_Training
domain: MSSQL
title: "Script MergeDeleteImpactPreview.sql fuer 13_Merge erstellen"
status: done
priority: 797
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:36:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0204"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeDeleteImpactPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeDeleteImpactPreview.md"
...
# MSSQL_TASK_initial_0204 - Script MergeDeleteImpactPreview.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Preview fuer Delete-Zweige in einem Merge-Szenario.
...
- T-SQL/13_Merge/SQLScripts/MergeDeleteImpactPreview.sql
- T-SQL/13_Merge/SQLScripts/MergeDeleteImpactPreview.md

## Umsetzungsauftrag

Erzeuge `MergeDeleteImpactPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Preview fuer Delete-Zweige in einem Merge-Szenario. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
