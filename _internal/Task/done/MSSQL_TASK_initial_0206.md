---
task_id: MSSQL_TASK_initial_0206
repository: SQL_Training
domain: MSSQL
title: "Script MergeMatchPriorityDemo.sql fuer 13_Merge erstellen"
status: done
priority: 795
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:50:28Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0206"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeMatchPriorityDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeMatchPriorityDemo.md"
...
# MSSQL_TASK_initial_0206 - Script MergeMatchPriorityDemo.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Zeigt, wie Match-Reihenfolge und Zusatzbedingungen das Verhalten eines `MERGE` veraendern.
...
- T-SQL/13_Merge/SQLScripts/MergeMatchPriorityDemo.sql
- T-SQL/13_Merge/SQLScripts/MergeMatchPriorityDemo.md

## Umsetzungsauftrag

Erzeuge `MergeMatchPriorityDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie Match-Reihenfolge und Zusatzbedingungen das Verhalten eines `MERGE` veraendern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
