---
task_id: MSSQL_TASK_initial_0285
repository: SQL_Training
domain: MSSQL
title: "Script GroupingSetsTemplate.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 716
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:18:34Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0285"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsTemplate.md"
...
# MSSQL_TASK_initial_0285 - Script GroupingSetsTemplate.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Vorlage fuer `GROUPING SETS`, `ROLLUP` und `CUBE` mit gut lesbarer Ergebniskennzeichnung.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsTemplate.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsTemplate.md

## Umsetzungsauftrag

Erzeuge `GroupingSetsTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer `GROUPING SETS`, `ROLLUP` und `CUBE` mit gut lesbarer Ergebniskennzeichnung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
