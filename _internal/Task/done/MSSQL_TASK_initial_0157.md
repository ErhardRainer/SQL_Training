---
task_id: MSSQL_TASK_initial_0157
repository: SQL_Training
domain: MSSQL
title: "Script AggregateMinMaxRangeAudit.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 844
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:52:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0157"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateMinMaxRangeAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateMinMaxRangeAudit.md"
...
# MSSQL_TASK_initial_0157 - Script AggregateMinMaxRangeAudit.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Audit ueber Min/Max-Spannen je Gruppierung.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateMinMaxRangeAudit.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateMinMaxRangeAudit.md

## Umsetzungsauftrag

Erzeuge `AggregateMinMaxRangeAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Min/Max-Spannen je Gruppierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
