---
task_id: MSSQL_TASK_initial_0302
repository: SQL_Training
domain: MSSQL
title: "Script OpenTransactionsBySession.sql fuer 19_Transaktions erstellen"
status: done
priority: 699
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T05:28:41Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0302"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/OpenTransactionsBySession.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/OpenTransactionsBySession.md"
...
# MSSQL_TASK_initial_0302 - Script OpenTransactionsBySession.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Zeigt offene Transaktionen pro Session inklusive Alter, Login, Host und geschaetztem Impact.
...
- T-SQL/19_Transaktions/SQLScripts/OpenTransactionsBySession.sql
- T-SQL/19_Transaktions/SQLScripts/OpenTransactionsBySession.md

## Umsetzungsauftrag

Erzeuge `OpenTransactionsBySession.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt offene Transaktionen pro Session inklusive Alter, Login, Host und geschaetztem Impact. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
