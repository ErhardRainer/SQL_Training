---
task_id: MSSQL_TASK_initial_0172
repository: SQL_Training
domain: MSSQL
title: "Script LagLeadChangeDetector.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 829
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:07:50Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0172"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetector.md"
...
# MSSQL_TASK_initial_0172 - Script LagLeadChangeDetector.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Markiert Status- und Wertewechsel per `LAG` und `LEAD`.
...
- T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetector.sql
- T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetector.md

## Umsetzungsauftrag

Erzeuge `LagLeadChangeDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Status- und Wertewechsel per `LAG` und `LEAD`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
