---
task_id: MSSQL_TASK_initial_0330
repository: SQL_Training
domain: MSSQL
title: "Script TempdbFileLayoutCheck.sql fuer 20_Create_Database erstellen"
status: done
priority: 671
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:06:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0330"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/TempdbFileLayoutCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/TempdbFileLayoutCheck.md"
...
# MSSQL_TASK_initial_0330 - Script TempdbFileLayoutCheck.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Stellt die aktuelle TempDB-Dateikonfiguration und moegliche Ungleichgewichte dar.
...
- T-SQL/20_Create_Database/SQLScripts/TempdbFileLayoutCheck.sql
- T-SQL/20_Create_Database/SQLScripts/TempdbFileLayoutCheck.md

## Umsetzungsauftrag

Erzeuge `TempdbFileLayoutCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Stellt die aktuelle TempDB-Dateikonfiguration und moegliche Ungleichgewichte dar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
