---
task_id: MSSQL_TASK_initial_0422
repository: SQL_Training
domain: MSSQL
title: "Script ThrowRaiserrorBehaviorCompare.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 579
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T07:24:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0422"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowRaiserrorBehaviorCompare.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowRaiserrorBehaviorCompare.md"
...
# MSSQL_TASK_initial_0422 - Script ThrowRaiserrorBehaviorCompare.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Vergleicht `THROW` und `RAISERROR` in modernen Fehlerpfaden.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowRaiserrorBehaviorCompare.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowRaiserrorBehaviorCompare.md

## Umsetzungsauftrag

Erzeuge `ThrowRaiserrorBehaviorCompare.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `THROW` und `RAISERROR` in modernen Fehlerpfaden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
