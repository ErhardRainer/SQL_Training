---
task_id: MSSQL_TASK_initial_0393
repository: SQL_Training
domain: MSSQL
title: "Script FunctionDeterminismAudit.sql fuer 24_UserDefinedFunctions erstellen"
status: done
priority: 608
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T11:52:49Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0393"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDeterminismAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDeterminismAudit.md"
...
# MSSQL_TASK_initial_0393 - Script FunctionDeterminismAudit.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Prueft Hinweise auf Determinismus und Seiteneffekte bei Funktionen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDeterminismAudit.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDeterminismAudit.md

## Umsetzungsauftrag

Erzeuge `FunctionDeterminismAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Hinweise auf Determinismus und Seiteneffekte bei Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
