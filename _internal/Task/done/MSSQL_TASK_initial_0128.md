---
task_id: MSSQL_TASK_initial_0128
repository: SQL_Training
domain: MSSQL
title: "Script UpdateColumnDriftReview.sql fuer 08_Update erstellen"
status: done
priority: 873
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:17:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0128"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateColumnDriftReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateColumnDriftReview.md"
...
# MSSQL_TASK_initial_0128 - Script UpdateColumnDriftReview.sql fuer 08_Update erstellen

## Anlass und Relevanz

Review fuer Updates in Tabellen mit geaenderter Spaltenstruktur.
...
- T-SQL/08_Update/SQLScripts/UpdateColumnDriftReview.sql
- T-SQL/08_Update/SQLScripts/UpdateColumnDriftReview.md

## Umsetzungsauftrag

Erzeuge `UpdateColumnDriftReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Review fuer Updates in Tabellen mit geaenderter Spaltenstruktur. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
