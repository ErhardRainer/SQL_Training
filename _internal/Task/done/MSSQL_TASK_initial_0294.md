---
task_id: MSSQL_TASK_initial_0294
repository: SQL_Training
domain: MSSQL
title: "Script DeadlockVictimCaptureStarter.sql fuer 19_Transaktions erstellen"
status: done
priority: 707
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T09:06:13Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0294"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/DeadlockVictimCaptureStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/DeadlockVictimCaptureStarter.md"
...
# MSSQL_TASK_initial_0294 - Script DeadlockVictimCaptureStarter.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Einstiegsskript zum Einsammeln und Dokumentieren von Deadlock-Opfern.
...
- T-SQL/19_Transaktions/SQLScripts/DeadlockVictimCaptureStarter.sql
- T-SQL/19_Transaktions/SQLScripts/DeadlockVictimCaptureStarter.md

## Umsetzungsauftrag

Erzeuge `DeadlockVictimCaptureStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Einstiegsskript zum Einsammeln und Dokumentieren von Deadlock-Opfern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
