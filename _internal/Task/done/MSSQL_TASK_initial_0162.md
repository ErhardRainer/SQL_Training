---
task_id: MSSQL_TASK_initial_0162
repository: SQL_Training
domain: MSSQL
title: "Script ConditionalAggregationTemplate.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 839
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:17:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0162"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/ConditionalAggregationTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/ConditionalAggregationTemplate.md"
...
# MSSQL_TASK_initial_0162 - Script ConditionalAggregationTemplate.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Vorlage fuer KPI-Bildung mit bedingten Aggregaten ueber `CASE`.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/ConditionalAggregationTemplate.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/ConditionalAggregationTemplate.md

## Umsetzungsauftrag

Erzeuge `ConditionalAggregationTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer KPI-Bildung mit bedingten Aggregaten ueber `CASE`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
