---
task_id: MSSQL_TASK_initial_0158
repository: SQL_Training
domain: MSSQL
title: "Script AggregateNullHandling.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 843
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:57:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0158"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateNullHandling.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateNullHandling.md"
...
# MSSQL_TASK_initial_0158 - Script AggregateNullHandling.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Zeigt das Verhalten von Aggregaten bei `NULL` und leeren Gruppen.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateNullHandling.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateNullHandling.md

## Umsetzungsauftrag

Erzeuge `AggregateNullHandling.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt das Verhalten von Aggregaten bei `NULL` und leeren Gruppen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
