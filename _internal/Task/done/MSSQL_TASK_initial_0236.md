---
task_id: MSSQL_TASK_initial_0236
repository: SQL_Training
domain: MSSQL
title: "Script SearchDefaultExpressions.sql fuer 15_SearchInTables erstellen"
status: done
priority: 765
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:22:57Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0236"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchDefaultExpressions.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchDefaultExpressions.md"
...
# MSSQL_TASK_initial_0236 - Script SearchDefaultExpressions.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Sucht gezielt nach Default-Ausdruecken in Tabellenmetadaten.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchDefaultExpressions.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchDefaultExpressions.md

## Umsetzungsauftrag

Erzeuge `SearchDefaultExpressions.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Sucht gezielt nach Default-Ausdruecken in Tabellenmetadaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
