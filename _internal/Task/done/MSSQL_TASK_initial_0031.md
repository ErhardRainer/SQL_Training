---
task_id: MSSQL_TASK_initial_0031
repository: SQL_Training
domain: MSSQL
title: "Script AntiSemiJoinPatterns.sql fuer 03_JOIN erstellen"
status: done
priority: 970
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T03:00:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0031"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/AntiSemiJoinPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/AntiSemiJoinPatterns.md"
...
# MSSQL_TASK_initial_0031 - Script AntiSemiJoinPatterns.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Zeigt Anti- und Semi-Join-Muster mit `EXISTS`, `NOT EXISTS` und passenden Alternativen.
...
- T-SQL/03_JOIN/SQLScripts/AntiSemiJoinPatterns.sql
- T-SQL/03_JOIN/SQLScripts/AntiSemiJoinPatterns.md

## Umsetzungsauftrag

Erzeuge `AntiSemiJoinPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Anti- und Semi-Join-Muster mit `EXISTS`, `NOT EXISTS` und passenden Alternativen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
