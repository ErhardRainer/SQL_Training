---
task_id: MSSQL_TASK_initial_0218
repository: SQL_Training
domain: MSSQL
title: "Script DynamicPivotTemplate.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 783
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:47:23Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0218"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotTemplate.md"
...
# MSSQL_TASK_initial_0218 - Script DynamicPivotTemplate.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Vorlage fuer dynamische Pivot-Abfragen mit sicherer Spaltenlisten-Erzeugung.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotTemplate.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotTemplate.md

## Umsetzungsauftrag

Erzeuge `DynamicPivotTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer dynamische Pivot-Abfragen mit sicherer Spaltenlisten-Erzeugung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
