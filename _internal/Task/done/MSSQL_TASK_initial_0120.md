---
task_id: MSSQL_TASK_initial_0120
repository: SQL_Training
domain: MSSQL
title: "Script UpsertInsertNotExists.sql fuer 07_Insert erstellen"
status: done
priority: 881
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T14:28:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0120"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/UpsertInsertNotExists.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/UpsertInsertNotExists.md"
...
# MSSQL_TASK_initial_0120 - Script UpsertInsertNotExists.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Demonstriert ein robustes Insert-Muster mit `NOT EXISTS` als Alternative zu `MERGE`.
...
- T-SQL/07_Insert/SQLScripts/UpsertInsertNotExists.sql
- T-SQL/07_Insert/SQLScripts/UpsertInsertNotExists.md

## Umsetzungsauftrag

Erzeuge `UpsertInsertNotExists.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert ein robustes Insert-Muster mit `NOT EXISTS` als Alternative zu `MERGE`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
