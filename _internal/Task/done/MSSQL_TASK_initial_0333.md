---
task_id: MSSQL_TASK_initial_0333
repository: SQL_Training
domain: MSSQL
title: "Script IdentifierEscapingCookbook.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 668
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:18:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0333"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IdentifierEscapingCookbook.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IdentifierEscapingCookbook.md"
...
# MSSQL_TASK_initial_0333 - Script IdentifierEscapingCookbook.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Liefert sichere Muster fuer problematische Objekt- und Spaltennamen mit Sonderzeichen.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IdentifierEscapingCookbook.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IdentifierEscapingCookbook.md

## Umsetzungsauftrag

Erzeuge `IdentifierEscapingCookbook.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Liefert sichere Muster fuer problematische Objekt- und Spaltennamen mit Sonderzeichen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
