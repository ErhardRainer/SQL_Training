---
task_id: MSSQL_TASK_initial_0159
repository: SQL_Training
domain: MSSQL
title: "Script AggregateRatioTemplate.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 842
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:02:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0159"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateRatioTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateRatioTemplate.md"
...
# MSSQL_TASK_initial_0159 - Script AggregateRatioTemplate.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Template fuer Quoten und Verhaeltnisse auf Aggregatbasis.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateRatioTemplate.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateRatioTemplate.md

## Umsetzungsauftrag

Erzeuge `AggregateRatioTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Template fuer Quoten und Verhaeltnisse auf Aggregatbasis. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
