---
task_id: MSSQL_TASK_initial_0412
repository: SQL_Training
domain: MSSQL
title: "Script ErrorLineAndStateAudit.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 589
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T09:52:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0412"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLineAndStateAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLineAndStateAudit.md"
...
# MSSQL_TASK_initial_0412 - Script ErrorLineAndStateAudit.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Audit ueber Fehlerzeilen, States und Muster.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLineAndStateAudit.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLineAndStateAudit.md

## Umsetzungsauftrag

Erzeuge `ErrorLineAndStateAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Fehlerzeilen, States und Muster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
