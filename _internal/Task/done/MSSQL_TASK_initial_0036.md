---
task_id: MSSQL_TASK_initial_0036
repository: SQL_Training
domain: MSSQL
title: "Script JoinDuplicateExplosionCheck.sql fuer 03_JOIN erstellen"
status: done
priority: 965
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T04:29:47Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0036"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinDuplicateExplosionCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinDuplicateExplosionCheck.md"
...
# MSSQL_TASK_initial_0036 - Script JoinDuplicateExplosionCheck.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Findet Stellen, an denen Join-Bedingungen zu unbeabsichtigter Zeilenvervielfachung fuehren.
...
- T-SQL/03_JOIN/SQLScripts/JoinDuplicateExplosionCheck.sql
- T-SQL/03_JOIN/SQLScripts/JoinDuplicateExplosionCheck.md

## Umsetzungsauftrag

Erzeuge `JoinDuplicateExplosionCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Findet Stellen, an denen Join-Bedingungen zu unbeabsichtigter Zeilenvervielfachung fuehren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
