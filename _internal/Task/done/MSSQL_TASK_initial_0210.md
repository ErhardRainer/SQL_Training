---
task_id: MSSQL_TASK_initial_0210
repository: SQL_Training
domain: MSSQL
title: "Script MergePostActionSummary.sql fuer 13_Merge erstellen"
status: done
priority: 791
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:07:11Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0210"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergePostActionSummary.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergePostActionSummary.md"
...
# MSSQL_TASK_initial_0210 - Script MergePostActionSummary.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Fasst Insert-, Update- und Delete-Anteile nach einem Merge zusammen.
...
- T-SQL/13_Merge/SQLScripts/MergePostActionSummary.sql
- T-SQL/13_Merge/SQLScripts/MergePostActionSummary.md

## Umsetzungsauftrag

Erzeuge `MergePostActionSummary.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Fasst Insert-, Update- und Delete-Anteile nach einem Merge zusammen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
