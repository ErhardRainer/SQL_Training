---
task_id: MSSQL_TASK_initial_0012
repository: SQL_Training
domain: MSSQL
title: "Script DistinctVsGroupByDemo.sql fuer 02_Select erstellen"
status: done
priority: 989
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T13:33:00Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0012"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/DistinctVsGroupByDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/DistinctVsGroupByDemo.md"
...
# MSSQL_TASK_initial_0012 - Script DistinctVsGroupByDemo.sql fuer 02_Select erstellen

## Anlass und Relevanz

Vergleicht `DISTINCT` und `GROUP BY` fachlich sowie hinsichtlich Ergebnisform und Plan.
...
- T-SQL/02_Select/SQLScripts/DistinctVsGroupByDemo.sql
- T-SQL/02_Select/SQLScripts/DistinctVsGroupByDemo.md

## Umsetzungsauftrag

Erzeuge `DistinctVsGroupByDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `DISTINCT` und `GROUP BY` fachlich sowie hinsichtlich Ergebnisform und Plan. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
