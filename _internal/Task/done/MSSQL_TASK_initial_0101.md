---
task_id: MSSQL_TASK_initial_0101
repository: SQL_Training
domain: MSSQL
title: "Script DeleteWithOutputAudit.sql fuer 06_Delete erstellen"
status: done
priority: 900
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T01:20:21Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0101"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteWithOutputAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteWithOutputAudit.md"
...
# MSSQL_TASK_initial_0101 - Script DeleteWithOutputAudit.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Demonstriert `DELETE ... OUTPUT` fuer Audit- und Undo-Szenarien.
...
- T-SQL/06_Delete/SQLScripts/DeleteWithOutputAudit.sql
- T-SQL/06_Delete/SQLScripts/DeleteWithOutputAudit.md

## Umsetzungsauftrag

Erzeuge `DeleteWithOutputAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert `DELETE ... OUTPUT` fuer Audit- und Undo-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
