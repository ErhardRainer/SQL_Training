---
task_id: MSSQL_TASK_initial_0044
repository: SQL_Training
domain: MSSQL
title: "Script JoinSurvivorRowPreview.sql fuer 03_JOIN erstellen"
status: done
priority: 957
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T07:16:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0044"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinSurvivorRowPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinSurvivorRowPreview.md"
...
# MSSQL_TASK_initial_0044 - Script JoinSurvivorRowPreview.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Preview der Zeilen, die nach einem komplexen Join wirklich uebrig bleiben.
...
- T-SQL/03_JOIN/SQLScripts/JoinSurvivorRowPreview.sql
- T-SQL/03_JOIN/SQLScripts/JoinSurvivorRowPreview.md

## Umsetzungsauftrag

Erzeuge `JoinSurvivorRowPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Preview der Zeilen, die nach einem komplexen Join wirklich uebrig bleiben. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
