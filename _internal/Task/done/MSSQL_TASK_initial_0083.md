---
task_id: MSSQL_TASK_initial_0083
repository: SQL_Training
domain: MSSQL
title: "Script NullSubstitutionTradeoffs.sql fuer 05_Funktionen erstellen"
status: done
priority: 918
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:48:11Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0083"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/NullSubstitutionTradeoffs.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/NullSubstitutionTradeoffs.md"
...
# MSSQL_TASK_initial_0083 - Script NullSubstitutionTradeoffs.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Vergleicht `ISNULL`, `COALESCE` und `NULLIF` fachlich sowie typbezogen.
...
- T-SQL/05_Funktionen/SQLScripts/NullSubstitutionTradeoffs.sql
- T-SQL/05_Funktionen/SQLScripts/NullSubstitutionTradeoffs.md

## Umsetzungsauftrag

Erzeuge `NullSubstitutionTradeoffs.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `ISNULL`, `COALESCE` und `NULLIF` fachlich sowie typbezogen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
