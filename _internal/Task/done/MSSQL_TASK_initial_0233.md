---
task_id: MSSQL_TASK_initial_0233
repository: SQL_Training
domain: MSSQL
title: "Script SearchAuditColumns.sql fuer 15_SearchInTables erstellen"
status: done
priority: 768
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:10:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0233"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchAuditColumns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchAuditColumns.md"
...
# MSSQL_TASK_initial_0233 - Script SearchAuditColumns.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Sucht typische Audit-Spalten wie `CreatedAt`, `ModifiedBy` und aehnliche Muster.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchAuditColumns.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchAuditColumns.md

## Umsetzungsauftrag

Erzeuge `SearchAuditColumns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Sucht typische Audit-Spalten wie `CreatedAt`, `ModifiedBy` und aehnliche Muster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
