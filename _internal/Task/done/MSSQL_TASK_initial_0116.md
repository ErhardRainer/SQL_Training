---
task_id: MSSQL_TASK_initial_0116
repository: SQL_Training
domain: MSSQL
title: "Script InsertSelectiveColumnsReview.sql fuer 07_Insert erstellen"
status: done
priority: 885
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T13:57:36Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0116"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertSelectiveColumnsReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertSelectiveColumnsReview.md"
...
# MSSQL_TASK_initial_0116 - Script InsertSelectiveColumnsReview.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Review fuer saubere und explizite Spaltenlisten bei Inserts.
...
- T-SQL/07_Insert/SQLScripts/InsertSelectiveColumnsReview.sql
- T-SQL/07_Insert/SQLScripts/InsertSelectiveColumnsReview.md

## Umsetzungsauftrag

Erzeuge `InsertSelectiveColumnsReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Review fuer saubere und explizite Spaltenlisten bei Inserts. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
