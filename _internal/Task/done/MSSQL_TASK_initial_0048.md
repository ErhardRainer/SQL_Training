---
task_id: MSSQL_TASK_initial_0048
repository: SQL_Training
domain: MSSQL
title: "Script ManyToManyBridgeAudit.sql fuer 03_JOIN erstellen"
status: done
priority: 953
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T07:38:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0048"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/ManyToManyBridgeAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/ManyToManyBridgeAudit.md"
...
# MSSQL_TASK_initial_0048 - Script ManyToManyBridgeAudit.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Prueft Bridge-Tabellen auf Dubletten und Kardinalitaetsprobleme.
...
- T-SQL/03_JOIN/SQLScripts/ManyToManyBridgeAudit.sql
- T-SQL/03_JOIN/SQLScripts/ManyToManyBridgeAudit.md

## Umsetzungsauftrag

Erzeuge `ManyToManyBridgeAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Bridge-Tabellen auf Dubletten und Kardinalitaetsprobleme. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
