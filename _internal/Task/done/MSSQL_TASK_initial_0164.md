---
task_id: MSSQL_TASK_initial_0164
repository: SQL_Training
domain: MSSQL
title: "Script GroupByDataQualityProfile.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 837
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:31:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0164"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByDataQualityProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByDataQualityProfile.md"
...
# MSSQL_TASK_initial_0164 - Script GroupByDataQualityProfile.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Profiliert Verteilungen, Null-Anteile und Extremwerte ueber Gruppierungen.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByDataQualityProfile.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByDataQualityProfile.md

## Umsetzungsauftrag

Erzeuge `GroupByDataQualityProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Profiliert Verteilungen, Null-Anteile und Extremwerte ueber Gruppierungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
