---
task_id: MSSQL_TASK_initial_0307
repository: SQL_Training
domain: MSSQL
title: "Script TransactionAgeByDatabase.sql fuer 19_Transaktions erstellen"
status: done
priority: 694
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:13:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0307"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/TransactionAgeByDatabase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/TransactionAgeByDatabase.md"
...
# MSSQL_TASK_initial_0307 - Script TransactionAgeByDatabase.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Zeigt die aeltesten offenen Transaktionen je Datenbank kompakt an.
...
- T-SQL/19_Transaktions/SQLScripts/TransactionAgeByDatabase.sql
- T-SQL/19_Transaktions/SQLScripts/TransactionAgeByDatabase.md

## Umsetzungsauftrag

Erzeuge `TransactionAgeByDatabase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt die aeltesten offenen Transaktionen je Datenbank kompakt an. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
