---
task_id: MSSQL_TASK_initial_0279
repository: SQL_Training
domain: MSSQL
title: "Script GroupingIdDecodeLab.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 722
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:43:13Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0279"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeLab.md"
...
# MSSQL_TASK_initial_0279 - Script GroupingIdDecodeLab.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Entschluesselt `GROUPING_ID()`-Werte in anschauliche Komponenten.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeLab.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeLab.md

## Umsetzungsauftrag

Erzeuge `GroupingIdDecodeLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Entschluesselt `GROUPING_ID()`-Werte in anschauliche Komponenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
