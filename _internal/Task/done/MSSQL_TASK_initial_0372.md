---
task_id: MSSQL_TASK_initial_0372
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureDefaultParameterAudit.sql fuer 23_StoredProcedures erstellen"
status: done
priority: 629
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T13:40:03Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0372"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureDefaultParameterAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureDefaultParameterAudit.md"
...
# MSSQL_TASK_initial_0372 - Script ProcedureDefaultParameterAudit.sql fuer 23_StoredProcedures erstellen

## Anlass und Relevanz

Listet Default-Parameterwerte und moegliche Inkonsistenzen auf.
...
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureDefaultParameterAudit.sql
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureDefaultParameterAudit.md

## Umsetzungsauftrag

Erzeuge `ProcedureDefaultParameterAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `23_StoredProcedures` und diese fachliche Kurzbeschreibung als Rahmen: Listet Default-Parameterwerte und moegliche Inkonsistenzen auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
