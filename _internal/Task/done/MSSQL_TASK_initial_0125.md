---
task_id: MSSQL_TASK_initial_0125
repository: SQL_Training
domain: MSSQL
title: "Script UpdateBeforeAfterSnapshot.sql fuer 08_Update erstellen"
status: done
priority: 876
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T14:53:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0125"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateBeforeAfterSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateBeforeAfterSnapshot.md"
...
# MSSQL_TASK_initial_0125 - Script UpdateBeforeAfterSnapshot.sql fuer 08_Update erstellen

## Anlass und Relevanz

Schnappschuss vor und nach dem Update fuer Nachkontrollen.
...
- T-SQL/08_Update/SQLScripts/UpdateBeforeAfterSnapshot.sql
- T-SQL/08_Update/SQLScripts/UpdateBeforeAfterSnapshot.md

## Umsetzungsauftrag

Erzeuge `UpdateBeforeAfterSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss vor und nach dem Update fuer Nachkontrollen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
