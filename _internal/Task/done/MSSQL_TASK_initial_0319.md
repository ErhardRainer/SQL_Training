---
task_id: MSSQL_TASK_initial_0319
repository: SQL_Training
domain: MSSQL
title: "Script DataFileSizeBalanceReport.sql fuer 20_Create_Database erstellen"
status: done
priority: 682
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:13:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0319"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DataFileSizeBalanceReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DataFileSizeBalanceReport.md"
...
# MSSQL_TASK_initial_0319 - Script DataFileSizeBalanceReport.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Bericht ueber Groessenverteilung mehrerer Datenfiles.
...
- T-SQL/20_Create_Database/SQLScripts/DataFileSizeBalanceReport.sql
- T-SQL/20_Create_Database/SQLScripts/DataFileSizeBalanceReport.md

## Umsetzungsauftrag

Erzeuge `DataFileSizeBalanceReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Bericht ueber Groessenverteilung mehrerer Datenfiles. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
