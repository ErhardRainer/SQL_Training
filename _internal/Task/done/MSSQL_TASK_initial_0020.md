---
task_id: MSSQL_TASK_initial_0020
repository: SQL_Training
domain: MSSQL
title: "Script SelectExpressionCatalog.sql fuer 02_Select erstellen"
status: done
priority: 981
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:22:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0020"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectExpressionCatalog.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectExpressionCatalog.md"
...
# MSSQL_TASK_initial_0020 - Script SelectExpressionCatalog.sql fuer 02_Select erstellen

## Anlass und Relevanz

Katalog gaengiger Ausdrucksformen fuer Projektionen und Anzeigeformate.
...
- T-SQL/02_Select/SQLScripts/SelectExpressionCatalog.sql
- T-SQL/02_Select/SQLScripts/SelectExpressionCatalog.md

## Umsetzungsauftrag

Erzeuge `SelectExpressionCatalog.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Katalog gaengiger Ausdrucksformen fuer Projektionen und Anzeigeformate. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
