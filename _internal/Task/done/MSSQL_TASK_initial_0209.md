---
task_id: MSSQL_TASK_initial_0209
repository: SQL_Training
domain: MSSQL
title: "Script MergeOutputToHistory.sql fuer 13_Merge erstellen"
status: done
priority: 792
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:02:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0209"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeOutputToHistory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeOutputToHistory.md"
...
# MSSQL_TASK_initial_0209 - Script MergeOutputToHistory.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Schreibt die Aktionen eines `MERGE` direkt in eine Delta- oder Historientabelle.
...
- T-SQL/13_Merge/SQLScripts/MergeOutputToHistory.sql
- T-SQL/13_Merge/SQLScripts/MergeOutputToHistory.md

## Umsetzungsauftrag

Erzeuge `MergeOutputToHistory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Schreibt die Aktionen eines `MERGE` direkt in eine Delta- oder Historientabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
