---
task_id: MSSQL_TASK_initial_0223
repository: SQL_Training
domain: MSSQL
title: "Script PivotDynamicListBuilder.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 778
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:12:16Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0223"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotDynamicListBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotDynamicListBuilder.md"
...
# MSSQL_TASK_initial_0223 - Script PivotDynamicListBuilder.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Baut dynamische Spaltenlisten fuer Pivot-Abfragen.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotDynamicListBuilder.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotDynamicListBuilder.md

## Umsetzungsauftrag

Erzeuge `PivotDynamicListBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Baut dynamische Spaltenlisten fuer Pivot-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
