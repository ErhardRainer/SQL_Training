---
task_id: MSSQL_TASK_initial_0247
repository: SQL_Training
domain: MSSQL
title: "Script ConstraintNamingConventionAudit.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 754
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:29:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0247"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintNamingConventionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintNamingConventionAudit.md"
...
# MSSQL_TASK_initial_0247 - Script ConstraintNamingConventionAudit.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Prueft Constraint-Namen gegen eine konsistente Benennungsregel.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintNamingConventionAudit.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintNamingConventionAudit.md

## Umsetzungsauftrag

Erzeuge `ConstraintNamingConventionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Constraint-Namen gegen eine konsistente Benennungsregel. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
