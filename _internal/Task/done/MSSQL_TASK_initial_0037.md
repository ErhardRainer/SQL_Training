---
task_id: MSSQL_TASK_initial_0037
repository: SQL_Training
domain: MSSQL
title: "Script JoinFanoutHeatmap.sql fuer 03_JOIN erstellen"
status: done
priority: 964
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T06:57:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0037"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinFanoutHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinFanoutHeatmap.md"
...
# MSSQL_TASK_initial_0037 - Script JoinFanoutHeatmap.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Macht Join-Fanout ueber Gruppierungen und Zaehler sichtbar.
...
- T-SQL/03_JOIN/SQLScripts/JoinFanoutHeatmap.sql
- T-SQL/03_JOIN/SQLScripts/JoinFanoutHeatmap.md

## Umsetzungsauftrag

Erzeuge `JoinFanoutHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Macht Join-Fanout ueber Gruppierungen und Zaehler sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
