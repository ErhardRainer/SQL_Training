---
task_id: MSSQL_TASK_initial_0334
repository: SQL_Training
domain: MSSQL
title: "Script IndexedComputedColumnSettingsCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 667
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:23:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0334"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedComputedColumnSettingsCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedComputedColumnSettingsCheck.md"
...
# MSSQL_TASK_initial_0334 - Script IndexedComputedColumnSettingsCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Prueft Session-Settings fuer indexed computed columns.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedComputedColumnSettingsCheck.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedComputedColumnSettingsCheck.md

## Umsetzungsauftrag

Erzeuge `IndexedComputedColumnSettingsCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Session-Settings fuer indexed computed columns. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
