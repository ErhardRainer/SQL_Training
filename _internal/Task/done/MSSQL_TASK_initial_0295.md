---
task_id: MSSQL_TASK_initial_0295
repository: SQL_Training
domain: MSSQL
title: "Script KillDecisionChecklist.sql fuer 19_Transaktions erstellen"
status: done
priority: 706
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T04:58:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0295"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/KillDecisionChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/KillDecisionChecklist.md"
...
# MSSQL_TASK_initial_0295 - Script KillDecisionChecklist.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Checkliste vor einem `KILL` gegen lang laufende oder blockierende Sessions.
...
- T-SQL/19_Transaktions/SQLScripts/KillDecisionChecklist.sql
- T-SQL/19_Transaktions/SQLScripts/KillDecisionChecklist.md

## Umsetzungsauftrag

Erzeuge `KillDecisionChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste vor einem `KILL` gegen lang laufende oder blockierende Sessions. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
