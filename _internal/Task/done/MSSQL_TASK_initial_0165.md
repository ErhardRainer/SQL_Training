---
task_id: MSSQL_TASK_initial_0165
repository: SQL_Training
domain: MSSQL
title: "Script GroupByExpressionReuse.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 836
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:32:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0165"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByExpressionReuse.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByExpressionReuse.md"
...
# MSSQL_TASK_initial_0165 - Script GroupByExpressionReuse.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Zeigt, wie berechnete Gruppierungsausdruecke lesbar wiederverwendet werden koennen.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByExpressionReuse.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/GroupByExpressionReuse.md

## Umsetzungsauftrag

Erzeuge `GroupByExpressionReuse.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie berechnete Gruppierungsausdruecke lesbar wiederverwendet werden koennen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
