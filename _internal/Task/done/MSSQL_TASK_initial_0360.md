---
task_id: MSSQL_TASK_initial_0360
repository: SQL_Training
domain: MSSQL
title: "Script SynonymDependencyHeatmap.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 641
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:39:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0360"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SynonymDependencyHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SynonymDependencyHeatmap.md"
...
# MSSQL_TASK_initial_0360 - Script SynonymDependencyHeatmap.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Heatmap fuer die Nutzung von Synonymen in Abhaengigkeiten.
...
- T-SQL/22_Views_Schemata/SQLScripts/SynonymDependencyHeatmap.sql
- T-SQL/22_Views_Schemata/SQLScripts/SynonymDependencyHeatmap.md

## Umsetzungsauftrag

Erzeuge `SynonymDependencyHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap fuer die Nutzung von Synonymen in Abhaengigkeiten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
