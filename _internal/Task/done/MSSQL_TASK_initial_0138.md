---
task_id: MSSQL_TASK_initial_0138
repository: SQL_Training
domain: MSSQL
title: "Script CompareSourceTargetSets.sql fuer 09_Set_Operations erstellen"
status: done
priority: 863
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:42:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0138"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/CompareSourceTargetSets.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/CompareSourceTargetSets.md"
...
# MSSQL_TASK_initial_0138 - Script CompareSourceTargetSets.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Vergleicht Quell- und Zielmengen systematisch ueber Set-Operatoren.
...
- T-SQL/09_Set_Operations/SQLScripts/CompareSourceTargetSets.sql
- T-SQL/09_Set_Operations/SQLScripts/CompareSourceTargetSets.md

## Umsetzungsauftrag

Erzeuge `CompareSourceTargetSets.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Quell- und Zielmengen systematisch ueber Set-Operatoren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
