---
task_id: MSSQL_TASK_initial_0186
repository: SQL_Training
domain: MSSQL
title: "Script CollationCastImpactDemo.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 815
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:13:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0186"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/CollationCastImpactDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/CollationCastImpactDemo.md"
...
# MSSQL_TASK_initial_0186 - Script CollationCastImpactDemo.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Demonstriert Seiteneffekte von Kollations- und Typwechseln auf Vergleiche und Sortierung.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/CollationCastImpactDemo.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/CollationCastImpactDemo.md

## Umsetzungsauftrag

Erzeuge `CollationCastImpactDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Seiteneffekte von Kollations- und Typwechseln auf Vergleiche und Sortierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
