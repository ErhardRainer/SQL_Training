---
task_id: MSSQL_TASK_initial_0219
repository: SQL_Training
domain: MSSQL
title: "Script DynamicUnpivotTemplate.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 782
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:52:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0219"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicUnpivotTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicUnpivotTemplate.md"
...
# MSSQL_TASK_initial_0219 - Script DynamicUnpivotTemplate.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Dynamische Vorlage zum Entpivotisieren variabler Spaltenlisten.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicUnpivotTemplate.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicUnpivotTemplate.md

## Umsetzungsauftrag

Erzeuge `DynamicUnpivotTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Dynamische Vorlage zum Entpivotisieren variabler Spaltenlisten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
