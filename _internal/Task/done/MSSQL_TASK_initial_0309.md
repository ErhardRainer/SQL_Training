---
task_id: MSSQL_TASK_initial_0309
repository: SQL_Training
domain: MSSQL
title: "Script TranSavepointRecoveryLab.sql fuer 19_Transaktions erstellen"
status: done
priority: 692
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:23:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0309"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/TranSavepointRecoveryLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/TranSavepointRecoveryLab.md"
...
# MSSQL_TASK_initial_0309 - Script TranSavepointRecoveryLab.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Labor fuer Wiederherstellung mit Savepoints.
...
- T-SQL/19_Transaktions/SQLScripts/TranSavepointRecoveryLab.sql
- T-SQL/19_Transaktions/SQLScripts/TranSavepointRecoveryLab.md

## Umsetzungsauftrag

Erzeuge `TranSavepointRecoveryLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer Wiederherstellung mit Savepoints. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
