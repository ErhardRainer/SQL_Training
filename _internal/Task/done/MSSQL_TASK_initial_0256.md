---
task_id: MSSQL_TASK_initial_0256
repository: SQL_Training
domain: MSSQL
title: "Script ForeignKeyIndexCoverage.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 745
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:26:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0256"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyIndexCoverage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyIndexCoverage.md"
...
# MSSQL_TASK_initial_0256 - Script ForeignKeyIndexCoverage.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Prueft, ob Foreign-Key-Spalten sinnvoll indiziert sind.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyIndexCoverage.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyIndexCoverage.md

## Umsetzungsauftrag

Erzeuge `ForeignKeyIndexCoverage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, ob Foreign-Key-Spalten sinnvoll indiziert sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
