---
task_id: MSSQL_TASK_initial_0068
repository: SQL_Training
domain: MSSQL
title: "Script WherePredicateShortList.sql fuer 04_Where erstellen"
status: done
priority: 933
priority_class: high
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0068"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WherePredicateShortList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WherePredicateShortList.md"
...
# MSSQL_TASK_initial_0068 - Script WherePredicateShortList.sql fuer 04_Where erstellen

## Anlass und Relevanz

Sammlung kurzer, gut lesbarer Praedikatmuster fuer Schulungszwecke.
...
- T-SQL/04_Where/SQLScripts/WherePredicateShortList.sql
- T-SQL/04_Where/SQLScripts/WherePredicateShortList.md

## Umsetzungsauftrag

Erzeuge `WherePredicateShortList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Sammlung kurzer, gut lesbarer Praedikatmuster fuer Schulungszwecke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
