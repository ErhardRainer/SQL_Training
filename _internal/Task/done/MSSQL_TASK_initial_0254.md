---
task_id: MSSQL_TASK_initial_0254
repository: SQL_Training
domain: MSSQL
title: "Script ForeignKeyCascadeMap.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 747
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:12:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0254"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeMap.md"
...
# MSSQL_TASK_initial_0254 - Script ForeignKeyCascadeMap.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Zeichnet eine Map von Cascade-Regeln ueber FK-Beziehungen hinweg.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeMap.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeMap.md

## Umsetzungsauftrag

Erzeuge `ForeignKeyCascadeMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Zeichnet eine Map von Cascade-Regeln ueber FK-Beziehungen hinweg. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
