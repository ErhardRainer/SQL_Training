---
task_id: MSSQL_TASK_initial_0312
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseCreationChecklist.sql fuer 20_Create_Database erstellen"
status: done
priority: 689
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:38:51Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0312"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseCreationChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseCreationChecklist.md"
...
# MSSQL_TASK_initial_0312 - Script DatabaseCreationChecklist.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Checkliste fuer das Anlegen neuer Datenbanken inklusive Optionen und Dateien.
...
- T-SQL/20_Create_Database/SQLScripts/DatabaseCreationChecklist.sql
- T-SQL/20_Create_Database/SQLScripts/DatabaseCreationChecklist.md

## Umsetzungsauftrag

Erzeuge `DatabaseCreationChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer das Anlegen neuer Datenbanken inklusive Optionen und Dateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
