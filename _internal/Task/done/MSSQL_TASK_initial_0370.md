---
task_id: MSSQL_TASK_initial_0370
repository: SQL_Training
domain: MSSQL
title: "Script ViewSchemaBindingCandidates.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 631
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T12:34:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0370"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewSchemaBindingCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewSchemaBindingCandidates.md"
...
# MSSQL_TASK_initial_0370 - Script ViewSchemaBindingCandidates.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Markiert Views, die Kandidaten fuer `SCHEMABINDING` sein koennten.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewSchemaBindingCandidates.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewSchemaBindingCandidates.md

## Umsetzungsauftrag

Erzeuge `ViewSchemaBindingCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Views, die Kandidaten fuer `SCHEMABINDING` sein koennten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
