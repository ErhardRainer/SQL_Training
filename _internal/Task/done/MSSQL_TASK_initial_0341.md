---
task_id: MSSQL_TASK_initial_0341
repository: SQL_Training
domain: MSSQL
title: "Script ModuleQuotedIdentifierReport.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 660
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:58:36Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0341"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleQuotedIdentifierReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleQuotedIdentifierReport.md"
...
# MSSQL_TASK_initial_0341 - Script ModuleQuotedIdentifierReport.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Erstellt einen Report ueber `QUOTED_IDENTIFIER` je Modul.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleQuotedIdentifierReport.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleQuotedIdentifierReport.md

## Umsetzungsauftrag

Erzeuge `ModuleQuotedIdentifierReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt einen Report ueber `QUOTED_IDENTIFIER` je Modul. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
