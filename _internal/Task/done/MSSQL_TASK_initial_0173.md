---
task_id: MSSQL_TASK_initial_0173
repository: SQL_Training
domain: MSSQL
title: "Script NtileSegmentationDemo.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 828
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:12:31Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0173"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/NtileSegmentationDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/NtileSegmentationDemo.md"
...
# MSSQL_TASK_initial_0173 - Script NtileSegmentationDemo.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Segmentiert Daten mit `NTILE` fuer Quartile, Dezile und Buckets.
...
- T-SQL/11_WindowFunctions/SQLScripts/NtileSegmentationDemo.sql
- T-SQL/11_WindowFunctions/SQLScripts/NtileSegmentationDemo.md

## Umsetzungsauftrag

Erzeuge `NtileSegmentationDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Segmentiert Daten mit `NTILE` fuer Quartile, Dezile und Buckets. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
