---
task_id: MSSQL_TASK_initial_0081
repository: SQL_Training
domain: MSSQL
title: "Script FunctionWhitespaceCleanupDemo.sql fuer 05_Funktionen erstellen"
status: done
priority: 920
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:37:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0081"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionWhitespaceCleanupDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionWhitespaceCleanupDemo.md"
...
# MSSQL_TASK_initial_0081 - Script FunctionWhitespaceCleanupDemo.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Beispiele zum Bereinigen von Leerzeichen und unsichtbaren Zeichen.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionWhitespaceCleanupDemo.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionWhitespaceCleanupDemo.md

## Umsetzungsauftrag

Erzeuge `FunctionWhitespaceCleanupDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Beispiele zum Bereinigen von Leerzeichen und unsichtbaren Zeichen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
