---
task_id: MSSQL_TASK_initial_0321
repository: SQL_Training
domain: MSSQL
title: "Script FilegroupNamingConventionTemplate.sql fuer 20_Create_Database erstellen"
status: done
priority: 680
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:25:03Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0321"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegroupNamingConventionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegroupNamingConventionTemplate.md"
...
# MSSQL_TASK_initial_0321 - Script FilegroupNamingConventionTemplate.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Vorlage fuer saubere Benennung von Filegroups und Dateien.
...
- T-SQL/20_Create_Database/SQLScripts/FilegroupNamingConventionTemplate.sql
- T-SQL/20_Create_Database/SQLScripts/FilegroupNamingConventionTemplate.md

## Umsetzungsauftrag

Erzeuge `FilegroupNamingConventionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer saubere Benennung von Filegroups und Dateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
