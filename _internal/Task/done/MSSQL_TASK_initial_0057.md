---
task_id: MSSQL_TASK_initial_0057
repository: SQL_Training
domain: MSSQL
title: "Script OptionalFilterPatternDemo.sql fuer 04_Where erstellen"
status: done
priority: 944
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T08:23:47Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0057"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/OptionalFilterPatternDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/OptionalFilterPatternDemo.md"
...
# MSSQL_TASK_initial_0057 - Script OptionalFilterPatternDemo.sql fuer 04_Where erstellen

## Anlass und Relevanz

Zeigt typische Muster fuer optionale Parameterfilter und ihre Planwirkungen.
...
- T-SQL/04_Where/SQLScripts/OptionalFilterPatternDemo.sql
- T-SQL/04_Where/SQLScripts/OptionalFilterPatternDemo.md

## Umsetzungsauftrag

Erzeuge `OptionalFilterPatternDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt typische Muster fuer optionale Parameterfilter und ihre Planwirkungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
