---
task_id: MSSQL_TASK_initial_0304
repository: SQL_Training
domain: MSSQL
title: "Script RollbackProgressSampler.sql fuer 19_Transaktions erstellen"
status: done
priority: 697
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:03:40Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0304"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/RollbackProgressSampler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/RollbackProgressSampler.md"
...
# MSSQL_TASK_initial_0304 - Script RollbackProgressSampler.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Sampelt den Fortschritt von Rollback-Vorgaengen.
...
- T-SQL/19_Transaktions/SQLScripts/RollbackProgressSampler.sql
- T-SQL/19_Transaktions/SQLScripts/RollbackProgressSampler.md

## Umsetzungsauftrag

Erzeuge `RollbackProgressSampler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Sampelt den Fortschritt von Rollback-Vorgaengen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
