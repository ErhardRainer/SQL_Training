---
task_id: MSSQL_TASK_initial_0431
repository: SQL_Training
domain: MSSQL
title: "Script DuplicateIndexDefinitionCheck.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 570
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T00:59:42Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0431"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexDefinitionCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexDefinitionCheck.md"
...
# MSSQL_TASK_initial_0431 - Script DuplicateIndexDefinitionCheck.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Findet technisch fast identische Indizes auf derselben Tabelle.
...
- T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexDefinitionCheck.sql
- T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexDefinitionCheck.md

## Umsetzungsauftrag

Erzeuge `DuplicateIndexDefinitionCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Findet technisch fast identische Indizes auf derselben Tabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
