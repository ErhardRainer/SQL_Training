---
task_id: MSSQL_TASK_initial_0066
repository: SQL_Training
domain: MSSQL
title: "Script WhereListExpansionPatterns.sql fuer 04_Where erstellen"
status: done
priority: 935
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:08:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0066"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WhereListExpansionPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WhereListExpansionPatterns.md"
...
# MSSQL_TASK_initial_0066 - Script WhereListExpansionPatterns.sql fuer 04_Where erstellen

## Anlass und Relevanz

Beispiele fuer Listenfilter mit `IN`, Table Variables oder Splittern.
...
- T-SQL/04_Where/SQLScripts/WhereListExpansionPatterns.sql
- T-SQL/04_Where/SQLScripts/WhereListExpansionPatterns.md

## Umsetzungsauftrag

Erzeuge `WhereListExpansionPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Beispiele fuer Listenfilter mit `IN`, Table Variables oder Splittern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
