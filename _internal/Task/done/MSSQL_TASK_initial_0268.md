---
task_id: MSSQL_TASK_initial_0268
repository: SQL_Training
domain: MSSQL
title: "Script NullComparisonBehaviorLab.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 733
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:49:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0268"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/NullComparisonBehaviorLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/NullComparisonBehaviorLab.md"
...
# MSSQL_TASK_initial_0268 - Script NullComparisonBehaviorLab.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Demonstriert Vergleichslogik mit `NULL` unter unterschiedlichen Einstellungen.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/NullComparisonBehaviorLab.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/NullComparisonBehaviorLab.md

## Umsetzungsauftrag

Erzeuge `NullComparisonBehaviorLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Vergleichslogik mit `NULL` unter unterschiedlichen Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
