---
task_id: MSSQL_TASK_initial_0237
repository: SQL_Training
domain: MSSQL
title: "Script SearchForeignKeyNames.sql fuer 15_SearchInTables erstellen"
status: done
priority: 764
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:28:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0237"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchForeignKeyNames.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchForeignKeyNames.md"
...
# MSSQL_TASK_initial_0237 - Script SearchForeignKeyNames.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Findet Foreign Keys nach Tabellen- oder Begriffsfragmenten.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchForeignKeyNames.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchForeignKeyNames.md

## Umsetzungsauftrag

Erzeuge `SearchForeignKeyNames.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Findet Foreign Keys nach Tabellen- oder Begriffsfragmenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
