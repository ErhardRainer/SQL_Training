---
task_id: MSSQL_TASK_initial_0033
repository: SQL_Training
domain: MSSQL
title: "Script FindOrphanRows.sql fuer 03_JOIN erstellen"
status: done
priority: 968
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T03:29:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0033"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/FindOrphanRows.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/FindOrphanRows.md"
...
# MSSQL_TASK_initial_0033 - Script FindOrphanRows.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Findet verwaiste Datensaetze per `LEFT JOIN` bzw. `NOT EXISTS`.
...
- T-SQL/03_JOIN/SQLScripts/FindOrphanRows.sql
- T-SQL/03_JOIN/SQLScripts/FindOrphanRows.md

## Umsetzungsauftrag

Erzeuge `FindOrphanRows.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Findet verwaiste Datensaetze per `LEFT JOIN` bzw. `NOT EXISTS`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
