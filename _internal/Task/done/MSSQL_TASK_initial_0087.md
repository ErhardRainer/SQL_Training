---
task_id: MSSQL_TASK_initial_0087
repository: SQL_Training
domain: MSSQL
title: "Script StringSearchFunctionMatrix.sql fuer 05_Funktionen erstellen"
status: done
priority: 914
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:08:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0087"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/StringSearchFunctionMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/StringSearchFunctionMatrix.md"
...
# MSSQL_TASK_initial_0087 - Script StringSearchFunctionMatrix.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Vergleicht `CHARINDEX`, `PATINDEX`, `LIKE` und verwandte Suchfunktionen.
...
- T-SQL/05_Funktionen/SQLScripts/StringSearchFunctionMatrix.sql
- T-SQL/05_Funktionen/SQLScripts/StringSearchFunctionMatrix.md

## Umsetzungsauftrag

Erzeuge `StringSearchFunctionMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `CHARINDEX`, `PATINDEX`, `LIKE` und verwandte Suchfunktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
