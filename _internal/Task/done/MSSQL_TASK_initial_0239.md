---
task_id: MSSQL_TASK_initial_0239
repository: SQL_Training
domain: MSSQL
title: "Script SearchProcedureText.sql fuer 15_SearchInTables erstellen"
status: done
priority: 762
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:39:25Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0239"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchProcedureText.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchProcedureText.md"
...
# MSSQL_TASK_initial_0239 - Script SearchProcedureText.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Durchsucht Prozedurdefinitionen nach Textmustern oder Objektverweisen.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchProcedureText.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchProcedureText.md

## Umsetzungsauftrag

Erzeuge `SearchProcedureText.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Durchsucht Prozedurdefinitionen nach Textmustern oder Objektverweisen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
