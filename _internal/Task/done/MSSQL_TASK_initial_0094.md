---
task_id: MSSQL_TASK_initial_0094
repository: SQL_Training
domain: MSSQL
title: "Script DeleteBatchProgressTemplate.sql fuer 06_Delete erstellen"
status: done
priority: 907
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:43:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0094"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteBatchProgressTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteBatchProgressTemplate.md"
...
# MSSQL_TASK_initial_0094 - Script DeleteBatchProgressTemplate.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Template fuer Delete-Loops mit Fortschrittsanzeige.
...
- T-SQL/06_Delete/SQLScripts/DeleteBatchProgressTemplate.sql
- T-SQL/06_Delete/SQLScripts/DeleteBatchProgressTemplate.md

## Umsetzungsauftrag

Erzeuge `DeleteBatchProgressTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Template fuer Delete-Loops mit Fortschrittsanzeige. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
