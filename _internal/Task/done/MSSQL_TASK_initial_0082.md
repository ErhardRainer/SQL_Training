---
task_id: MSSQL_TASK_initial_0082
repository: SQL_Training
domain: MSSQL
title: "Script NullHandlingFunctionMatrix.sql fuer 05_Funktionen erstellen"
status: done
priority: 919
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:42:57Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0082"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/NullHandlingFunctionMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/NullHandlingFunctionMatrix.md"
...
# MSSQL_TASK_initial_0082 - Script NullHandlingFunctionMatrix.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Vergleicht `ISNULL`, `COALESCE`, `NULLIF` und verwandte Funktionen in einer Matrix.
...
- T-SQL/05_Funktionen/SQLScripts/NullHandlingFunctionMatrix.sql
- T-SQL/05_Funktionen/SQLScripts/NullHandlingFunctionMatrix.md

## Umsetzungsauftrag

Erzeuge `NullHandlingFunctionMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `ISNULL`, `COALESCE`, `NULLIF` und verwandte Funktionen in einer Matrix. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
