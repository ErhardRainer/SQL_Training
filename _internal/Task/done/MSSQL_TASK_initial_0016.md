---
task_id: MSSQL_TASK_initial_0016
repository: SQL_Training
domain: MSSQL
title: "Script ProjectionAliasPatterns.sql fuer 02_Select erstellen"
status: done
priority: 985
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:13:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0016"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/ProjectionAliasPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/ProjectionAliasPatterns.md"
...
# MSSQL_TASK_initial_0016 - Script ProjectionAliasPatterns.sql fuer 02_Select erstellen

## Anlass und Relevanz

Zeigt Projektionen, Literale, berechnete Spalten und Alias-Muster kompakt in einem Demo-Skript.
...
- T-SQL/02_Select/SQLScripts/ProjectionAliasPatterns.sql
- T-SQL/02_Select/SQLScripts/ProjectionAliasPatterns.md

## Umsetzungsauftrag

Erzeuge `ProjectionAliasPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Projektionen, Literale, berechnete Spalten und Alias-Muster kompakt in einem Demo-Skript. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
