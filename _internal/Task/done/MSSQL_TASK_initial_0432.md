---
task_id: MSSQL_TASK_initial_0432
repository: SQL_Training
domain: MSSQL
title: "Script FilteredIndexCandidateFinder.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 569
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T01:48:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0432"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCandidateFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCandidateFinder.md"
...
# MSSQL_TASK_initial_0432 - Script FilteredIndexCandidateFinder.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Findet Tabellenbereiche, die Kandidaten fuer Filtered Indexes sein koennten.
...
- T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCandidateFinder.sql
- T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCandidateFinder.md

## Umsetzungsauftrag

Erzeuge `FilteredIndexCandidateFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Findet Tabellenbereiche, die Kandidaten fuer Filtered Indexes sein koennten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
