---
task_id: MSSQL_TASK_initial_0092
repository: SQL_Training
domain: MSSQL
title: "Script DeleteArchiveSwitchPattern.sql fuer 06_Delete erstellen"
status: done
priority: 909
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:32:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0092"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteArchiveSwitchPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteArchiveSwitchPattern.md"
...
# MSSQL_TASK_initial_0092 - Script DeleteArchiveSwitchPattern.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Muster fuer Archivieren und anschliessendes Entfernen alter Daten.
...
- T-SQL/06_Delete/SQLScripts/DeleteArchiveSwitchPattern.sql
- T-SQL/06_Delete/SQLScripts/DeleteArchiveSwitchPattern.md

## Umsetzungsauftrag

Erzeuge `DeleteArchiveSwitchPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Muster fuer Archivieren und anschliessendes Entfernen alter Daten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
