---
task_id: MSSQL_TASK_initial_0232
repository: SQL_Training
domain: MSSQL
title: "Script UnpivotNullSafePattern.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 769
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:02:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0232"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotNullSafePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotNullSafePattern.md"
...
# MSSQL_TASK_initial_0232 - Script UnpivotNullSafePattern.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Zeigt robuste `UNPIVOT`-Muster inklusive `NULL`- und Datentypbehandlung.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotNullSafePattern.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotNullSafePattern.md

## Umsetzungsauftrag

Erzeuge `UnpivotNullSafePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt robuste `UNPIVOT`-Muster inklusive `NULL`- und Datentypbehandlung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
