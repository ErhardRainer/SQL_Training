---
task_id: MSSQL_TASK_initial_0093
repository: SQL_Training
domain: MSSQL
title: "Script DeleteAuditMirrorPattern.sql fuer 06_Delete erstellen"
status: done
priority: 908
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:37:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0093"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteAuditMirrorPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteAuditMirrorPattern.md"
...
# MSSQL_TASK_initial_0093 - Script DeleteAuditMirrorPattern.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Spiegelt geloeschte Zeilen in eine Audit-Struktur.
...
- T-SQL/06_Delete/SQLScripts/DeleteAuditMirrorPattern.sql
- T-SQL/06_Delete/SQLScripts/DeleteAuditMirrorPattern.md

## Umsetzungsauftrag

Erzeuge `DeleteAuditMirrorPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Spiegelt geloeschte Zeilen in eine Audit-Struktur. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
