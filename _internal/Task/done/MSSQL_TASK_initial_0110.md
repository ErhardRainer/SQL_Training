---
task_id: MSSQL_TASK_initial_0110
repository: SQL_Training
domain: MSSQL
title: "Script InsertFromValuesBatch.sql fuer 07_Insert erstellen"
status: done
priority: 891
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T01:30:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0110"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertFromValuesBatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertFromValuesBatch.md"
...
# MSSQL_TASK_initial_0110 - Script InsertFromValuesBatch.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Mehrzeilige Insert-Beispiele ueber VALUES-Bloecke.
...
- T-SQL/07_Insert/SQLScripts/InsertFromValuesBatch.sql
- T-SQL/07_Insert/SQLScripts/InsertFromValuesBatch.md

## Umsetzungsauftrag

Erzeuge `InsertFromValuesBatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Mehrzeilige Insert-Beispiele ueber VALUES-Bloecke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
