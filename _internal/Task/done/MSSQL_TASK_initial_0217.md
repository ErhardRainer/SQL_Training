---
task_id: MSSQL_TASK_initial_0217
repository: SQL_Training
domain: MSSQL
title: "Script DynamicPivotColumnListBuilder.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 784
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:43:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0217"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotColumnListBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotColumnListBuilder.md"
...
# MSSQL_TASK_initial_0217 - Script DynamicPivotColumnListBuilder.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Erstellt eine dynamische, sichere Spaltenliste fuer flexible Pivot-Abfragen.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotColumnListBuilder.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/DynamicPivotColumnListBuilder.md

## Umsetzungsauftrag

Erzeuge `DynamicPivotColumnListBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine dynamische, sichere Spaltenliste fuer flexible Pivot-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
