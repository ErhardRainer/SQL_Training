---
task_id: MSSQL_TASK_initial_0382
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureRecompileCandidateList.sql fuer 23_StoredProcedures erstellen"
status: done
priority: 619
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0382"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureRecompileCandidateList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureRecompileCandidateList.md"
...
# MSSQL_TASK_initial_0382 - Script ProcedureRecompileCandidateList.sql fuer 23_StoredProcedures erstellen

## Anlass und Relevanz

Liste moeglicher Kandidaten fuer gezielte Recompile-Strategien.
...
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureRecompileCandidateList.sql
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureRecompileCandidateList.md

## Umsetzungsauftrag

Erzeuge `ProcedureRecompileCandidateList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `23_StoredProcedures` und diese fachliche Kurzbeschreibung als Rahmen: Liste moeglicher Kandidaten fuer gezielte Recompile-Strategien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
