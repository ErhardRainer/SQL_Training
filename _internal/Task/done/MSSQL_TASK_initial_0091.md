---
task_id: MSSQL_TASK_initial_0091
repository: SQL_Training
domain: MSSQL
title: "Script DeleteArchiveBeforeRemove.sql fuer 06_Delete erstellen"
status: done
priority: 910
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:27:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0091"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteArchiveBeforeRemove.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteArchiveBeforeRemove.md"
...
# MSSQL_TASK_initial_0091 - Script DeleteArchiveBeforeRemove.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Archiviert betroffene Zeilen vor dem endgueltigen Loeschen in eine Sicherungstabelle.
...
- T-SQL/06_Delete/SQLScripts/DeleteArchiveBeforeRemove.sql
- T-SQL/06_Delete/SQLScripts/DeleteArchiveBeforeRemove.md

## Umsetzungsauftrag

Erzeuge `DeleteArchiveBeforeRemove.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Archiviert betroffene Zeilen vor dem endgueltigen Loeschen in eine Sicherungstabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
