---
task_id: MSSQL_TASK_initial_0002
repository: SQL_Training
domain: MSSQL
title: "Script CandidateKeySampler.sql fuer 01_Normalformen erstellen"
status: done
priority: 999
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T19:44:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0002"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/CandidateKeySampler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/CandidateKeySampler.md"
...
# MSSQL_TASK_initial_0002 - Script CandidateKeySampler.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Ermittelt potenzielle Kandidatenschluessel auf Basis von Distinct-Kombinationen.
...
- T-SQL/01_Normalformen/SQLScripts/CandidateKeySampler.sql
- T-SQL/01_Normalformen/SQLScripts/CandidateKeySampler.md

## Umsetzungsauftrag

Erzeuge `CandidateKeySampler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Ermittelt potenzielle Kandidatenschluessel auf Basis von Distinct-Kombinationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
