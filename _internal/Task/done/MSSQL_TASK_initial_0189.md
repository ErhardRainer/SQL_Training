---
task_id: MSSQL_TASK_initial_0189
repository: SQL_Training
domain: MSSQL
title: "Script ConversionPrecedenceSandbox.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 812
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:28:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0189"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionPrecedenceSandbox.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionPrecedenceSandbox.md"
...
# MSSQL_TASK_initial_0189 - Script ConversionPrecedenceSandbox.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Sandbox fuer Datentyp-Prioritaeten und implizite Zieltypen.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionPrecedenceSandbox.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionPrecedenceSandbox.md

## Umsetzungsauftrag

Erzeuge `ConversionPrecedenceSandbox.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Sandbox fuer Datentyp-Prioritaeten und implizite Zieltypen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
