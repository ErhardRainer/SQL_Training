---
task_id: MSSQL_TASK_initial_0097
repository: SQL_Training
domain: MSSQL
title: "Script DeleteImpactPreviewByKey.sql fuer 06_Delete erstellen"
status: done
priority: 904
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:59:26Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0097"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteImpactPreviewByKey.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteImpactPreviewByKey.md"
...
# MSSQL_TASK_initial_0097 - Script DeleteImpactPreviewByKey.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Preview der betroffenen Zeilen auf Basis eines Schluessels vor dem Delete.
...
- T-SQL/06_Delete/SQLScripts/DeleteImpactPreviewByKey.sql
- T-SQL/06_Delete/SQLScripts/DeleteImpactPreviewByKey.md

## Umsetzungsauftrag

Erzeuge `DeleteImpactPreviewByKey.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Preview der betroffenen Zeilen auf Basis eines Schluessels vor dem Delete. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
