---
task_id: MSSQL_TASK_initial_0169
repository: SQL_Training
domain: MSSQL
title: "Script DedupWithRowNumber.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 832
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:52:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0169"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/DedupWithRowNumber.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/DedupWithRowNumber.md"
...
# MSSQL_TASK_initial_0169 - Script DedupWithRowNumber.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Entfernt oder markiert Dubletten mithilfe von `ROW_NUMBER()`.
...
- T-SQL/11_WindowFunctions/SQLScripts/DedupWithRowNumber.sql
- T-SQL/11_WindowFunctions/SQLScripts/DedupWithRowNumber.md

## Umsetzungsauftrag

Erzeuge `DedupWithRowNumber.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Entfernt oder markiert Dubletten mithilfe von `ROW_NUMBER()`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
