---
task_id: MSSQL_TASK_initial_0248
repository: SQL_Training
domain: MSSQL
title: "Script ConstraintTrustStatusInventory.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 753
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:29:15Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0248"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintTrustStatusInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintTrustStatusInventory.md"
...
# MSSQL_TASK_initial_0248 - Script ConstraintTrustStatusInventory.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Inventarisiert Trust-Status und Aktivierung von Constraints.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintTrustStatusInventory.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintTrustStatusInventory.md

## Umsetzungsauftrag

Erzeuge `ConstraintTrustStatusInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Trust-Status und Aktivierung von Constraints. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
