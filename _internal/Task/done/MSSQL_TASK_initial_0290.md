---
task_id: MSSQL_TASK_initial_0290
repository: SQL_Training
domain: MSSQL
title: "Script SuperAggregateFilterPattern.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 711
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T07:38:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0290"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/SuperAggregateFilterPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/SuperAggregateFilterPattern.md"
...
# MSSQL_TASK_initial_0290 - Script SuperAggregateFilterPattern.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Filtert gezielt auf Super-Aggregate und Totals.
...
- T-SQL/18_Cube_Rollup/SQLScripts/SuperAggregateFilterPattern.sql
- T-SQL/18_Cube_Rollup/SQLScripts/SuperAggregateFilterPattern.md

## Umsetzungsauftrag

Erzeuge `SuperAggregateFilterPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Filtert gezielt auf Super-Aggregate und Totals. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
