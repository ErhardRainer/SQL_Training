---
task_id: MSSQL_TASK_initial_0354
repository: SQL_Training
domain: MSSQL
title: "Script CrossSchemaObjectInventory.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 647
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:09:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0354"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaObjectInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaObjectInventory.md"
...
# MSSQL_TASK_initial_0354 - Script CrossSchemaObjectInventory.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Inventarisiert Objekte je Schema und markiert schemauebergreifende Referenzen.
...
- T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaObjectInventory.sql
- T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaObjectInventory.md

## Umsetzungsauftrag

Erzeuge `CrossSchemaObjectInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Objekte je Schema und markiert schemauebergreifende Referenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
