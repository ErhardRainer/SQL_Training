---
task_id: MSSQL_TASK_initial_0215
repository: SQL_Training
domain: MSSQL
title: "Script MergeStagingDeltaClassifier.sql fuer 13_Merge erstellen"
status: done
priority: 786
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:32:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0215"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeStagingDeltaClassifier.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeStagingDeltaClassifier.md"
...
# MSSQL_TASK_initial_0215 - Script MergeStagingDeltaClassifier.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Klassifiziert Deltas in Stage-Daten vor dem eigentlichen Merge.
...
- T-SQL/13_Merge/SQLScripts/MergeStagingDeltaClassifier.sql
- T-SQL/13_Merge/SQLScripts/MergeStagingDeltaClassifier.md

## Umsetzungsauftrag

Erzeuge `MergeStagingDeltaClassifier.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Klassifiziert Deltas in Stage-Daten vor dem eigentlichen Merge. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
