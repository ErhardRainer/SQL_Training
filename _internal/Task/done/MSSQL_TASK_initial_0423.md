---
task_id: MSSQL_TASK_initial_0423
repository: SQL_Training
domain: MSSQL
title: "Script ThrowVsRaiserrorDemo.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 578
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T07:14:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0423"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowVsRaiserrorDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowVsRaiserrorDemo.md"
...
# MSSQL_TASK_initial_0423 - Script ThrowVsRaiserrorDemo.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Vergleicht `THROW` und `RAISERROR` im Verhalten innerhalb und ausserhalb von `TRY...CATCH`.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowVsRaiserrorDemo.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ThrowVsRaiserrorDemo.md

## Umsetzungsauftrag

Erzeuge `ThrowVsRaiserrorDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `THROW` und `RAISERROR` im Verhalten innerhalb und ausserhalb von `TRY...CATCH`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
