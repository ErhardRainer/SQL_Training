---
task_id: MSSQL_TASK_initial_0344
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierCreateScriptGuide.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 657
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:13:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0344"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierCreateScriptGuide.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierCreateScriptGuide.md"
...
# MSSQL_TASK_initial_0344 - Script QuotedIdentifierCreateScriptGuide.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Leitfaden fuer konsistente Create-Skripte mit Session-Optionen.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierCreateScriptGuide.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierCreateScriptGuide.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierCreateScriptGuide.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Leitfaden fuer konsistente Create-Skripte mit Session-Optionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
