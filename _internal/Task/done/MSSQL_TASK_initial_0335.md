---
task_id: MSSQL_TASK_initial_0335
repository: SQL_Training
domain: MSSQL
title: "Script IndexedViewBatchSettings.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 666
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:28:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0335"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewBatchSettings.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewBatchSettings.md"
...
# MSSQL_TASK_initial_0335 - Script IndexedViewBatchSettings.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Review fuer Session-Settings beim Arbeiten mit indexed views.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewBatchSettings.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewBatchSettings.md

## Umsetzungsauftrag

Erzeuge `IndexedViewBatchSettings.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Review fuer Session-Settings beim Arbeiten mit indexed views. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
