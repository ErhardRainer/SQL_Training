---
task_id: MSSQL_TASK_initial_0346
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierLegacyBatchScan.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 655
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:30:31Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0346"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierLegacyBatchScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierLegacyBatchScan.md"
...
# MSSQL_TASK_initial_0346 - Script QuotedIdentifierLegacyBatchScan.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Scan fuer aeltere Batch-Muster mit problematischem Quoted Identifier.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierLegacyBatchScan.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierLegacyBatchScan.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierLegacyBatchScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Scan fuer aeltere Batch-Muster mit problematischem Quoted Identifier. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
