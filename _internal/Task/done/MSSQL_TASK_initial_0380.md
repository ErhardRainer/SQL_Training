---
task_id: MSSQL_TASK_initial_0380
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureParameterInventory.sql fuer 23_StoredProcedures erstellen"
status: done
priority: 621
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T00:33:49Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0380"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureParameterInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureParameterInventory.md"
...
# MSSQL_TASK_initial_0380 - Script ProcedureParameterInventory.sql fuer 23_StoredProcedures erstellen

## Anlass und Relevanz

Erstellt ein Inventar aller Prozedurparameter inklusive Datentypen und Defaults.
...
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureParameterInventory.sql
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureParameterInventory.md

## Umsetzungsauftrag

Erzeuge `ProcedureParameterInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `23_StoredProcedures` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt ein Inventar aller Prozedurparameter inklusive Datentypen und Defaults. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
