---
task_id: MSSQL_TASK_initial_0214
repository: SQL_Training
domain: MSSQL
title: "Script MergeSourceRowUniqueness.sql fuer 13_Merge erstellen"
status: done
priority: 787
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:27:40Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0214"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceRowUniqueness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceRowUniqueness.md"
...
# MSSQL_TASK_initial_0214 - Script MergeSourceRowUniqueness.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Prueft Quellzeilen auf Eindeutigkeit vor dem Merge.
...
- T-SQL/13_Merge/SQLScripts/MergeSourceRowUniqueness.sql
- T-SQL/13_Merge/SQLScripts/MergeSourceRowUniqueness.md

## Umsetzungsauftrag

Erzeuge `MergeSourceRowUniqueness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Quellzeilen auf Eindeutigkeit vor dem Merge. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
