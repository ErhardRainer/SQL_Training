---
task_id: MSSQL_TASK_initial_0131
repository: SQL_Training
domain: MSSQL
title: "Script UpdateFromDerivedTable.sql fuer 08_Update erstellen"
status: done
priority: 870
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T02:07:34Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0131"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateFromDerivedTable.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateFromDerivedTable.md"
...
# MSSQL_TASK_initial_0131 - Script UpdateFromDerivedTable.sql fuer 08_Update erstellen

## Anlass und Relevanz

Zeigt Updates auf Basis einer vorberechneten Derived Table fuer nachvollziehbare Massenkorrekturen.
...
- T-SQL/08_Update/SQLScripts/UpdateFromDerivedTable.sql
- T-SQL/08_Update/SQLScripts/UpdateFromDerivedTable.md

## Umsetzungsauftrag

Erzeuge `UpdateFromDerivedTable.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Updates auf Basis einer vorberechneten Derived Table fuer nachvollziehbare Massenkorrekturen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
