---
task_id: MSSQL_TASK_initial_0196
repository: SQL_Training
domain: MSSQL
title: "Script SafeCastProfile.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 805
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:11:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0196"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/SafeCastProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/SafeCastProfile.md"
...
# MSSQL_TASK_initial_0196 - Script SafeCastProfile.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Profiliert, welche Werte sich sauber mit `TRY_CAST` oder `TRY_CONVERT` umwandeln lassen.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/SafeCastProfile.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/SafeCastProfile.md

## Umsetzungsauftrag

Erzeuge `SafeCastProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Profiliert, welche Werte sich sauber mit `TRY_CAST` oder `TRY_CONVERT` umwandeln lassen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
