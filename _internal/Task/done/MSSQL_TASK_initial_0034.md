---
task_id: MSSQL_TASK_initial_0034
repository: SQL_Training
domain: MSSQL
title: "Script JoinBridgeDuplicateCheck.sql fuer 03_JOIN erstellen"
status: done
priority: 967
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T03:49:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0034"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinBridgeDuplicateCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinBridgeDuplicateCheck.md"
...
# MSSQL_TASK_initial_0034 - Script JoinBridgeDuplicateCheck.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Prueft Zuordnungstabellen auf Dubletten, die Join-Fanout erzeugen.
...
- T-SQL/03_JOIN/SQLScripts/JoinBridgeDuplicateCheck.sql
- T-SQL/03_JOIN/SQLScripts/JoinBridgeDuplicateCheck.md

## Umsetzungsauftrag

Erzeuge `JoinBridgeDuplicateCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Zuordnungstabellen auf Dubletten, die Join-Fanout erzeugen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
