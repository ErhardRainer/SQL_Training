---
task_id: MSSQL_TASK_initial_0085
repository: SQL_Training
domain: MSSQL
title: "Script NumericSafetyFunctionDemo.sql fuer 05_Funktionen erstellen"
status: done
priority: 916
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:57:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0085"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/NumericSafetyFunctionDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/NumericSafetyFunctionDemo.md"
...
# MSSQL_TASK_initial_0085 - Script NumericSafetyFunctionDemo.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Demonstriert defensive Rechenmuster gegen Division durch Null und Overflow.
...
- T-SQL/05_Funktionen/SQLScripts/NumericSafetyFunctionDemo.sql
- T-SQL/05_Funktionen/SQLScripts/NumericSafetyFunctionDemo.md

## Umsetzungsauftrag

Erzeuge `NumericSafetyFunctionDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert defensive Rechenmuster gegen Division durch Null und Overflow. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
