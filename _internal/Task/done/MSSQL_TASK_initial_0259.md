---
task_id: MSSQL_TASK_initial_0259
repository: SQL_Training
domain: MSSQL
title: "Script PrimaryKeyCoverageReport.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 742
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:43:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0259"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/PrimaryKeyCoverageReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/PrimaryKeyCoverageReport.md"
...
# MSSQL_TASK_initial_0259 - Script PrimaryKeyCoverageReport.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Listet Tabellen ohne Primary Key oder mit ungewoehnlichen Schluesselmustern.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/PrimaryKeyCoverageReport.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/PrimaryKeyCoverageReport.md

## Umsetzungsauftrag

Erzeuge `PrimaryKeyCoverageReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Listet Tabellen ohne Primary Key oder mit ungewoehnlichen Schluesselmustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
