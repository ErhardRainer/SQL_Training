---
task_id: MSSQL_TASK_initial_0074
repository: SQL_Training
domain: MSSQL
title: "Script FunctionCharacterCountAudit.sql fuer 05_Funktionen erstellen"
status: done
priority: 927
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T00:52:39Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0074"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionCharacterCountAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionCharacterCountAudit.md"
...
# MSSQL_TASK_initial_0074 - Script FunctionCharacterCountAudit.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Prueft Zeichen- und Laengenfunktionen an realistischen Texten.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionCharacterCountAudit.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionCharacterCountAudit.md

## Umsetzungsauftrag

Erzeuge `FunctionCharacterCountAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Zeichen- und Laengenfunktionen an realistischen Texten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
