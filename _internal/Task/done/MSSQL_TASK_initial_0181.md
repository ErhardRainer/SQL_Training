---
task_id: MSSQL_TASK_initial_0181
repository: SQL_Training
domain: MSSQL
title: "Script WindowPreviousNextStatus.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 820
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:47:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0181"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowPreviousNextStatus.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowPreviousNextStatus.md"
...
# MSSQL_TASK_initial_0181 - Script WindowPreviousNextStatus.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Vergleich von aktuellem, vorherigem und naechstem Statuswert.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowPreviousNextStatus.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowPreviousNextStatus.md

## Umsetzungsauftrag

Erzeuge `WindowPreviousNextStatus.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Vergleich von aktuellem, vorherigem und naechstem Statuswert. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
