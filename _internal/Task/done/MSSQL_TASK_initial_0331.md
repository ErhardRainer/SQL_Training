---
task_id: MSSQL_TASK_initial_0331
repository: SQL_Training
domain: MSSQL
title: "Script FilteredIndexBuildSessionTemplate.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 670
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:08:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0331"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexBuildSessionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexBuildSessionTemplate.md"
...
# MSSQL_TASK_initial_0331 - Script FilteredIndexBuildSessionTemplate.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Vorlage fuer Session-Optionen beim Erstellen gefilterter Indizes.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexBuildSessionTemplate.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexBuildSessionTemplate.md

## Umsetzungsauftrag

Erzeuge `FilteredIndexBuildSessionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Session-Optionen beim Erstellen gefilterter Indizes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
