---
task_id: MSSQL_TASK_initial_0414
repository: SQL_Training
domain: MSSQL
title: "Script ErrorNumberFrequencyReport.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 587
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T10:07:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0414"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorNumberFrequencyReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorNumberFrequencyReport.md"
...
# MSSQL_TASK_initial_0414 - Script ErrorNumberFrequencyReport.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Aggregiert Fehlernummern aus Logs oder Testlaeufen nach Haeufigkeit.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorNumberFrequencyReport.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorNumberFrequencyReport.md

## Umsetzungsauftrag

Erzeuge `ErrorNumberFrequencyReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Aggregiert Fehlernummern aus Logs oder Testlaeufen nach Haeufigkeit. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
