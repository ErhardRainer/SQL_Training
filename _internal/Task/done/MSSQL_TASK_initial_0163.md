---
task_id: MSSQL_TASK_initial_0163
repository: SQL_Training
domain: MSSQL
title: "Script DistinctCountPatterns.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 838
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:22:41Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0163"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/DistinctCountPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/DistinctCountPatterns.md"
...
# MSSQL_TASK_initial_0163 - Script DistinctCountPatterns.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Zeigt Muster fuer `COUNT(DISTINCT ...)` und haeufige Stolperfallen bei Mehrfachjoins.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/DistinctCountPatterns.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/DistinctCountPatterns.md

## Umsetzungsauftrag

Erzeuge `DistinctCountPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Muster fuer `COUNT(DISTINCT ...)` und haeufige Stolperfallen bei Mehrfachjoins. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
