---
task_id: MSSQL_TASK_initial_0363
repository: SQL_Training
domain: MSSQL
title: "Script ViewDefinitionSearchIndex.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 638
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:55:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0363"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDefinitionSearchIndex.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDefinitionSearchIndex.md"
...
# MSSQL_TASK_initial_0363 - Script ViewDefinitionSearchIndex.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Suchindex ueber View-Definitionen fuer Analysezwecke.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewDefinitionSearchIndex.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewDefinitionSearchIndex.md

## Umsetzungsauftrag

Erzeuge `ViewDefinitionSearchIndex.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Suchindex ueber View-Definitionen fuer Analysezwecke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
