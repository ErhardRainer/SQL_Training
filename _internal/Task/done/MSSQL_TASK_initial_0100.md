---
task_id: MSSQL_TASK_initial_0100
repository: SQL_Training
domain: MSSQL
title: "Script DeleteTopLoopWithOrder.sql fuer 06_Delete erstellen"
status: done
priority: 901
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T12:18:13Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0100"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteTopLoopWithOrder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteTopLoopWithOrder.md"
...
# MSSQL_TASK_initial_0100 - Script DeleteTopLoopWithOrder.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Vorlage fuer deterministisches `DELETE TOP (n)` mit stabiler Sortierung.
...
- T-SQL/06_Delete/SQLScripts/DeleteTopLoopWithOrder.sql
- T-SQL/06_Delete/SQLScripts/DeleteTopLoopWithOrder.md

## Umsetzungsauftrag

Erzeuge `DeleteTopLoopWithOrder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer deterministisches `DELETE TOP (n)` mit stabiler Sortierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
