---
task_id: MSSQL_TASK_initial_0038
repository: SQL_Training
domain: MSSQL
title: "Script JoinMatchRateProfiler.sql fuer 03_JOIN erstellen"
status: done
priority: 963
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T17:09:27Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0038"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinMatchRateProfiler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinMatchRateProfiler.md"
...
# MSSQL_TASK_initial_0038 - Script JoinMatchRateProfiler.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Profiliert Match- und Nicht-Match-Raten zweier Join-Partner.
...
- T-SQL/03_JOIN/SQLScripts/JoinMatchRateProfiler.sql
- T-SQL/03_JOIN/SQLScripts/JoinMatchRateProfiler.md

## Umsetzungsauftrag

Erzeuge `JoinMatchRateProfiler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Profiliert Match- und Nicht-Match-Raten zweier Join-Partner. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
