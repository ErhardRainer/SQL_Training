---
task_id: MSSQL_TASK_initial_0332
repository: SQL_Training
domain: MSSQL
title: "Script FilteredIndexSessionOptionsAudit.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 669
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:12:50Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0332"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexSessionOptionsAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexSessionOptionsAudit.md"
...
# MSSQL_TASK_initial_0332 - Script FilteredIndexSessionOptionsAudit.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Audit fuer Session-Optionen, die bei Filtered Indexes wichtig sind.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexSessionOptionsAudit.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/FilteredIndexSessionOptionsAudit.md

## Umsetzungsauftrag

Erzeuge `FilteredIndexSessionOptionsAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Session-Optionen, die bei Filtered Indexes wichtig sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
