---
task_id: MSSQL_TASK_initial_0212
repository: SQL_Training
domain: MSSQL
title: "Script MergeSourceDedupGuard.sql fuer 13_Merge erstellen"
status: done
priority: 789
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:17:39Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0212"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceDedupGuard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceDedupGuard.md"
...
# MSSQL_TASK_initial_0212 - Script MergeSourceDedupGuard.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Verhindert Mehrfachtreffer im `MERGE` durch Voraggregation oder Quell-Deduplizierung.
...
- T-SQL/13_Merge/SQLScripts/MergeSourceDedupGuard.sql
- T-SQL/13_Merge/SQLScripts/MergeSourceDedupGuard.md

## Umsetzungsauftrag

Erzeuge `MergeSourceDedupGuard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Verhindert Mehrfachtreffer im `MERGE` durch Voraggregation oder Quell-Deduplizierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
