---
task_id: MSSQL_TASK_initial_0199
repository: SQL_Training
domain: MSSQL
title: "Script UnicodeFallbackRiskCheck.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 802
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:17:52Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0199"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeFallbackRiskCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeFallbackRiskCheck.md"
...
# MSSQL_TASK_initial_0199 - Script UnicodeFallbackRiskCheck.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Check fuer Probleme beim Wechsel zwischen Unicode- und Nicht-Unicode-Typen.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeFallbackRiskCheck.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeFallbackRiskCheck.md

## Umsetzungsauftrag

Erzeuge `UnicodeFallbackRiskCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Check fuer Probleme beim Wechsel zwischen Unicode- und Nicht-Unicode-Typen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
