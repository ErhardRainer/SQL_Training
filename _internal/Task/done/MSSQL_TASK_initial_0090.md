---
task_id: MSSQL_TASK_initial_0090
repository: SQL_Training
domain: MSSQL
title: "Script CascadingDeleteImpactCheck.sql fuer 06_Delete erstellen"
status: done
priority: 911
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:23:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0090"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/CascadingDeleteImpactCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/CascadingDeleteImpactCheck.md"
...
# MSSQL_TASK_initial_0090 - Script CascadingDeleteImpactCheck.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Schaetzt die Auswirkungen eines Deletes auf FK-Ketten und abhaengige Tabellen ab.
...
- T-SQL/06_Delete/SQLScripts/CascadingDeleteImpactCheck.sql
- T-SQL/06_Delete/SQLScripts/CascadingDeleteImpactCheck.md

## Umsetzungsauftrag

Erzeuge `CascadingDeleteImpactCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Schaetzt die Auswirkungen eines Deletes auf FK-Ketten und abhaengige Tabellen ab. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
