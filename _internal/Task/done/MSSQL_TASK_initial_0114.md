---
task_id: MSSQL_TASK_initial_0114
repository: SQL_Training
domain: MSSQL
title: "Script InsertOutputCapture.sql fuer 07_Insert erstellen"
status: done
priority: 887
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T13:47:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0114"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertOutputCapture.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertOutputCapture.md"
...
# MSSQL_TASK_initial_0114 - Script InsertOutputCapture.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Schreibt neu eingefuegte Schluessel und Metadaten via `OUTPUT` in eine Nachverfolgungstabelle.
...
- T-SQL/07_Insert/SQLScripts/InsertOutputCapture.sql
- T-SQL/07_Insert/SQLScripts/InsertOutputCapture.md

## Umsetzungsauftrag

Erzeuge `InsertOutputCapture.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Schreibt neu eingefuegte Schluessel und Metadaten via `OUTPUT` in eine Nachverfolgungstabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
