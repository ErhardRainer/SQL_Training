---
task_id: MSSQL_TASK_initial_0104
repository: SQL_Training
domain: MSSQL
title: "Script SoftDeleteMigrationTemplate.sql fuer 06_Delete erstellen"
status: done
priority: 897
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T12:37:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0104"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/SoftDeleteMigrationTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/SoftDeleteMigrationTemplate.md"
...
# MSSQL_TASK_initial_0104 - Script SoftDeleteMigrationTemplate.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Zeigt eine Umstellung von physischem Delete auf Soft-Delete-Felder.
...
- T-SQL/06_Delete/SQLScripts/SoftDeleteMigrationTemplate.sql
- T-SQL/06_Delete/SQLScripts/SoftDeleteMigrationTemplate.md

## Umsetzungsauftrag

Erzeuge `SoftDeleteMigrationTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt eine Umstellung von physischem Delete auf Soft-Delete-Felder. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
