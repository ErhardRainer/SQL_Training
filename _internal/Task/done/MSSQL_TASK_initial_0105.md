---
task_id: MSSQL_TASK_initial_0105
repository: SQL_Training
domain: MSSQL
title: "Script IdentityGapDemo.sql fuer 07_Insert erstellen"
status: done
priority: 896
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T12:42:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0105"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/IdentityGapDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/IdentityGapDemo.md"
...
# MSSQL_TASK_initial_0105 - Script IdentityGapDemo.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Zeigt, wie Identity-Luecken entstehen und warum sie fachlich oft unkritisch sind.
...
- T-SQL/07_Insert/SQLScripts/IdentityGapDemo.sql
- T-SQL/07_Insert/SQLScripts/IdentityGapDemo.md

## Umsetzungsauftrag

Erzeuge `IdentityGapDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie Identity-Luecken entstehen und warum sie fachlich oft unkritisch sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
