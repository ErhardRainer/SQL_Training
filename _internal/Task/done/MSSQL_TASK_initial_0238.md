---
task_id: MSSQL_TASK_initial_0238
repository: SQL_Training
domain: MSSQL
title: "Script SearchIdentityColumns.sql fuer 15_SearchInTables erstellen"
status: done
priority: 763
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:32:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0238"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchIdentityColumns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchIdentityColumns.md"
...
# MSSQL_TASK_initial_0238 - Script SearchIdentityColumns.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Findet Identity-Spalten im gesamten Schema.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchIdentityColumns.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchIdentityColumns.md

## Umsetzungsauftrag

Erzeuge `SearchIdentityColumns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Findet Identity-Spalten im gesamten Schema. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
