---
task_id: MSSQL_TASK_initial_0315
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseOwnerAndOptionsBaseline.sql fuer 20_Create_Database erstellen"
status: done
priority: 686
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:54:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0315"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerAndOptionsBaseline.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerAndOptionsBaseline.md"
...
# MSSQL_TASK_initial_0315 - Script DatabaseOwnerAndOptionsBaseline.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Liefert eine Basispruefung fuer Owner, Kompatibilitaet und wichtige Datenbankoptionen.
...
- T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerAndOptionsBaseline.sql
- T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerAndOptionsBaseline.md

## Umsetzungsauftrag

Erzeuge `DatabaseOwnerAndOptionsBaseline.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Liefert eine Basispruefung fuer Owner, Kompatibilitaet und wichtige Datenbankoptionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
