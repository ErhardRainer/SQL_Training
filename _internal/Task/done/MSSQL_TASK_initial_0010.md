---
task_id: MSSQL_TASK_initial_0010
repository: SQL_Training
domain: MSSQL
title: "Script ThirdNormalFormViolationExamples.sql fuer 01_Normalformen erstellen"
status: done
priority: 991
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T21:44:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0010"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/ThirdNormalFormViolationExamples.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/ThirdNormalFormViolationExamples.md"
...
# MSSQL_TASK_initial_0010 - Script ThirdNormalFormViolationExamples.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Beispielsammlung fuer 3NF-Verletzungen in realistischen Tabellenmodellen.
...
- T-SQL/01_Normalformen/SQLScripts/ThirdNormalFormViolationExamples.sql
- T-SQL/01_Normalformen/SQLScripts/ThirdNormalFormViolationExamples.md

## Umsetzungsauftrag

Erzeuge `ThirdNormalFormViolationExamples.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Beispielsammlung fuer 3NF-Verletzungen in realistischen Tabellenmodellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
