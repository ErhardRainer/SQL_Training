---
task_id: MSSQL_TASK_initial_0328
repository: SQL_Training
domain: MSSQL
title: "Script PrimaryFileRelocationPlan.sql fuer 20_Create_Database erstellen"
status: done
priority: 673
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:55:34Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0328"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/PrimaryFileRelocationPlan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/PrimaryFileRelocationPlan.md"
...
# MSSQL_TASK_initial_0328 - Script PrimaryFileRelocationPlan.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Plant die Verlagerung von Primary Files in strukturierte Pfade.
...
- T-SQL/20_Create_Database/SQLScripts/PrimaryFileRelocationPlan.sql
- T-SQL/20_Create_Database/SQLScripts/PrimaryFileRelocationPlan.md

## Umsetzungsauftrag

Erzeuge `PrimaryFileRelocationPlan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Plant die Verlagerung von Primary Files in strukturierte Pfade. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
