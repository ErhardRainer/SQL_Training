---
task_id: MSSQL_TASK_initial_0194
repository: SQL_Training
domain: MSSQL
title: "Script DecimalScaleLossReview.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 807
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:53:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0194"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalScaleLossReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalScaleLossReview.md"
...
# MSSQL_TASK_initial_0194 - Script DecimalScaleLossReview.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Macht Praezisions- und Skalenverluste bei numerischen Konvertierungen sichtbar.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalScaleLossReview.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalScaleLossReview.md

## Umsetzungsauftrag

Erzeuge `DecimalScaleLossReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Macht Praezisions- und Skalenverluste bei numerischen Konvertierungen sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
