---
task_id: MSSQL_TASK_initial_0143
repository: SQL_Training
domain: MSSQL
title: "Script SetExceptDriftAudit.sql fuer 09_Set_Operations erstellen"
status: done
priority: 858
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:37:21Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0143"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetExceptDriftAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetExceptDriftAudit.md"
...
# MSSQL_TASK_initial_0143 - Script SetExceptDriftAudit.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Audit fuer fachliche Drift ueber `EXCEPT`.
...
- T-SQL/09_Set_Operations/SQLScripts/SetExceptDriftAudit.sql
- T-SQL/09_Set_Operations/SQLScripts/SetExceptDriftAudit.md

## Umsetzungsauftrag

Erzeuge `SetExceptDriftAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer fachliche Drift ueber `EXCEPT`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
