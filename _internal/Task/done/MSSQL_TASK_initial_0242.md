---
task_id: MSSQL_TASK_initial_0242
repository: SQL_Training
domain: MSSQL
title: "Script SearchViewDefinitions.sql fuer 15_SearchInTables erstellen"
status: done
priority: 759
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:59:12Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0242"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchViewDefinitions.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchViewDefinitions.md"
...
# MSSQL_TASK_initial_0242 - Script SearchViewDefinitions.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Durchsucht View-Definitionen nach Begriffen oder veralteten Referenzen.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchViewDefinitions.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchViewDefinitions.md

## Umsetzungsauftrag

Erzeuge `SearchViewDefinitions.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Durchsucht View-Definitionen nach Begriffen oder veralteten Referenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
