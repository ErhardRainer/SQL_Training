---
task_id: MSSQL_TASK_initial_0029
repository: SQL_Training
domain: MSSQL
title: "Script TopOffsetFetchPlayground.sql fuer 02_Select erstellen"
status: done
priority: 972
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:49:39Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0029"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/TopOffsetFetchPlayground.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/TopOffsetFetchPlayground.md"
...
# MSSQL_TASK_initial_0029 - Script TopOffsetFetchPlayground.sql fuer 02_Select erstellen

## Anlass und Relevanz

Spielwiese fuer `TOP`, `OFFSET/FETCH` und Paging-Varianten mit vergleichbarer Sortierung.
...
- T-SQL/02_Select/SQLScripts/TopOffsetFetchPlayground.sql
- T-SQL/02_Select/SQLScripts/TopOffsetFetchPlayground.md

## Umsetzungsauftrag

Erzeuge `TopOffsetFetchPlayground.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Spielwiese fuer `TOP`, `OFFSET/FETCH` und Paging-Varianten mit vergleichbarer Sortierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
