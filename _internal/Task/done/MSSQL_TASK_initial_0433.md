---
task_id: MSSQL_TASK_initial_0433
repository: SQL_Training
domain: MSSQL
title: "Script FilteredIndexCoverageMap.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 568
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-16T23:59:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0433"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCoverageMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCoverageMap.md"
...
# MSSQL_TASK_initial_0433 - Script FilteredIndexCoverageMap.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Map fuer vorhandene und moegliche Filtered Indexes.
...
- T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCoverageMap.sql
- T-SQL/26_Indexes_Basics/SQLScripts/FilteredIndexCoverageMap.md

## Umsetzungsauftrag

Erzeuge `FilteredIndexCoverageMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Map fuer vorhandene und moegliche Filtered Indexes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
