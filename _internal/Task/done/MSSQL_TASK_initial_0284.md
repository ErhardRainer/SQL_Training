---
task_id: MSSQL_TASK_initial_0284
repository: SQL_Training
domain: MSSQL
title: "Script GroupingSetsFinancialLayout.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 717
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:08:51Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0284"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsFinancialLayout.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsFinancialLayout.md"
...
# MSSQL_TASK_initial_0284 - Script GroupingSetsFinancialLayout.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Layout-Vorlage fuer Finanzreports mit mehreren Aggregationsstufen.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsFinancialLayout.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetsFinancialLayout.md

## Umsetzungsauftrag

Erzeuge `GroupingSetsFinancialLayout.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Layout-Vorlage fuer Finanzreports mit mehreren Aggregationsstufen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
