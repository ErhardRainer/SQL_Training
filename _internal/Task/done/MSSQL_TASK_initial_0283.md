---
task_id: MSSQL_TASK_initial_0283
repository: SQL_Training
domain: MSSQL
title: "Script SelectiveSubtotalDesign.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 718
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T03:55:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0283"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/SelectiveSubtotalDesign.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/SelectiveSubtotalDesign.md"
...
# MSSQL_TASK_initial_0283 - Script SelectiveSubtotalDesign.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Hilft bei der gezielten Auswahl fachlich noetiger Subtotal-Ebenen statt voller `CUBE`-Expansion.
...
- T-SQL/18_Cube_Rollup/SQLScripts/SelectiveSubtotalDesign.sql
- T-SQL/18_Cube_Rollup/SQLScripts/SelectiveSubtotalDesign.md

## Umsetzungsauftrag

Erzeuge `SelectiveSubtotalDesign.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Hilft bei der gezielten Auswahl fachlich noetiger Subtotal-Ebenen statt voller `CUBE`-Expansion. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
