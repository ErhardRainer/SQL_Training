---
task_id: MSSQL_TASK_initial_0014
repository: SQL_Training
domain: MSSQL
title: "Script OrderByDeterminismDemo.sql fuer 02_Select erstellen"
status: done
priority: 987
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:03:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0014"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/OrderByDeterminismDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/OrderByDeterminismDemo.md"
...
# MSSQL_TASK_initial_0014 - Script OrderByDeterminismDemo.sql fuer 02_Select erstellen

## Anlass und Relevanz

Demonstriert, warum `TOP` ohne eindeutiges `ORDER BY` zu nicht deterministischen Ergebnissen fuehrt.
...
- T-SQL/02_Select/SQLScripts/OrderByDeterminismDemo.sql
- T-SQL/02_Select/SQLScripts/OrderByDeterminismDemo.md

## Umsetzungsauftrag

Erzeuge `OrderByDeterminismDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert, warum `TOP` ohne eindeutiges `ORDER BY` zu nicht deterministischen Ergebnissen fuehrt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
