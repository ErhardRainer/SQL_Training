---
task_id: MSSQL_TASK_initial_0052
repository: SQL_Training
domain: MSSQL
title: "Script BetweenBoundaryPitfalls.sql fuer 04_Where erstellen"
status: done
priority: 949
priority_class: high
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0052"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/BetweenBoundaryPitfalls.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/BetweenBoundaryPitfalls.md"
...
# MSSQL_TASK_initial_0052 - Script BetweenBoundaryPitfalls.sql fuer 04_Where erstellen

## Anlass und Relevanz

Macht inklusive Grenzen, Datumsenden und Off-by-one-Faelle bei `BETWEEN` sichtbar.
...
- T-SQL/04_Where/SQLScripts/BetweenBoundaryPitfalls.sql
- T-SQL/04_Where/SQLScripts/BetweenBoundaryPitfalls.md

## Umsetzungsauftrag

Erzeuge `BetweenBoundaryPitfalls.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Macht inklusive Grenzen, Datumsenden und Off-by-one-Faelle bei `BETWEEN` sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
