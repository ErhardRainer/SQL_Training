---
task_id: MSSQL_TASK_initial_0241
repository: SQL_Training
domain: MSSQL
title: "Script SearchValueAcrossTables.sql fuer 15_SearchInTables erstellen"
status: done
priority: 760
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:53:34Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0241"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchValueAcrossTables.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchValueAcrossTables.md"
...
# MSSQL_TASK_initial_0241 - Script SearchValueAcrossTables.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Durchsucht viele Tabellen dynamisch nach einem konkreten Wert oder Suchmuster.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchValueAcrossTables.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchValueAcrossTables.md

## Umsetzungsauftrag

Erzeuge `SearchValueAcrossTables.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Durchsucht viele Tabellen dynamisch nach einem konkreten Wert oder Suchmuster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
