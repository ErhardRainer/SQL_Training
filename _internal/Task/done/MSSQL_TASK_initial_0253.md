---
task_id: MSSQL_TASK_initial_0253
repository: SQL_Training
domain: MSSQL
title: "Script ForeignKeyCascadeDepthScan.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 748
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:09:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0253"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeDepthScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeDepthScan.md"
...
# MSSQL_TASK_initial_0253 - Script ForeignKeyCascadeDepthScan.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Scan fuer Kaskadentiefe in Foreign-Key-Ketten.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeDepthScan.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ForeignKeyCascadeDepthScan.md

## Umsetzungsauftrag

Erzeuge `ForeignKeyCascadeDepthScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Scan fuer Kaskadentiefe in Foreign-Key-Ketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
