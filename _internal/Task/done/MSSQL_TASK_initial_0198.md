---
task_id: MSSQL_TASK_initial_0198
repository: SQL_Training
domain: MSSQL
title: "Script TruncationRiskScanner.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 803
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:16:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0198"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/TruncationRiskScanner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/TruncationRiskScanner.md"
...
# MSSQL_TASK_initial_0198 - Script TruncationRiskScanner.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Markiert Spalten, bei denen reale Werte nah an der definierten Maximalbreite liegen.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/TruncationRiskScanner.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/TruncationRiskScanner.md

## Umsetzungsauftrag

Erzeuge `TruncationRiskScanner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Spalten, bei denen reale Werte nah an der definierten Maximalbreite liegen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
