---
task_id: MSSQL_TASK_initial_0314
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseOptionDriftAudit.sql fuer 20_Create_Database erstellen"
status: done
priority: 687
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:50:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0314"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOptionDriftAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOptionDriftAudit.md"
...
# MSSQL_TASK_initial_0314 - Script DatabaseOptionDriftAudit.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Audit ueber Optionsdrift gegen eine definierte Datenbank-Baseline.
...
- T-SQL/20_Create_Database/SQLScripts/DatabaseOptionDriftAudit.sql
- T-SQL/20_Create_Database/SQLScripts/DatabaseOptionDriftAudit.md

## Umsetzungsauftrag

Erzeuge `DatabaseOptionDriftAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Optionsdrift gegen eine definierte Datenbank-Baseline. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
