---
task_id: MSSQL_TASK_initial_0274
repository: SQL_Training
domain: MSSQL
title: "Script CubeOutputFormattingTemplate.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 727
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:20:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0274"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeOutputFormattingTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeOutputFormattingTemplate.md"
...
# MSSQL_TASK_initial_0274 - Script CubeOutputFormattingTemplate.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Vorlage fuer lesbare Cube-Ausgaben in Reports.
...
- T-SQL/18_Cube_Rollup/SQLScripts/CubeOutputFormattingTemplate.sql
- T-SQL/18_Cube_Rollup/SQLScripts/CubeOutputFormattingTemplate.md

## Umsetzungsauftrag

Erzeuge `CubeOutputFormattingTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer lesbare Cube-Ausgaben in Reports. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
