---
task_id: MSSQL_TASK_initial_0076
repository: SQL_Training
domain: MSSQL
title: "Script FunctionDateWindowBuilder.sql fuer 05_Funktionen erstellen"
status: done
priority: 925
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T01:03:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0076"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionDateWindowBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionDateWindowBuilder.md"
...
# MSSQL_TASK_initial_0076 - Script FunctionDateWindowBuilder.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Baut Zeitfenster mit Datumsfunktionen fuer Reporting-Szenarien.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionDateWindowBuilder.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionDateWindowBuilder.md

## Umsetzungsauftrag

Erzeuge `FunctionDateWindowBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Baut Zeitfenster mit Datumsfunktionen fuer Reporting-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
