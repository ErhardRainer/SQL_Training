---
task_id: MSSQL_TASK_initial_0221
repository: SQL_Training
domain: MSSQL
title: "Script PivotAuditDifferenceMatrix.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 780
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:02:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0221"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotAuditDifferenceMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotAuditDifferenceMatrix.md"
...
# MSSQL_TASK_initial_0221 - Script PivotAuditDifferenceMatrix.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Stellt Unterschiede in einer auditierbaren Pivot-Matrix dar.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotAuditDifferenceMatrix.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotAuditDifferenceMatrix.md

## Umsetzungsauftrag

Erzeuge `PivotAuditDifferenceMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Stellt Unterschiede in einer auditierbaren Pivot-Matrix dar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
