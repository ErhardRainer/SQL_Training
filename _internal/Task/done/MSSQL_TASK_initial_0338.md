---
task_id: MSSQL_TASK_initial_0338
repository: SQL_Training
domain: MSSQL
title: "Script LegacySessionSettingFinder.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 663
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:42:40Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0338"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/LegacySessionSettingFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/LegacySessionSettingFinder.md"
...
# MSSQL_TASK_initial_0338 - Script LegacySessionSettingFinder.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Findet Altmodule mit problematischen Session-Settings.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/LegacySessionSettingFinder.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/LegacySessionSettingFinder.md

## Umsetzungsauftrag

Erzeuge `LegacySessionSettingFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Findet Altmodule mit problematischen Session-Settings. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
