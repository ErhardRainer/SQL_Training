---
task_id: MSSQL_TASK_initial_0303
repository: SQL_Training
domain: MSSQL
title: "Script RollbackEtaApproximation.sql fuer 19_Transaktions erstellen"
status: done
priority: 698
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T17:14:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0303"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/RollbackEtaApproximation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/RollbackEtaApproximation.md"
...
# MSSQL_TASK_initial_0303 - Script RollbackEtaApproximation.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Versucht eine grobe ETA fuer laufende Rollbacks abzuschaetzen.
...
- T-SQL/19_Transaktions/SQLScripts/RollbackEtaApproximation.sql
- T-SQL/19_Transaktions/SQLScripts/RollbackEtaApproximation.md

## Umsetzungsauftrag

Erzeuge `RollbackEtaApproximation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Versucht eine grobe ETA fuer laufende Rollbacks abzuschaetzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
