---
task_id: MSSQL_TASK_initial_0430
repository: SQL_Training
domain: MSSQL
title: "Script DuplicateIndexCandidates.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 571
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T01:35:26Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0430"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexCandidates.md"
...
# MSSQL_TASK_initial_0430 - Script DuplicateIndexCandidates.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Findet vollstaendig oder weitgehend doppelte Indizes als Konsolidierungs-Kandidaten.
...
- T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexCandidates.sql
- T-SQL/26_Indexes_Basics/SQLScripts/DuplicateIndexCandidates.md

## Umsetzungsauftrag

Erzeuge `DuplicateIndexCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Findet vollstaendig oder weitgehend doppelte Indizes als Konsolidierungs-Kandidaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
