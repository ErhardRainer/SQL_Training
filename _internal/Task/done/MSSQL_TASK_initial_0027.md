---
task_id: MSSQL_TASK_initial_0027
repository: SQL_Training
domain: MSSQL
title: "Script SelectTopPercentDemo.sql fuer 02_Select erstellen"
status: done
priority: 974
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:38:22Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0027"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectTopPercentDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectTopPercentDemo.md"
...
# MSSQL_TASK_initial_0027 - Script SelectTopPercentDemo.sql fuer 02_Select erstellen

## Anlass und Relevanz

Beispiel fuer `TOP (x) PERCENT` und seine Fallstricke.
...
- T-SQL/02_Select/SQLScripts/SelectTopPercentDemo.sql
- T-SQL/02_Select/SQLScripts/SelectTopPercentDemo.md

## Umsetzungsauftrag

Erzeuge `SelectTopPercentDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Beispiel fuer `TOP (x) PERCENT` und seine Fallstricke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
