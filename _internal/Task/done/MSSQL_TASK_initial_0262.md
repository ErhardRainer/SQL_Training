---
task_id: MSSQL_TASK_initial_0262
repository: SQL_Training
domain: MSSQL
title: "Script AnsiNullDefaultInventory.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 739
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:19:16Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0262"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/AnsiNullDefaultInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/AnsiNullDefaultInventory.md"
...
# MSSQL_TASK_initial_0262 - Script AnsiNullDefaultInventory.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Inventarisiert Einstellungen und Auswirkungen von `ANSI_NULL_DFLT_*`.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/AnsiNullDefaultInventory.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/AnsiNullDefaultInventory.md

## Umsetzungsauftrag

Erzeuge `AnsiNullDefaultInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Einstellungen und Auswirkungen von `ANSI_NULL_DFLT_*`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
