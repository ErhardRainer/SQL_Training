---
task_id: MSSQL_TASK_initial_0065
repository: SQL_Training
domain: MSSQL
title: "Script WhereHalfOpenDateRange.sql fuer 04_Where erstellen"
status: done
priority: 936
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:02:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0065"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WhereHalfOpenDateRange.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WhereHalfOpenDateRange.md"
...
# MSSQL_TASK_initial_0065 - Script WhereHalfOpenDateRange.sql fuer 04_Where erstellen

## Anlass und Relevanz

Zeigt das robuste Halb-offen-Muster fuer Datumsbereiche.
...
- T-SQL/04_Where/SQLScripts/WhereHalfOpenDateRange.sql
- T-SQL/04_Where/SQLScripts/WhereHalfOpenDateRange.md

## Umsetzungsauftrag

Erzeuge `WhereHalfOpenDateRange.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt das robuste Halb-offen-Muster fuer Datumsbereiche. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
