---
task_id: MSSQL_TASK_initial_0415
repository: SQL_Training
domain: MSSQL
title: "Script ErrorSeverityRoutingMatrix.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 586
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T10:21:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0415"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorSeverityRoutingMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorSeverityRoutingMatrix.md"
...
# MSSQL_TASK_initial_0415 - Script ErrorSeverityRoutingMatrix.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Matrix fuer Routing nach Fehler-Schweregrad.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorSeverityRoutingMatrix.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorSeverityRoutingMatrix.md

## Umsetzungsauftrag

Erzeuge `ErrorSeverityRoutingMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Matrix fuer Routing nach Fehler-Schweregrad. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
