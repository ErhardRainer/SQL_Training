---
task_id: MSSQL_TASK_initial_0420
repository: SQL_Training
domain: MSSQL
title: "Script RetryableErrorClassifier.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 581
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T07:57:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0420"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RetryableErrorClassifier.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RetryableErrorClassifier.md"
...
# MSSQL_TASK_initial_0420 - Script RetryableErrorClassifier.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Klassifiziert typische Fehlercodes nach retrybar und nicht retrybar.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RetryableErrorClassifier.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RetryableErrorClassifier.md

## Umsetzungsauftrag

Erzeuge `RetryableErrorClassifier.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Klassifiziert typische Fehlercodes nach retrybar und nicht retrybar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
