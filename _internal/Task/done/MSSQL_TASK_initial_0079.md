---
task_id: MSSQL_TASK_initial_0079
repository: SQL_Training
domain: MSSQL
title: "Script FunctionStringNormalizeLab.sql fuer 05_Funktionen erstellen"
status: done
priority: 922
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T01:18:51Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0079"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionStringNormalizeLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionStringNormalizeLab.md"
...
# MSSQL_TASK_initial_0079 - Script FunctionStringNormalizeLab.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Labor fuer String-Normalisierung mit mehreren Textfunktionen.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionStringNormalizeLab.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionStringNormalizeLab.md

## Umsetzungsauftrag

Erzeuge `FunctionStringNormalizeLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer String-Normalisierung mit mehreren Textfunktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
