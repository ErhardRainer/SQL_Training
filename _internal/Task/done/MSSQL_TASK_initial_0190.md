---
task_id: MSSQL_TASK_initial_0190
repository: SQL_Training
domain: MSSQL
title: "Script DateLiteralAmbiguityLab.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 811
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:36:40Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0190"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DateLiteralAmbiguityLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DateLiteralAmbiguityLab.md"
...
# MSSQL_TASK_initial_0190 - Script DateLiteralAmbiguityLab.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Labor fuer mehrdeutige Datums-Literale und deren Interpretation.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/DateLiteralAmbiguityLab.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/DateLiteralAmbiguityLab.md

## Umsetzungsauftrag

Erzeuge `DateLiteralAmbiguityLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer mehrdeutige Datums-Literale und deren Interpretation. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
