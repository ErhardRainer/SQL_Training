---
task_id: MSSQL_TASK_initial_0039
repository: SQL_Training
domain: MSSQL
title: "Script JoinNullPropagationDemo.sql fuer 03_JOIN erstellen"
status: done
priority: 962
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T07:00:47Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0039"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinNullPropagationDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinNullPropagationDemo.md"
...
# MSSQL_TASK_initial_0039 - Script JoinNullPropagationDemo.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Macht sichtbar, wie `NULL`-Werte sich in verschiedenen Join-Typen verhalten.
...
- T-SQL/03_JOIN/SQLScripts/JoinNullPropagationDemo.sql
- T-SQL/03_JOIN/SQLScripts/JoinNullPropagationDemo.md

## Umsetzungsauftrag

Erzeuge `JoinNullPropagationDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Macht sichtbar, wie `NULL`-Werte sich in verschiedenen Join-Typen verhalten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
