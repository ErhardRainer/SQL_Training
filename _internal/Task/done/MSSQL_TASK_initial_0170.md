---
task_id: MSSQL_TASK_initial_0170
repository: SQL_Training
domain: MSSQL
title: "Script GapsAndIslandsStarter.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 831
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:57:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0170"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/GapsAndIslandsStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/GapsAndIslandsStarter.md"
...
# MSSQL_TASK_initial_0170 - Script GapsAndIslandsStarter.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Einstiegsskript fuer Gaps-and-Islands-Probleme mit `ROW_NUMBER()` und Differenzlogik.
...
- T-SQL/11_WindowFunctions/SQLScripts/GapsAndIslandsStarter.sql
- T-SQL/11_WindowFunctions/SQLScripts/GapsAndIslandsStarter.md

## Umsetzungsauftrag

Erzeuge `GapsAndIslandsStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Einstiegsskript fuer Gaps-and-Islands-Probleme mit `ROW_NUMBER()` und Differenzlogik. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
