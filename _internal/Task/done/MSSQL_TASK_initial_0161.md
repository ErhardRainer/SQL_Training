---
task_id: MSSQL_TASK_initial_0161
repository: SQL_Training
domain: MSSQL
title: "Script AggregateZeroActivityGroups.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 840
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:12:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0161"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateZeroActivityGroups.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateZeroActivityGroups.md"
...
# MSSQL_TASK_initial_0161 - Script AggregateZeroActivityGroups.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Hebt Gruppen mit Null-Aktivitaet oder fehlenden Bewegungen hervor.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateZeroActivityGroups.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateZeroActivityGroups.md

## Umsetzungsauftrag

Erzeuge `AggregateZeroActivityGroups.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Hebt Gruppen mit Null-Aktivitaet oder fehlenden Bewegungen hervor. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
