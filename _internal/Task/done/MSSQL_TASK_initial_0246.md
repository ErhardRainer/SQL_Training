---
task_id: MSSQL_TASK_initial_0246
repository: SQL_Training
domain: MSSQL
title: "Script ConstraintDisableEnableBatch.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 755
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:18:52Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0246"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDisableEnableBatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDisableEnableBatch.md"
...
# MSSQL_TASK_initial_0246 - Script ConstraintDisableEnableBatch.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Vorlage fuer kontrolliertes Deaktivieren und Reaktivieren von Constraints.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDisableEnableBatch.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDisableEnableBatch.md

## Umsetzungsauftrag

Erzeuge `ConstraintDisableEnableBatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer kontrolliertes Deaktivieren und Reaktivieren von Constraints. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
