---
task_id: MSSQL_TASK_initial_0017
repository: SQL_Training
domain: MSSQL
title: "Script SelectAliasCollisionCheck.sql fuer 02_Select erstellen"
status: done
priority: 984
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:18:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0017"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectAliasCollisionCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectAliasCollisionCheck.md"
...
# MSSQL_TASK_initial_0017 - Script SelectAliasCollisionCheck.sql fuer 02_Select erstellen

## Anlass und Relevanz

Demonstriert problematische Alias-Kollisionen und saubere Namenskonventionen.
...
- T-SQL/02_Select/SQLScripts/SelectAliasCollisionCheck.sql
- T-SQL/02_Select/SQLScripts/SelectAliasCollisionCheck.md

## Umsetzungsauftrag

Erzeuge `SelectAliasCollisionCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert problematische Alias-Kollisionen und saubere Namenskonventionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
