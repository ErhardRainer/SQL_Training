---
task_id: MSSQL_TASK_initial_0123
repository: SQL_Training
domain: MSSQL
title: "Script ConditionalUpdateByHash.sql fuer 08_Update erstellen"
status: done
priority: 878
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T14:42:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0123"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/ConditionalUpdateByHash.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/ConditionalUpdateByHash.md"
...
# MSSQL_TASK_initial_0123 - Script ConditionalUpdateByHash.sql fuer 08_Update erstellen

## Anlass und Relevanz

Fuehrt Updates nur bei geaendertem Zeilenhash aus und spart unnoetige Writes.
...
- T-SQL/08_Update/SQLScripts/ConditionalUpdateByHash.sql
- T-SQL/08_Update/SQLScripts/ConditionalUpdateByHash.md

## Umsetzungsauftrag

Erzeuge `ConditionalUpdateByHash.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Fuehrt Updates nur bei geaendertem Zeilenhash aus und spart unnoetige Writes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
