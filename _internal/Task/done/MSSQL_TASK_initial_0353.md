---
task_id: MSSQL_TASK_initial_0353
repository: SQL_Training
domain: MSSQL
title: "Script CrossSchemaGrantReview.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 648
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:04:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0353"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaGrantReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaGrantReview.md"
...
# MSSQL_TASK_initial_0353 - Script CrossSchemaGrantReview.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Review ueber Berechtigungen auf schemauebergreifende Objekte.
...
- T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaGrantReview.sql
- T-SQL/22_Views_Schemata/SQLScripts/CrossSchemaGrantReview.md

## Umsetzungsauftrag

Erzeuge `CrossSchemaGrantReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Berechtigungen auf schemauebergreifende Objekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
