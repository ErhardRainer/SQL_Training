---
task_id: MSSQL_TASK_initial_0229
repository: SQL_Training
domain: MSSQL
title: "Script PivotWideToTallCleanup.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 772
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:47:49Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0229"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotWideToTallCleanup.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotWideToTallCleanup.md"
...
# MSSQL_TASK_initial_0229 - Script PivotWideToTallCleanup.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Bereinigt breite Tabellen vor dem Entpivotisieren in ein Tall-Format.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotWideToTallCleanup.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotWideToTallCleanup.md

## Umsetzungsauftrag

Erzeuge `PivotWideToTallCleanup.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Bereinigt breite Tabellen vor dem Entpivotisieren in ein Tall-Format. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
