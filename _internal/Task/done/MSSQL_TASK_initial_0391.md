---
task_id: MSSQL_TASK_initial_0391
repository: SQL_Training
domain: MSSQL
title: "Script FunctionDataAccessHeatmap.sql fuer 24_UserDefinedFunctions erstellen"
status: done
priority: 610
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T13:26:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0391"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDataAccessHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDataAccessHeatmap.md"
...
# MSSQL_TASK_initial_0391 - Script FunctionDataAccessHeatmap.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Heatmap fuer Datenzugriffe aus Funktionen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDataAccessHeatmap.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDataAccessHeatmap.md

## Umsetzungsauftrag

Erzeuge `FunctionDataAccessHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap fuer Datenzugriffe aus Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
