---
task_id: MSSQL_TASK_initial_0176
repository: SQL_Training
domain: MSSQL
title: "Script WindowDenseRankComparison.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 825
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:26:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0176"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowDenseRankComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowDenseRankComparison.md"
...
# MSSQL_TASK_initial_0176 - Script WindowDenseRankComparison.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Vergleich von `RANK`, `DENSE_RANK` und `ROW_NUMBER`.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowDenseRankComparison.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowDenseRankComparison.md

## Umsetzungsauftrag

Erzeuge `WindowDenseRankComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Vergleich von `RANK`, `DENSE_RANK` und `ROW_NUMBER`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
