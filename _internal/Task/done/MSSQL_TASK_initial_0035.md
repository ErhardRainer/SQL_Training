---
task_id: MSSQL_TASK_initial_0035
repository: SQL_Training
domain: MSSQL
title: "Script JoinCardinalitySmokeTest.sql fuer 03_JOIN erstellen"
status: done
priority: 966
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:54:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0035"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinCardinalitySmokeTest.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinCardinalitySmokeTest.md"
...
# MSSQL_TASK_initial_0035 - Script JoinCardinalitySmokeTest.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Vergleicht Join-Ergebnisse und Kardinalitaeten fuer typische 1:n- und n:m-Faelle.
...
- T-SQL/03_JOIN/SQLScripts/JoinCardinalitySmokeTest.sql
- T-SQL/03_JOIN/SQLScripts/JoinCardinalitySmokeTest.md

## Umsetzungsauftrag

Erzeuge `JoinCardinalitySmokeTest.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Join-Ergebnisse und Kardinalitaeten fuer typische 1:n- und n:m-Faelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
