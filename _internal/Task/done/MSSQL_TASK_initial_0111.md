---
task_id: MSSQL_TASK_initial_0111
repository: SQL_Training
domain: MSSQL
title: "Script InsertIdentityEchoDemo.sql fuer 07_Insert erstellen"
status: done
priority: 890
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T13:26:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0111"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertIdentityEchoDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertIdentityEchoDemo.md"
...
# MSSQL_TASK_initial_0111 - Script InsertIdentityEchoDemo.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Zeigt, wie neue Identity-Werte direkt wieder ausgegeben werden.
...
- T-SQL/07_Insert/SQLScripts/InsertIdentityEchoDemo.sql
- T-SQL/07_Insert/SQLScripts/InsertIdentityEchoDemo.md

## Umsetzungsauftrag

Erzeuge `InsertIdentityEchoDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie neue Identity-Werte direkt wieder ausgegeben werden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
