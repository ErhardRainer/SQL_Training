---
task_id: MSSQL_TASK_initial_0187
repository: SQL_Training
domain: MSSQL
title: "Script ConversionFailureHeatmap.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 814
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:25:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0187"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionFailureHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionFailureHeatmap.md"
...
# MSSQL_TASK_initial_0187 - Script ConversionFailureHeatmap.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Heatmap fuer typische Konvertierungsfehler in einer Quellspalte.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionFailureHeatmap.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionFailureHeatmap.md

## Umsetzungsauftrag

Erzeuge `ConversionFailureHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap fuer typische Konvertierungsfehler in einer Quellspalte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
