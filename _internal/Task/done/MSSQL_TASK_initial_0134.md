---
task_id: MSSQL_TASK_initial_0134
repository: SQL_Training
domain: MSSQL
title: "Script UpdatePreviewWithJoin.sql fuer 08_Update erstellen"
status: done
priority: 867
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:47:22Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0134"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdatePreviewWithJoin.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdatePreviewWithJoin.md"
...
# MSSQL_TASK_initial_0134 - Script UpdatePreviewWithJoin.sql fuer 08_Update erstellen

## Anlass und Relevanz

Bietet eine Preview fuer geplante Join-Updates inklusive Alt-/Neu-Werten.
...
- T-SQL/08_Update/SQLScripts/UpdatePreviewWithJoin.sql
- T-SQL/08_Update/SQLScripts/UpdatePreviewWithJoin.md

## Umsetzungsauftrag

Erzeuge `UpdatePreviewWithJoin.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Bietet eine Preview fuer geplante Join-Updates inklusive Alt-/Neu-Werten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
