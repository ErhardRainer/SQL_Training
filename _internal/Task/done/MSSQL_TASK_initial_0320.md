---
task_id: MSSQL_TASK_initial_0320
repository: SQL_Training
domain: MSSQL
title: "Script FilegroupLayoutStarter.sql fuer 20_Create_Database erstellen"
status: done
priority: 681
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:19:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0320"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegroupLayoutStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegroupLayoutStarter.md"
...
# MSSQL_TASK_initial_0320 - Script FilegroupLayoutStarter.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Startskript fuer Filegroups, Dateinamen und Growth-Konventionen.
...
- T-SQL/20_Create_Database/SQLScripts/FilegroupLayoutStarter.sql
- T-SQL/20_Create_Database/SQLScripts/FilegroupLayoutStarter.md

## Umsetzungsauftrag

Erzeuge `FilegroupLayoutStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Startskript fuer Filegroups, Dateinamen und Growth-Konventionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
