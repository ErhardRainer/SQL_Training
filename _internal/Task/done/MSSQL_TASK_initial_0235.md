---
task_id: MSSQL_TASK_initial_0235
repository: SQL_Training
domain: MSSQL
title: "Script SearchConstraintDefinitions.sql fuer 15_SearchInTables erstellen"
status: done
priority: 766
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:18:28Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0235"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchConstraintDefinitions.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchConstraintDefinitions.md"
...
# MSSQL_TASK_initial_0235 - Script SearchConstraintDefinitions.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Findet CHECK-, DEFAULT- und FK-Definitionen mit passenden Suchbegriffen.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchConstraintDefinitions.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchConstraintDefinitions.md

## Umsetzungsauftrag

Erzeuge `SearchConstraintDefinitions.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Findet CHECK-, DEFAULT- und FK-Definitionen mit passenden Suchbegriffen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
