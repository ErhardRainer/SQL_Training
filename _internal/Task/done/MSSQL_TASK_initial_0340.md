---
task_id: MSSQL_TASK_initial_0340
repository: SQL_Training
domain: MSSQL
title: "Script ModuleOptionMismatchReport.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 661
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:54:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0340"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleOptionMismatchReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleOptionMismatchReport.md"
...
# MSSQL_TASK_initial_0340 - Script ModuleOptionMismatchReport.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Report ueber Modulumgebungen mit inkonsistenten Settings.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleOptionMismatchReport.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleOptionMismatchReport.md

## Umsetzungsauftrag

Erzeuge `ModuleOptionMismatchReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Report ueber Modulumgebungen mit inkonsistenten Settings. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
