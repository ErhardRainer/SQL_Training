---
task_id: MSSQL_TASK_initial_0191
repository: SQL_Training
domain: MSSQL
title: "Script DateParsingFailureBucket.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 810
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:40:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0191"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DateParsingFailureBucket.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DateParsingFailureBucket.md"
...
# MSSQL_TASK_initial_0191 - Script DateParsingFailureBucket.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Gruppiert problematische Datumsstrings nach Fehlermustern.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/DateParsingFailureBucket.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/DateParsingFailureBucket.md

## Umsetzungsauftrag

Erzeuge `DateParsingFailureBucket.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Gruppiert problematische Datumsstrings nach Fehlermustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
