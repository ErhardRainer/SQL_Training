---
task_id: MSSQL_TASK_initial_0305
repository: SQL_Training
domain: MSSQL
title: "Script SavepointDemoHarness.sql fuer 19_Transaktions erstellen"
status: done
priority: 696
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:08:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0305"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/SavepointDemoHarness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/SavepointDemoHarness.md"
...
# MSSQL_TASK_initial_0305 - Script SavepointDemoHarness.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Demonstriert `SAVE TRANSACTION` und partielles Rollback in einer Beispielstrecke.
...
- T-SQL/19_Transaktions/SQLScripts/SavepointDemoHarness.sql
- T-SQL/19_Transaktions/SQLScripts/SavepointDemoHarness.md

## Umsetzungsauftrag

Erzeuge `SavepointDemoHarness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert `SAVE TRANSACTION` und partielles Rollback in einer Beispielstrecke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
