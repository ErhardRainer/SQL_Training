---
task_id: MSSQL_TASK_initial_0351
repository: SQL_Training
domain: MSSQL
title: "Script BrokenViewReferenceFinder.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 650
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:54:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0351"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/BrokenViewReferenceFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/BrokenViewReferenceFinder.md"
...
# MSSQL_TASK_initial_0351 - Script BrokenViewReferenceFinder.sql fuer 22_Views_Schemata erstellen
...
- T-SQL/22_Views_Schemata/SQLScripts/BrokenViewReferenceFinder.sql
- T-SQL/22_Views_Schemata/SQLScripts/BrokenViewReferenceFinder.md

## Umsetzungsauftrag

Erzeuge `BrokenViewReferenceFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Findet Views mit potenziell gebrochenen Objekt- oder Spaltenreferenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
