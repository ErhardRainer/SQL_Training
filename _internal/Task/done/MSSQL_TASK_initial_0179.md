---
task_id: MSSQL_TASK_initial_0179
repository: SQL_Training
domain: MSSQL
title: "Script WindowPartitionShareDemo.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 822
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:36:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0179"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowPartitionShareDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowPartitionShareDemo.md"
...
# MSSQL_TASK_initial_0179 - Script WindowPartitionShareDemo.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Zeigt den Anteil einer Zeile an ihrer Partition.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowPartitionShareDemo.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowPartitionShareDemo.md

## Umsetzungsauftrag

Erzeuge `WindowPartitionShareDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Anteil einer Zeile an ihrer Partition. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
