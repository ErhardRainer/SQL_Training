---
task_id: MSSQL_TASK_initial_0225
repository: SQL_Training
domain: MSSQL
title: "Script PivotMeasureNameNormalizer.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 776
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:24:14Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0225"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotMeasureNameNormalizer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotMeasureNameNormalizer.md"
...
# MSSQL_TASK_initial_0225 - Script PivotMeasureNameNormalizer.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Normalisiert Kennzahlennamen fuer Pivot-Layouts.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotMeasureNameNormalizer.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotMeasureNameNormalizer.md

## Umsetzungsauftrag

Erzeuge `PivotMeasureNameNormalizer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Normalisiert Kennzahlennamen fuer Pivot-Layouts. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
