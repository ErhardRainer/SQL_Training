---
task_id: MSSQL_TASK_initial_0004
repository: SQL_Training
domain: MSSQL
title: "Script DetectPartialDependencies.sql fuer 01_Normalformen erstellen"
status: done
priority: 997
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T20:13:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0004"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/DetectPartialDependencies.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/DetectPartialDependencies.md"
...
# MSSQL_TASK_initial_0004 - Script DetectPartialDependencies.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Prueft Beispieldaten auf partielle Abhaengigkeiten als Einstieg in 2NF-Verletzungen.
...
- T-SQL/01_Normalformen/SQLScripts/DetectPartialDependencies.sql
- T-SQL/01_Normalformen/SQLScripts/DetectPartialDependencies.md

## Umsetzungsauftrag

Erzeuge `DetectPartialDependencies.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Beispieldaten auf partielle Abhaengigkeiten als Einstieg in 2NF-Verletzungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
