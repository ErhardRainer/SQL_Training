---
task_id: MSSQL_TASK_initial_0019
repository: SQL_Training
domain: MSSQL
title: "Script SelectDerivedAliasCatalogue.sql fuer 02_Select erstellen"
status: done
priority: 982
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T23:44:23Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0019"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectDerivedAliasCatalogue.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectDerivedAliasCatalogue.md"
...
# MSSQL_TASK_initial_0019 - Script SelectDerivedAliasCatalogue.sql fuer 02_Select erstellen

## Anlass und Relevanz

Sammlung typischer Alias- und Ausdrucksmuster in Projektionen.
...
- T-SQL/02_Select/SQLScripts/SelectDerivedAliasCatalogue.sql
- T-SQL/02_Select/SQLScripts/SelectDerivedAliasCatalogue.md

## Umsetzungsauftrag

Erzeuge `SelectDerivedAliasCatalogue.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Sammlung typischer Alias- und Ausdrucksmuster in Projektionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
