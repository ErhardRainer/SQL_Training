---
task_id: MSSQL_TASK_initial_0419
repository: SQL_Training
domain: MSSQL
title: "Script RethrowPreserveContextDemo.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 582
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T15:49:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0419"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RethrowPreserveContextDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RethrowPreserveContextDemo.md"
...
# MSSQL_TASK_initial_0419 - Script RethrowPreserveContextDemo.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Zeigt den Unterschied zwischen sauberem Rethrow und Kontextverlust.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RethrowPreserveContextDemo.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/RethrowPreserveContextDemo.md

## Umsetzungsauftrag

Erzeuge `RethrowPreserveContextDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Unterschied zwischen sauberem Rethrow und Kontextverlust. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
