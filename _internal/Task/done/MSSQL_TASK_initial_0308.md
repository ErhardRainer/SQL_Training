---
task_id: MSSQL_TASK_initial_0308
repository: SQL_Training
domain: MSSQL
title: "Script TransactionAgeRadar.sql fuer 19_Transaktions erstellen"
status: done
priority: 693
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:18:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0308"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/TransactionAgeRadar.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/TransactionAgeRadar.md"
...
# MSSQL_TASK_initial_0308 - Script TransactionAgeRadar.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Radar ueber das Alter laufender Transaktionen.
...
- T-SQL/19_Transaktions/SQLScripts/TransactionAgeRadar.sql
- T-SQL/19_Transaktions/SQLScripts/TransactionAgeRadar.md

## Umsetzungsauftrag

Erzeuge `TransactionAgeRadar.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Radar ueber das Alter laufender Transaktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
