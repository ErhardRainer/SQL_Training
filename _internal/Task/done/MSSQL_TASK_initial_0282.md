---
task_id: MSSQL_TASK_initial_0282
repository: SQL_Training
domain: MSSQL
title: "Script GroupingSetOverlapAudit.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 719
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:03:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0282"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetOverlapAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetOverlapAudit.md"
...
# MSSQL_TASK_initial_0282 - Script GroupingSetOverlapAudit.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Audit auf doppelt abgedeckte Gruppierungsstufen.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetOverlapAudit.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingSetOverlapAudit.md

## Umsetzungsauftrag

Erzeuge `GroupingSetOverlapAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Audit auf doppelt abgedeckte Gruppierungsstufen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
