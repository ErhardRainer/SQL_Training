---
task_id: MSSQL_TASK_initial_0107
repository: SQL_Training
domain: MSSQL
title: "Script InsertDefaultValueDemo.sql fuer 07_Insert erstellen"
status: done
priority: 894
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T12:52:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0107"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertDefaultValueDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertDefaultValueDemo.md"
...
# MSSQL_TASK_initial_0107 - Script InsertDefaultValueDemo.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Zeigt den Einsatz von Defaults, `IDENTITY` und expliziten Spaltenlisten beim Einfuegen.
...
- T-SQL/07_Insert/SQLScripts/InsertDefaultValueDemo.sql
- T-SQL/07_Insert/SQLScripts/InsertDefaultValueDemo.md

## Umsetzungsauftrag

Erzeuge `InsertDefaultValueDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Einsatz von Defaults, `IDENTITY` und expliziten Spaltenlisten beim Einfuegen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
