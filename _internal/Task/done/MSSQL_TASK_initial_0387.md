---
task_id: MSSQL_TASK_initial_0387
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureReturnCodeConvention.sql fuer 23_StoredProcedures erstellen"
status: done
priority: 614
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T12:51:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0387"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureReturnCodeConvention.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureReturnCodeConvention.md"
...
# MSSQL_TASK_initial_0387 - Script ProcedureReturnCodeConvention.sql fuer 23_StoredProcedures erstellen

## Anlass und Relevanz

Demonstriert konsistente Returncodes und Fehlerkonventionen fuer Stored Procedures.
...
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureReturnCodeConvention.sql
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureReturnCodeConvention.md

## Umsetzungsauftrag

Erzeuge `ProcedureReturnCodeConvention.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `23_StoredProcedures` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert konsistente Returncodes und Fehlerkonventionen fuer Stored Procedures. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
