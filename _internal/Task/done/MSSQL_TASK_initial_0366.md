---
task_id: MSSQL_TASK_initial_0366
repository: SQL_Training
domain: MSSQL
title: "Script ViewInvalidObjectProbe.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 635
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T12:10:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0366"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewInvalidObjectProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewInvalidObjectProbe.md"
...
# MSSQL_TASK_initial_0366 - Script ViewInvalidObjectProbe.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Probe auf ungÃƒÂ¼ltige oder aufgeloeste Objektverweise in Views.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewInvalidObjectProbe.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewInvalidObjectProbe.md

## Umsetzungsauftrag

Erzeuge `ViewInvalidObjectProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Probe auf ungÃƒÂ¼ltige oder aufgeloeste Objektverweise in Views. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
