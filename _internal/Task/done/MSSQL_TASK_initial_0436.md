---
task_id: MSSQL_TASK_initial_0436
repository: SQL_Training
domain: MSSQL
title: "Script IncludedColumnBloatReview.sql fuer 26_Indexes_Basics erstellen"
status: done
priority: 565
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-16T22:28:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0436"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IncludedColumnBloatReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IncludedColumnBloatReview.md"
...
# MSSQL_TASK_initial_0436 - Script IncludedColumnBloatReview.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Markiert Indizes mit potenziell zu breiten Include-Listen.
...
- T-SQL/26_Indexes_Basics/SQLScripts/IncludedColumnBloatReview.sql
- T-SQL/26_Indexes_Basics/SQLScripts/IncludedColumnBloatReview.md

## Umsetzungsauftrag

Erzeuge `IncludedColumnBloatReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Indizes mit potenziell zu breiten Include-Listen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
