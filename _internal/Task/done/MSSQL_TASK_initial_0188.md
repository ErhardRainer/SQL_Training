---
task_id: MSSQL_TASK_initial_0188
repository: SQL_Training
domain: MSSQL
title: "Script ConversionLocaleMismatchProbe.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 813
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:22:15Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0188"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionLocaleMismatchProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionLocaleMismatchProbe.md"
...
# MSSQL_TASK_initial_0188 - Script ConversionLocaleMismatchProbe.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Prueft Konvertierungsrisiken durch unterschiedliche Locale- und Formatannahmen.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionLocaleMismatchProbe.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/ConversionLocaleMismatchProbe.md

## Umsetzungsauftrag

Erzeuge `ConversionLocaleMismatchProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Konvertierungsrisiken durch unterschiedliche Locale- und Formatannahmen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
