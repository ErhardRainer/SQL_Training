---
task_id: MSSQL_TASK_initial_0099
repository: SQL_Training
domain: MSSQL
title: "Script DeleteRollbackDrill.sql fuer 06_Delete erstellen"
status: done
priority: 902
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T12:12:51Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0099"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteRollbackDrill.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteRollbackDrill.md"
...
# MSSQL_TASK_initial_0099 - Script DeleteRollbackDrill.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Uebungsskript fuer Rollback nach kritischen Deletes.
...
- T-SQL/06_Delete/SQLScripts/DeleteRollbackDrill.sql
- T-SQL/06_Delete/SQLScripts/DeleteRollbackDrill.md

## Umsetzungsauftrag

Erzeuge `DeleteRollbackDrill.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Uebungsskript fuer Rollback nach kritischen Deletes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
