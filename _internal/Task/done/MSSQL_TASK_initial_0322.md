---
task_id: MSSQL_TASK_initial_0322
repository: SQL_Training
domain: MSSQL
title: "Script FilegrowthPolicyAudit.sql fuer 20_Create_Database erstellen"
status: done
priority: 679
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:28:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0322"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegrowthPolicyAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/FilegrowthPolicyAudit.md"
...
# MSSQL_TASK_initial_0322 - Script FilegrowthPolicyAudit.sql fuer 20_Create_Database erstellen
...
- T-SQL/20_Create_Database/SQLScripts/FilegrowthPolicyAudit.sql
- T-SQL/20_Create_Database/SQLScripts/FilegrowthPolicyAudit.md

## Umsetzungsauftrag

Erzeuge `FilegrowthPolicyAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Daten- und Logdateien auf problematische Growth-Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
