---
task_id: MSSQL_TASK_initial_0072
repository: SQL_Training
domain: MSSQL
title: "Script DateFunctionCookbook.sql fuer 05_Funktionen erstellen"
status: done
priority: 929
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:37:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0072"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/DateFunctionCookbook.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/DateFunctionCookbook.md"
...
# MSSQL_TASK_initial_0072 - Script DateFunctionCookbook.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Liefert praxisnahe Rezepte fuer Datumsfunktionen, Monatsgrenzen und Intervallrechnungen.
...
- T-SQL/05_Funktionen/SQLScripts/DateFunctionCookbook.sql
- T-SQL/05_Funktionen/SQLScripts/DateFunctionCookbook.md

## Umsetzungsauftrag

Erzeuge `DateFunctionCookbook.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Liefert praxisnahe Rezepte fuer Datumsfunktionen, Monatsgrenzen und Intervallrechnungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
