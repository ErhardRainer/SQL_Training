---
task_id: MSSQL_TASK_initial_0001
repository: SQL_Training
domain: MSSQL
title: "Script BcnfDecompositionStarter.sql fuer 01_Normalformen erstellen"
status: done
priority: 1000
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T19:23:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0001"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/BcnfDecompositionStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/BcnfDecompositionStarter.md"
...
# MSSQL_TASK_initial_0001 - Script BcnfDecompositionStarter.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Startskript fuer die Zerlegung hin zu BCNF.
...
- T-SQL/01_Normalformen/SQLScripts/BcnfDecompositionStarter.sql
- T-SQL/01_Normalformen/SQLScripts/BcnfDecompositionStarter.md

## Umsetzungsauftrag

Erzeuge `BcnfDecompositionStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Startskript fuer die Zerlegung hin zu BCNF. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
