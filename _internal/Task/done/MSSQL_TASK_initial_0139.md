---
task_id: MSSQL_TASK_initial_0139
repository: SQL_Training
domain: MSSQL
title: "Script ExceptIntersectAudit.sql fuer 09_Set_Operations erstellen"
status: done
priority: 862
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:37:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0139"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/ExceptIntersectAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/ExceptIntersectAudit.md"
...
# MSSQL_TASK_initial_0139 - Script ExceptIntersectAudit.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Erstellt eine Audit-Sicht auf Gleichheiten und Unterschiede zweier Ergebnismengen.
...
- T-SQL/09_Set_Operations/SQLScripts/ExceptIntersectAudit.sql
- T-SQL/09_Set_Operations/SQLScripts/ExceptIntersectAudit.md

## Umsetzungsauftrag

Erzeuge `ExceptIntersectAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine Audit-Sicht auf Gleichheiten und Unterschiede zweier Ergebnismengen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
