---
task_id: MSSQL_TASK_initial_0062
repository: SQL_Training
domain: MSSQL
title: "Script WhereBooleanPrecedenceLab.sql fuer 04_Where erstellen"
status: done
priority: 939
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T00:53:14Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0062"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WhereBooleanPrecedenceLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WhereBooleanPrecedenceLab.md"
...
# MSSQL_TASK_initial_0062 - Script WhereBooleanPrecedenceLab.sql fuer 04_Where erstellen

## Anlass und Relevanz

Demonstriert die Wirkung von AND/OR-Prioritaeten in Filterketten.
...
- T-SQL/04_Where/SQLScripts/WhereBooleanPrecedenceLab.sql
- T-SQL/04_Where/SQLScripts/WhereBooleanPrecedenceLab.md

## Umsetzungsauftrag

Erzeuge `WhereBooleanPrecedenceLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert die Wirkung von AND/OR-Prioritaeten in Filterketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
