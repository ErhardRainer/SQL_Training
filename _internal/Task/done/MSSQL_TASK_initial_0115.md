---
task_id: MSSQL_TASK_initial_0115
repository: SQL_Training
domain: MSSQL
title: "Script InsertOutputIdentityCapture.sql fuer 07_Insert erstellen"
status: done
priority: 886
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T13:52:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0115"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertOutputIdentityCapture.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertOutputIdentityCapture.md"
...
# MSSQL_TASK_initial_0115 - Script InsertOutputIdentityCapture.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Faengt neue Identity-Werte per `OUTPUT` fuer Folgeoperationen sauber ab.
...
- T-SQL/07_Insert/SQLScripts/InsertOutputIdentityCapture.sql
- T-SQL/07_Insert/SQLScripts/InsertOutputIdentityCapture.md

## Umsetzungsauftrag

Erzeuge `InsertOutputIdentityCapture.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Faengt neue Identity-Werte per `OUTPUT` fuer Folgeoperationen sauber ab. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
