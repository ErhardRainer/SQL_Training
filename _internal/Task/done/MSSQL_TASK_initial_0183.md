---
task_id: MSSQL_TASK_initial_0183
repository: SQL_Training
domain: MSSQL
title: "Script WindowSequenceAnomalyScan.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 818
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:58:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0183"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowSequenceAnomalyScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowSequenceAnomalyScan.md"
...
# MSSQL_TASK_initial_0183 - Script WindowSequenceAnomalyScan.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Scan fuer Ausreisser und Spruenge in Sequenzen mittels Window Functions.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowSequenceAnomalyScan.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowSequenceAnomalyScan.md

## Umsetzungsauftrag

Erzeuge `WindowSequenceAnomalyScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Scan fuer Ausreisser und Spruenge in Sequenzen mittels Window Functions. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
