---
task_id: MSSQL_TASK_initial_0424
repository: SQL_Training
domain: MSSQL
title: "Script TransactionRollbackAudit.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 577
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T07:53:50Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0424"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransactionRollbackAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransactionRollbackAudit.md"
...
# MSSQL_TASK_initial_0424 - Script TransactionRollbackAudit.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Zeigt Rollback-Pfade und moegliche Audit-Infos nach Fehlern in Transaktionen.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransactionRollbackAudit.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransactionRollbackAudit.md

## Umsetzungsauftrag

Erzeuge `TransactionRollbackAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Rollback-Pfade und moegliche Audit-Infos nach Fehlern in Transaktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
