---
task_id: MSSQL_TASK_initial_0361
repository: SQL_Training
domain: MSSQL
title: "Script SynonymInventoryReport.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 640
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:43:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0361"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SynonymInventoryReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SynonymInventoryReport.md"
...
# MSSQL_TASK_initial_0361 - Script SynonymInventoryReport.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Uebersicht ueber Synonyme und ihre Zielobjekte.
...
- T-SQL/22_Views_Schemata/SQLScripts/SynonymInventoryReport.sql
- T-SQL/22_Views_Schemata/SQLScripts/SynonymInventoryReport.md

## Umsetzungsauftrag

Erzeuge `SynonymInventoryReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber Synonyme und ihre Zielobjekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
