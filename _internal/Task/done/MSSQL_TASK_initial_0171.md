---
task_id: MSSQL_TASK_initial_0171
repository: SQL_Training
domain: MSSQL
title: "Script LagLeadChangeDetection.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 830
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:01:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0171"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetection.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetection.md"
...
# MSSQL_TASK_initial_0171 - Script LagLeadChangeDetection.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Erkennt Zustandswechsel und Aenderungen ueber `LAG` und `LEAD`.
...
- T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetection.sql
- T-SQL/11_WindowFunctions/SQLScripts/LagLeadChangeDetection.md

## Umsetzungsauftrag

Erzeuge `LagLeadChangeDetection.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Erkennt Zustandswechsel und Aenderungen ueber `LAG` und `LEAD`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
