---
task_id: MSSQL_TASK_initial_0316
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseOwnerReview.sql fuer 20_Create_Database erstellen"
status: done
priority: 685
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T07:58:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0316"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerReview.md"
...
# MSSQL_TASK_initial_0316 - Script DatabaseOwnerReview.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Review ueber DB-Owner und Besitzkonventionen.
...
- T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerReview.sql
- T-SQL/20_Create_Database/SQLScripts/DatabaseOwnerReview.md

## Umsetzungsauftrag

Erzeuge `DatabaseOwnerReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber DB-Owner und Besitzkonventionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
