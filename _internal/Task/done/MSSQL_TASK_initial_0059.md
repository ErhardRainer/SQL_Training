---
task_id: MSSQL_TASK_initial_0059
repository: SQL_Training
domain: MSSQL
title: "Script PredicateSelectivityQuickCheck.sql fuer 04_Where erstellen"
status: done
priority: 942
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T08:38:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0059"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/PredicateSelectivityQuickCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/PredicateSelectivityQuickCheck.md"
...
# MSSQL_TASK_initial_0059 - Script PredicateSelectivityQuickCheck.sql fuer 04_Where erstellen

## Anlass und Relevanz

Misst schnell, wie selektiv typische Filterbedingungen auf einer Tabelle sind.
...
- T-SQL/04_Where/SQLScripts/PredicateSelectivityQuickCheck.sql
- T-SQL/04_Where/SQLScripts/PredicateSelectivityQuickCheck.md

## Umsetzungsauftrag

Erzeuge `PredicateSelectivityQuickCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Misst schnell, wie selektiv typische Filterbedingungen auf einer Tabelle sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
