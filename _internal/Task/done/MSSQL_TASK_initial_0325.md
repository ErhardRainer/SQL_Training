---
task_id: MSSQL_TASK_initial_0325
repository: SQL_Training
domain: MSSQL
title: "Script GrowthIncrementNormalizer.sql fuer 20_Create_Database erstellen"
status: done
priority: 676
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:43:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0325"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/GrowthIncrementNormalizer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/GrowthIncrementNormalizer.md"
...
# MSSQL_TASK_initial_0325 - Script GrowthIncrementNormalizer.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Harmonisiert Growth-Inkremente fuer Daten- und Logfiles.
...
- T-SQL/20_Create_Database/SQLScripts/GrowthIncrementNormalizer.sql
- T-SQL/20_Create_Database/SQLScripts/GrowthIncrementNormalizer.md

## Umsetzungsauftrag

Erzeuge `GrowthIncrementNormalizer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Harmonisiert Growth-Inkremente fuer Daten- und Logfiles. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
