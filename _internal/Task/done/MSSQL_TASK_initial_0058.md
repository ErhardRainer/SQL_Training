---
task_id: MSSQL_TASK_initial_0058
repository: SQL_Training
domain: MSSQL
title: "Script PredicatePushdownPreview.sql fuer 04_Where erstellen"
status: done
priority: 943
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T08:29:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0058"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/PredicatePushdownPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/PredicatePushdownPreview.md"
...
# MSSQL_TASK_initial_0058 - Script PredicatePushdownPreview.sql fuer 04_Where erstellen

## Anlass und Relevanz

Macht sichtbar, welche Filter frueh greifen und welche erst spaeter wirken.
...
- T-SQL/04_Where/SQLScripts/PredicatePushdownPreview.sql
- T-SQL/04_Where/SQLScripts/PredicatePushdownPreview.md

## Umsetzungsauftrag

Erzeuge `PredicatePushdownPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Macht sichtbar, welche Filter frueh greifen und welche erst spaeter wirken. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
