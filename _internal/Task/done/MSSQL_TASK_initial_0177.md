---
task_id: MSSQL_TASK_initial_0177
repository: SQL_Training
domain: MSSQL
title: "Script WindowFrameComparison.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 824
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:32:31Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0177"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowFrameComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowFrameComparison.md"
...
# MSSQL_TASK_initial_0177 - Script WindowFrameComparison.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Vergleicht `ROWS` und `RANGE` in Fensterrahmen mit anschaulichen Beispielen.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowFrameComparison.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowFrameComparison.md

## Umsetzungsauftrag

Erzeuge `WindowFrameComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `ROWS` und `RANGE` in Fensterrahmen mit anschaulichen Beispielen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
