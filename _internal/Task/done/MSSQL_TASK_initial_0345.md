---
task_id: MSSQL_TASK_initial_0345
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierDependencyCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 656
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:19:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0345"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierDependencyCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierDependencyCheck.md"
...
# MSSQL_TASK_initial_0345 - Script QuotedIdentifierDependencyCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Findet Objekte, bei denen `QUOTED_IDENTIFIER OFF` Build- oder Recreate-Risiken erzeugt.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierDependencyCheck.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierDependencyCheck.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierDependencyCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Findet Objekte, bei denen `QUOTED_IDENTIFIER OFF` Build- oder Recreate-Risiken erzeugt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
