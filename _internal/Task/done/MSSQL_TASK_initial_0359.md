---
task_id: MSSQL_TASK_initial_0359
repository: SQL_Training
domain: MSSQL
title: "Script SchemaOwnershipReview.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 642
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:33:58Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0359"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipReview.md"
...
# MSSQL_TASK_initial_0359 - Script SchemaOwnershipReview.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Prueft Schemas auf Owner-Abweichungen und uneinheitliche Besitzverhaeltnisse.
...
- T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipReview.sql
- T-SQL/22_Views_Schemata/SQLScripts/SchemaOwnershipReview.md

## Umsetzungsauftrag

Erzeuge `SchemaOwnershipReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Schemas auf Owner-Abweichungen und uneinheitliche Besitzverhaeltnisse. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
