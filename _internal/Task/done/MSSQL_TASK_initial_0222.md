---
task_id: MSSQL_TASK_initial_0222
repository: SQL_Training
domain: MSSQL
title: "Script PivotCalendarMatrix.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 779
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:09:15Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0222"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotCalendarMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotCalendarMatrix.md"
...
# MSSQL_TASK_initial_0222 - Script PivotCalendarMatrix.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Baut eine Monats- oder Wochenmatrix per Pivot auf.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotCalendarMatrix.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotCalendarMatrix.md

## Umsetzungsauftrag

Erzeuge `PivotCalendarMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Baut eine Monats- oder Wochenmatrix per Pivot auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
