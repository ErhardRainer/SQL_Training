---
task_id: MSSQL_TASK_initial_0336
repository: SQL_Training
domain: MSSQL
title: "Script IndexedViewRequiredSettingsCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 665
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T09:34:16Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0336"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewRequiredSettingsCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewRequiredSettingsCheck.md"
...
# MSSQL_TASK_initial_0336 - Script IndexedViewRequiredSettingsCheck.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Prueft die fuer indexed views notwendigen Session-Optionen.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewRequiredSettingsCheck.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/IndexedViewRequiredSettingsCheck.md

## Umsetzungsauftrag

Erzeuge `IndexedViewRequiredSettingsCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Prueft die fuer indexed views notwendigen Session-Optionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
