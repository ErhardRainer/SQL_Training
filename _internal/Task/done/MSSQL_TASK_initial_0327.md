---
task_id: MSSQL_TASK_initial_0327
repository: SQL_Training
domain: MSSQL
title: "Script ModelDatabaseOptionSnapshot.sql fuer 20_Create_Database erstellen"
status: done
priority: 674
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T10:54:19Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0327"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/ModelDatabaseOptionSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/ModelDatabaseOptionSnapshot.md"
...
# MSSQL_TASK_initial_0327 - Script ModelDatabaseOptionSnapshot.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Schnappschuss der Optionen der `model`-Datenbank als Baseline fuer neue DBs.
...
- T-SQL/20_Create_Database/SQLScripts/ModelDatabaseOptionSnapshot.sql
- T-SQL/20_Create_Database/SQLScripts/ModelDatabaseOptionSnapshot.md

## Umsetzungsauftrag

Erzeuge `ModelDatabaseOptionSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss der Optionen der `model`-Datenbank als Baseline fuer neue DBs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
