---
task_id: MSSQL_TASK_initial_0245
repository: SQL_Training
domain: MSSQL
title: "Script ConstraintDependencyMap.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 756
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:23:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0245"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDependencyMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDependencyMap.md"
...
# MSSQL_TASK_initial_0245 - Script ConstraintDependencyMap.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Zeichnet Abhaengigkeiten zwischen Constraints und Objekten nach.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDependencyMap.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/ConstraintDependencyMap.md

## Umsetzungsauftrag

Erzeuge `ConstraintDependencyMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Zeichnet Abhaengigkeiten zwischen Constraints und Objekten nach. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
