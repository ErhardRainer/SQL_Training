---
task_id: MSSQL_TASK_initial_0288
repository: SQL_Training
domain: MSSQL
title: "Script RollupRunningSubtotalDemo.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 713
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:33:52Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0288"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupRunningSubtotalDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupRunningSubtotalDemo.md"
...
# MSSQL_TASK_initial_0288 - Script RollupRunningSubtotalDemo.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Demonstriert laufende Zwischensummen in Rollup-Ergebnissen.
...
- T-SQL/18_Cube_Rollup/SQLScripts/RollupRunningSubtotalDemo.sql
- T-SQL/18_Cube_Rollup/SQLScripts/RollupRunningSubtotalDemo.md

## Umsetzungsauftrag

Erzeuge `RollupRunningSubtotalDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert laufende Zwischensummen in Rollup-Ergebnissen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
