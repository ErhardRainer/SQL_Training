---
task_id: MSSQL_TASK_initial_0153
repository: SQL_Training
domain: MSSQL
title: "Script AggregateBucketSummary.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 848
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:33:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0153"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateBucketSummary.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateBucketSummary.md"
...
# MSSQL_TASK_initial_0153 - Script AggregateBucketSummary.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Erstellt Buckets und fasst Kennzahlen je Bucket zusammen.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateBucketSummary.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateBucketSummary.md

## Umsetzungsauftrag

Erzeuge `AggregateBucketSummary.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt Buckets und fasst Kennzahlen je Bucket zusammen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
