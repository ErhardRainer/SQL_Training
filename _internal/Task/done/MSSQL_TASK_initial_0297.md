---
task_id: MSSQL_TASK_initial_0297
repository: SQL_Training
domain: MSSQL
title: "Script LogReuseWaitSnapshot.sql fuer 19_Transaktions erstellen"
status: done
priority: 704
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T09:10:24Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0297"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/LogReuseWaitSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/LogReuseWaitSnapshot.md"
...
# MSSQL_TASK_initial_0297 - Script LogReuseWaitSnapshot.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Snapshot ueber `log_reuse_wait_desc` in allen Datenbanken.
...
- T-SQL/19_Transaktions/SQLScripts/LogReuseWaitSnapshot.sql
- T-SQL/19_Transaktions/SQLScripts/LogReuseWaitSnapshot.md

## Umsetzungsauftrag

Erzeuge `LogReuseWaitSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Snapshot ueber `log_reuse_wait_desc` in allen Datenbanken. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
