---
task_id: MSSQL_TASK_initial_0054
repository: SQL_Training
domain: MSSQL
title: "Script LikePatternEdgeCases.sql fuer 04_Where erstellen"
status: done
priority: 947
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T08:09:24Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0054"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/LikePatternEdgeCases.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/LikePatternEdgeCases.md"
...
# MSSQL_TASK_initial_0054 - Script LikePatternEdgeCases.sql fuer 04_Where erstellen

## Anlass und Relevanz

Zeigt Sonderfaelle mit `LIKE`, Escape-Zeichen, Wildcards und Kollationen.
...
- T-SQL/04_Where/SQLScripts/LikePatternEdgeCases.sql
- T-SQL/04_Where/SQLScripts/LikePatternEdgeCases.md

## Umsetzungsauftrag

Erzeuge `LikePatternEdgeCases.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Sonderfaelle mit `LIKE`, Escape-Zeichen, Wildcards und Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
