---
task_id: MSSQL_TASK_initial_0263
repository: SQL_Training
domain: MSSQL
title: "Script AnsiOptionMismatchDetector.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 738
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:23:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0263"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/AnsiOptionMismatchDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/AnsiOptionMismatchDetector.md"
...
# MSSQL_TASK_initial_0263 - Script AnsiOptionMismatchDetector.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Sucht Module und Sitzungen mit problematischen oder inkonsistenten ANSI-Optionen.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/AnsiOptionMismatchDetector.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/AnsiOptionMismatchDetector.md

## Umsetzungsauftrag

Erzeuge `AnsiOptionMismatchDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Sucht Module und Sitzungen mit problematischen oder inkonsistenten ANSI-Optionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
