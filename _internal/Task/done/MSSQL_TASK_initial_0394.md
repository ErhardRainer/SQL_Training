---
task_id: MSSQL_TASK_initial_0394
repository: SQL_Training
domain: MSSQL
title: "Script FunctionExecutionContextAudit.sql fuer 24_UserDefinedFunctions erstellen"
status: done
priority: 607
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T13:35:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0394"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionExecutionContextAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionExecutionContextAudit.md"
...
# MSSQL_TASK_initial_0394 - Script FunctionExecutionContextAudit.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Audit ueber Kontext, Berechtigungen und Eigentuemerschaft von Funktionen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionExecutionContextAudit.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionExecutionContextAudit.md

## Umsetzungsauftrag

Erzeuge `FunctionExecutionContextAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Kontext, Berechtigungen und Eigentuemerschaft von Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
