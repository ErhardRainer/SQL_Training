---
task_id: MSSQL_TASK_initial_0224
repository: SQL_Training
domain: MSSQL
title: "Script PivotFallbackCasePattern.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 777
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:18:03Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0224"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotFallbackCasePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotFallbackCasePattern.md"
...
# MSSQL_TASK_initial_0224 - Script PivotFallbackCasePattern.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Fallback-Muster mit CASE, wenn Pivot nicht passend ist.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotFallbackCasePattern.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotFallbackCasePattern.md

## Umsetzungsauftrag

Erzeuge `PivotFallbackCasePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Fallback-Muster mit CASE, wenn Pivot nicht passend ist. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
