---
task_id: MSSQL_TASK_initial_0025
repository: SQL_Training
domain: MSSQL
title: "Script SelectOutputFormattingExamples.sql fuer 02_Select erstellen"
status: done
priority: 976
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:32:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0025"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectOutputFormattingExamples.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectOutputFormattingExamples.md"
...
# MSSQL_TASK_initial_0025 - Script SelectOutputFormattingExamples.sql fuer 02_Select erstellen

## Anlass und Relevanz

Beispiele fuer Anzeigeformate direkt in der SELECT-Liste.
...
- T-SQL/02_Select/SQLScripts/SelectOutputFormattingExamples.sql
- T-SQL/02_Select/SQLScripts/SelectOutputFormattingExamples.md

## Umsetzungsauftrag

Erzeuge `SelectOutputFormattingExamples.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Beispiele fuer Anzeigeformate direkt in der SELECT-Liste. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
