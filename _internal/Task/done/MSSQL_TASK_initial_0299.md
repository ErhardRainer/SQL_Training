---
task_id: MSSQL_TASK_initial_0299
repository: SQL_Training
domain: MSSQL
title: "Script LongTranHostProgramAudit.sql fuer 19_Transaktions erstellen"
status: done
priority: 702
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-21T22:59:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0299"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/LongTranHostProgramAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/LongTranHostProgramAudit.md"
...
# MSSQL_TASK_initial_0299 - Script LongTranHostProgramAudit.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Audit ueber Host und Programm lang laufender Transaktionen.
...
- T-SQL/19_Transaktions/SQLScripts/LongTranHostProgramAudit.sql
- T-SQL/19_Transaktions/SQLScripts/LongTranHostProgramAudit.md

## Umsetzungsauftrag

Erzeuge `LongTranHostProgramAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Host und Programm lang laufender Transaktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
