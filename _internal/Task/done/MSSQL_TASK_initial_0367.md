---
task_id: MSSQL_TASK_initial_0367
repository: SQL_Training
domain: MSSQL
title: "Script ViewRefreshCandidateList.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 634
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T12:14:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0367"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewRefreshCandidateList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewRefreshCandidateList.md"
...
# MSSQL_TASK_initial_0367 - Script ViewRefreshCandidateList.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Liste von Views, die nach Metadatenaenderungen refreshed werden sollten.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewRefreshCandidateList.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewRefreshCandidateList.md

## Umsetzungsauftrag

Erzeuge `ViewRefreshCandidateList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Liste von Views, die nach Metadatenaenderungen refreshed werden sollten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
