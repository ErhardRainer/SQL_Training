---
task_id: MSSQL_TASK_initial_0032
repository: SQL_Training
domain: MSSQL
title: "Script BridgeTableCoverageAudit.sql fuer 03_JOIN erstellen"
status: done
priority: 969
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T03:14:18Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0032"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/BridgeTableCoverageAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/BridgeTableCoverageAudit.md"
...
# MSSQL_TASK_initial_0032 - Script BridgeTableCoverageAudit.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Prueft n:m-Zwischentabellen auf fehlende oder doppelte Zuordnungen.
...
- T-SQL/03_JOIN/SQLScripts/BridgeTableCoverageAudit.sql
- T-SQL/03_JOIN/SQLScripts/BridgeTableCoverageAudit.md

## Umsetzungsauftrag

Erzeuge `BridgeTableCoverageAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Prueft n:m-Zwischentabellen auf fehlende oder doppelte Zuordnungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
