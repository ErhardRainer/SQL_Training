---
task_id: MSSQL_TASK_initial_0005
repository: SQL_Training
domain: MSSQL
title: "Script DetectRepeatingGroups.sql fuer 01_Normalformen erstellen"
status: done
priority: 996
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T20:29:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0005"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/DetectRepeatingGroups.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/DetectRepeatingGroups.md"
...
# MSSQL_TASK_initial_0005 - Script DetectRepeatingGroups.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Findet moegliche Wiederholungsgruppen als Startpunkt fuer die 1NF-Diskussion.
...
- T-SQL/01_Normalformen/SQLScripts/DetectRepeatingGroups.sql
- T-SQL/01_Normalformen/SQLScripts/DetectRepeatingGroups.md

## Umsetzungsauftrag

Erzeuge `DetectRepeatingGroups.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Findet moegliche Wiederholungsgruppen als Startpunkt fuer die 1NF-Diskussion. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
