---
task_id: MSSQL_TASK_initial_0293
repository: SQL_Training
domain: MSSQL
title: "Script BlockingChainWithTranCount.sql fuer 19_Transaktions erstellen"
status: done
priority: 708
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T09:08:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0293"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/BlockingChainWithTranCount.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/BlockingChainWithTranCount.md"
...
# MSSQL_TASK_initial_0293 - Script BlockingChainWithTranCount.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Stellt Blocking-Ketten zusammen mit Transaktionsanzahl und betroffenen Requests dar.
...
- T-SQL/19_Transaktions/SQLScripts/BlockingChainWithTranCount.sql
- T-SQL/19_Transaktions/SQLScripts/BlockingChainWithTranCount.md

## Umsetzungsauftrag

Erzeuge `BlockingChainWithTranCount.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Stellt Blocking-Ketten zusammen mit Transaktionsanzahl und betroffenen Requests dar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
