---
task_id: MSSQL_TASK_initial_0167
repository: SQL_Training
domain: MSSQL
title: "Script HavingThresholdPatterns.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 834
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T14:42:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0167"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/HavingThresholdPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/HavingThresholdPatterns.md"
...
# MSSQL_TASK_initial_0167 - Script HavingThresholdPatterns.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Liefert typische `HAVING`-Muster fuer Mindestumsatz, Mindestanzahl und Ausreisserfilter.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/HavingThresholdPatterns.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/HavingThresholdPatterns.md

## Umsetzungsauftrag

Erzeuge `HavingThresholdPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Liefert typische `HAVING`-Muster fuer Mindestumsatz, Mindestanzahl und Ausreisserfilter. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
