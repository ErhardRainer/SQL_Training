---
task_id: MSSQL_TASK_initial_0024
repository: SQL_Training
domain: MSSQL
title: "Script SelectNullSortPreview.sql fuer 02_Select erstellen"
status: done
priority: 977
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:27:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0024"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectNullSortPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectNullSortPreview.md"
...
# MSSQL_TASK_initial_0024 - Script SelectNullSortPreview.sql fuer 02_Select erstellen

## Anlass und Relevanz

Zeigt, wie `NULL`-Werte bei Sortierungen in der Praxis einsortiert werden.
...
- T-SQL/02_Select/SQLScripts/SelectNullSortPreview.sql
- T-SQL/02_Select/SQLScripts/SelectNullSortPreview.md

## Umsetzungsauftrag

Erzeuge `SelectNullSortPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie `NULL`-Werte bei Sortierungen in der Praxis einsortiert werden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
