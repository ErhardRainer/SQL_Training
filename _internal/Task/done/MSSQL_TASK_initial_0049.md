---
task_id: MSSQL_TASK_initial_0049
repository: SQL_Training
domain: MSSQL
title: "Script OuterJoinFilterPitfallDemo.sql fuer 03_JOIN erstellen"
status: done
priority: 952
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T07:44:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0049"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/OuterJoinFilterPitfallDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/OuterJoinFilterPitfallDemo.md"
...
# MSSQL_TASK_initial_0049 - Script OuterJoinFilterPitfallDemo.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Zeigt, wie Filter im `WHERE` aus einem Outer Join unbeabsichtigt einen Inner Join machen.
...
- T-SQL/03_JOIN/SQLScripts/OuterJoinFilterPitfallDemo.sql
- T-SQL/03_JOIN/SQLScripts/OuterJoinFilterPitfallDemo.md

## Umsetzungsauftrag

Erzeuge `OuterJoinFilterPitfallDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie Filter im `WHERE` aus einem Outer Join unbeabsichtigt einen Inner Join machen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
