---
task_id: MSSQL_TASK_initial_0141
repository: SQL_Training
domain: MSSQL
title: "Script SetDifferenceAudit.sql fuer 09_Set_Operations erstellen"
status: done
priority: 860
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:31:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0141"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetDifferenceAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetDifferenceAudit.md"
...
# MSSQL_TASK_initial_0141 - Script SetDifferenceAudit.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Vergleicht zwei Ergebnismengen mit `EXCEPT` und `INTERSECT` fuer Delta-Analysen.
...
- T-SQL/09_Set_Operations/SQLScripts/SetDifferenceAudit.sql
- T-SQL/09_Set_Operations/SQLScripts/SetDifferenceAudit.md

## Umsetzungsauftrag

Erzeuge `SetDifferenceAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht zwei Ergebnismengen mit `EXCEPT` und `INTERSECT` fuer Delta-Analysen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
