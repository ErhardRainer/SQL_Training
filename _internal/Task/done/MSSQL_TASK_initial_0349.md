---
task_id: MSSQL_TASK_initial_0349
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierSessionMismatch.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 652
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:44:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0349"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierSessionMismatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierSessionMismatch.md"
...
# MSSQL_TASK_initial_0349 - Script QuotedIdentifierSessionMismatch.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Zeigt Unterschiede zwischen Objektmetadaten und aktuellen Session-Einstellungen.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierSessionMismatch.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierSessionMismatch.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierSessionMismatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Unterschiede zwischen Objektmetadaten und aktuellen Session-Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
