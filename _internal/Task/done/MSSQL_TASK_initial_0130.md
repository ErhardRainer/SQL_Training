---
task_id: MSSQL_TASK_initial_0130
repository: SQL_Training
domain: MSSQL
title: "Script UpdateDerivedValueRefresh.sql fuer 08_Update erstellen"
status: done
priority: 871
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:30:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0130"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateDerivedValueRefresh.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateDerivedValueRefresh.md"
...
# MSSQL_TASK_initial_0130 - Script UpdateDerivedValueRefresh.sql fuer 08_Update erstellen

## Anlass und Relevanz

Aktualisiert abgeleitete Werte gezielt nach Datenaenderungen.
...
- T-SQL/08_Update/SQLScripts/UpdateDerivedValueRefresh.sql
- T-SQL/08_Update/SQLScripts/UpdateDerivedValueRefresh.md

## Umsetzungsauftrag

Erzeuge `UpdateDerivedValueRefresh.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Aktualisiert abgeleitete Werte gezielt nach Datenaenderungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
