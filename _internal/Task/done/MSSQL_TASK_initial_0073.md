---
task_id: MSSQL_TASK_initial_0073
repository: SQL_Training
domain: MSSQL
title: "Script DateTruncationPatterns.sql fuer 05_Funktionen erstellen"
status: done
priority: 928
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:42:48Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0073"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/DateTruncationPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/DateTruncationPatterns.md"
...
# MSSQL_TASK_initial_0073 - Script DateTruncationPatterns.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Zeigt Muster fuer Tages-, Monats- und Jahresanfang ohne Fehler durch Uhrzeiten.
...
- T-SQL/05_Funktionen/SQLScripts/DateTruncationPatterns.sql
- T-SQL/05_Funktionen/SQLScripts/DateTruncationPatterns.md

## Umsetzungsauftrag

Erzeuge `DateTruncationPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Muster fuer Tages-, Monats- und Jahresanfang ohne Fehler durch Uhrzeiten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
