---
task_id: MSSQL_TASK_initial_0127
repository: SQL_Training
domain: MSSQL
title: "Script UpdateChangedValueDetector.sql fuer 08_Update erstellen"
status: done
priority: 874
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T01:58:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0127"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateChangedValueDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateChangedValueDetector.md"
...
# MSSQL_TASK_initial_0127 - Script UpdateChangedValueDetector.sql fuer 08_Update erstellen

## Anlass und Relevanz

Ermittelt vor dem Update, welche Werte sich wirklich aendern.
...
- T-SQL/08_Update/SQLScripts/UpdateChangedValueDetector.sql
- T-SQL/08_Update/SQLScripts/UpdateChangedValueDetector.md

## Umsetzungsauftrag

Erzeuge `UpdateChangedValueDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Ermittelt vor dem Update, welche Werte sich wirklich aendern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
