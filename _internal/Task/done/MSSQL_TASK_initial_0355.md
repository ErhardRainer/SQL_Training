---
task_id: MSSQL_TASK_initial_0355
repository: SQL_Training
domain: MSSQL
title: "Script SchemaDriftImpactOnViews.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 646
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:15:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0355"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaDriftImpactOnViews.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaDriftImpactOnViews.md"
...
# MSSQL_TASK_initial_0355 - Script SchemaDriftImpactOnViews.sql fuer 22_Views_Schemata erstellen
...
- T-SQL/22_Views_Schemata/SQLScripts/SchemaDriftImpactOnViews.sql
- T-SQL/22_Views_Schemata/SQLScripts/SchemaDriftImpactOnViews.md

## Umsetzungsauftrag

Erzeuge `SchemaDriftImpactOnViews.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Sucht Views, die von potenzieller Schema-Drift betroffen waeren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
