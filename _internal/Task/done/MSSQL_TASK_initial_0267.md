---
task_id: MSSQL_TASK_initial_0267
repository: SQL_Training
domain: MSSQL
title: "Script ConcatNullYieldsNullCheck.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 734
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:43:31Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0267"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/ConcatNullYieldsNullCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/ConcatNullYieldsNullCheck.md"
...
# MSSQL_TASK_initial_0267 - Script ConcatNullYieldsNullCheck.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Macht das Verhalten von `CONCAT_NULL_YIELDS_NULL` anschaulich.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/ConcatNullYieldsNullCheck.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/ConcatNullYieldsNullCheck.md

## Umsetzungsauftrag

Erzeuge `ConcatNullYieldsNullCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Macht das Verhalten von `CONCAT_NULL_YIELDS_NULL` anschaulich. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
