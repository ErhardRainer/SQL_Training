---
task_id: MSSQL_TASK_initial_0070
repository: SQL_Training
domain: MSSQL
title: "Script ConditionalLogicCasePatterns.sql fuer 05_Funktionen erstellen"
status: done
priority: 931
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:27:42Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0070"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/ConditionalLogicCasePatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/ConditionalLogicCasePatterns.md"
...
# MSSQL_TASK_initial_0070 - Script ConditionalLogicCasePatterns.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Buendelt typische `CASE`-Muster fuer Klassifikation, Bucketing und Sortierschluessel.
...
- T-SQL/05_Funktionen/SQLScripts/ConditionalLogicCasePatterns.sql
- T-SQL/05_Funktionen/SQLScripts/ConditionalLogicCasePatterns.md

## Umsetzungsauftrag

Erzeuge `ConditionalLogicCasePatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Buendelt typische `CASE`-Muster fuer Klassifikation, Bucketing und Sortierschluessel. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
