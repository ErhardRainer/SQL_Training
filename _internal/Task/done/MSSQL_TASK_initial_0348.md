---
task_id: MSSQL_TASK_initial_0348
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierOffRiskList.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 653
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:38:28Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0348"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierOffRiskList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierOffRiskList.md"
...
# MSSQL_TASK_initial_0348 - Script QuotedIdentifierOffRiskList.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Liste moeglicher Risiken bei `QUOTED_IDENTIFIER OFF`.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierOffRiskList.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/QuotedIdentifierOffRiskList.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierOffRiskList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Liste moeglicher Risiken bei `QUOTED_IDENTIFIER OFF`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
