---
task_id: MSSQL_TASK_initial_0069
repository: SQL_Training
domain: MSSQL
title: "Script WhereSelectiveFilterProfiler.sql fuer 04_Where erstellen"
status: done
priority: 932
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:27:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0069"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WhereSelectiveFilterProfiler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WhereSelectiveFilterProfiler.md"
...
# MSSQL_TASK_initial_0069 - Script WhereSelectiveFilterProfiler.sql fuer 04_Where erstellen

## Anlass und Relevanz

Profiling typischer Filterbedingungen auf Selektivitaet.
...
- T-SQL/04_Where/SQLScripts/WhereSelectiveFilterProfiler.sql
- T-SQL/04_Where/SQLScripts/WhereSelectiveFilterProfiler.md

## Umsetzungsauftrag

Erzeuge `WhereSelectiveFilterProfiler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Profiling typischer Filterbedingungen auf Selektivitaet. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
