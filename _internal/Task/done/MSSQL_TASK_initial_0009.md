---
task_id: MSSQL_TASK_initial_0009
repository: SQL_Training
domain: MSSQL
title: "Script SurrogateKeyTradeoffDemo.sql fuer 01_Normalformen erstellen"
status: done
priority: 992
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T21:29:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0009"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/SurrogateKeyTradeoffDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/SurrogateKeyTradeoffDemo.md"
...
# MSSQL_TASK_initial_0009 - Script SurrogateKeyTradeoffDemo.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Zeigt Vor- und Nachteile von Surrogatschluesseln gegen natuerliche Keys.
...
- T-SQL/01_Normalformen/SQLScripts/SurrogateKeyTradeoffDemo.sql
- T-SQL/01_Normalformen/SQLScripts/SurrogateKeyTradeoffDemo.md

## Umsetzungsauftrag

Erzeuge `SurrogateKeyTradeoffDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Vor- und Nachteile von Surrogatschluesseln gegen natuerliche Keys. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
