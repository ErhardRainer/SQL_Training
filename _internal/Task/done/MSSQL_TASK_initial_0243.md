---
task_id: MSSQL_TASK_initial_0243
repository: SQL_Training
domain: MSSQL
title: "Script CheckConstraintViolationProbe.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 758
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:07:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0243"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckConstraintViolationProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckConstraintViolationProbe.md"
...
# MSSQL_TASK_initial_0243 - Script CheckConstraintViolationProbe.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Sucht Datenbereiche, die bei geplanten CHECK-Constraints problematisch waeren.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckConstraintViolationProbe.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckConstraintViolationProbe.md

## Umsetzungsauftrag

Erzeuge `CheckConstraintViolationProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Sucht Datenbereiche, die bei geplanten CHECK-Constraints problematisch waeren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
