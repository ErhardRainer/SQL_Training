---
task_id: MSSQL_TASK_initial_0202
repository: SQL_Training
domain: MSSQL
title: "Script MergeColumnComparisonMatrix.sql fuer 13_Merge erstellen"
status: done
priority: 799
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:27:57Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0202"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeColumnComparisonMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeColumnComparisonMatrix.md"
...
# MSSQL_TASK_initial_0202 - Script MergeColumnComparisonMatrix.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Matrix fuer Spaltenvergleiche zwischen Quelle und Ziel.
...
- T-SQL/13_Merge/SQLScripts/MergeColumnComparisonMatrix.sql
- T-SQL/13_Merge/SQLScripts/MergeColumnComparisonMatrix.md

## Umsetzungsauftrag

Erzeuge `MergeColumnComparisonMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Matrix fuer Spaltenvergleiche zwischen Quelle und Ziel. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
