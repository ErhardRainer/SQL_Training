---
task_id: MSSQL_TASK_initial_0300
repository: SQL_Training
domain: MSSQL
title: "Script MarkedTransactionDemo.sql fuer 19_Transaktions erstellen"
status: done
priority: 701
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-21T23:04:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0300"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/MarkedTransactionDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/MarkedTransactionDemo.md"
...
# MSSQL_TASK_initial_0300 - Script MarkedTransactionDemo.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Demonstriert markierte Transaktionen fuer koordinierte Restore-Szenarien.
...
- T-SQL/19_Transaktions/SQLScripts/MarkedTransactionDemo.sql
- T-SQL/19_Transaktions/SQLScripts/MarkedTransactionDemo.md

## Umsetzungsauftrag

Erzeuge `MarkedTransactionDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert markierte Transaktionen fuer koordinierte Restore-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
