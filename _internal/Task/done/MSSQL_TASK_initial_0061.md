---
task_id: MSSQL_TASK_initial_0061
repository: SQL_Training
domain: MSSQL
title: "Script SearchArgumentAntiPatterns.sql fuer 04_Where erstellen"
status: done
priority: 940
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-22T00:42:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0061"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/SearchArgumentAntiPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/SearchArgumentAntiPatterns.md"
...
# MSSQL_TASK_initial_0061 - Script SearchArgumentAntiPatterns.sql fuer 04_Where erstellen

## Anlass und Relevanz

Sammelt haeufige Anti-Patterns, die aus guten Filtern schlechte Praedikate machen.
...
- T-SQL/04_Where/SQLScripts/SearchArgumentAntiPatterns.sql
- T-SQL/04_Where/SQLScripts/SearchArgumentAntiPatterns.md

## Umsetzungsauftrag

Erzeuge `SearchArgumentAntiPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Sammelt haeufige Anti-Patterns, die aus guten Filtern schlechte Praedikate machen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
