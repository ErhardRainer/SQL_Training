---
task_id: MSSQL_TASK_initial_0269
repository: SQL_Training
domain: MSSQL
title: "Script NullConcatBehaviorLab.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 732
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:54:17Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0269"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/NullConcatBehaviorLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/NullConcatBehaviorLab.md"
...
# MSSQL_TASK_initial_0269 - Script NullConcatBehaviorLab.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Lab fuer Verkettungsverhalten mit `NULL` in unterschiedlichen Varianten.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/NullConcatBehaviorLab.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/NullConcatBehaviorLab.md

## Umsetzungsauftrag

Erzeuge `NullConcatBehaviorLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Lab fuer Verkettungsverhalten mit `NULL` in unterschiedlichen Varianten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
