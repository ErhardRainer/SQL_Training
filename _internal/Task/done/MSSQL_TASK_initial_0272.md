---
task_id: MSSQL_TASK_initial_0272
repository: SQL_Training
domain: MSSQL
title: "Script CubeCrossJoinExplosionPreview.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 729
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:10:36Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0272"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeCrossJoinExplosionPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeCrossJoinExplosionPreview.md"
...
# MSSQL_TASK_initial_0272 - Script CubeCrossJoinExplosionPreview.sql fuer 18_Cube_Rollup erstellen
...
- T-SQL/18_Cube_Rollup/SQLScripts/CubeCrossJoinExplosionPreview.sql
- T-SQL/18_Cube_Rollup/SQLScripts/CubeCrossJoinExplosionPreview.md

## Umsetzungsauftrag

Erzeuge `CubeCrossJoinExplosionPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Macht die Groessenwirkung vieler Dimensionen in `CUBE`-Abfragen sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
