---
task_id: MSSQL_TASK_initial_0258
repository: SQL_Training
domain: MSSQL
title: "Script OrphanCandidateFromMissingFk.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 743
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:37:07Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0258"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/OrphanCandidateFromMissingFk.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/OrphanCandidateFromMissingFk.md"
...
# MSSQL_TASK_initial_0258 - Script OrphanCandidateFromMissingFk.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Findet Orphan-Kandidaten in Bereichen ohne definierte Foreign Keys.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/OrphanCandidateFromMissingFk.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/OrphanCandidateFromMissingFk.md

## Umsetzungsauftrag

Erzeuge `OrphanCandidateFromMissingFk.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Findet Orphan-Kandidaten in Bereichen ohne definierte Foreign Keys. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
