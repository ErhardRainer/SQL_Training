---
task_id: MSSQL_TASK_initial_0213
repository: SQL_Training
domain: MSSQL
title: "Script MergeSourceHashChangeDetect.sql fuer 13_Merge erstellen"
status: done
priority: 788
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:22:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0213"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceHashChangeDetect.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeSourceHashChangeDetect.md"
...
# MSSQL_TASK_initial_0213 - Script MergeSourceHashChangeDetect.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Vergleicht Quell- und Zielhashes zur gezielten Steuerung von `MERGE`-Updates.
...
- T-SQL/13_Merge/SQLScripts/MergeSourceHashChangeDetect.sql
- T-SQL/13_Merge/SQLScripts/MergeSourceHashChangeDetect.md

## Umsetzungsauftrag

Erzeuge `MergeSourceHashChangeDetect.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Quell- und Zielhashes zur gezielten Steuerung von `MERGE`-Updates. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
