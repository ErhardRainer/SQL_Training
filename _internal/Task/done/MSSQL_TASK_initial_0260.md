---
task_id: MSSQL_TASK_initial_0260
repository: SQL_Training
domain: MSSQL
title: "Script UniqueConstraintCollisionPreview.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 741
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:43:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0260"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintCollisionPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintCollisionPreview.md"
...
# MSSQL_TASK_initial_0260 - Script UniqueConstraintCollisionPreview.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Identifiziert moegliche Kollisionen vor dem Einfuehren eines `UNIQUE`-Constraints.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintCollisionPreview.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintCollisionPreview.md

## Umsetzungsauftrag

Erzeuge `UniqueConstraintCollisionPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Identifiziert moegliche Kollisionen vor dem Einfuehren eines `UNIQUE`-Constraints. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
