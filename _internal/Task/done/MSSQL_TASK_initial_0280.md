---
task_id: MSSQL_TASK_initial_0280
repository: SQL_Training
domain: MSSQL
title: "Script GroupingIdExplainer.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 721
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:49:06Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0280"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdExplainer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdExplainer.md"
...
# MSSQL_TASK_initial_0280 - Script GroupingIdExplainer.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Erklaert `GROUPING()` und `GROUPING_ID()` anhand kompakter Praxisbeispiele.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdExplainer.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdExplainer.md

## Umsetzungsauftrag

Erzeuge `GroupingIdExplainer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Erklaert `GROUPING()` und `GROUPING_ID()` anhand kompakter Praxisbeispiele. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
