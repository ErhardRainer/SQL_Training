---
task_id: MSSQL_TASK_initial_0318
repository: SQL_Training
domain: MSSQL
title: "Script DataFileAutogrowthTemplate.sql fuer 20_Create_Database erstellen"
status: done
priority: 683
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:08:20Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0318"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/DataFileAutogrowthTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/DataFileAutogrowthTemplate.md"
...
# MSSQL_TASK_initial_0318 - Script DataFileAutogrowthTemplate.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Vorlage fuer konsistente Autogrowth-Einstellungen von Datenfiles.
...
- T-SQL/20_Create_Database/SQLScripts/DataFileAutogrowthTemplate.sql
- T-SQL/20_Create_Database/SQLScripts/DataFileAutogrowthTemplate.md

## Umsetzungsauftrag

Erzeuge `DataFileAutogrowthTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer konsistente Autogrowth-Einstellungen von Datenfiles. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
