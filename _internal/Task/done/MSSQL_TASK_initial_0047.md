---
task_id: MSSQL_TASK_initial_0047
repository: SQL_Training
domain: MSSQL
title: "Script JoinUnmatchedRightRows.sql fuer 03_JOIN erstellen"
status: done
priority: 954
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T00:22:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0047"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinUnmatchedRightRows.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinUnmatchedRightRows.md"
...
# MSSQL_TASK_initial_0047 - Script JoinUnmatchedRightRows.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Zeigt gezielt die rechtsseitig nicht gematchten Zeilen.
...
- T-SQL/03_JOIN/SQLScripts/JoinUnmatchedRightRows.sql
- T-SQL/03_JOIN/SQLScripts/JoinUnmatchedRightRows.md

## Umsetzungsauftrag

Erzeuge `JoinUnmatchedRightRows.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt gezielt die rechtsseitig nicht gematchten Zeilen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
