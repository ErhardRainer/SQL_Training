---
task_id: MSSQL_TASK_initial_0063
repository: SQL_Training
domain: MSSQL
title: "Script WhereCaseInsensitiveSearchDemo.sql fuer 04_Where erstellen"
status: done
priority: 938
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T08:52:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0063"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/04_Where/SQLScripts/WhereCaseInsensitiveSearchDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/04_Where/SQLScripts/WhereCaseInsensitiveSearchDemo.md"
...
# MSSQL_TASK_initial_0063 - Script WhereCaseInsensitiveSearchDemo.sql fuer 04_Where erstellen

## Anlass und Relevanz

Demonstriert case-insensitive Suchmuster in der WHERE-Clause.
...
- T-SQL/04_Where/SQLScripts/WhereCaseInsensitiveSearchDemo.sql
- T-SQL/04_Where/SQLScripts/WhereCaseInsensitiveSearchDemo.md

## Umsetzungsauftrag

Erzeuge `WhereCaseInsensitiveSearchDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `04_Where` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert case-insensitive Suchmuster in der WHERE-Clause. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
