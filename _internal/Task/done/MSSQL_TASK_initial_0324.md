---
task_id: MSSQL_TASK_initial_0324
repository: SQL_Training
domain: MSSQL
title: "Script FilePathConventionTemplate.sql fuer 20_Create_Database erstellen"
status: done
priority: 677
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:41:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0324"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/FilePathConventionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/FilePathConventionTemplate.md"
...
# MSSQL_TASK_initial_0324 - Script FilePathConventionTemplate.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Vorlage fuer standardisierte Datei- und Pfadkonventionen.
...
- T-SQL/20_Create_Database/SQLScripts/FilePathConventionTemplate.sql
- T-SQL/20_Create_Database/SQLScripts/FilePathConventionTemplate.md

## Umsetzungsauftrag

Erzeuge `FilePathConventionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer standardisierte Datei- und Pfadkonventionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
