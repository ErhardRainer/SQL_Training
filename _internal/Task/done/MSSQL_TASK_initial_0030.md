---
task_id: MSSQL_TASK_initial_0030
repository: SQL_Training
domain: MSSQL
title: "Script TopWithTiesShowcase.sql fuer 02_Select erstellen"
status: done
priority: 971
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T02:53:21Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0030"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/TopWithTiesShowcase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/TopWithTiesShowcase.md"
...
# MSSQL_TASK_initial_0030 - Script TopWithTiesShowcase.sql fuer 02_Select erstellen

## Anlass und Relevanz

Zeigt das Verhalten von `TOP WITH TIES` bei Gleichstaenden.
...
- T-SQL/02_Select/SQLScripts/TopWithTiesShowcase.sql
- T-SQL/02_Select/SQLScripts/TopWithTiesShowcase.md

## Umsetzungsauftrag

Erzeuge `TopWithTiesShowcase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt das Verhalten von `TOP WITH TIES` bei Gleichstaenden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
