---
task_id: MSSQL_TASK_initial_0250
repository: SQL_Training
domain: MSSQL
title: "Script DefaultConstraintInventory.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 751
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:53:24Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0250"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultConstraintInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultConstraintInventory.md"
...
# MSSQL_TASK_initial_0250 - Script DefaultConstraintInventory.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Inventarisiert Default Constraints und ihre Expressions je Tabelle.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultConstraintInventory.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultConstraintInventory.md

## Umsetzungsauftrag

Erzeuge `DefaultConstraintInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Default Constraints und ihre Expressions je Tabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
