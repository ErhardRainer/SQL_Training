---
task_id: MSSQL_TASK_initial_0270
repository: SQL_Training
domain: MSSQL
title: "Script QuotedIdentifierAnsiNullPairAudit.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 731
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:58:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0270"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/QuotedIdentifierAnsiNullPairAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/QuotedIdentifierAnsiNullPairAudit.md"
...
# MSSQL_TASK_initial_0270 - Script QuotedIdentifierAnsiNullPairAudit.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Audit ueber gemeinsam auftretende Session-Optionen in Altmodulen.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/QuotedIdentifierAnsiNullPairAudit.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/QuotedIdentifierAnsiNullPairAudit.md

## Umsetzungsauftrag

Erzeuge `QuotedIdentifierAnsiNullPairAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber gemeinsam auftretende Session-Optionen in Altmodulen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
