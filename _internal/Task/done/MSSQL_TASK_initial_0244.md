---
task_id: MSSQL_TASK_initial_0244
repository: SQL_Training
domain: MSSQL
title: "Script CheckPredicateCoverageReview.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 757
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T21:12:27Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0244"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckPredicateCoverageReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckPredicateCoverageReview.md"
...
# MSSQL_TASK_initial_0244 - Script CheckPredicateCoverageReview.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Review, ob CHECK-Constraints die relevanten Regeln ausreichend abdecken.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckPredicateCoverageReview.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/CheckPredicateCoverageReview.md

## Umsetzungsauftrag

Erzeuge `CheckPredicateCoverageReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Review, ob CHECK-Constraints die relevanten Regeln ausreichend abdecken. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
