---
task_id: MSSQL_TASK_initial_0028
repository: SQL_Training
domain: MSSQL
title: "Script SelectWildcardDependencyCheck.sql fuer 02_Select erstellen"
status: done
priority: 973
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T23:43:43Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0028"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectWildcardDependencyCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectWildcardDependencyCheck.md"
...
# MSSQL_TASK_initial_0028 - Script SelectWildcardDependencyCheck.sql fuer 02_Select erstellen

## Anlass und Relevanz

Veranschaulicht Risiken von `SELECT *` bei Schemaaenderungen.
...
- T-SQL/02_Select/SQLScripts/SelectWildcardDependencyCheck.sql
- T-SQL/02_Select/SQLScripts/SelectWildcardDependencyCheck.md

## Umsetzungsauftrag

Erzeuge `SelectWildcardDependencyCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Veranschaulicht Risiken von `SELECT *` bei Schemaaenderungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
