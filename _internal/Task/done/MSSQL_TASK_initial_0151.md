---
task_id: MSSQL_TASK_initial_0151
repository: SQL_Training
domain: MSSQL
title: "Script UnionAllVsUnionDemo.sql fuer 09_Set_Operations erstellen"
status: done
priority: 850
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:36:00Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0151"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/UnionAllVsUnionDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/UnionAllVsUnionDemo.md"
...
# MSSQL_TASK_initial_0151 - Script UnionAllVsUnionDemo.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Stellt `UNION` und `UNION ALL` fachlich und hinsichtlich Duplikatkosten gegenueber.
...
- T-SQL/09_Set_Operations/SQLScripts/UnionAllVsUnionDemo.sql
- T-SQL/09_Set_Operations/SQLScripts/UnionAllVsUnionDemo.md

## Umsetzungsauftrag

Erzeuge `UnionAllVsUnionDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Stellt `UNION` und `UNION ALL` fachlich und hinsichtlich Duplikatkosten gegenueber. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
