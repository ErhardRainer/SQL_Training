---
task_id: MSSQL_TASK_initial_0040
repository: SQL_Training
domain: MSSQL
title: "Script JoinOnVsWhereComparison.sql fuer 03_JOIN erstellen"
status: done
priority: 961
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T06:59:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0040"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/JoinOnVsWhereComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/JoinOnVsWhereComparison.md"
...
# MSSQL_TASK_initial_0040 - Script JoinOnVsWhereComparison.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Vergleicht Filter im `ON` gegen Filter im `WHERE`.
...
- T-SQL/03_JOIN/SQLScripts/JoinOnVsWhereComparison.sql
- T-SQL/03_JOIN/SQLScripts/JoinOnVsWhereComparison.md

## Umsetzungsauftrag

Erzeuge `JoinOnVsWhereComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Filter im `ON` gegen Filter im `WHERE`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
