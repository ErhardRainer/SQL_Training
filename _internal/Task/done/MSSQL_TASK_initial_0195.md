---
task_id: MSSQL_TASK_initial_0195
repository: SQL_Training
domain: MSSQL
title: "Script ImplicitConversionDetector.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 806
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:02:06Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0195"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ImplicitConversionDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/ImplicitConversionDetector.md"
...
# MSSQL_TASK_initial_0195 - Script ImplicitConversionDetector.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Sucht nach typischen impliziten Konvertierungen, die SARGability und Plaene verschlechtern.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/ImplicitConversionDetector.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/ImplicitConversionDetector.md

## Umsetzungsauftrag

Erzeuge `ImplicitConversionDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Sucht nach typischen impliziten Konvertierungen, die SARGability und Plaene verschlechtern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
