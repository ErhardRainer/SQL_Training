---
task_id: MSSQL_TASK_initial_0356
repository: SQL_Training
domain: MSSQL
title: "Script SchemaObjectCountSummary.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 645
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:18:06Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0356"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaObjectCountSummary.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/SchemaObjectCountSummary.md"
...
# MSSQL_TASK_initial_0356 - Script SchemaObjectCountSummary.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Zusammenfassung der Objektzahlen je Schema.
...
- T-SQL/22_Views_Schemata/SQLScripts/SchemaObjectCountSummary.sql
- T-SQL/22_Views_Schemata/SQLScripts/SchemaObjectCountSummary.md

## Umsetzungsauftrag

Erzeuge `SchemaObjectCountSummary.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Zusammenfassung der Objektzahlen je Schema. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
