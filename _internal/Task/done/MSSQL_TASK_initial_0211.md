---
task_id: MSSQL_TASK_initial_0211
repository: SQL_Training
domain: MSSQL
title: "Script MergeSoftDeletePattern.sql fuer 13_Merge erstellen"
status: done
priority: 790
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:12:29Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0211"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeSoftDeletePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeSoftDeletePattern.md"
...
# MSSQL_TASK_initial_0211 - Script MergeSoftDeletePattern.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Zeigt ein `MERGE`-Muster fuer Soft Deletes statt physischem Loeschen.
...
- T-SQL/13_Merge/SQLScripts/MergeSoftDeletePattern.sql
- T-SQL/13_Merge/SQLScripts/MergeSoftDeletePattern.md

## Umsetzungsauftrag

Erzeuge `MergeSoftDeletePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt ein `MERGE`-Muster fuer Soft Deletes statt physischem Loeschen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
