---
task_id: MSSQL_TASK_initial_0140
repository: SQL_Training
domain: MSSQL
title: "Script SetChangeWindowCompare.sql fuer 09_Set_Operations erstellen"
status: done
priority: 861
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:36:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0140"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetChangeWindowCompare.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetChangeWindowCompare.md"
...
# MSSQL_TASK_initial_0140 - Script SetChangeWindowCompare.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Vergleicht Mengen innerhalb zweier Zeitfenster.
...
- T-SQL/09_Set_Operations/SQLScripts/SetChangeWindowCompare.sql
- T-SQL/09_Set_Operations/SQLScripts/SetChangeWindowCompare.md

## Umsetzungsauftrag

Erzeuge `SetChangeWindowCompare.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Mengen innerhalb zweier Zeitfenster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
