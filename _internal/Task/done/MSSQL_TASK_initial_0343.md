---
task_id: MSSQL_TASK_initial_0343
repository: SQL_Training
domain: MSSQL
title: "Script ModuleSessionSettingsAudit.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 658
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:09:26Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0343"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleSessionSettingsAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleSessionSettingsAudit.md"
...
# MSSQL_TASK_initial_0343 - Script ModuleSessionSettingsAudit.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Zeigt, mit welchen Session-Settings Module kompiliert bzw. erstellt wurden.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleSessionSettingsAudit.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/ModuleSessionSettingsAudit.md

## Umsetzungsauftrag

Erzeuge `ModuleSessionSettingsAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, mit welchen Session-Settings Module kompiliert bzw. erstellt wurden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
