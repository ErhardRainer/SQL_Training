---
task_id: MSSQL_TASK_initial_0329
repository: SQL_Training
domain: MSSQL
title: "Script RecoveryModelBootstrap.sql fuer 20_Create_Database erstellen"
status: done
priority: 672
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:58:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0329"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/RecoveryModelBootstrap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/RecoveryModelBootstrap.md"
...
# MSSQL_TASK_initial_0329 - Script RecoveryModelBootstrap.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Bootstrap fuer sinnvolle Recovery-Model-Defaults.
...
- T-SQL/20_Create_Database/SQLScripts/RecoveryModelBootstrap.sql
- T-SQL/20_Create_Database/SQLScripts/RecoveryModelBootstrap.md

## Umsetzungsauftrag

Erzeuge `RecoveryModelBootstrap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Bootstrap fuer sinnvolle Recovery-Model-Defaults. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
