---
task_id: MSSQL_TASK_initial_0261
repository: SQL_Training
domain: MSSQL
title: "Script UniqueConstraintOverlapCheck.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 740
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T02:18:32Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0261"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintOverlapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintOverlapCheck.md"
...
# MSSQL_TASK_initial_0261 - Script UniqueConstraintOverlapCheck.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Findet ueberlappende UNIQUE-Definitionen mit moeglichem Redundanzpotenzial.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintOverlapCheck.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/UniqueConstraintOverlapCheck.md

## Umsetzungsauftrag

Erzeuge `UniqueConstraintOverlapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Findet ueberlappende UNIQUE-Definitionen mit moeglichem Redundanzpotenzial. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
