---
task_id: MSSQL_TASK_initial_0287
repository: SQL_Training
domain: MSSQL
title: "Script RollupPercentOfTotalDemo.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 714
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:28:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0287"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupPercentOfTotalDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupPercentOfTotalDemo.md"
...
# MSSQL_TASK_initial_0287 - Script RollupPercentOfTotalDemo.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Demonstriert Prozent-vom-Gesamtwert auf Basis von `ROLLUP`.
...
- T-SQL/18_Cube_Rollup/SQLScripts/RollupPercentOfTotalDemo.sql
- T-SQL/18_Cube_Rollup/SQLScripts/RollupPercentOfTotalDemo.md

## Umsetzungsauftrag

Erzeuge `RollupPercentOfTotalDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Prozent-vom-Gesamtwert auf Basis von `ROLLUP`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
