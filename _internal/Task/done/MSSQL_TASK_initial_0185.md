---
task_id: MSSQL_TASK_initial_0185
repository: SQL_Training
domain: MSSQL
title: "Script BinaryHexRoundtripDemo.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 816
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:07:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0185"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/BinaryHexRoundtripDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/BinaryHexRoundtripDemo.md"
...
# MSSQL_TASK_initial_0185 - Script BinaryHexRoundtripDemo.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Demonstriert Rundreisen zwischen BinÃƒÂ¤r- und Hex-Darstellung.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/BinaryHexRoundtripDemo.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/BinaryHexRoundtripDemo.md

## Umsetzungsauftrag

Erzeuge `BinaryHexRoundtripDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Rundreisen zwischen BinÃƒÂ¤r- und Hex-Darstellung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
