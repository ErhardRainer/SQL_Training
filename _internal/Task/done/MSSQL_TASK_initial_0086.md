---
task_id: MSSQL_TASK_initial_0086
repository: SQL_Training
domain: MSSQL
title: "Script StringCleanupPatterns.sql fuer 05_Funktionen erstellen"
status: done
priority: 915
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T11:02:53Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0086"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/StringCleanupPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/StringCleanupPatterns.md"
...
# MSSQL_TASK_initial_0086 - Script StringCleanupPatterns.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Buendelt typische Textbereinigungen mit `LTRIM`, `RTRIM`, `REPLACE`, `TRANSLATE` und Co.
...
- T-SQL/05_Funktionen/SQLScripts/StringCleanupPatterns.sql
- T-SQL/05_Funktionen/SQLScripts/StringCleanupPatterns.md

## Umsetzungsauftrag

Erzeuge `StringCleanupPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Buendelt typische Textbereinigungen mit `LTRIM`, `RTRIM`, `REPLACE`, `TRANSLATE` und Co. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
