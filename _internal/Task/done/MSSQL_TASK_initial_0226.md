---
task_id: MSSQL_TASK_initial_0226
repository: SQL_Training
domain: MSSQL
title: "Script PivotQuarterMatrixTemplate.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 775
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:28:34Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0226"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotQuarterMatrixTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotQuarterMatrixTemplate.md"
...
# MSSQL_TASK_initial_0226 - Script PivotQuarterMatrixTemplate.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Vorlage fuer Quartalsmatrizen mit Pivot.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotQuarterMatrixTemplate.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotQuarterMatrixTemplate.md

## Umsetzungsauftrag

Erzeuge `PivotQuarterMatrixTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Quartalsmatrizen mit Pivot. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
