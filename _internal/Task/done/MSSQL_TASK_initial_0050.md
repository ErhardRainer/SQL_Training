---
task_id: MSSQL_TASK_initial_0050
repository: SQL_Training
domain: MSSQL
title: "Script SelfJoinHierarchyStarter.sql fuer 03_JOIN erstellen"
status: done
priority: 951
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T00:27:35Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0050"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/SelfJoinHierarchyStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/SelfJoinHierarchyStarter.md"
...
# MSSQL_TASK_initial_0050 - Script SelfJoinHierarchyStarter.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Einstiegsskript fuer Self-Joins auf Hierarchiedaten.
...
- T-SQL/03_JOIN/SQLScripts/SelfJoinHierarchyStarter.sql
- T-SQL/03_JOIN/SQLScripts/SelfJoinHierarchyStarter.md

## Umsetzungsauftrag

Erzeuge `SelfJoinHierarchyStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Einstiegsskript fuer Self-Joins auf Hierarchiedaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
