---
task_id: MSSQL_TASK_initial_0289
repository: SQL_Training
domain: MSSQL
title: "Script RollupSubtotalLabeling.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 712
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T04:33:21Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0289"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupSubtotalLabeling.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/RollupSubtotalLabeling.md"
...
# MSSQL_TASK_initial_0289 - Script RollupSubtotalLabeling.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Beschriftet Zwischensummen und Gesamtsummen in `ROLLUP`-Ergebnissen sauber.
...
- T-SQL/18_Cube_Rollup/SQLScripts/RollupSubtotalLabeling.sql
- T-SQL/18_Cube_Rollup/SQLScripts/RollupSubtotalLabeling.md

## Umsetzungsauftrag

Erzeuge `RollupSubtotalLabeling.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Beschriftet Zwischensummen und Gesamtsummen in `ROLLUP`-Ergebnissen sauber. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
