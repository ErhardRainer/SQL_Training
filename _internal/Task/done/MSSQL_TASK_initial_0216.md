---
task_id: MSSQL_TASK_initial_0216
repository: SQL_Training
domain: MSSQL
title: "Script MergeTargetLockWatch.sql fuer 13_Merge erstellen"
status: done
priority: 785
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:37:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0216"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeTargetLockWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeTargetLockWatch.md"
...
# MSSQL_TASK_initial_0216 - Script MergeTargetLockWatch.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Beobachtet potenzielle Sperrkonflikte auf dem Ziel waehrend eines Merge.
...
- T-SQL/13_Merge/SQLScripts/MergeTargetLockWatch.sql
- T-SQL/13_Merge/SQLScripts/MergeTargetLockWatch.md

## Umsetzungsauftrag

Erzeuge `MergeTargetLockWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet potenzielle Sperrkonflikte auf dem Ziel waehrend eines Merge. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
