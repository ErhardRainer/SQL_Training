---
task_id: MSSQL_TASK_initial_0278
repository: SQL_Training
domain: MSSQL
title: "Script GroupingIdDecodeHelper.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 723
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:41:36Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0278"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeHelper.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeHelper.md"
...
# MSSQL_TASK_initial_0278 - Script GroupingIdDecodeHelper.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Macht `GROUPING_ID()`-Werte fuer Subtotal-Zeilen leichter lesbar.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeHelper.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingIdDecodeHelper.md

## Umsetzungsauftrag

Erzeuge `GroupingIdDecodeHelper.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Macht `GROUPING_ID()`-Werte fuer Subtotal-Zeilen leichter lesbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
