---
task_id: MSSQL_TASK_initial_0252
repository: SQL_Training
domain: MSSQL
title: "Script FindUntrustedConstraints.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 749
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:02:28Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0252"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/FindUntrustedConstraints.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/FindUntrustedConstraints.md"
...
# MSSQL_TASK_initial_0252 - Script FindUntrustedConstraints.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Findet deaktivierte oder nicht vertrauenswuerdige Constraints in einer Datenbank.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/FindUntrustedConstraints.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/FindUntrustedConstraints.md

## Umsetzungsauftrag

Erzeuge `FindUntrustedConstraints.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Findet deaktivierte oder nicht vertrauenswuerdige Constraints in einer Datenbank. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
