---
task_id: MSSQL_TASK_initial_0150
repository: SQL_Training
domain: MSSQL
title: "Script SymmetricDifferencePattern.sql fuer 09_Set_Operations erstellen"
status: done
priority: 851
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:17:54Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0150"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SymmetricDifferencePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SymmetricDifferencePattern.md"
...
# MSSQL_TASK_initial_0150 - Script SymmetricDifferencePattern.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Zeigt die symmetrische Differenz zweier Mengen ueber kombinierte `EXCEPT`-Abfragen.
...
- T-SQL/09_Set_Operations/SQLScripts/SymmetricDifferencePattern.sql
- T-SQL/09_Set_Operations/SQLScripts/SymmetricDifferencePattern.md

## Umsetzungsauftrag

Erzeuge `SymmetricDifferencePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt die symmetrische Differenz zweier Mengen ueber kombinierte `EXCEPT`-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
