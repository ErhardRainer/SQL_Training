---
task_id: MSSQL_TASK_initial_0136
repository: SQL_Training
domain: MSSQL
title: "Script UpdateWithOutputHistory.sql fuer 08_Update erstellen"
status: done
priority: 865
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T02:08:46Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0136"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateWithOutputHistory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateWithOutputHistory.md"
...
# MSSQL_TASK_initial_0136 - Script UpdateWithOutputHistory.sql fuer 08_Update erstellen

## Anlass und Relevanz

Schreibt vor und nach einem Update geaenderte Werte in eine Historientabelle.
...
- T-SQL/08_Update/SQLScripts/UpdateWithOutputHistory.sql
- T-SQL/08_Update/SQLScripts/UpdateWithOutputHistory.md

## Umsetzungsauftrag

Erzeuge `UpdateWithOutputHistory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Schreibt vor und nach einem Update geaenderte Werte in eine Historientabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
