---
task_id: MSSQL_TASK_initial_0251
repository: SQL_Training
domain: MSSQL
title: "Script DefaultExpressionStandardizer.sql fuer 16_DataIntegrity_Constraints erstellen"
status: done
priority: 750
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T22:01:22Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0251"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultExpressionStandardizer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultExpressionStandardizer.md"
...
# MSSQL_TASK_initial_0251 - Script DefaultExpressionStandardizer.sql fuer 16_DataIntegrity_Constraints erstellen

## Anlass und Relevanz

Review von Default-Ausdruecken im Hinblick auf Konventionen.
...
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultExpressionStandardizer.sql
- T-SQL/16_DataIntegrity_Constraints/SQLScripts/DefaultExpressionStandardizer.md

## Umsetzungsauftrag

Erzeuge `DefaultExpressionStandardizer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `16_DataIntegrity_Constraints` und diese fachliche Kurzbeschreibung als Rahmen: Review von Default-Ausdruecken im Hinblick auf Konventionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
