---
task_id: MSSQL_TASK_initial_0117
repository: SQL_Training
domain: MSSQL
title: "Script InsertSourceTargetShapeCheck.sql fuer 07_Insert erstellen"
status: done
priority: 884
priority_class: high
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0117"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertSourceTargetShapeCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertSourceTargetShapeCheck.md"
...
# MSSQL_TASK_initial_0117 - Script InsertSourceTargetShapeCheck.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Formcheck zwischen Quelle und Ziel vor einem Insert.
...
- T-SQL/07_Insert/SQLScripts/InsertSourceTargetShapeCheck.sql
- T-SQL/07_Insert/SQLScripts/InsertSourceTargetShapeCheck.md

## Umsetzungsauftrag

Erzeuge `InsertSourceTargetShapeCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Formcheck zwischen Quelle und Ziel vor einem Insert. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
