---
task_id: MSSQL_TASK_initial_0326
repository: SQL_Training
domain: MSSQL
title: "Script LogFileSizingPlanner.sql fuer 20_Create_Database erstellen"
status: done
priority: 675
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T08:49:41Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0326"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/20_Create_Database/SQLScripts/LogFileSizingPlanner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/20_Create_Database/SQLScripts/LogFileSizingPlanner.md"
...
# MSSQL_TASK_initial_0326 - Script LogFileSizingPlanner.sql fuer 20_Create_Database erstellen

## Anlass und Relevanz

Hilft bei der Planung sinnvoller initialer Logfile-Groessen.
...
- T-SQL/20_Create_Database/SQLScripts/LogFileSizingPlanner.sql
- T-SQL/20_Create_Database/SQLScripts/LogFileSizingPlanner.md

## Umsetzungsauftrag

Erzeuge `LogFileSizingPlanner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `20_Create_Database` und diese fachliche Kurzbeschreibung als Rahmen: Hilft bei der Planung sinnvoller initialer Logfile-Groessen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
