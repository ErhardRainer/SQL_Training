---
task_id: MSSQL_TASK_initial_0392
repository: SQL_Training
domain: MSSQL
title: "Script FunctionDependencyInventory.sql fuer 24_UserDefinedFunctions erstellen"
status: done
priority: 609
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T15:42:00+02:00"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0392"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDependencyInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDependencyInventory.md"
...
# MSSQL_TASK_initial_0392 - Script FunctionDependencyInventory.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Listet Funktionen und ihre Abhaengigkeiten zu Tabellen, Views und anderen Modulen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDependencyInventory.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionDependencyInventory.md

## Umsetzungsauftrag

Erzeuge `FunctionDependencyInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Listet Funktionen und ihre Abhaengigkeiten zu Tabellen, Views und anderen Modulen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
