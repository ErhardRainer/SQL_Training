---
task_id: MSSQL_TASK_initial_0178
repository: SQL_Training
domain: MSSQL
title: "Script WindowNthValueLab.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 823
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T17:40:33Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0178"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowNthValueLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowNthValueLab.md"
...
# MSSQL_TASK_initial_0178 - Script WindowNthValueLab.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Labor fuer `NTH_VALUE`-aehnliche Muster in T-SQL.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowNthValueLab.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowNthValueLab.md

## Umsetzungsauftrag

Erzeuge `WindowNthValueLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer `NTH_VALUE`-aehnliche Muster in T-SQL. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
