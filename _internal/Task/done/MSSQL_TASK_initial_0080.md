---
task_id: MSSQL_TASK_initial_0080
repository: SQL_Training
domain: MSSQL
title: "Script FunctionWeekNumberExamples.sql fuer 05_Funktionen erstellen"
status: done
priority: 921
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:33:14Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0080"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionWeekNumberExamples.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionWeekNumberExamples.md"
...
# MSSQL_TASK_initial_0080 - Script FunctionWeekNumberExamples.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Beispiele fuer Wochenlogik und unterschiedliche Kalenderdefinitionen.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionWeekNumberExamples.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionWeekNumberExamples.md

## Umsetzungsauftrag

Erzeuge `FunctionWeekNumberExamples.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Beispiele fuer Wochenlogik und unterschiedliche Kalenderdefinitionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
