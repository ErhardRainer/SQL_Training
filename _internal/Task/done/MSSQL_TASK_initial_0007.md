---
task_id: MSSQL_TASK_initial_0007
repository: SQL_Training
domain: MSSQL
title: "Script FunctionalDependencyWorksheet.sql fuer 01_Normalformen erstellen"
status: done
priority: 994
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T20:59:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0007"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/01_Normalformen/SQLScripts/FunctionalDependencyWorksheet.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/01_Normalformen/SQLScripts/FunctionalDependencyWorksheet.md"
...
# MSSQL_TASK_initial_0007 - Script FunctionalDependencyWorksheet.sql fuer 01_Normalformen erstellen

## Anlass und Relevanz

Liefert ein Arbeitsblatt fuer funktionale Abhaengigkeiten in Beispieldaten.
...
- T-SQL/01_Normalformen/SQLScripts/FunctionalDependencyWorksheet.sql
- T-SQL/01_Normalformen/SQLScripts/FunctionalDependencyWorksheet.md

## Umsetzungsauftrag

Erzeuge `FunctionalDependencyWorksheet.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `01_Normalformen` und diese fachliche Kurzbeschreibung als Rahmen: Liefert ein Arbeitsblatt fuer funktionale Abhaengigkeiten in Beispieldaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
