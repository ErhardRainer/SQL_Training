---
task_id: MSSQL_TASK_initial_0350
repository: SQL_Training
domain: MSSQL
title: "Script RecreateScriptHeaderTemplate.sql fuer 21_QUOTED_IDENTIFIER erstellen"
status: done
priority: 651
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T10:49:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0350"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/RecreateScriptHeaderTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/RecreateScriptHeaderTemplate.md"
...
# MSSQL_TASK_initial_0350 - Script RecreateScriptHeaderTemplate.sql fuer 21_QUOTED_IDENTIFIER erstellen

## Anlass und Relevanz

Liefert eine Vorlage fuer konsistente Script-Header beim Recreate von Modulen.
...
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/RecreateScriptHeaderTemplate.sql
- T-SQL/21_QUOTED_IDENTIFIER/SQLScripts/RecreateScriptHeaderTemplate.md

## Umsetzungsauftrag

Erzeuge `RecreateScriptHeaderTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `21_QUOTED_IDENTIFIER` und diese fachliche Kurzbeschreibung als Rahmen: Liefert eine Vorlage fuer konsistente Script-Header beim Recreate von Modulen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
