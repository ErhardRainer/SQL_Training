---
task_id: MSSQL_TASK_initial_0277
repository: SQL_Training
domain: MSSQL
title: "Script GroupingFlagsDebugView.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 724
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:33:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0277"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingFlagsDebugView.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/GroupingFlagsDebugView.md"
...
# MSSQL_TASK_initial_0277 - Script GroupingFlagsDebugView.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Macht `GROUPING()`-Marker in komplexen Ergebnissen transparent.
...
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingFlagsDebugView.sql
- T-SQL/18_Cube_Rollup/SQLScripts/GroupingFlagsDebugView.md

## Umsetzungsauftrag

Erzeuge `GroupingFlagsDebugView.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Macht `GROUPING()`-Marker in komplexen Ergebnissen transparent. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
