---
task_id: MSSQL_TASK_initial_0373
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureDependencyGraph.sql fuer 23_StoredProcedures erstellen"
status: done
priority: 628
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T14:02:39Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0373"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureDependencyGraph.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/23_StoredProcedures/SQLScripts/ProcedureDependencyGraph.md"
...
# MSSQL_TASK_initial_0373 - Script ProcedureDependencyGraph.sql fuer 23_StoredProcedures erstellen

## Anlass und Relevanz

Baut einen Abhaengigkeitsgraphen zwischen Prozeduren und aufgerufenen Objekten.
...
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureDependencyGraph.sql
- T-SQL/23_StoredProcedures/SQLScripts/ProcedureDependencyGraph.md

## Umsetzungsauftrag

Erzeuge `ProcedureDependencyGraph.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `23_StoredProcedures` und diese fachliche Kurzbeschreibung als Rahmen: Baut einen Abhaengigkeitsgraphen zwischen Prozeduren und aufgerufenen Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
