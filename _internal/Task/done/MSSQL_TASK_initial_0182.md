---
task_id: MSSQL_TASK_initial_0182
repository: SQL_Training
domain: MSSQL
title: "Script WindowRollingAverageTemplate.sql fuer 11_WindowFunctions erstellen"
status: done
priority: 819
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T15:52:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0182"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowRollingAverageTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/11_WindowFunctions/SQLScripts/WindowRollingAverageTemplate.md"
...
# MSSQL_TASK_initial_0182 - Script WindowRollingAverageTemplate.sql fuer 11_WindowFunctions erstellen

## Anlass und Relevanz

Vorlage fuer gleitende Durchschnitte ueber Fensterrahmen.
...
- T-SQL/11_WindowFunctions/SQLScripts/WindowRollingAverageTemplate.sql
- T-SQL/11_WindowFunctions/SQLScripts/WindowRollingAverageTemplate.md

## Umsetzungsauftrag

Erzeuge `WindowRollingAverageTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `11_WindowFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer gleitende Durchschnitte ueber Fensterrahmen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
