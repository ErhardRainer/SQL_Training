---
task_id: MSSQL_TASK_initial_0207
repository: SQL_Training
domain: MSSQL
title: "Script MergeMinimalChangeStrategy.sql fuer 13_Merge erstellen"
status: done
priority: 794
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:52:56Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0207"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeMinimalChangeStrategy.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeMinimalChangeStrategy.md"
...
# MSSQL_TASK_initial_0207 - Script MergeMinimalChangeStrategy.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Muster fuer minimale Aenderungen statt breiter Merge-Updates.
...
- T-SQL/13_Merge/SQLScripts/MergeMinimalChangeStrategy.sql
- T-SQL/13_Merge/SQLScripts/MergeMinimalChangeStrategy.md

## Umsetzungsauftrag

Erzeuge `MergeMinimalChangeStrategy.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Muster fuer minimale Aenderungen statt breiter Merge-Updates. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
