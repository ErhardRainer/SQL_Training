---
task_id: MSSQL_TASK_initial_0155
repository: SQL_Training
domain: MSSQL
title: "Script AggregateDistinctKeyProfile.sql fuer 10_GroupBy_Aggregate erstellen"
status: done
priority: 846
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T13:42:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0155"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateDistinctKeyProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateDistinctKeyProfile.md"
...
# MSSQL_TASK_initial_0155 - Script AggregateDistinctKeyProfile.sql fuer 10_GroupBy_Aggregate erstellen

## Anlass und Relevanz

Profiling ueber eindeutige Schluessel innerhalb von Gruppen.
...
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateDistinctKeyProfile.sql
- T-SQL/10_GroupBy_Aggregate/SQLScripts/AggregateDistinctKeyProfile.md

## Umsetzungsauftrag

Erzeuge `AggregateDistinctKeyProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `10_GroupBy_Aggregate` und diese fachliche Kurzbeschreibung als Rahmen: Profiling ueber eindeutige Schluessel innerhalb von Gruppen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
