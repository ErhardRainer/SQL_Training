---
task_id: MSSQL_TASK_initial_0042
repository: SQL_Training
domain: MSSQL
title: "Script OuterJoinFilterTrap.sql fuer 03_JOIN erstellen"
status: done
priority: 959
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T07:01:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0042"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/03_JOIN/SQLScripts/OuterJoinFilterTrap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/03_JOIN/SQLScripts/OuterJoinFilterTrap.md"
...
# MSSQL_TASK_initial_0042 - Script OuterJoinFilterTrap.sql fuer 03_JOIN erstellen

## Anlass und Relevanz

Zeigt typische Filterfallen bei Outer Joins und wie sie vermieden werden.
...
- T-SQL/03_JOIN/SQLScripts/OuterJoinFilterTrap.sql
- T-SQL/03_JOIN/SQLScripts/OuterJoinFilterTrap.md

## Umsetzungsauftrag

Erzeuge `OuterJoinFilterTrap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `03_JOIN` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt typische Filterfallen bei Outer Joins und wie sie vermieden werden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
