---
task_id: MSSQL_TASK_initial_0271
repository: SQL_Training
domain: MSSQL
title: "Script SessionOptionSnapshot.sql fuer 17_ANSI_NULL \u0026 Co erstellen"
status: done
priority: 730
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:03:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0271"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/SessionOptionSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/17_ANSI_NULL \u0026 Co/SQLScripts/SessionOptionSnapshot.md"
...
# MSSQL_TASK_initial_0271 - Script SessionOptionSnapshot.sql fuer 17_ANSI_NULL & Co erstellen

## Anlass und Relevanz

Zeigt die relevanten Session-Optionen wie `ANSI_NULLS`, `QUOTED_IDENTIFIER` und `ANSI_WARNINGS` auf einen Blick.
...
- T-SQL/17_ANSI_NULL & Co/SQLScripts/SessionOptionSnapshot.sql
- T-SQL/17_ANSI_NULL & Co/SQLScripts/SessionOptionSnapshot.md

## Umsetzungsauftrag

Erzeuge `SessionOptionSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `17_ANSI_NULL & Co` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt die relevanten Session-Optionen wie `ANSI_NULLS`, `QUOTED_IDENTIFIER` und `ANSI_WARNINGS` auf einen Blick. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
