---
task_id: MSSQL_TASK_initial_0122
repository: SQL_Training
domain: MSSQL
title: "Script CaseBasedMassUpdate.sql fuer 08_Update erstellen"
status: done
priority: 879
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T14:40:44Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0122"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/CaseBasedMassUpdate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/CaseBasedMassUpdate.md"
...
# MSSQL_TASK_initial_0122 - Script CaseBasedMassUpdate.sql fuer 08_Update erstellen

## Anlass und Relevanz

Nutzt `CASE` fuer mehrere Regelpfade in einem kontrollierten `UPDATE`.
...
- T-SQL/08_Update/SQLScripts/CaseBasedMassUpdate.sql
- T-SQL/08_Update/SQLScripts/CaseBasedMassUpdate.md

## Umsetzungsauftrag

Erzeuge `CaseBasedMassUpdate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Nutzt `CASE` fuer mehrere Regelpfade in einem kontrollierten `UPDATE`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
