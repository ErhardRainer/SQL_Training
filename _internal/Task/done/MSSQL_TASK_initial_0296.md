---
task_id: MSSQL_TASK_initial_0296
repository: SQL_Training
domain: MSSQL
title: "Script LockOwnerByTransaction.sql fuer 19_Transaktions erstellen"
status: done
priority: 705
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T08:22:04Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0296"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/19_Transaktions/SQLScripts/LockOwnerByTransaction.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/19_Transaktions/SQLScripts/LockOwnerByTransaction.md"
...
# MSSQL_TASK_initial_0296 - Script LockOwnerByTransaction.sql fuer 19_Transaktions erstellen

## Anlass und Relevanz

Ordnet Sperren ihren besitzenden Transaktionen zu.
...
- T-SQL/19_Transaktions/SQLScripts/LockOwnerByTransaction.sql
- T-SQL/19_Transaktions/SQLScripts/LockOwnerByTransaction.md

## Umsetzungsauftrag

Erzeuge `LockOwnerByTransaction.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `19_Transaktions` und diese fachliche Kurzbeschreibung als Rahmen: Ordnet Sperren ihren besitzenden Transaktionen zu. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
