---
task_id: MSSQL_TASK_initial_0135
repository: SQL_Training
domain: MSSQL
title: "Script UpdateTargetRowcountCheck.sql fuer 08_Update erstellen"
status: done
priority: 866
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T01:32:00Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0135"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/08_Update/SQLScripts/UpdateTargetRowcountCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/08_Update/SQLScripts/UpdateTargetRowcountCheck.md"
...
# MSSQL_TASK_initial_0135 - Script UpdateTargetRowcountCheck.sql fuer 08_Update erstellen

## Anlass und Relevanz

Prueft die erwartete Zielzeilenanzahl eines Updates vorab.
...
- T-SQL/08_Update/SQLScripts/UpdateTargetRowcountCheck.sql
- T-SQL/08_Update/SQLScripts/UpdateTargetRowcountCheck.md

## Umsetzungsauftrag

Erzeuge `UpdateTargetRowcountCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `08_Update` und diese fachliche Kurzbeschreibung als Rahmen: Prueft die erwartete Zielzeilenanzahl eines Updates vorab. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
