---
task_id: MSSQL_TASK_initial_0390
repository: SQL_Training
domain: MSSQL
title: "Script FunctionCrossSchemaUsage.sql fuer 24_UserDefinedFunctions erstellen"
status: done
priority: 611
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T13:06:02Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0390"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionCrossSchemaUsage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionCrossSchemaUsage.md"
...
# MSSQL_TASK_initial_0390 - Script FunctionCrossSchemaUsage.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Zeigt Funktionen, die schemauebergreifend verwendet werden.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionCrossSchemaUsage.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/FunctionCrossSchemaUsage.md

## Umsetzungsauftrag

Erzeuge `FunctionCrossSchemaUsage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Funktionen, die schemauebergreifend verwendet werden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
