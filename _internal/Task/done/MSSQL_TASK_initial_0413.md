---
task_id: MSSQL_TASK_initial_0413
repository: SQL_Training
domain: MSSQL
title: "Script ErrorLogTableTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 588
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T09:58:10Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0413"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLogTableTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLogTableTemplate.md"
...
# MSSQL_TASK_initial_0413 - Script ErrorLogTableTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Liefert ein Startskript fuer eine zentrale Fehlerlog-Tabelle samt Standardspalten.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLogTableTemplate.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ErrorLogTableTemplate.md

## Umsetzungsauftrag

Erzeuge `ErrorLogTableTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Liefert ein Startskript fuer eine zentrale Fehlerlog-Tabelle samt Standardspalten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
