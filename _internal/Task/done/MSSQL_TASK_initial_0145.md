---
task_id: MSSQL_TASK_initial_0145
repository: SQL_Training
domain: MSSQL
title: "Script SetOperatorNullSemantics.sql fuer 09_Set_Operations erstellen"
status: done
priority: 856
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:52:40Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0145"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetOperatorNullSemantics.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetOperatorNullSemantics.md"
...
# MSSQL_TASK_initial_0145 - Script SetOperatorNullSemantics.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Zeigt, wie `NULL`-Werte `UNION`, `INTERSECT` und `EXCEPT` beeinflussen.
...
- T-SQL/09_Set_Operations/SQLScripts/SetOperatorNullSemantics.sql
- T-SQL/09_Set_Operations/SQLScripts/SetOperatorNullSemantics.md

## Umsetzungsauftrag

Erzeuge `SetOperatorNullSemantics.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie `NULL`-Werte `UNION`, `INTERSECT` und `EXCEPT` beeinflussen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
