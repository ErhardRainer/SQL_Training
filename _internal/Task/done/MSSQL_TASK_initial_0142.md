---
task_id: MSSQL_TASK_initial_0142
repository: SQL_Training
domain: MSSQL
title: "Script SetDuplicateSourceProbe.sql fuer 09_Set_Operations erstellen"
status: done
priority: 859
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T12:44:30Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0142"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetDuplicateSourceProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/09_Set_Operations/SQLScripts/SetDuplicateSourceProbe.md"
...
# MSSQL_TASK_initial_0142 - Script SetDuplicateSourceProbe.sql fuer 09_Set_Operations erstellen

## Anlass und Relevanz

Spuert Duplikate auf, die Set-Ergebnisse verzerren koennen.
...
- T-SQL/09_Set_Operations/SQLScripts/SetDuplicateSourceProbe.sql
- T-SQL/09_Set_Operations/SQLScripts/SetDuplicateSourceProbe.md

## Umsetzungsauftrag

Erzeuge `SetDuplicateSourceProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `09_Set_Operations` und diese fachliche Kurzbeschreibung als Rahmen: Spuert Duplikate auf, die Set-Ergebnisse verzerren koennen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
