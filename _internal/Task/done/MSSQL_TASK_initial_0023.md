---
task_id: MSSQL_TASK_initial_0023
repository: SQL_Training
domain: MSSQL
title: "Script SelectLiteralProjectionShowcase.sql fuer 02_Select erstellen"
status: done
priority: 978
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T00:43:26Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0023"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectLiteralProjectionShowcase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectLiteralProjectionShowcase.md"
...
# MSSQL_TASK_initial_0023 - Script SelectLiteralProjectionShowcase.sql fuer 02_Select erstellen

## Anlass und Relevanz

Demonstriert Literale, Konstanten und Formatspalten in Projektionen.
...
- T-SQL/02_Select/SQLScripts/SelectLiteralProjectionShowcase.sql
- T-SQL/02_Select/SQLScripts/SelectLiteralProjectionShowcase.md

## Umsetzungsauftrag

Erzeuge `SelectLiteralProjectionShowcase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Literale, Konstanten und Formatspalten in Projektionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
