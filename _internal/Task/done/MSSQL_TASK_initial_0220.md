---
task_id: MSSQL_TASK_initial_0220
repository: SQL_Training
domain: MSSQL
title: "Script MultiMeasurePivotTemplate.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 781
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T18:57:14Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0220"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/MultiMeasurePivotTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/MultiMeasurePivotTemplate.md"
...
# MSSQL_TASK_initial_0220 - Script MultiMeasurePivotTemplate.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Vorlage fuer Pivot-Abfragen mit mehreren Kennzahlen und sauberem Alias-Schema.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/MultiMeasurePivotTemplate.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/MultiMeasurePivotTemplate.md

## Umsetzungsauftrag

Erzeuge `MultiMeasurePivotTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Pivot-Abfragen mit mehreren Kennzahlen und sauberem Alias-Schema. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
