---
task_id: MSSQL_TASK_initial_0071
repository: SQL_Training
domain: MSSQL
title: "Script DateBucketGenerator.sql fuer 05_Funktionen erstellen"
status: done
priority: 930
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T09:32:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0071"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/DateBucketGenerator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/DateBucketGenerator.md"
...
# MSSQL_TASK_initial_0071 - Script DateBucketGenerator.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Erzeugt Zeit-Buckets fuer Tages-, Wochen- und Monatsverdichtung.
...
- T-SQL/05_Funktionen/SQLScripts/DateBucketGenerator.sql
- T-SQL/05_Funktionen/SQLScripts/DateBucketGenerator.md

## Umsetzungsauftrag

Erzeuge `DateBucketGenerator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Erzeugt Zeit-Buckets fuer Tages-, Wochen- und Monatsverdichtung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
