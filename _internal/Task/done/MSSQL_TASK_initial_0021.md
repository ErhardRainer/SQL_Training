---
task_id: MSSQL_TASK_initial_0021
repository: SQL_Training
domain: MSSQL
title: "Script SelectIntoPermanentTableDemo.sql fuer 02_Select erstellen"
status: done
priority: 980
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T00:14:38Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0021"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/02_Select/SQLScripts/SelectIntoPermanentTableDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/02_Select/SQLScripts/SelectIntoPermanentTableDemo.md"
...
# MSSQL_TASK_initial_0021 - Script SelectIntoPermanentTableDemo.sql fuer 02_Select erstellen

## Anlass und Relevanz

Demonstriert `SELECT INTO` fuer schnelle Tabellenkopien als Start fuer Staging-Strukturen.
...
- T-SQL/02_Select/SQLScripts/SelectIntoPermanentTableDemo.sql
- T-SQL/02_Select/SQLScripts/SelectIntoPermanentTableDemo.md

## Umsetzungsauftrag

Erzeuge `SelectIntoPermanentTableDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `02_Select` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert `SELECT INTO` fuer schnelle Tabellenkopien als Start fuer Staging-Strukturen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
