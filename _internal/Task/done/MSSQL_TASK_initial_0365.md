---
task_id: MSSQL_TASK_initial_0365
repository: SQL_Training
domain: MSSQL
title: "Script ViewDependencyTree.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 636
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T12:04:09Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0365"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyTree.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyTree.md"
...
# MSSQL_TASK_initial_0365 - Script ViewDependencyTree.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Baut einen lesbaren Abhaengigkeitsbaum fuer Views, Tabellen und weitere Module.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyTree.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyTree.md

## Umsetzungsauftrag

Erzeuge `ViewDependencyTree.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Baut einen lesbaren Abhaengigkeitsbaum fuer Views, Tabellen und weitere Module. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
