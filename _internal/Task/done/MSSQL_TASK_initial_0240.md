---
task_id: MSSQL_TASK_initial_0240
repository: SQL_Training
domain: MSSQL
title: "Script SearchSqlAgentJobCommands.sql fuer 15_SearchInTables erstellen"
status: done
priority: 761
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T20:47:39Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0240"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchSqlAgentJobCommands.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/15_SearchInTables/SQLScripts/SearchSqlAgentJobCommands.md"
...
# MSSQL_TASK_initial_0240 - Script SearchSqlAgentJobCommands.sql fuer 15_SearchInTables erstellen

## Anlass und Relevanz

Durchsucht SQL-Agent-Kommandos nach bestimmten Objekt- oder Textmustern.
...
- T-SQL/15_SearchInTables/SQLScripts/SearchSqlAgentJobCommands.sql
- T-SQL/15_SearchInTables/SQLScripts/SearchSqlAgentJobCommands.md

## Umsetzungsauftrag

Erzeuge `SearchSqlAgentJobCommands.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `15_SearchInTables` und diese fachliche Kurzbeschreibung als Rahmen: Durchsucht SQL-Agent-Kommandos nach bestimmten Objekt- oder Textmustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
