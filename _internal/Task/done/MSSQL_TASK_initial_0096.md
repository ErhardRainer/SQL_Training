---
task_id: MSSQL_TASK_initial_0096
repository: SQL_Training
domain: MSSQL
title: "Script DeleteCandidateSnapshot.sql fuer 06_Delete erstellen"
status: done
priority: 905
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T01:25:06Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0096"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/DeleteCandidateSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/DeleteCandidateSnapshot.md"
...
# MSSQL_TASK_initial_0096 - Script DeleteCandidateSnapshot.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Schreibt potenzielle Delete-Kandidaten zuerst in eine Kontrolltabelle.
...
- T-SQL/06_Delete/SQLScripts/DeleteCandidateSnapshot.sql
- T-SQL/06_Delete/SQLScripts/DeleteCandidateSnapshot.md

## Umsetzungsauftrag

Erzeuge `DeleteCandidateSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Schreibt potenzielle Delete-Kandidaten zuerst in eine Kontrolltabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
