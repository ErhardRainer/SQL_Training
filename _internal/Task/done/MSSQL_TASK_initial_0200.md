---
task_id: MSSQL_TASK_initial_0200
repository: SQL_Training
domain: MSSQL
title: "Script UnicodeLengthAudit.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 801
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-16T18:06:16Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0200"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeLengthAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeLengthAudit.md"
...
# MSSQL_TASK_initial_0200 - Script UnicodeLengthAudit.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Vergleicht Zeichenlaenge, Bytebedarf und Unicode-Risiken fuer Textspalten.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeLengthAudit.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/UnicodeLengthAudit.md

## Umsetzungsauftrag

Erzeuge `UnicodeLengthAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Zeichenlaenge, Bytebedarf und Unicode-Risiken fuer Textspalten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
