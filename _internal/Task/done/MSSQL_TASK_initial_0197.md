---
task_id: MSSQL_TASK_initial_0197
repository: SQL_Training
domain: MSSQL
title: "Script StringLengthVsByteLengthDemo.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 804
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:07:31Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0197"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/StringLengthVsByteLengthDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/StringLengthVsByteLengthDemo.md"
...
# MSSQL_TASK_initial_0197 - Script StringLengthVsByteLengthDemo.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Zeigt den Unterschied zwischen Zeichenlaenge und Bytebedarf.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/StringLengthVsByteLengthDemo.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/StringLengthVsByteLengthDemo.md

## Umsetzungsauftrag

Erzeuge `StringLengthVsByteLengthDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Unterschied zwischen Zeichenlaenge und Bytebedarf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
