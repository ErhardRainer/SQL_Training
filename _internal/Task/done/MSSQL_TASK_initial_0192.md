---
task_id: MSSQL_TASK_initial_0192
repository: SQL_Training
domain: MSSQL
title: "Script DecimalPrecisionImpactDemo.sql fuer 12_DataTypes_Conversion erstellen"
status: done
priority: 809
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T16:43:01Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0192"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalPrecisionImpactDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalPrecisionImpactDemo.md"
...
# MSSQL_TASK_initial_0192 - Script DecimalPrecisionImpactDemo.sql fuer 12_DataTypes_Conversion erstellen

## Anlass und Relevanz

Zeigt die Auswirkungen von Praezision und Skala auf Rundung und Overflow.
...
- T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalPrecisionImpactDemo.sql
- T-SQL/12_DataTypes_Conversion/SQLScripts/DecimalPrecisionImpactDemo.md

## Umsetzungsauftrag

Erzeuge `DecimalPrecisionImpactDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `12_DataTypes_Conversion` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt die Auswirkungen von Praezision und Skala auf Rundung und Overflow. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
