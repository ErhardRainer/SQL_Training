---
task_id: MSSQL_TASK_initial_0231
repository: SQL_Training
domain: MSSQL
title: "Script UnpivotColumnWhitelist.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 770
priority_class: high
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-18T19:57:21Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0231"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotColumnWhitelist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotColumnWhitelist.md"
...
# MSSQL_TASK_initial_0231 - Script UnpivotColumnWhitelist.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Entpivotisiert gezielt nur freigegebene Spaltenlisten.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotColumnWhitelist.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/UnpivotColumnWhitelist.md

## Umsetzungsauftrag

Erzeuge `UnpivotColumnWhitelist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Entpivotisiert gezielt nur freigegebene Spaltenlisten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
