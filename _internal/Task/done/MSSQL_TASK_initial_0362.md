---
task_id: MSSQL_TASK_initial_0362
repository: SQL_Training
domain: MSSQL
title: "Script ViewColumnLineageReport.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 639
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:53:14Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0362"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewColumnLineageReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewColumnLineageReport.md"
...
# MSSQL_TASK_initial_0362 - Script ViewColumnLineageReport.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Bericht ueber Spaltenherkunft in Views fuer Dokumentation und Analyse.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewColumnLineageReport.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewColumnLineageReport.md

## Umsetzungsauftrag

Erzeuge `ViewColumnLineageReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Bericht ueber Spaltenherkunft in Views fuer Dokumentation und Analyse. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
