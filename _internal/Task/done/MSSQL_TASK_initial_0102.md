---
task_id: MSSQL_TASK_initial_0102
repository: SQL_Training
domain: MSSQL
title: "Script SafeDeletePreview.sql fuer 06_Delete erstellen"
status: done
priority: 899
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-19T01:33:42Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0102"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/06_Delete/SQLScripts/SafeDeletePreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/06_Delete/SQLScripts/SafeDeletePreview.md"
...
# MSSQL_TASK_initial_0102 - Script SafeDeletePreview.sql fuer 06_Delete erstellen

## Anlass und Relevanz

Zeigt zu loeschende Zeilen zuerst als Preview, bevor das eigentliche `DELETE` ausgefuehrt wird.
...
- T-SQL/06_Delete/SQLScripts/SafeDeletePreview.sql
- T-SQL/06_Delete/SQLScripts/SafeDeletePreview.md

## Umsetzungsauftrag

Erzeuge `SafeDeletePreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `06_Delete` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt zu loeschende Zeilen zuerst als Preview, bevor das eigentliche `DELETE` ausgefuehrt wird. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
