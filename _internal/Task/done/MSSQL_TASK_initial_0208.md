---
task_id: MSSQL_TASK_initial_0208
repository: SQL_Training
domain: MSSQL
title: "Script MergeNotMatchedBySourcePreview.sql fuer 13_Merge erstellen"
status: done
priority: 793
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T17:58:55Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0208"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/13_Merge/SQLScripts/MergeNotMatchedBySourcePreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/13_Merge/SQLScripts/MergeNotMatchedBySourcePreview.md"
...
# MSSQL_TASK_initial_0208 - Script MergeNotMatchedBySourcePreview.sql fuer 13_Merge erstellen

## Anlass und Relevanz

Preview fuer die Zeilen, die bei `NOT MATCHED BY SOURCE` betroffen waeren.
...
- T-SQL/13_Merge/SQLScripts/MergeNotMatchedBySourcePreview.sql
- T-SQL/13_Merge/SQLScripts/MergeNotMatchedBySourcePreview.md

## Umsetzungsauftrag

Erzeuge `MergeNotMatchedBySourcePreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `13_Merge` und diese fachliche Kurzbeschreibung als Rahmen: Preview fuer die Zeilen, die bei `NOT MATCHED BY SOURCE` betroffen waeren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
