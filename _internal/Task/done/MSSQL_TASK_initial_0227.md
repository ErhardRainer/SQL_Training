---
task_id: MSSQL_TASK_initial_0227
repository: SQL_Training
domain: MSSQL
title: "Script PivotSparseCategoryDemo.sql fuer 14_Pivot_Unpivot erstellen"
status: done
priority: 774
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-18T19:33:45Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0227"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotSparseCategoryDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/14_Pivot_Unpivot/SQLScripts/PivotSparseCategoryDemo.md"
...
# MSSQL_TASK_initial_0227 - Script PivotSparseCategoryDemo.sql fuer 14_Pivot_Unpivot erstellen

## Anlass und Relevanz

Zeigt den Umgang mit duenn besetzten Pivot-Kategorien und fehlenden Spaltenwerten.
...
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotSparseCategoryDemo.sql
- T-SQL/14_Pivot_Unpivot/SQLScripts/PivotSparseCategoryDemo.md

## Umsetzungsauftrag

Erzeuge `PivotSparseCategoryDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `14_Pivot_Unpivot` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Umgang mit duenn besetzten Pivot-Kategorien und fehlenden Spaltenwerten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
