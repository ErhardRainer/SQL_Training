---
task_id: MSSQL_TASK_initial_0075
repository: SQL_Training
domain: MSSQL
title: "Script FunctionConditionalLabeling.sql fuer 05_Funktionen erstellen"
status: done
priority: 926
priority_class: high
created_at: "2026-04-18T22:47:52Z"
updated_at: "2026-04-17T10:12:28Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0075"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionConditionalLabeling.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/05_Funktionen/SQLScripts/FunctionConditionalLabeling.md"
...
# MSSQL_TASK_initial_0075 - Script FunctionConditionalLabeling.sql fuer 05_Funktionen erstellen

## Anlass und Relevanz

Kombination von CASE und Funktionen fuer fachliche Labels.
...
- T-SQL/05_Funktionen/SQLScripts/FunctionConditionalLabeling.sql
- T-SQL/05_Funktionen/SQLScripts/FunctionConditionalLabeling.md

## Umsetzungsauftrag

Erzeuge `FunctionConditionalLabeling.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `05_Funktionen` und diese fachliche Kurzbeschreibung als Rahmen: Kombination von CASE und Funktionen fuer fachliche Labels. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
