---
task_id: MSSQL_TASK_initial_0276
repository: SQL_Training
domain: MSSQL
title: "Script CubeToRollupCostCompare.sql fuer 18_Cube_Rollup erstellen"
status: done
priority: 725
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-19T03:32:37Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0276"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeToRollupCostCompare.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/18_Cube_Rollup/SQLScripts/CubeToRollupCostCompare.md"
...
# MSSQL_TASK_initial_0276 - Script CubeToRollupCostCompare.sql fuer 18_Cube_Rollup erstellen

## Anlass und Relevanz

Vergleicht Ergebnisumfang und Aufwand von `ROLLUP`, `CUBE` und gezielten `GROUPING SETS`.
...
- T-SQL/18_Cube_Rollup/SQLScripts/CubeToRollupCostCompare.sql
- T-SQL/18_Cube_Rollup/SQLScripts/CubeToRollupCostCompare.md

## Umsetzungsauftrag

Erzeuge `CubeToRollupCostCompare.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `18_Cube_Rollup` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Ergebnisumfang und Aufwand von `ROLLUP`, `CUBE` und gezielten `GROUPING SETS`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
