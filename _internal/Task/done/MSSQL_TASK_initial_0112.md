---
task_id: MSSQL_TASK_initial_0112
repository: SQL_Training
domain: MSSQL
title: "Script InsertIgnoreExistingRows.sql fuer 07_Insert erstellen"
status: done
priority: 889
priority_class: high
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0112"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/07_Insert/SQLScripts/InsertIgnoreExistingRows.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/07_Insert/SQLScripts/InsertIgnoreExistingRows.md"
...
# MSSQL_TASK_initial_0112 - Script InsertIgnoreExistingRows.sql fuer 07_Insert erstellen

## Anlass und Relevanz

Beispiellogik fuer Inserts, die vorhandene Datensaetze ueberspringen.
...
- T-SQL/07_Insert/SQLScripts/InsertIgnoreExistingRows.sql
- T-SQL/07_Insert/SQLScripts/InsertIgnoreExistingRows.md

## Umsetzungsauftrag

Erzeuge `InsertIgnoreExistingRows.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `07_Insert` und diese fachliche Kurzbeschreibung als Rahmen: Beispiellogik fuer Inserts, die vorhandene Datensaetze ueberspringen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
