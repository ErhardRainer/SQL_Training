---
task_id: MSSQL_TASK_initial_0364
repository: SQL_Training
domain: MSSQL
title: "Script ViewDependencyGraph.sql fuer 22_Views_Schemata erstellen"
status: done
priority: 637
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-22T11:59:24Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0364"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyGraph.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyGraph.md"
...
# MSSQL_TASK_initial_0364 - Script ViewDependencyGraph.sql fuer 22_Views_Schemata erstellen

## Anlass und Relevanz

Baut eine einfache Abhaengigkeitskette zwischen Views, Tabellen und anderen Objekten.
...
- T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyGraph.sql
- T-SQL/22_Views_Schemata/SQLScripts/ViewDependencyGraph.md

## Umsetzungsauftrag

Erzeuge `ViewDependencyGraph.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `22_Views_Schemata` und diese fachliche Kurzbeschreibung als Rahmen: Baut eine einfache Abhaengigkeitskette zwischen Views, Tabellen und anderen Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
