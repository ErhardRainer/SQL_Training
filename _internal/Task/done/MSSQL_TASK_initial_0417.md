---
task_id: MSSQL_TASK_initial_0417
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureCatchBlockTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: done
priority: 584
priority_class: normal
created_at: "2026-04-18T22:47:53Z"
updated_at: "2026-04-17T08:32:08Z"
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0417"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ProcedureCatchBlockTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ProcedureCatchBlockTemplate.md"
...
# MSSQL_TASK_initial_0417 - Script ProcedureCatchBlockTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Vorlage fuer konsistente `TRY...CATCH`-Bloecke in Prozeduren.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ProcedureCatchBlockTemplate.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/ProcedureCatchBlockTemplate.md

## Umsetzungsauftrag

Erzeuge `ProcedureCatchBlockTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer konsistente `TRY...CATCH`-Bloecke in Prozeduren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
