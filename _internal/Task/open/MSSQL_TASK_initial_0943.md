---
task_id: MSSQL_TASK_initial_0943
repository: SQL_Training
domain: MSSQL
title: "Script tSQLtAssertionTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 58
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0943"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/tSQLtAssertionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/tSQLtAssertionTemplate.md"
...
# MSSQL_TASK_initial_0943 - Script tSQLtAssertionTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer wiederverwendbare tSQLt-Assertions.
...
- T-SQL/79_TSQL_Testing/SQLScripts/tSQLtAssertionTemplate.sql
- T-SQL/79_TSQL_Testing/SQLScripts/tSQLtAssertionTemplate.md

## Umsetzungsauftrag

Erzeuge `tSQLtAssertionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer wiederverwendbare tSQLt-Assertions. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
