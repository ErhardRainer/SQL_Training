---
task_id: MSSQL_TASK_initial_0869
repository: SQL_Training
domain: MSSQL
title: "Script GeographyDistanceRingDemo.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 132
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0869"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyDistanceRingDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyDistanceRingDemo.md"
...
# MSSQL_TASK_initial_0869 - Script GeographyDistanceRingDemo.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Zeigt Distanzringe und Pufferabfragen mit `geography`.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyDistanceRingDemo.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyDistanceRingDemo.md

## Umsetzungsauftrag

Erzeuge `GeographyDistanceRingDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Distanzringe und Pufferabfragen mit `geography`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
