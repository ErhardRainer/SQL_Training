---
task_id: MSSQL_TASK_initial_0988
repository: SQL_Training
domain: MSSQL
title: "Script LoginHostProgramMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 13
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0988"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/LoginHostProgramMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/LoginHostProgramMatrix.md"
...
# MSSQL_TASK_initial_0988 - Script LoginHostProgramMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Matrix ueber aktive Sessions nach Login, Host und Programm.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/LoginHostProgramMatrix.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/LoginHostProgramMatrix.md

## Umsetzungsauftrag

Erzeuge `LoginHostProgramMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber aktive Sessions nach Login, Host und Programm. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
