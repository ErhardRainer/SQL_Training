---
task_id: MSSQL_TASK_initial_0677
repository: SQL_Training
domain: MSSQL
title: "Script AvailabilityReplicaStateSnapshot.sql fuer 67_HA_DR erstellen"
status: open
priority: 324
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0677"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/AvailabilityReplicaStateSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/AvailabilityReplicaStateSnapshot.md"
...
# MSSQL_TASK_initial_0677 - Script AvailabilityReplicaStateSnapshot.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Zeigt Synchronisationsstatus, Latenzen und Rollen in Always-On-Umgebungen.
...
- T-SQL/67_HA_DR/SQLScripts/AvailabilityReplicaStateSnapshot.sql
- T-SQL/67_HA_DR/SQLScripts/AvailabilityReplicaStateSnapshot.md

## Umsetzungsauftrag

Erzeuge `AvailabilityReplicaStateSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Synchronisationsstatus, Latenzen und Rollen in Always-On-Umgebungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
