---
task_id: MSSQL_TASK_initial_0492
repository: SQL_Training
domain: MSSQL
title: "Script BusinessDayCalculator.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 509
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0492"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayCalculator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayCalculator.md"
...
# MSSQL_TASK_initial_0492 - Script BusinessDayCalculator.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Berechnet Arbeitstage zwischen zwei Daten mit optionalem Feiertagsabzug.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayCalculator.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayCalculator.md

## Umsetzungsauftrag

Erzeuge `BusinessDayCalculator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Berechnet Arbeitstage zwischen zwei Daten mit optionalem Feiertagsabzug. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
