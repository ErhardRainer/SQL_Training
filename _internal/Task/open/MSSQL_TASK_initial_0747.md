---
task_id: MSSQL_TASK_initial_0747
repository: SQL_Training
domain: MSSQL
title: "Script ExternalTableRefreshChecklist.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 254
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0747"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableRefreshChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableRefreshChecklist.md"
...
# MSSQL_TASK_initial_0747 - Script ExternalTableRefreshChecklist.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Checkliste fuer Refresh und Revalidation externer Tabellen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableRefreshChecklist.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableRefreshChecklist.md

## Umsetzungsauftrag

Erzeuge `ExternalTableRefreshChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Refresh und Revalidation externer Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
