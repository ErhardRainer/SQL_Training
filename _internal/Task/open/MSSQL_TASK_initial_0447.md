---
task_id: MSSQL_TASK_initial_0447
repository: SQL_Training
domain: MSSQL
title: "Script KeyColumnOrderAdvisor.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 554
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0447"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/KeyColumnOrderAdvisor.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/KeyColumnOrderAdvisor.md"
...
# MSSQL_TASK_initial_0447 - Script KeyColumnOrderAdvisor.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Hilft bei der fachlichen Beurteilung von Schluesselspalten-Reihenfolgen.
...
- T-SQL/26_Indexes_Basics/SQLScripts/KeyColumnOrderAdvisor.sql
- T-SQL/26_Indexes_Basics/SQLScripts/KeyColumnOrderAdvisor.md

## Umsetzungsauftrag

Erzeuge `KeyColumnOrderAdvisor.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Hilft bei der fachlichen Beurteilung von Schluesselspalten-Reihenfolgen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
