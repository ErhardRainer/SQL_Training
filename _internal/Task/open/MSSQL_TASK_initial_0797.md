---
task_id: MSSQL_TASK_initial_0797
repository: SQL_Training
domain: MSSQL
title: "Script ProxyCredentialUsageMap.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 204
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0797"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/ProxyCredentialUsageMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/ProxyCredentialUsageMap.md"
...
# MSSQL_TASK_initial_0797 - Script ProxyCredentialUsageMap.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Mappt Proxies auf verwendete Credentials und Jobs.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/ProxyCredentialUsageMap.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/ProxyCredentialUsageMap.md

## Umsetzungsauftrag

Erzeuge `ProxyCredentialUsageMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Mappt Proxies auf verwendete Credentials und Jobs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
