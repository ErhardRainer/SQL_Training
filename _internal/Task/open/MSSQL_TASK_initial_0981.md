---
task_id: MSSQL_TASK_initial_0981
repository: SQL_Training
domain: MSSQL
title: "Script ActiveRequestPlanHandles.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 20
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0981"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/ActiveRequestPlanHandles.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/ActiveRequestPlanHandles.md"
...
# MSSQL_TASK_initial_0981 - Script ActiveRequestPlanHandles.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Zeigt aktive Requests mit Plan-Handle, SQL-Handle und Query-Text.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/ActiveRequestPlanHandles.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/ActiveRequestPlanHandles.md

## Umsetzungsauftrag

Erzeuge `ActiveRequestPlanHandles.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt aktive Requests mit Plan-Handle, SQL-Handle und Query-Text. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
