---
task_id: MSSQL_TASK_initial_0523
repository: SQL_Training
domain: MSSQL
title: "Script CsvDelimiterDriftCheck.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 478
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0523"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/CsvDelimiterDriftCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/CsvDelimiterDriftCheck.md"
...
# MSSQL_TASK_initial_0523 - Script CsvDelimiterDriftCheck.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Check fuer unerwartete Delimiter-Drift in CSV-Dateien.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/CsvDelimiterDriftCheck.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/CsvDelimiterDriftCheck.md

## Umsetzungsauftrag

Erzeuge `CsvDelimiterDriftCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Check fuer unerwartete Delimiter-Drift in CSV-Dateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
