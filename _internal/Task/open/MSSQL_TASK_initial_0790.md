---
task_id: MSSQL_TASK_initial_0790
repository: SQL_Training
domain: MSSQL
title: "Script JobOwnerAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 211
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0790"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobOwnerAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobOwnerAudit.md"
...
# MSSQL_TASK_initial_0790 - Script JobOwnerAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Audit ueber Job-Owner und moegliche Risiken in der Zustandsverwaltung.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobOwnerAudit.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobOwnerAudit.md

## Umsetzungsauftrag

Erzeuge `JobOwnerAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Job-Owner und moegliche Risiken in der Zustandsverwaltung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
