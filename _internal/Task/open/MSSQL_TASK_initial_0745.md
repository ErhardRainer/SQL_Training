---
task_id: MSSQL_TASK_initial_0745
repository: SQL_Training
domain: MSSQL
title: "Script ExternalTableColumnMappingAudit.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 256
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0745"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableColumnMappingAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableColumnMappingAudit.md"
...
# MSSQL_TASK_initial_0745 - Script ExternalTableColumnMappingAudit.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Audit ueber Spaltenmappings externer Tabellen gegen ihre Quellen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableColumnMappingAudit.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableColumnMappingAudit.md

## Umsetzungsauftrag

Erzeuge `ExternalTableColumnMappingAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Spaltenmappings externer Tabellen gegen ihre Quellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
