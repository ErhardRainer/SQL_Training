---
task_id: MSSQL_TASK_initial_0507
repository: SQL_Training
domain: MSSQL
title: "Script Rolling13MonthWindow.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 494
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0507"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/Rolling13MonthWindow.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/Rolling13MonthWindow.md"
...
# MSSQL_TASK_initial_0507 - Script Rolling13MonthWindow.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Beispiel fuer ein rollierendes 13-Monats-Fenster.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/Rolling13MonthWindow.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/Rolling13MonthWindow.md

## Umsetzungsauftrag

Erzeuge `Rolling13MonthWindow.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Beispiel fuer ein rollierendes 13-Monats-Fenster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
