---
task_id: MSSQL_TASK_initial_0663
repository: SQL_Training
domain: MSSQL
title: "Script OrphanedUsersAndRoleMap.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 338
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0663"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/OrphanedUsersAndRoleMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/OrphanedUsersAndRoleMap.md"
...
# MSSQL_TASK_initial_0663 - Script OrphanedUsersAndRoleMap.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Findet verwaiste Benutzer und ordnet sie ihrer Rollenstruktur zu.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/OrphanedUsersAndRoleMap.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/OrphanedUsersAndRoleMap.md

## Umsetzungsauftrag

Erzeuge `OrphanedUsersAndRoleMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Findet verwaiste Benutzer und ordnet sie ihrer Rollenstruktur zu. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
