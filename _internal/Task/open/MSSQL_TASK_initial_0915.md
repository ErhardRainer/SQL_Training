---
task_id: MSSQL_TASK_initial_0915
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreRowgroupTrimCheck.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 86
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0915"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTrimCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTrimCheck.md"
...
# MSSQL_TASK_initial_0915 - Script ColumnstoreRowgroupTrimCheck.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Prueft zu kleine oder unguenstig gefuellte Rowgroups.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTrimCheck.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTrimCheck.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreRowgroupTrimCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Prueft zu kleine oder unguenstig gefuellte Rowgroups. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
