---
task_id: MSSQL_TASK_initial_0980
repository: SQL_Training
domain: MSSQL
title: "Script ActiveQueryTextSnapshot.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 21
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0980"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ActiveQueryTextSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ActiveQueryTextSnapshot.md"
...
# MSSQL_TASK_initial_0980 - Script ActiveQueryTextSnapshot.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Schnappschuss des aktuellen SQL-Texts aktiver Requests.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ActiveQueryTextSnapshot.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ActiveQueryTextSnapshot.md

## Umsetzungsauftrag

Erzeuge `ActiveQueryTextSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss des aktuellen SQL-Texts aktiver Requests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
