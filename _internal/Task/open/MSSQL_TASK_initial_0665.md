---
task_id: MSSQL_TASK_initial_0665
repository: SQL_Training
domain: MSSQL
title: "Script PermissionChangeSnapshot.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 336
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0665"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionChangeSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionChangeSnapshot.md"
...
# MSSQL_TASK_initial_0665 - Script PermissionChangeSnapshot.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Schnappschuss fuer spaetere Vergleiche von Rechteaenderungen.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionChangeSnapshot.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionChangeSnapshot.md

## Umsetzungsauftrag

Erzeuge `PermissionChangeSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss fuer spaetere Vergleiche von Rechteaenderungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
