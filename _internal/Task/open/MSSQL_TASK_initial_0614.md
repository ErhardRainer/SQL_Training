---
task_id: MSSQL_TASK_initial_0614
repository: SQL_Training
domain: MSSQL
title: "Script MemoryGrantOutlierQueries.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 387
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0614"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantOutlierQueries.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantOutlierQueries.md"
...
# MSSQL_TASK_initial_0614 - Script MemoryGrantOutlierQueries.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Findet Abfragen mit auffaellig hohen Memory Grants.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantOutlierQueries.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantOutlierQueries.md

## Umsetzungsauftrag

Erzeuge `MemoryGrantOutlierQueries.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Findet Abfragen mit auffaellig hohen Memory Grants. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
