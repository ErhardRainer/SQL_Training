---
task_id: MSSQL_TASK_initial_0896
repository: SQL_Training
domain: MSSQL
title: "Script JsonNestedArrayExploder.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 105
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0896"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonNestedArrayExploder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonNestedArrayExploder.md"
...
# MSSQL_TASK_initial_0896 - Script JsonNestedArrayExploder.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Vorlage fuer das Aufloesen tiefer verschachtelter JSON-Arrays.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonNestedArrayExploder.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonNestedArrayExploder.md

## Umsetzungsauftrag

Erzeuge `JsonNestedArrayExploder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer das Aufloesen tiefer verschachtelter JSON-Arrays. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
