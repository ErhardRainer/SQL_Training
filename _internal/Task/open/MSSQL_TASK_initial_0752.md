---
task_id: MSSQL_TASK_initial_0752
repository: SQL_Training
domain: MSSQL
title: "Script PolybaseObjectDependencyMap.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 249
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0752"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/PolybaseObjectDependencyMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/PolybaseObjectDependencyMap.md"
...
# MSSQL_TASK_initial_0752 - Script PolybaseObjectDependencyMap.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Map der Abhaengigkeiten zwischen PolyBase-Objekten.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/PolybaseObjectDependencyMap.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/PolybaseObjectDependencyMap.md

## Umsetzungsauftrag

Erzeuge `PolybaseObjectDependencyMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Map der Abhaengigkeiten zwischen PolyBase-Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
