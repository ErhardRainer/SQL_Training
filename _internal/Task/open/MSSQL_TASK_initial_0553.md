---
task_id: MSSQL_TASK_initial_0553
repository: SQL_Training
domain: MSSQL
title: "Script ApplyVsSubqueryComparison.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 448
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0553"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsSubqueryComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsSubqueryComparison.md"
...
# MSSQL_TASK_initial_0553 - Script ApplyVsSubqueryComparison.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Stellt `APPLY` gegen korrelierte Subqueries in typischen Mustern.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsSubqueryComparison.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsSubqueryComparison.md

## Umsetzungsauftrag

Erzeuge `ApplyVsSubqueryComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Stellt `APPLY` gegen korrelierte Subqueries in typischen Mustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
