---
task_id: MSSQL_TASK_initial_0718
repository: SQL_Training
domain: MSSQL
title: "Script BrokerRouteInventory.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 283
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0718"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerRouteInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerRouteInventory.md"
...
# MSSQL_TASK_initial_0718 - Script BrokerRouteInventory.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Inventarisiert vorhandene Broker-Routen.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerRouteInventory.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerRouteInventory.md

## Umsetzungsauftrag

Erzeuge `BrokerRouteInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert vorhandene Broker-Routen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
