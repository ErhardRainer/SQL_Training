---
task_id: MSSQL_TASK_initial_0674
repository: SQL_Training
domain: MSSQL
title: "Script AgListenerDnsReview.sql fuer 67_HA_DR erstellen"
status: open
priority: 327
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0674"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/AgListenerDnsReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/AgListenerDnsReview.md"
...
# MSSQL_TASK_initial_0674 - Script AgListenerDnsReview.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Review fuer Listener-Namen, DNS und Zugriffspfade.
...
- T-SQL/67_HA_DR/SQLScripts/AgListenerDnsReview.sql
- T-SQL/67_HA_DR/SQLScripts/AgListenerDnsReview.md

## Umsetzungsauftrag

Erzeuge `AgListenerDnsReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Review fuer Listener-Namen, DNS und Zugriffspfade. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
