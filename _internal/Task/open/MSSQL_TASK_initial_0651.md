---
task_id: MSSQL_TASK_initial_0651
repository: SQL_Training
domain: MSSQL
title: "Script SwitchCompatibilityMatrix.sql fuer 65_Partitioning erstellen"
status: open
priority: 350
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0651"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/SwitchCompatibilityMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/SwitchCompatibilityMatrix.md"
...
# MSSQL_TASK_initial_0651 - Script SwitchCompatibilityMatrix.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Matrix fuer SWITCH-Kompatibilitaet zwischen Stage und Ziel.
...
- T-SQL/65_Partitioning/SQLScripts/SwitchCompatibilityMatrix.sql
- T-SQL/65_Partitioning/SQLScripts/SwitchCompatibilityMatrix.md

## Umsetzungsauftrag

Erzeuge `SwitchCompatibilityMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Matrix fuer SWITCH-Kompatibilitaet zwischen Stage und Ziel. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
