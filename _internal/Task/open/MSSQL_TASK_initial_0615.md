---
task_id: MSSQL_TASK_initial_0615
repository: SQL_Training
domain: MSSQL
title: "Script MemoryGrantSpikeSample.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 386
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0615"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantSpikeSample.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantSpikeSample.md"
...
# MSSQL_TASK_initial_0615 - Script MemoryGrantSpikeSample.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Sample fuer ploetzliche Memory-Grant-Spitzen.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantSpikeSample.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/MemoryGrantSpikeSample.md

## Umsetzungsauftrag

Erzeuge `MemoryGrantSpikeSample.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Sample fuer ploetzliche Memory-Grant-Spitzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
