---
task_id: MSSQL_TASK_initial_0534
repository: SQL_Training
domain: MSSQL
title: "Script IsolationLevelSessionInventory.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 467
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0534"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelSessionInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelSessionInventory.md"
...
# MSSQL_TASK_initial_0534 - Script IsolationLevelSessionInventory.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Listet aktive Sessions samt Isolationsstufe und offenen Requests auf.
...
- T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelSessionInventory.sql
- T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelSessionInventory.md

## Umsetzungsauftrag

Erzeuge `IsolationLevelSessionInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Listet aktive Sessions samt Isolationsstufe und offenen Requests auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
