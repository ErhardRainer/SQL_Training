---
task_id: MSSQL_TASK_initial_0739
repository: SQL_Training
domain: MSSQL
title: "Script ExternalLocationAccessibilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 262
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0739"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalLocationAccessibilityCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalLocationAccessibilityCheck.md"
...
# MSSQL_TASK_initial_0739 - Script ExternalLocationAccessibilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Checkt die Erreichbarkeit externer Speicherorte.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalLocationAccessibilityCheck.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalLocationAccessibilityCheck.md

## Umsetzungsauftrag

Erzeuge `ExternalLocationAccessibilityCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Checkt die Erreichbarkeit externer Speicherorte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
