---
task_id: MSSQL_TASK_initial_0952
repository: SQL_Training
domain: MSSQL
title: "Script AzureSqlDbSizingSnapshot.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 49
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0952"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlDbSizingSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlDbSizingSnapshot.md"
...
# MSSQL_TASK_initial_0952 - Script AzureSqlDbSizingSnapshot.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Liefert eine kompakte Groessen- und Objektbasis fuer Migrationen nach Azure SQL.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlDbSizingSnapshot.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlDbSizingSnapshot.md

## Umsetzungsauftrag

Erzeuge `AzureSqlDbSizingSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Liefert eine kompakte Groessen- und Objektbasis fuer Migrationen nach Azure SQL. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
