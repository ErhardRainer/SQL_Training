---
task_id: MSSQL_TASK_initial_0944
repository: SQL_Training
domain: MSSQL
title: "Script tSQLtClassBootstrap.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 57
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0944"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/tSQLtClassBootstrap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/tSQLtClassBootstrap.md"
...
# MSSQL_TASK_initial_0944 - Script tSQLtClassBootstrap.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Legt eine tSQLt-Testklasse mit Basisstruktur fuer neue Tests an.
...
- T-SQL/79_TSQL_Testing/SQLScripts/tSQLtClassBootstrap.sql
- T-SQL/79_TSQL_Testing/SQLScripts/tSQLtClassBootstrap.md

## Umsetzungsauftrag

Erzeuge `tSQLtClassBootstrap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Legt eine tSQLt-Testklasse mit Basisstruktur fuer neue Tests an. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
