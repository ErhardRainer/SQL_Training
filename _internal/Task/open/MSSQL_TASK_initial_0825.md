---
task_id: MSSQL_TASK_initial_0825
repository: SQL_Training
domain: MSSQL
title: "Script RowVersionCleanupWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 176
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0825"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/RowVersionCleanupWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/RowVersionCleanupWatch.md"
...
# MSSQL_TASK_initial_0825 - Script RowVersionCleanupWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Beobachtet den Abbau alter Row Versions.
