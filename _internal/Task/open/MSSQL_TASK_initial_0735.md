---
task_id: MSSQL_TASK_initial_0735
repository: SQL_Training
domain: MSSQL
title: "Script CredentialReuseInventory.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 266
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0735"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/CredentialReuseInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/CredentialReuseInventory.md"
...
# MSSQL_TASK_initial_0735 - Script CredentialReuseInventory.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Inventarisiert wiederverwendete Credentials in externen Objekten.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/CredentialReuseInventory.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/CredentialReuseInventory.md

## Umsetzungsauftrag

Erzeuge `CredentialReuseInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert wiederverwendete Credentials in externen Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
