---
task_id: MSSQL_TASK_initial_0582
repository: SQL_Training
domain: MSSQL
title: "Script RlsRegressionTestTemplate.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 419
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0582"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsRegressionTestTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsRegressionTestTemplate.md"
...
# MSSQL_TASK_initial_0582 - Script RlsRegressionTestTemplate.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Vorlage fuer Regressionstests rund um RLS-Verhalten.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsRegressionTestTemplate.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsRegressionTestTemplate.md

## Umsetzungsauftrag

Erzeuge `RlsRegressionTestTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Regressionstests rund um RLS-Verhalten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
