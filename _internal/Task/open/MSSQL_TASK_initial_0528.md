---
task_id: MSSQL_TASK_initial_0528
repository: SQL_Training
domain: MSSQL
title: "Script OpenrowsetCsvTemplate.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 473
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0528"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetCsvTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetCsvTemplate.md"
...
# MSSQL_TASK_initial_0528 - Script OpenrowsetCsvTemplate.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Vorlage fuer CSV-Importe ueber `OPENROWSET`.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetCsvTemplate.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetCsvTemplate.md

## Umsetzungsauftrag

Erzeuge `OpenrowsetCsvTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer CSV-Importe ueber `OPENROWSET`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
