---
task_id: MSSQL_TASK_initial_0482
repository: SQL_Training
domain: MSSQL
title: "Script JsonToRelationalTemplate.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 519
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0482"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonToRelationalTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonToRelationalTemplate.md"
...
# MSSQL_TASK_initial_0482 - Script JsonToRelationalTemplate.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Vorlage fuer die Umwandlung typischer JSON-Payloads in relationale Tabellen.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonToRelationalTemplate.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonToRelationalTemplate.md

## Umsetzungsauftrag

Erzeuge `JsonToRelationalTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer die Umwandlung typischer JSON-Payloads in relationale Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
