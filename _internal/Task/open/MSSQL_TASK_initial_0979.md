---
task_id: MSSQL_TASK_initial_0979
repository: SQL_Training
domain: MSSQL
title: "Script XtpMemoryConsumptionSnapshot.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 22
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0979"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/XtpMemoryConsumptionSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/XtpMemoryConsumptionSnapshot.md"
...
# MSSQL_TASK_initial_0979 - Script XtpMemoryConsumptionSnapshot.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Snapshot des Speicherverbrauchs speicheroptimierter Objekte.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/XtpMemoryConsumptionSnapshot.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/XtpMemoryConsumptionSnapshot.md

## Umsetzungsauftrag

Erzeuge `XtpMemoryConsumptionSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Snapshot des Speicherverbrauchs speicheroptimierter Objekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
