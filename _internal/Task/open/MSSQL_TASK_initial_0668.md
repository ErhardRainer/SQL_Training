---
task_id: MSSQL_TASK_initial_0668
repository: SQL_Training
domain: MSSQL
title: "Script RoleMembershipMatrix.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 333
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0668"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleMembershipMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleMembershipMatrix.md"
...
# MSSQL_TASK_initial_0668 - Script RoleMembershipMatrix.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Erstellt eine Matrix aller Rollenmitgliedschaften pro Datenbank oder Server.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleMembershipMatrix.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleMembershipMatrix.md

## Umsetzungsauftrag

Erzeuge `RoleMembershipMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine Matrix aller Rollenmitgliedschaften pro Datenbank oder Server. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
