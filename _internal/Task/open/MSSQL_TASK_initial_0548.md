---
task_id: MSSQL_TASK_initial_0548
repository: SQL_Training
domain: MSSQL
title: "Script UpdateLockScopeReview.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 453
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0548"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/UpdateLockScopeReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/UpdateLockScopeReview.md"
...
# MSSQL_TASK_initial_0548 - Script UpdateLockScopeReview.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Review ueber die Reichweite von Update Locks.
...
- T-SQL/60_IsolationLevels/SQLScripts/UpdateLockScopeReview.sql
- T-SQL/60_IsolationLevels/SQLScripts/UpdateLockScopeReview.md

## Umsetzungsauftrag

Erzeuge `UpdateLockScopeReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber die Reichweite von Update Locks. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
