---
task_id: MSSQL_TASK_initial_0846
repository: SQL_Training
domain: MSSQL
title: "Script ChecksumDeltaComparison.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 155
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0846"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ChecksumDeltaComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ChecksumDeltaComparison.md"
...
# MSSQL_TASK_initial_0846 - Script ChecksumDeltaComparison.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Vergleicht Quell- und Zielmengen ueber Checksummen fuer schnelle Delta-Pruefungen.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ChecksumDeltaComparison.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ChecksumDeltaComparison.md

## Umsetzungsauftrag

Erzeuge `ChecksumDeltaComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Quell- und Zielmengen ueber Checksummen fuer schnelle Delta-Pruefungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
