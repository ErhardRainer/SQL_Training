---
task_id: MSSQL_TASK_initial_0775
repository: SQL_Training
domain: MSSQL
title: "Script RestoreVerifyonlyRunner.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 226
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0775"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/RestoreVerifyonlyRunner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/RestoreVerifyonlyRunner.md"
...
# MSSQL_TASK_initial_0775 - Script RestoreVerifyonlyRunner.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Vorlage fuer systematische `RESTORE VERIFYONLY`-Laeufe.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/RestoreVerifyonlyRunner.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/RestoreVerifyonlyRunner.md

## Umsetzungsauftrag

Erzeuge `RestoreVerifyonlyRunner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer systematische `RESTORE VERIFYONLY`-Laeufe. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
