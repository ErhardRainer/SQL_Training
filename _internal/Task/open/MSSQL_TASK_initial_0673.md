---
task_id: MSSQL_TASK_initial_0673
repository: SQL_Training
domain: MSSQL
title: "Script AgDatabaseLagByReplica.sql fuer 67_HA_DR erstellen"
status: open
priority: 328
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0673"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/AgDatabaseLagByReplica.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/AgDatabaseLagByReplica.md"
...
# MSSQL_TASK_initial_0673 - Script AgDatabaseLagByReplica.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Zeigt AG-Lags je Datenbank und Replik.
...
- T-SQL/67_HA_DR/SQLScripts/AgDatabaseLagByReplica.sql
- T-SQL/67_HA_DR/SQLScripts/AgDatabaseLagByReplica.md

## Umsetzungsauftrag

Erzeuge `AgDatabaseLagByReplica.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt AG-Lags je Datenbank und Replik. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
