---
task_id: MSSQL_TASK_initial_0852
repository: SQL_Training
domain: MSSQL
title: "Script IdempotentLoadGuard.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 149
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0852"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentLoadGuard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentLoadGuard.md"
...
# MSSQL_TASK_initial_0852 - Script IdempotentLoadGuard.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Guard-Skript gegen Doppelverarbeitung in idempotenten ETL-Laeufen.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentLoadGuard.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentLoadGuard.md

## Umsetzungsauftrag

Erzeuge `IdempotentLoadGuard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Guard-Skript gegen Doppelverarbeitung in idempotenten ETL-Laeufen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
