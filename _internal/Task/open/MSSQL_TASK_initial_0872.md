---
task_id: MSSQL_TASK_initial_0872
repository: SQL_Training
domain: MSSQL
title: "Script GeometrySelfIntersectionCheck.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 129
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0872"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeometrySelfIntersectionCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeometrySelfIntersectionCheck.md"
...
# MSSQL_TASK_initial_0872 - Script GeometrySelfIntersectionCheck.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Prueft Geometrien auf Selbstueberschneidungen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeometrySelfIntersectionCheck.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeometrySelfIntersectionCheck.md

## Umsetzungsauftrag

Erzeuge `GeometrySelfIntersectionCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Geometrien auf Selbstueberschneidungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
