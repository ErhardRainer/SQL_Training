---
task_id: MSSQL_TASK_initial_0640
repository: SQL_Training
domain: MSSQL
title: "Script PartitionCompressionReview.sql fuer 65_Partitioning erstellen"
status: open
priority: 361
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0640"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionCompressionReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionCompressionReview.md"
...
# MSSQL_TASK_initial_0640 - Script PartitionCompressionReview.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Review der Kompression je Partition und moeglicher Ausreisser.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionCompressionReview.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionCompressionReview.md

## Umsetzungsauftrag

Erzeuge `PartitionCompressionReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Review der Kompression je Partition und moeglicher Ausreisser. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
