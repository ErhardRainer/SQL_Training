---
task_id: MSSQL_TASK_initial_0863
repository: SQL_Training
domain: MSSQL
title: "Script StageToCoreDriftAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 138
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0863"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageToCoreDriftAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageToCoreDriftAudit.md"
...
# MSSQL_TASK_initial_0863 - Script StageToCoreDriftAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Audit ueber Drift zwischen Stage und Core.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageToCoreDriftAudit.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageToCoreDriftAudit.md

## Umsetzungsauftrag

Erzeuge `StageToCoreDriftAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Drift zwischen Stage und Core. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
