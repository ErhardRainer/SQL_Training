---
task_id: MSSQL_TASK_initial_0974
repository: SQL_Training
domain: MSSQL
title: "Script NativeProcParameterReview.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 27
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0974"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/NativeProcParameterReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/NativeProcParameterReview.md"
...
# MSSQL_TASK_initial_0974 - Script NativeProcParameterReview.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Review ueber Parameter nativer Prozeduren.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/NativeProcParameterReview.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/NativeProcParameterReview.md

## Umsetzungsauftrag

Erzeuge `NativeProcParameterReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Parameter nativer Prozeduren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
