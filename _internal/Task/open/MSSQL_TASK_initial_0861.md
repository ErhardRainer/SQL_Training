---
task_id: MSSQL_TASK_initial_0861
repository: SQL_Training
domain: MSSQL
title: "Script StageRecycleBinTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 140
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0861"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageRecycleBinTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageRecycleBinTemplate.md"
...
# MSSQL_TASK_initial_0861 - Script StageRecycleBinTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Vorlage fuer einen Stage-Recycle-Bin-Ansatz.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageRecycleBinTemplate.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StageRecycleBinTemplate.md

## Umsetzungsauftrag

Erzeuge `StageRecycleBinTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer einen Stage-Recycle-Bin-Ansatz. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
