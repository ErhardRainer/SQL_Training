---
task_id: MSSQL_TASK_initial_0948
repository: SQL_Training
domain: MSSQL
title: "Script AzureFeatureParityChecklist.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 53
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0948"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureParityChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureParityChecklist.md"
...
# MSSQL_TASK_initial_0948 - Script AzureFeatureParityChecklist.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Checkliste fuer Feature-Paritaet zwischen On-Prem und Azure.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureParityChecklist.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureParityChecklist.md

## Umsetzungsauftrag

Erzeuge `AzureFeatureParityChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Feature-Paritaet zwischen On-Prem und Azure. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
