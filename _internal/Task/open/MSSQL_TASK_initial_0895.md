---
task_id: MSSQL_TASK_initial_0895
repository: SQL_Training
domain: MSSQL
title: "Script JsonMalformedTokenBucket.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 106
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0895"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonMalformedTokenBucket.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonMalformedTokenBucket.md"
...
# MSSQL_TASK_initial_0895 - Script JsonMalformedTokenBucket.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Gruppiert Fehler nach fehlerhaften Tokenmustern.
