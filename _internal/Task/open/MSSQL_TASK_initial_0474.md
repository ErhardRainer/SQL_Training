---
task_id: MSSQL_TASK_initial_0474
repository: SQL_Training
domain: MSSQL
title: "Script JsonInvalidDocumentBucket.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 527
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0474"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonInvalidDocumentBucket.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonInvalidDocumentBucket.md"
...
# MSSQL_TASK_initial_0474 - Script JsonInvalidDocumentBucket.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Gruppiert ungueltige JSON-Dokumente nach Fehlermustern.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonInvalidDocumentBucket.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonInvalidDocumentBucket.md

## Umsetzungsauftrag

Erzeuge `JsonInvalidDocumentBucket.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Gruppiert ungueltige JSON-Dokumente nach Fehlermustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
