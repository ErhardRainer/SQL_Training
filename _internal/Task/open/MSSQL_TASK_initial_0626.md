---
task_id: MSSQL_TASK_initial_0626
repository: SQL_Training
domain: MSSQL
title: "Script QueryStoreForcedPlanReview.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 375
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0626"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreForcedPlanReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreForcedPlanReview.md"
...
# MSSQL_TASK_initial_0626 - Script QueryStoreForcedPlanReview.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Review von forcierten Plaenen aus dem Query Store.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreForcedPlanReview.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreForcedPlanReview.md

## Umsetzungsauftrag

Erzeuge `QueryStoreForcedPlanReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Review von forcierten Plaenen aus dem Query Store. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
