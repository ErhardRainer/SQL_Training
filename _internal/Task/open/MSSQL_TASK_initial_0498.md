---
task_id: MSSQL_TASK_initial_0498
repository: SQL_Training
domain: MSSQL
title: "Script DateBoundaryTestHarness.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 503
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0498"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateBoundaryTestHarness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateBoundaryTestHarness.md"
...
# MSSQL_TASK_initial_0498 - Script DateBoundaryTestHarness.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Testharness fuer Randfaelle an Monats-, Quartals- und Jahresgrenzen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/DateBoundaryTestHarness.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/DateBoundaryTestHarness.md

## Umsetzungsauftrag

Erzeuge `DateBoundaryTestHarness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Testharness fuer Randfaelle an Monats-, Quartals- und Jahresgrenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
