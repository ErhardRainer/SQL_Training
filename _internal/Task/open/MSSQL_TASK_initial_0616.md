---
task_id: MSSQL_TASK_initial_0616
repository: SQL_Training
domain: MSSQL
title: "Script ParallelismSkewSnapshot.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 385
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0616"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelismSkewSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelismSkewSnapshot.md"
...
# MSSQL_TASK_initial_0616 - Script ParallelismSkewSnapshot.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Liefert Hinweise auf ungleich verteilte Arbeit in parallelen Ausfuehrungen.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelismSkewSnapshot.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelismSkewSnapshot.md

## Umsetzungsauftrag

Erzeuge `ParallelismSkewSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Liefert Hinweise auf ungleich verteilte Arbeit in parallelen Ausfuehrungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
