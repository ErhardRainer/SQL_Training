---
task_id: MSSQL_TASK_initial_0731
repository: SQL_Training
domain: MSSQL
title: "Script ServiceActivationProcMap.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 270
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0731"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceActivationProcMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceActivationProcMap.md"
...
# MSSQL_TASK_initial_0731 - Script ServiceActivationProcMap.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Mappt Services auf Aktivierungsprozeduren.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceActivationProcMap.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceActivationProcMap.md

## Umsetzungsauftrag

Erzeuge `ServiceActivationProcMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Mappt Services auf Aktivierungsprozeduren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
