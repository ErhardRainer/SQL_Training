---
task_id: MSSQL_TASK_initial_0470
repository: SQL_Training
domain: MSSQL
title: "Script SortCostOutlierPlans.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 531
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0470"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/SortCostOutlierPlans.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/SortCostOutlierPlans.md"
...
# MSSQL_TASK_initial_0470 - Script SortCostOutlierPlans.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Zeigt Plaene mit besonders teuren Sort-Operatoren.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/SortCostOutlierPlans.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/SortCostOutlierPlans.md

## Umsetzungsauftrag

Erzeuge `SortCostOutlierPlans.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Plaene mit besonders teuren Sort-Operatoren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
