---
task_id: MSSQL_TASK_initial_0408
repository: SQL_Training
domain: MSSQL
title: "Script TableValuedFunctionUsageReport.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 593
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0408"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionUsageReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionUsageReport.md"
...
# MSSQL_TASK_initial_0408 - Script TableValuedFunctionUsageReport.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Uebersicht ueber table-valued Functions und ihre Aufrufmuster.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionUsageReport.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionUsageReport.md

## Umsetzungsauftrag

Erzeuge `TableValuedFunctionUsageReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber table-valued Functions und ihre Aufrufmuster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
