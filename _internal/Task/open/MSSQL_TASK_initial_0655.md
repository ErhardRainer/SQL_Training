---
task_id: MSSQL_TASK_initial_0655
repository: SQL_Training
domain: MSSQL
title: "Script EffectivePermissionsByPrincipal.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 346
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0655"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionsByPrincipal.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionsByPrincipal.md"
...
# MSSQL_TASK_initial_0655 - Script EffectivePermissionsByPrincipal.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Berechnet effektive Rechte je Login, User oder Rolle ueber mehrere Ebenen.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionsByPrincipal.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionsByPrincipal.md

## Umsetzungsauftrag

Erzeuge `EffectivePermissionsByPrincipal.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Berechnet effektive Rechte je Login, User oder Rolle ueber mehrere Ebenen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
