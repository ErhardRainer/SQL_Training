---
task_id: MSSQL_TASK_initial_0480
repository: SQL_Training
domain: MSSQL
title: "Script JsonSchemaKeyCoverage.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 521
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0480"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaKeyCoverage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaKeyCoverage.md"
...
# MSSQL_TASK_initial_0480 - Script JsonSchemaKeyCoverage.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Prueft, welche erwarteten Schluessel in JSON-Dokumenten abgedeckt sind.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaKeyCoverage.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaKeyCoverage.md

## Umsetzungsauftrag

Erzeuge `JsonSchemaKeyCoverage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, welche erwarteten Schluessel in JSON-Dokumenten abgedeckt sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
