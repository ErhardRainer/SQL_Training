---
task_id: MSSQL_TASK_initial_0998
repository: SQL_Training
domain: MSSQL
title: "Script SleepingSessionsOpenTranCheck.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 3
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0998"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SleepingSessionsOpenTranCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SleepingSessionsOpenTranCheck.md"
...
# MSSQL_TASK_initial_0998 - Script SleepingSessionsOpenTranCheck.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Findet schlafende Sessions mit noch offener Transaktion.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SleepingSessionsOpenTranCheck.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SleepingSessionsOpenTranCheck.md

## Umsetzungsauftrag

Erzeuge `SleepingSessionsOpenTranCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Findet schlafende Sessions mit noch offener Transaktion. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
