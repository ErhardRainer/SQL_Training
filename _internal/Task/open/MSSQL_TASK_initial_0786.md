---
task_id: MSSQL_TASK_initial_0786
repository: SQL_Training
domain: MSSQL
title: "Script FailedJobRunsLast7Days.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 215
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0786"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/FailedJobRunsLast7Days.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/FailedJobRunsLast7Days.md"
...
# MSSQL_TASK_initial_0786 - Script FailedJobRunsLast7Days.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Listet fehlgeschlagene Job-Runs der letzten Tage inklusive Fehlermeldung und Schritt.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/FailedJobRunsLast7Days.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/FailedJobRunsLast7Days.md

## Umsetzungsauftrag

Erzeuge `FailedJobRunsLast7Days.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Listet fehlgeschlagene Job-Runs der letzten Tage inklusive Fehlermeldung und Schritt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
