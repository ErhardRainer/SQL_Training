---
task_id: MSSQL_TASK_initial_0953
repository: SQL_Training
domain: MSSQL
title: "Script AzureSqlNetworkBoundaryAudit.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 48
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0953"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlNetworkBoundaryAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlNetworkBoundaryAudit.md"
...
# MSSQL_TASK_initial_0953 - Script AzureSqlNetworkBoundaryAudit.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Audit ueber Netzwerkgrenzen und Zugriffsmodelle.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlNetworkBoundaryAudit.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlNetworkBoundaryAudit.md

## Umsetzungsauftrag

Erzeuge `AzureSqlNetworkBoundaryAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Netzwerkgrenzen und Zugriffsmodelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
