---
task_id: MSSQL_TASK_initial_0632
repository: SQL_Training
domain: MSSQL
title: "Script WaitCategoryBreakdown.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 369
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0632"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitCategoryBreakdown.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitCategoryBreakdown.md"
...
# MSSQL_TASK_initial_0632 - Script WaitCategoryBreakdown.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Schluesselt Waits nach Kategorien und Anteilen auf.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitCategoryBreakdown.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitCategoryBreakdown.md

## Umsetzungsauftrag

Erzeuge `WaitCategoryBreakdown.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Schluesselt Waits nach Kategorien und Anteilen auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
