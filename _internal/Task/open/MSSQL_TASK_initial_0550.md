---
task_id: MSSQL_TASK_initial_0550
repository: SQL_Training
domain: MSSQL
title: "Script ApplyAsJoinAlternative.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 451
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0550"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyAsJoinAlternative.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyAsJoinAlternative.md"
...
# MSSQL_TASK_initial_0550 - Script ApplyAsJoinAlternative.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Zeigt APPLY als Alternative zu bestimmten Join- oder Subquery-Mustern.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyAsJoinAlternative.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyAsJoinAlternative.md

## Umsetzungsauftrag

Erzeuge `ApplyAsJoinAlternative.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt APPLY als Alternative zu bestimmten Join- oder Subquery-Mustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
