---
task_id: MSSQL_TASK_initial_0934
repository: SQL_Training
domain: MSSQL
title: "Script SeededFixtureLoader.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 67
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0934"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/SeededFixtureLoader.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/SeededFixtureLoader.md"
...
# MSSQL_TASK_initial_0934 - Script SeededFixtureLoader.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Laedt deterministische Testfixtures fuer reproduzierbare Tests.
...
- T-SQL/79_TSQL_Testing/SQLScripts/SeededFixtureLoader.sql
- T-SQL/79_TSQL_Testing/SQLScripts/SeededFixtureLoader.md

## Umsetzungsauftrag

Erzeuge `SeededFixtureLoader.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Laedt deterministische Testfixtures fuer reproduzierbare Tests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
