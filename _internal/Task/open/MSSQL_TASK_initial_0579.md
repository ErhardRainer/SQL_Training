---
task_id: MSSQL_TASK_initial_0579
repository: SQL_Training
domain: MSSQL
title: "Script RlsPolicySelectivityDemo.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 422
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0579"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPolicySelectivityDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPolicySelectivityDemo.md"
...
# MSSQL_TASK_initial_0579 - Script RlsPolicySelectivityDemo.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Zeigt, wie selektive und unselektive RLS-Predicates die Laufzeit beeinflussen.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPolicySelectivityDemo.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPolicySelectivityDemo.md

## Umsetzungsauftrag

Erzeuge `RlsPolicySelectivityDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie selektive und unselektive RLS-Predicates die Laufzeit beeinflussen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
