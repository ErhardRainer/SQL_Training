---
task_id: MSSQL_TASK_initial_0609
repository: SQL_Training
domain: MSSQL
title: "Script UnicodeComparisonMatrix.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 392
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0609"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/UnicodeComparisonMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/UnicodeComparisonMatrix.md"
...
# MSSQL_TASK_initial_0609 - Script UnicodeComparisonMatrix.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Vergleichsmatrix fuer Unicode- und Nicht-Unicode-Zeichenketten.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/UnicodeComparisonMatrix.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/UnicodeComparisonMatrix.md

## Umsetzungsauftrag

Erzeuge `UnicodeComparisonMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Vergleichsmatrix fuer Unicode- und Nicht-Unicode-Zeichenketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
