---
task_id: MSSQL_TASK_initial_0639
repository: SQL_Training
domain: MSSQL
title: "Script PartitionBoundaryHealthCheck.sql fuer 65_Partitioning erstellen"
status: open
priority: 362
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0639"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryHealthCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryHealthCheck.md"
...
# MSSQL_TASK_initial_0639 - Script PartitionBoundaryHealthCheck.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Prueft Grenzen, leere Fangpartitionen und ungleiche Verteilung in Partitionen.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryHealthCheck.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryHealthCheck.md

## Umsetzungsauftrag

Erzeuge `PartitionBoundaryHealthCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Grenzen, leere Fangpartitionen und ungleiche Verteilung in Partitionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
