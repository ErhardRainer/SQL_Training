---
task_id: MSSQL_TASK_initial_0625
repository: SQL_Training
domain: MSSQL
title: "Script PlanFeedbackOpportunityList.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 376
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0625"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanFeedbackOpportunityList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanFeedbackOpportunityList.md"
...
# MSSQL_TASK_initial_0625 - Script PlanFeedbackOpportunityList.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Liste fuer moegliche Optimierungs- oder Feedback-Kandidaten.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanFeedbackOpportunityList.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanFeedbackOpportunityList.md

## Umsetzungsauftrag

Erzeuge `PlanFeedbackOpportunityList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Liste fuer moegliche Optimierungs- oder Feedback-Kandidaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
