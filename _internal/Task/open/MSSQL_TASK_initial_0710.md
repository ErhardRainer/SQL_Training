---
task_id: MSSQL_TASK_initial_0710
repository: SQL_Training
domain: MSSQL
title: "Script TemporalRetentionAudit.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 291
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0710"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionAudit.md"
...
# MSSQL_TASK_initial_0710 - Script TemporalRetentionAudit.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Audit fuer Historientabellen, Retentionslogik und Wachstumsentwicklung bei Temporal Tables.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionAudit.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionAudit.md

## Umsetzungsauftrag

Erzeuge `TemporalRetentionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Historientabellen, Retentionslogik und Wachstumsentwicklung bei Temporal Tables. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
