---
task_id: MSSQL_TASK_initial_0945
repository: SQL_Training
domain: MSSQL
title: "Script AzureCompatibilityBaseline.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 56
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0945"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityBaseline.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityBaseline.md"
...
# MSSQL_TASK_initial_0945 - Script AzureCompatibilityBaseline.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Baseline fuer Azure-Kompatibilitaet einer Datenbank.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityBaseline.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityBaseline.md

## Umsetzungsauftrag

Erzeuge `AzureCompatibilityBaseline.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Baseline fuer Azure-Kompatibilitaet einer Datenbank. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
