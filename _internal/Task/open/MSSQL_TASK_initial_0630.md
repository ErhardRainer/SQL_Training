---
task_id: MSSQL_TASK_initial_0630
repository: SQL_Training
domain: MSSQL
title: "Script TempdbSpillGrantCorrelation.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 371
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0630"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TempdbSpillGrantCorrelation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TempdbSpillGrantCorrelation.md"
...
# MSSQL_TASK_initial_0630 - Script TempdbSpillGrantCorrelation.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Verknuepft Memory Grants mit Spills und ausufernden Sort- oder Hash-Operatoren.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TempdbSpillGrantCorrelation.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TempdbSpillGrantCorrelation.md

## Umsetzungsauftrag

Erzeuge `TempdbSpillGrantCorrelation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Verknuepft Memory Grants mit Spills und ausufernden Sort- oder Hash-Operatoren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
