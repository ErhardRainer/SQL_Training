---
task_id: MSSQL_TASK_initial_0871
repository: SQL_Training
domain: MSSQL
title: "Script GeographyRingValidation.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 130
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0871"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyRingValidation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyRingValidation.md"
...
# MSSQL_TASK_initial_0871 - Script GeographyRingValidation.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Validiert Ringrichtungen und geschlossene Formen in Geography-Daten.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyRingValidation.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyRingValidation.md

## Umsetzungsauftrag

Erzeuge `GeographyRingValidation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Validiert Ringrichtungen und geschlossene Formen in Geography-Daten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
