---
task_id: MSSQL_TASK_initial_0926
repository: SQL_Training
domain: MSSQL
title: "Script TupleMoverActivitySnapshot.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 75
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0926"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/TupleMoverActivitySnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/TupleMoverActivitySnapshot.md"
...
# MSSQL_TASK_initial_0926 - Script TupleMoverActivitySnapshot.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Snapshot zur Aktivitaet des Tuple Movers und offener Delta Stores.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/TupleMoverActivitySnapshot.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/TupleMoverActivitySnapshot.md

## Umsetzungsauftrag

Erzeuge `TupleMoverActivitySnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Snapshot zur Aktivitaet des Tuple Movers und offener Delta Stores. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
