---
task_id: MSSQL_TASK_initial_0692
repository: SQL_Training
domain: MSSQL
title: "Script ReplicaSyncModeReview.sql fuer 67_HA_DR erstellen"
status: open
priority: 309
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0692"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaSyncModeReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaSyncModeReview.md"
...
# MSSQL_TASK_initial_0692 - Script ReplicaSyncModeReview.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Vergleicht Synchronisations- und Seeding-Konfigurationen in AG-Umgebungen.
...
- T-SQL/67_HA_DR/SQLScripts/ReplicaSyncModeReview.sql
- T-SQL/67_HA_DR/SQLScripts/ReplicaSyncModeReview.md

## Umsetzungsauftrag

Erzeuge `ReplicaSyncModeReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Synchronisations- und Seeding-Konfigurationen in AG-Umgebungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
