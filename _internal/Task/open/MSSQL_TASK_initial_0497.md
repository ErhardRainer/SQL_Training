---
task_id: MSSQL_TASK_initial_0497
repository: SQL_Training
domain: MSSQL
title: "Script DateAddMonthEdgeCases.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 504
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0497"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateAddMonthEdgeCases.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateAddMonthEdgeCases.md"
...
# MSSQL_TASK_initial_0497 - Script DateAddMonthEdgeCases.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Zeigt Monatswechsel, `EOMONTH` und problematische Tagesuebertraege.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/DateAddMonthEdgeCases.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/DateAddMonthEdgeCases.md

## Umsetzungsauftrag

Erzeuge `DateAddMonthEdgeCases.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Monatswechsel, `EOMONTH` und problematische Tagesuebertraege. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
