---
task_id: MSSQL_TASK_initial_0577
repository: SQL_Training
domain: MSSQL
title: "Script RlsPredicateJoinCostReview.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 424
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0577"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateJoinCostReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateJoinCostReview.md"
...
# MSSQL_TASK_initial_0577 - Script RlsPredicateJoinCostReview.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Review der Join-Kosten in Security-Predicate-Funktionen.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateJoinCostReview.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateJoinCostReview.md

## Umsetzungsauftrag

Erzeuge `RlsPredicateJoinCostReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Review der Join-Kosten in Security-Predicate-Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
