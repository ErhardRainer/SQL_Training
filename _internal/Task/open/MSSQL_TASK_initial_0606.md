---
task_id: MSSQL_TASK_initial_0606
repository: SQL_Training
domain: MSSQL
title: "Script TempdbCollationMismatchDemo.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 395
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0606"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbCollationMismatchDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbCollationMismatchDemo.md"
...
# MSSQL_TASK_initial_0606 - Script TempdbCollationMismatchDemo.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Demonstriert Kollationskonflikte zwischen User-DB und TempDB.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbCollationMismatchDemo.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbCollationMismatchDemo.md

## Umsetzungsauftrag

Erzeuge `TempdbCollationMismatchDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Kollationskonflikte zwischen User-DB und TempDB. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
