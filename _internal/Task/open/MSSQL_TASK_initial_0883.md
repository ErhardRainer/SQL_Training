---
task_id: MSSQL_TASK_initial_0883
repository: SQL_Training
domain: MSSQL
title: "Script SpatialCoordinateRangeCheck.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 118
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0883"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateRangeCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateRangeCheck.md"
...
# MSSQL_TASK_initial_0883 - Script SpatialCoordinateRangeCheck.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Prueft Koordinaten auf ungueltige Wertebereiche und Achsvertauschungen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateRangeCheck.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateRangeCheck.md

## Umsetzungsauftrag

Erzeuge `SpatialCoordinateRangeCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Koordinaten auf ungueltige Wertebereiche und Achsvertauschungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
