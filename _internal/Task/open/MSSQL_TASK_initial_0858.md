---
task_id: MSSQL_TASK_initial_0858
repository: SQL_Training
domain: MSSQL
title: "Script SourceDeleteHandlingPattern.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 143
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0858"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/SourceDeleteHandlingPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/SourceDeleteHandlingPattern.md"
...
# MSSQL_TASK_initial_0858 - Script SourceDeleteHandlingPattern.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Muster fuer den Umgang mit geloeschten Datensaetzen in Quellsystemen.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/SourceDeleteHandlingPattern.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/SourceDeleteHandlingPattern.md

## Umsetzungsauftrag

Erzeuge `SourceDeleteHandlingPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Muster fuer den Umgang mit geloeschten Datensaetzen in Quellsystemen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
