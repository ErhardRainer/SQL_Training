---
task_id: MSSQL_TASK_initial_0475
repository: SQL_Training
domain: MSSQL
title: "Script JsonOptionalFieldDrift.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 526
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0475"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonOptionalFieldDrift.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonOptionalFieldDrift.md"
...
# MSSQL_TASK_initial_0475 - Script JsonOptionalFieldDrift.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Beobachtet Drift optionaler Felder in JSON-Payloads.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonOptionalFieldDrift.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonOptionalFieldDrift.md

## Umsetzungsauftrag

Erzeuge `JsonOptionalFieldDrift.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet Drift optionaler Felder in JSON-Payloads. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
