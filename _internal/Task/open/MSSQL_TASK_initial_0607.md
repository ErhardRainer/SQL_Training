---
task_id: MSSQL_TASK_initial_0607
repository: SQL_Training
domain: MSSQL
title: "Script TempdbStringJoinFix.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 394
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0607"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbStringJoinFix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbStringJoinFix.md"
...
# MSSQL_TASK_initial_0607 - Script TempdbStringJoinFix.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Fix-Muster fuer String-Joins mit TempDB-Kollationskonflikten.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbStringJoinFix.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/TempdbStringJoinFix.md

## Umsetzungsauftrag

Erzeuge `TempdbStringJoinFix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Fix-Muster fuer String-Joins mit TempDB-Kollationskonflikten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
