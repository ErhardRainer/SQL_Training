---
task_id: MSSQL_TASK_initial_0524
repository: SQL_Training
domain: MSSQL
title: "Script FileEncodingChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 477
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0524"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FileEncodingChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FileEncodingChecklist.md"
...
# MSSQL_TASK_initial_0524 - Script FileEncodingChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Checkliste fuer Encodings und typische Importprobleme.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FileEncodingChecklist.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FileEncodingChecklist.md

## Umsetzungsauftrag

Erzeuge `FileEncodingChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Encodings und typische Importprobleme. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
