---
task_id: MSSQL_TASK_initial_0515
repository: SQL_Training
domain: MSSQL
title: "Script BulkInsertFileAccessChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 486
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0515"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFileAccessChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFileAccessChecklist.md"
...
# MSSQL_TASK_initial_0515 - Script BulkInsertFileAccessChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Checklistenskript fuer Dateizugriff, Pfade und Berechtigungen vor einem Bulk Load.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFileAccessChecklist.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFileAccessChecklist.md

## Umsetzungsauftrag

Erzeuge `BulkInsertFileAccessChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Checklistenskript fuer Dateizugriff, Pfade und Berechtigungen vor einem Bulk Load. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
