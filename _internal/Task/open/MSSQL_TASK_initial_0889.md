---
task_id: MSSQL_TASK_initial_0889
repository: SQL_Training
domain: MSSQL
title: "Script JsonContractChangeTimeline.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 112
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0889"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractChangeTimeline.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractChangeTimeline.md"
...
# MSSQL_TASK_initial_0889 - Script JsonContractChangeTimeline.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Zeigt Veraenderungen an JSON-Vertraegen ueber die Zeit.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractChangeTimeline.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractChangeTimeline.md

## Umsetzungsauftrag

Erzeuge `JsonContractChangeTimeline.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Veraenderungen an JSON-Vertraegen ueber die Zeit. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
