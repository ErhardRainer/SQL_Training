---
task_id: MSSQL_TASK_initial_0622
repository: SQL_Training
domain: MSSQL
title: "Script ParameterSniffingSmokeTest.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 379
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0622"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingSmokeTest.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingSmokeTest.md"
...
# MSSQL_TASK_initial_0622 - Script ParameterSniffingSmokeTest.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Macht moegliche Parameter-Sniffing-Probleme ueber Plaene und Laufzeiten sichtbar.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingSmokeTest.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingSmokeTest.md

## Umsetzungsauftrag

Erzeuge `ParameterSniffingSmokeTest.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Macht moegliche Parameter-Sniffing-Probleme ueber Plaene und Laufzeiten sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
