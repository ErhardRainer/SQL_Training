---
task_id: MSSQL_TASK_initial_0662
repository: SQL_Training
domain: MSSQL
title: "Script LoginUserMappingDrift.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 339
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0662"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/LoginUserMappingDrift.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/LoginUserMappingDrift.md"
...
# MSSQL_TASK_initial_0662 - Script LoginUserMappingDrift.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Findet Drift zwischen Logins und Datenbank-Usern.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/LoginUserMappingDrift.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/LoginUserMappingDrift.md

## Umsetzungsauftrag

Erzeuge `LoginUserMappingDrift.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Findet Drift zwischen Logins und Datenbank-Usern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
