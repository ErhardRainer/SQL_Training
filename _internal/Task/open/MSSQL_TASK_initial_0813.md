---
task_id: MSSQL_TASK_initial_0813
repository: SQL_Training
domain: MSSQL
title: "Script TvpColumnOrderAudit.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 188
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0813"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpColumnOrderAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpColumnOrderAudit.md"
...
# MSSQL_TASK_initial_0813 - Script TvpColumnOrderAudit.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Prueft Spaltenreihenfolgen zwischen TVP und Zielobjekten.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpColumnOrderAudit.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpColumnOrderAudit.md

## Umsetzungsauftrag

Erzeuge `TvpColumnOrderAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Spaltenreihenfolgen zwischen TVP und Zielobjekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
