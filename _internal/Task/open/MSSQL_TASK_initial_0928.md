---
task_id: MSSQL_TASK_initial_0928
repository: SQL_Training
domain: MSSQL
title: "Script DatabaseUnitTestChecklist.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 73
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0928"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/DatabaseUnitTestChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/DatabaseUnitTestChecklist.md"
...
# MSSQL_TASK_initial_0928 - Script DatabaseUnitTestChecklist.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Checkliste fuer Datenbank-Unit-Tests.
...
- T-SQL/79_TSQL_Testing/SQLScripts/DatabaseUnitTestChecklist.sql
- T-SQL/79_TSQL_Testing/SQLScripts/DatabaseUnitTestChecklist.md

## Umsetzungsauftrag

Erzeuge `DatabaseUnitTestChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Datenbank-Unit-Tests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
