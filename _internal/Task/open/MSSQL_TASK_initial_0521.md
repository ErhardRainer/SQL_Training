---
task_id: MSSQL_TASK_initial_0521
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadRejectBucket.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 480
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0521"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectBucket.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectBucket.md"
...
# MSSQL_TASK_initial_0521 - Script BulkLoadRejectBucket.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Bessere Einordnung abgelehnter Zeilen in Bulk-Load-Szenarien.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectBucket.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectBucket.md

## Umsetzungsauftrag

Erzeuge `BulkLoadRejectBucket.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Bessere Einordnung abgelehnter Zeilen in Bulk-Load-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
