---
task_id: MSSQL_TASK_initial_0912
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreLoadBatchSizer.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 89
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0912"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreLoadBatchSizer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreLoadBatchSizer.md"
...
# MSSQL_TASK_initial_0912 - Script ColumnstoreLoadBatchSizer.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Hilft bei der Wahl sinnvoller Batchgroessen fuer Columnstore-Loads.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreLoadBatchSizer.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreLoadBatchSizer.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreLoadBatchSizer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Hilft bei der Wahl sinnvoller Batchgroessen fuer Columnstore-Loads. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
