---
task_id: MSSQL_TASK_initial_0675
repository: SQL_Training
domain: MSSQL
title: "Script AgSecondaryReadHealth.sql fuer 67_HA_DR erstellen"
status: open
priority: 326
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0675"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/AgSecondaryReadHealth.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/AgSecondaryReadHealth.md"
...
# MSSQL_TASK_initial_0675 - Script AgSecondaryReadHealth.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Bewertet den Lesezustand von Secondary-Replikaten.
...
- T-SQL/67_HA_DR/SQLScripts/AgSecondaryReadHealth.sql
- T-SQL/67_HA_DR/SQLScripts/AgSecondaryReadHealth.md

## Umsetzungsauftrag

Erzeuge `AgSecondaryReadHealth.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Bewertet den Lesezustand von Secondary-Replikaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
