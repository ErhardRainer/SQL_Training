---
task_id: MSSQL_TASK_initial_0525
repository: SQL_Training
domain: MSSQL
title: "Script FormatFileColumnAudit.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 476
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0525"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileColumnAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileColumnAudit.md"
...
# MSSQL_TASK_initial_0525 - Script FormatFileColumnAudit.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Audit ueber Spaltenzuordnungen in Format-Dateien.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileColumnAudit.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileColumnAudit.md

## Umsetzungsauftrag

Erzeuge `FormatFileColumnAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Spaltenzuordnungen in Format-Dateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
