---
task_id: MSSQL_TASK_initial_0954
repository: SQL_Training
domain: MSSQL
title: "Script ElasticJobsMetadataAudit.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 47
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0954"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticJobsMetadataAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticJobsMetadataAudit.md"
...
# MSSQL_TASK_initial_0954 - Script ElasticJobsMetadataAudit.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Uebersicht ueber vorhandene Elastic-Jobs-Metadaten in Azure-Szenarien.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticJobsMetadataAudit.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticJobsMetadataAudit.md

## Umsetzungsauftrag

Erzeuge `ElasticJobsMetadataAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber vorhandene Elastic-Jobs-Metadaten in Azure-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
