---
task_id: MSSQL_TASK_initial_0699
repository: SQL_Training
domain: MSSQL
title: "Script CdcLsnRangeInspector.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 302
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0699"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLsnRangeInspector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLsnRangeInspector.md"
...
# MSSQL_TASK_initial_0699 - Script CdcLsnRangeInspector.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Zeigt relevante LSN-Bereiche fuer CDC-Diagnosen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLsnRangeInspector.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLsnRangeInspector.md

## Umsetzungsauftrag

Erzeuge `CdcLsnRangeInspector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt relevante LSN-Bereiche fuer CDC-Diagnosen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
