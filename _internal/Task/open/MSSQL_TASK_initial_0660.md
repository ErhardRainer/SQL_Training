---
task_id: MSSQL_TASK_initial_0660
repository: SQL_Training
domain: MSSQL
title: "Script ImpersonationPermissionAudit.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 341
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0660"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ImpersonationPermissionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ImpersonationPermissionAudit.md"
...
# MSSQL_TASK_initial_0660 - Script ImpersonationPermissionAudit.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Audit ueber `EXECUTE AS` und moegliche Impersonation-Rechte.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ImpersonationPermissionAudit.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ImpersonationPermissionAudit.md

## Umsetzungsauftrag

Erzeuge `ImpersonationPermissionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber `EXECUTE AS` und moegliche Impersonation-Rechte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
