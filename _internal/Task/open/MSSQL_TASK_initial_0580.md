---
task_id: MSSQL_TASK_initial_0580
repository: SQL_Training
domain: MSSQL
title: "Script RlsPredicateResultSampler.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 421
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0580"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateResultSampler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateResultSampler.md"
...
# MSSQL_TASK_initial_0580 - Script RlsPredicateResultSampler.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Sampelt Ergebnisbilder unter verschiedenen RLS-Kontexten.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateResultSampler.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicateResultSampler.md

## Umsetzungsauftrag

Erzeuge `RlsPredicateResultSampler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Sampelt Ergebnisbilder unter verschiedenen RLS-Kontexten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
