---
task_id: MSSQL_TASK_initial_0924
repository: SQL_Training
domain: MSSQL
title: "Script RowgroupMergeOpportunityScan.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 77
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0924"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupMergeOpportunityScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupMergeOpportunityScan.md"
...
# MSSQL_TASK_initial_0924 - Script RowgroupMergeOpportunityScan.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Scan fuer moegliche Merge-Kandidaten zwischen Rowgroups.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupMergeOpportunityScan.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupMergeOpportunityScan.md

## Umsetzungsauftrag

Erzeuge `RowgroupMergeOpportunityScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Scan fuer moegliche Merge-Kandidaten zwischen Rowgroups. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
