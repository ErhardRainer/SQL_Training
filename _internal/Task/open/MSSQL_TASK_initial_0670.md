---
task_id: MSSQL_TASK_initial_0670
repository: SQL_Training
domain: MSSQL
title: "Script SchemaLevelGrantInventory.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 331
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0670"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaLevelGrantInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaLevelGrantInventory.md"
...
# MSSQL_TASK_initial_0670 - Script SchemaLevelGrantInventory.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Inventarisiert Rechte auf Schemaebene.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaLevelGrantInventory.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaLevelGrantInventory.md

## Umsetzungsauftrag

Erzeuge `SchemaLevelGrantInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Rechte auf Schemaebene. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
