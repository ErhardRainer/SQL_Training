---
task_id: MSSQL_TASK_initial_0795
repository: SQL_Training
domain: MSSQL
title: "Script NightWindowJobMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 206
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0795"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/NightWindowJobMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/NightWindowJobMatrix.md"
...
# MSSQL_TASK_initial_0795 - Script NightWindowJobMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Matrix ueber Jobs im Nachtfenster.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/NightWindowJobMatrix.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/NightWindowJobMatrix.md

## Umsetzungsauftrag

Erzeuge `NightWindowJobMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber Jobs im Nachtfenster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
