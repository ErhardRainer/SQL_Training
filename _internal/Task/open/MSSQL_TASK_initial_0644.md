---
task_id: MSSQL_TASK_initial_0644
repository: SQL_Training
domain: MSSQL
title: "Script PartitionRangeCoverageAudit.sql fuer 65_Partitioning erstellen"
status: open
priority: 357
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0644"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionRangeCoverageAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionRangeCoverageAudit.md"
...
# MSSQL_TASK_initial_0644 - Script PartitionRangeCoverageAudit.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Audit ueber die Abdeckung der definierten Partitionsbereiche.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionRangeCoverageAudit.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionRangeCoverageAudit.md

## Umsetzungsauftrag

Erzeuge `PartitionRangeCoverageAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber die Abdeckung der definierten Partitionsbereiche. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
