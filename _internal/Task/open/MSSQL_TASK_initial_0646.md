---
task_id: MSSQL_TASK_initial_0646
repository: SQL_Training
domain: MSSQL
title: "Script PartitionSkewReport.sql fuer 65_Partitioning erstellen"
status: open
priority: 355
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0646"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSkewReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSkewReport.md"
...
# MSSQL_TASK_initial_0646 - Script PartitionSkewReport.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Reportet ungleich grosse Partitionen und moegliche Hotspot-Partitionen.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionSkewReport.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionSkewReport.md

## Umsetzungsauftrag

Erzeuge `PartitionSkewReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Reportet ungleich grosse Partitionen und moegliche Hotspot-Partitionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
