---
task_id: MSSQL_TASK_initial_0907
repository: SQL_Training
domain: MSSQL
title: "Script ArchiveCompressionCandidates.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 94
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0907"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ArchiveCompressionCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ArchiveCompressionCandidates.md"
...
# MSSQL_TASK_initial_0907 - Script ArchiveCompressionCandidates.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Markiert Partitionen oder Tabellen als Kandidaten fuer Archive Compression.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ArchiveCompressionCandidates.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ArchiveCompressionCandidates.md

## Umsetzungsauftrag

Erzeuge `ArchiveCompressionCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Partitionen oder Tabellen als Kandidaten fuer Archive Compression. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
