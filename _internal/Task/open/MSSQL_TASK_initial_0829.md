---
task_id: MSSQL_TASK_initial_0829
repository: SQL_Training
domain: MSSQL
title: "Script SnapshotEnabledDatabases.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 172
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0829"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotEnabledDatabases.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotEnabledDatabases.md"
...
# MSSQL_TASK_initial_0829 - Script SnapshotEnabledDatabases.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Zeigt Datenbanken mit aktivem Snapshot- oder RCSI-Betrieb.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotEnabledDatabases.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotEnabledDatabases.md

## Umsetzungsauftrag

Erzeuge `SnapshotEnabledDatabases.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Datenbanken mit aktivem Snapshot- oder RCSI-Betrieb. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
