---
task_id: MSSQL_TASK_initial_0853
repository: SQL_Training
domain: MSSQL
title: "Script IdempotentMergeWorkflow.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 148
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0853"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentMergeWorkflow.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentMergeWorkflow.md"
...
# MSSQL_TASK_initial_0853 - Script IdempotentMergeWorkflow.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Workflow-Vorlage fuer idempotente Merge-basierte ETL-Strecken.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentMergeWorkflow.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/IdempotentMergeWorkflow.md

## Umsetzungsauftrag

Erzeuge `IdempotentMergeWorkflow.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Workflow-Vorlage fuer idempotente Merge-basierte ETL-Strecken. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
