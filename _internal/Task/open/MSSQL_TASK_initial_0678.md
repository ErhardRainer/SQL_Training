---
task_id: MSSQL_TASK_initial_0678
repository: SQL_Training
domain: MSSQL
title: "Script FailoverReadinessChecklist.sql fuer 67_HA_DR erstellen"
status: open
priority: 323
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0678"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/FailoverReadinessChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/FailoverReadinessChecklist.md"
...
# MSSQL_TASK_initial_0678 - Script FailoverReadinessChecklist.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Technische Checkliste fuer einen moeglichen geplanten Failover.
...
- T-SQL/67_HA_DR/SQLScripts/FailoverReadinessChecklist.sql
- T-SQL/67_HA_DR/SQLScripts/FailoverReadinessChecklist.md

## Umsetzungsauftrag

Erzeuge `FailoverReadinessChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Technische Checkliste fuer einen moeglichen geplanten Failover. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
