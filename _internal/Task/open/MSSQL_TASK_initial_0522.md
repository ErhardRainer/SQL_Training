---
task_id: MSSQL_TASK_initial_0522
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadTransactionWrapper.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 479
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0522"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadTransactionWrapper.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadTransactionWrapper.md"
...
# MSSQL_TASK_initial_0522 - Script BulkLoadTransactionWrapper.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Vorlage fuer Importlaeufe mit Transaktionsrahmen und Fehlerbehandlung.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadTransactionWrapper.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadTransactionWrapper.md

## Umsetzungsauftrag

Erzeuge `BulkLoadTransactionWrapper.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Importlaeufe mit Transaktionsrahmen und Fehlerbehandlung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
