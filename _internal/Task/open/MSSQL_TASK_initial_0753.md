---
task_id: MSSQL_TASK_initial_0753
repository: SQL_Training
domain: MSSQL
title: "Script RejectRowsDiagnostics.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 248
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0753"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowsDiagnostics.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowsDiagnostics.md"
...
# MSSQL_TASK_initial_0753 - Script RejectRowsDiagnostics.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Hilft bei der Analyse abgewiesener Zeilen und Mapping-Probleme in PolyBase-Laeufen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowsDiagnostics.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowsDiagnostics.md

## Umsetzungsauftrag

Erzeuge `RejectRowsDiagnostics.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Hilft bei der Analyse abgewiesener Zeilen und Mapping-Probleme in PolyBase-Laeufen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
