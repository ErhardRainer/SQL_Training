---
task_id: MSSQL_TASK_initial_0780
repository: SQL_Training
domain: MSSQL
title: "Script AgentProxyUsageInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 221
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0780"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentProxyUsageInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentProxyUsageInventory.md"
...
# MSSQL_TASK_initial_0780 - Script AgentProxyUsageInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Inventarisiert eingesetzte Proxies in Agent-Jobs.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentProxyUsageInventory.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentProxyUsageInventory.md

## Umsetzungsauftrag

Erzeuge `AgentProxyUsageInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert eingesetzte Proxies in Agent-Jobs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
