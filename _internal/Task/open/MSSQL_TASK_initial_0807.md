---
task_id: MSSQL_TASK_initial_0807
repository: SQL_Training
domain: MSSQL
title: "Script TableTypePrimaryKeyTemplate.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 194
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0807"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypePrimaryKeyTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypePrimaryKeyTemplate.md"
...
# MSSQL_TASK_initial_0807 - Script TableTypePrimaryKeyTemplate.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Vorlage fuer Table Types mit sinnvoller Schluesseldefinition.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypePrimaryKeyTemplate.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypePrimaryKeyTemplate.md

## Umsetzungsauftrag

Erzeuge `TableTypePrimaryKeyTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Table Types mit sinnvoller Schluesseldefinition. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
