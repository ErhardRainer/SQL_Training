---
task_id: MSSQL_TASK_initial_0791
repository: SQL_Training
domain: MSSQL
title: "Script JobRetryConfigurationReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 210
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0791"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryConfigurationReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryConfigurationReview.md"
...
# MSSQL_TASK_initial_0791 - Script JobRetryConfigurationReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Review ueber Retry-Settings von Jobs und Schritten.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryConfigurationReview.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryConfigurationReview.md

## Umsetzungsauftrag

Erzeuge `JobRetryConfigurationReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Retry-Settings von Jobs und Schritten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
