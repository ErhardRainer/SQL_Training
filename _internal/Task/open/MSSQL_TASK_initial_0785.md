---
task_id: MSSQL_TASK_initial_0785
repository: SQL_Training
domain: MSSQL
title: "Script DisabledJobInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 216
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0785"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/DisabledJobInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/DisabledJobInventory.md"
...
# MSSQL_TASK_initial_0785 - Script DisabledJobInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Inventarisiert deaktivierte SQL-Agent-Jobs.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/DisabledJobInventory.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/DisabledJobInventory.md

## Umsetzungsauftrag

Erzeuge `DisabledJobInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert deaktivierte SQL-Agent-Jobs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
