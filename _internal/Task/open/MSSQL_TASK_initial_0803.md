---
task_id: MSSQL_TASK_initial_0803
repository: SQL_Training
domain: MSSQL
title: "Script TableTypeColumnDiffCheck.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 198
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0803"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeColumnDiffCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeColumnDiffCheck.md"
...
# MSSQL_TASK_initial_0803 - Script TableTypeColumnDiffCheck.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Vergleicht Table Types mit Zieltabellen auf Spaltenabweichungen.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeColumnDiffCheck.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeColumnDiffCheck.md

## Umsetzungsauftrag

Erzeuge `TableTypeColumnDiffCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Table Types mit Zieltabellen auf Spaltenabweichungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
