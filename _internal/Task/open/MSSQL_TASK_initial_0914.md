---
task_id: MSSQL_TASK_initial_0914
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstorePredicateCoverage.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 87
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0914"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstorePredicateCoverage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstorePredicateCoverage.md"
...
# MSSQL_TASK_initial_0914 - Script ColumnstorePredicateCoverage.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Review, welche Praedikate Segment-Pruning unterstuetzen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstorePredicateCoverage.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstorePredicateCoverage.md

## Umsetzungsauftrag

Erzeuge `ColumnstorePredicateCoverage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Review, welche Praedikate Segment-Pruning unterstuetzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
