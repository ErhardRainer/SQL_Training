---
task_id: MSSQL_TASK_initial_0906
repository: SQL_Training
domain: MSSQL
title: "Script SchemaVersionRoutingTemplate.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 95
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0906"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaVersionRoutingTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaVersionRoutingTemplate.md"
...
# MSSQL_TASK_initial_0906 - Script SchemaVersionRoutingTemplate.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Routing-Vorlage fuer unterschiedliche JSON-Schema-Versionen.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaVersionRoutingTemplate.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaVersionRoutingTemplate.md

## Umsetzungsauftrag

Erzeuge `SchemaVersionRoutingTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Routing-Vorlage fuer unterschiedliche JSON-Schema-Versionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
