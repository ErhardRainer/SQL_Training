---
task_id: MSSQL_TASK_initial_0611
repository: SQL_Training
domain: MSSQL
title: "Script CompileBurstDetector.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 390
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0611"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CompileBurstDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CompileBurstDetector.md"
...
# MSSQL_TASK_initial_0611 - Script CompileBurstDetector.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Detektor fuer kurzfristige Compile-Wellen.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CompileBurstDetector.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CompileBurstDetector.md

## Umsetzungsauftrag

Erzeuge `CompileBurstDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Detektor fuer kurzfristige Compile-Wellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
