---
task_id: MSSQL_TASK_initial_0721
repository: SQL_Training
domain: MSSQL
title: "Script ConversationCleanupBacklog.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 280
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0721"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationCleanupBacklog.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationCleanupBacklog.md"
...
# MSSQL_TASK_initial_0721 - Script ConversationCleanupBacklog.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Findet alte Conversations mit Aufraeumbedarf und moeglichem Nachrichtenstau.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationCleanupBacklog.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationCleanupBacklog.md

## Umsetzungsauftrag

Erzeuge `ConversationCleanupBacklog.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Findet alte Conversations mit Aufraeumbedarf und moeglichem Nachrichtenstau. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
