---
task_id: MSSQL_TASK_initial_0694
repository: SQL_Training
domain: MSSQL
title: "Script SynchronizationLagHeatmap.sql fuer 67_HA_DR erstellen"
status: open
priority: 307
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0694"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/SynchronizationLagHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/SynchronizationLagHeatmap.md"
...
# MSSQL_TASK_initial_0694 - Script SynchronizationLagHeatmap.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Heatmap fuer Synchronisationsverzoegerungen.
...
- T-SQL/67_HA_DR/SQLScripts/SynchronizationLagHeatmap.sql
- T-SQL/67_HA_DR/SQLScripts/SynchronizationLagHeatmap.md

## Umsetzungsauftrag

Erzeuge `SynchronizationLagHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap fuer Synchronisationsverzoegerungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
