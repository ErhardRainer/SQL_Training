---
task_id: MSSQL_TASK_initial_0874
repository: SQL_Training
domain: MSSQL
title: "Script InvalidGeometryFinder.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 127
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0874"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/InvalidGeometryFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/InvalidGeometryFinder.md"
...
# MSSQL_TASK_initial_0874 - Script InvalidGeometryFinder.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Findet ungueltige Geometrien und zeigt Reparaturansaetze mit `MakeValid()` an.
...
- T-SQL/76_Spatial_Geography/SQLScripts/InvalidGeometryFinder.sql
- T-SQL/76_Spatial_Geography/SQLScripts/InvalidGeometryFinder.md

## Umsetzungsauftrag

Erzeuge `InvalidGeometryFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Findet ungueltige Geometrien und zeigt Reparaturansaetze mit `MakeValid()` an. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
