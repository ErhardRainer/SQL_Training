---
task_id: MSSQL_TASK_initial_0488
repository: SQL_Training
domain: MSSQL
title: "Script XmlNamespaceStarter.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 513
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0488"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNamespaceStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNamespaceStarter.md"
...
# MSSQL_TASK_initial_0488 - Script XmlNamespaceStarter.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Startskript fuer XML-Abfragen mit Namespaces und typischen `WITH XMLNAMESPACES`-Mustern.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNamespaceStarter.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNamespaceStarter.md

## Umsetzungsauftrag

Erzeuge `XmlNamespaceStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Startskript fuer XML-Abfragen mit Namespaces und typischen `WITH XMLNAMESPACES`-Mustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
