---
task_id: MSSQL_TASK_initial_0461
repository: SQL_Training
domain: MSSQL
title: "Script NestedLoopsLookupRisk.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 540
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0461"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/NestedLoopsLookupRisk.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/NestedLoopsLookupRisk.md"
...
# MSSQL_TASK_initial_0461 - Script NestedLoopsLookupRisk.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Markiert Nested-Loops-Plaene mit Lookup-Risiko.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/NestedLoopsLookupRisk.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/NestedLoopsLookupRisk.md

## Umsetzungsauftrag

Erzeuge `NestedLoopsLookupRisk.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Nested-Loops-Plaene mit Lookup-Risiko. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
