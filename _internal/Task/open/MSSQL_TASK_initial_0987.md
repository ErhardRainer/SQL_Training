---
task_id: MSSQL_TASK_initial_0987
repository: SQL_Training
domain: MSSQL
title: "Script LiveBlockingMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 14
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0987"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/LiveBlockingMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/LiveBlockingMatrix.md"
...
# MSSQL_TASK_initial_0987 - Script LiveBlockingMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Zeigt aktuelle Blocker, Waits, SQL-Text und Hierarchie in einer Live-Matrix.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/LiveBlockingMatrix.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/LiveBlockingMatrix.md

## Umsetzungsauftrag

Erzeuge `LiveBlockingMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt aktuelle Blocker, Waits, SQL-Text und Hierarchie in einer Live-Matrix. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
