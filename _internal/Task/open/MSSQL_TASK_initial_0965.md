---
task_id: MSSQL_TASK_initial_0965
repository: SQL_Training
domain: MSSQL
title: "Script HashVsRangeIndexComparison.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 36
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0965"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashVsRangeIndexComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashVsRangeIndexComparison.md"
...
# MSSQL_TASK_initial_0965 - Script HashVsRangeIndexComparison.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Vergleicht Hash- und Range-Indexmuster auf memory-optimized Tabellen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/HashVsRangeIndexComparison.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/HashVsRangeIndexComparison.md

## Umsetzungsauftrag

Erzeuge `HashVsRangeIndexComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Hash- und Range-Indexmuster auf memory-optimized Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
