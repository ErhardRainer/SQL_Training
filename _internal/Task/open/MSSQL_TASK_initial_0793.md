---
task_id: MSSQL_TASK_initial_0793
repository: SQL_Training
domain: MSSQL
title: "Script JobStepFailureMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 208
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0793"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobStepFailureMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobStepFailureMatrix.md"
...
# MSSQL_TASK_initial_0793 - Script JobStepFailureMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Matrix fehlgeschlagener Jobschritte nach Job, Schritt und Fehlercode.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobStepFailureMatrix.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobStepFailureMatrix.md

## Umsetzungsauftrag

Erzeuge `JobStepFailureMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Matrix fehlgeschlagener Jobschritte nach Job, Schritt und Fehlercode. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
