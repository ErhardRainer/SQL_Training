---
task_id: MSSQL_TASK_initial_0814
repository: SQL_Training
domain: MSSQL
title: "Script TvpConsumerPerformanceCheck.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 187
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0814"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpConsumerPerformanceCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpConsumerPerformanceCheck.md"
...
# MSSQL_TASK_initial_0814 - Script TvpConsumerPerformanceCheck.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Prueft Performance relevanter TVP-Konsumenten.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpConsumerPerformanceCheck.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpConsumerPerformanceCheck.md

## Umsetzungsauftrag

Erzeuge `TvpConsumerPerformanceCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Performance relevanter TVP-Konsumenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
