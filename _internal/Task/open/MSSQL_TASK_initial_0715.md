---
task_id: MSSQL_TASK_initial_0715
repository: SQL_Training
domain: MSSQL
title: "Script BrokerConversationTimerAudit.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 286
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0715"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerConversationTimerAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerConversationTimerAudit.md"
...
# MSSQL_TASK_initial_0715 - Script BrokerConversationTimerAudit.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Audit fuer Conversation Timer und deren Ablauf.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerConversationTimerAudit.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerConversationTimerAudit.md

## Umsetzungsauftrag

Erzeuge `BrokerConversationTimerAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Conversation Timer und deren Ablauf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
