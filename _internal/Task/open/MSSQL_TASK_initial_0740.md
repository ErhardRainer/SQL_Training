---
task_id: MSSQL_TASK_initial_0740
repository: SQL_Training
domain: MSSQL
title: "Script ExternalObjectDropRecreatePlan.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 261
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0740"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalObjectDropRecreatePlan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalObjectDropRecreatePlan.md"
...
# MSSQL_TASK_initial_0740 - Script ExternalObjectDropRecreatePlan.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Erstellt einen Ablaufplan fuer Drop und Recreate externer Objekte.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalObjectDropRecreatePlan.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalObjectDropRecreatePlan.md

## Umsetzungsauftrag

Erzeuge `ExternalObjectDropRecreatePlan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt einen Ablaufplan fuer Drop und Recreate externer Objekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
