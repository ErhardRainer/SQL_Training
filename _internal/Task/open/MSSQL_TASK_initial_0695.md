---
task_id: MSSQL_TASK_initial_0695
repository: SQL_Training
domain: MSSQL
title: "Script CdcCaptureInstanceInventory.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 306
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0695"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcCaptureInstanceInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcCaptureInstanceInventory.md"
...
# MSSQL_TASK_initial_0695 - Script CdcCaptureInstanceInventory.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Inventarisiert CDC Capture Instances samt Tabellen- und Jobzuordnung.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcCaptureInstanceInventory.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcCaptureInstanceInventory.md

## Umsetzungsauftrag

Erzeuge `CdcCaptureInstanceInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert CDC Capture Instances samt Tabellen- und Jobzuordnung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
