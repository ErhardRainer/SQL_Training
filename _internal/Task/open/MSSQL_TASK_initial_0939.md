---
task_id: MSSQL_TASK_initial_0939
repository: SQL_Training
domain: MSSQL
title: "Script TestExecutionOrderAudit.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 62
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0939"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestExecutionOrderAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestExecutionOrderAudit.md"
...
# MSSQL_TASK_initial_0939 - Script TestExecutionOrderAudit.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Audit ueber die Reihenfolge von Testausfuehrungen.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestExecutionOrderAudit.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestExecutionOrderAudit.md

## Umsetzungsauftrag

Erzeuge `TestExecutionOrderAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber die Reihenfolge von Testausfuehrungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
