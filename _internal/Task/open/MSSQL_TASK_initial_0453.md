---
task_id: MSSQL_TASK_initial_0453
repository: SQL_Training
domain: MSSQL
title: "Script ActualVsEstimatedRowGapScan.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 548
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0453"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/ActualVsEstimatedRowGapScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/ActualVsEstimatedRowGapScan.md"
...
# MSSQL_TASK_initial_0453 - Script ActualVsEstimatedRowGapScan.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Scan auf groessere Abweichungen zwischen geschaetzten und echten Zeilen.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/ActualVsEstimatedRowGapScan.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/ActualVsEstimatedRowGapScan.md

## Umsetzungsauftrag

Erzeuge `ActualVsEstimatedRowGapScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Scan auf groessere Abweichungen zwischen geschaetzten und echten Zeilen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
