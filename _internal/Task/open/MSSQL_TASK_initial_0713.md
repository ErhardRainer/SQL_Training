---
task_id: MSSQL_TASK_initial_0713
repository: SQL_Training
domain: MSSQL
title: "Script TemporalTableModeInventory.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 288
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0713"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalTableModeInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalTableModeInventory.md"
...
# MSSQL_TASK_initial_0713 - Script TemporalTableModeInventory.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Inventarisiert Modi und Zustandsarten temporaler Tabellen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalTableModeInventory.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalTableModeInventory.md

## Umsetzungsauftrag

Erzeuge `TemporalTableModeInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Modi und Zustandsarten temporaler Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
