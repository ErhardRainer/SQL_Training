---
task_id: MSSQL_TASK_initial_0940
repository: SQL_Training
domain: MSSQL
title: "Script TestFixtureDataSeeder.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 61
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0940"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestFixtureDataSeeder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestFixtureDataSeeder.md"
...
# MSSQL_TASK_initial_0940 - Script TestFixtureDataSeeder.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Laedt definierte Testdaten-Fixpunkte fuer Unit-Tests.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestFixtureDataSeeder.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestFixtureDataSeeder.md

## Umsetzungsauftrag

Erzeuge `TestFixtureDataSeeder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Laedt definierte Testdaten-Fixpunkte fuer Unit-Tests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
