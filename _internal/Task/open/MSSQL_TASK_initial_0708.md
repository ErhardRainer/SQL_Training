---
task_id: MSSQL_TASK_initial_0708
repository: SQL_Training
domain: MSSQL
title: "Script TemporalHistoryIndexAudit.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 293
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0708"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAudit.md"
...
# MSSQL_TASK_initial_0708 - Script TemporalHistoryIndexAudit.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Audit ueber Indizes auf Historientabellen systemversionierter Tabellen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAudit.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAudit.md

## Umsetzungsauftrag

Erzeuge `TemporalHistoryIndexAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Indizes auf Historientabellen systemversionierter Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
