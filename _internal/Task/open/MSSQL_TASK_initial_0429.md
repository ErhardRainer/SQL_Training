---
task_id: MSSQL_TASK_initial_0429
repository: SQL_Training
domain: MSSQL
title: "Script DisabledIndexesReport.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 572
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0429"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DisabledIndexesReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/DisabledIndexesReport.md"
...
# MSSQL_TASK_initial_0429 - Script DisabledIndexesReport.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Listet deaktivierte Indizes samt Groesse und betroffenem Objekt auf.
...
- T-SQL/26_Indexes_Basics/SQLScripts/DisabledIndexesReport.sql
- T-SQL/26_Indexes_Basics/SQLScripts/DisabledIndexesReport.md

## Umsetzungsauftrag

Erzeuge `DisabledIndexesReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Listet deaktivierte Indizes samt Groesse und betroffenem Objekt auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
