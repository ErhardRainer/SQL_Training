---
task_id: MSSQL_TASK_initial_0648
repository: SQL_Training
domain: MSSQL
title: "Script PartitionSwitchOutArchiveTemplate.sql fuer 65_Partitioning erstellen"
status: open
priority: 353
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0648"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSwitchOutArchiveTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSwitchOutArchiveTemplate.md"
...
# MSSQL_TASK_initial_0648 - Script PartitionSwitchOutArchiveTemplate.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Vorlage fuer das Archivieren alter Partitionen via `SWITCH OUT`.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionSwitchOutArchiveTemplate.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionSwitchOutArchiveTemplate.md

## Umsetzungsauftrag

Erzeuge `PartitionSwitchOutArchiveTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer das Archivieren alter Partitionen via `SWITCH OUT`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
