---
task_id: MSSQL_TASK_initial_0628
repository: SQL_Training
domain: MSSQL
title: "Script QueryStoreTopRegressions.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 373
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0628"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreTopRegressions.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreTopRegressions.md"
...
# MSSQL_TASK_initial_0628 - Script QueryStoreTopRegressions.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Listet Query-Store-Regressionen nach Dauer, CPU oder Reads.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreTopRegressions.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreTopRegressions.md

## Umsetzungsauftrag

Erzeuge `QueryStoreTopRegressions.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Listet Query-Store-Regressionen nach Dauer, CPU oder Reads. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
