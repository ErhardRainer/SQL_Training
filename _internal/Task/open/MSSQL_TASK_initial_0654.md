---
task_id: MSSQL_TASK_initial_0654
repository: SQL_Training
domain: MSSQL
title: "Script DenyOverridesGrantDemo.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 347
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0654"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/DenyOverridesGrantDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/DenyOverridesGrantDemo.md"
...
# MSSQL_TASK_initial_0654 - Script DenyOverridesGrantDemo.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Demonstriert, wie `DENY` ein `GRANT` ueberschreibt.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/DenyOverridesGrantDemo.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/DenyOverridesGrantDemo.md

## Umsetzungsauftrag

Erzeuge `DenyOverridesGrantDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert, wie `DENY` ein `GRANT` ueberschreibt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
