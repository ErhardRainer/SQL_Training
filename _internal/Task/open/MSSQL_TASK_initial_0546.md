---
task_id: MSSQL_TASK_initial_0546
repository: SQL_Training
domain: MSSQL
title: "Script SerializableRangeLockDemo.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 455
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0546"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/SerializableRangeLockDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/SerializableRangeLockDemo.md"
...
# MSSQL_TASK_initial_0546 - Script SerializableRangeLockDemo.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Demonstriert Range Locks unter `SERIALIZABLE` auf anschauliche Weise.
...
- T-SQL/60_IsolationLevels/SQLScripts/SerializableRangeLockDemo.sql
- T-SQL/60_IsolationLevels/SQLScripts/SerializableRangeLockDemo.md

## Umsetzungsauftrag

Erzeuge `SerializableRangeLockDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Range Locks unter `SERIALIZABLE` auf anschauliche Weise. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
