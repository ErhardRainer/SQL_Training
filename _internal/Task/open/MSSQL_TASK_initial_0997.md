---
task_id: MSSQL_TASK_initial_0997
repository: SQL_Training
domain: MSSQL
title: "Script SleepingBlockerFinder.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 4
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0997"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SleepingBlockerFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SleepingBlockerFinder.md"
...
# MSSQL_TASK_initial_0997 - Script SleepingBlockerFinder.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Findet schlafende Sessions, die andere blockieren.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SleepingBlockerFinder.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SleepingBlockerFinder.md

## Umsetzungsauftrag

Erzeuge `SleepingBlockerFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Findet schlafende Sessions, die andere blockieren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
