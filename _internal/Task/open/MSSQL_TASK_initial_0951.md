---
task_id: MSSQL_TASK_initial_0951
repository: SQL_Training
domain: MSSQL
title: "Script AzureSqlConnectionPolicyAudit.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 50
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0951"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlConnectionPolicyAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlConnectionPolicyAudit.md"
...
# MSSQL_TASK_initial_0951 - Script AzureSqlConnectionPolicyAudit.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Dokumentiert Connection Policies und netzwerknahe Azure-SQL-Einstellungen.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlConnectionPolicyAudit.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureSqlConnectionPolicyAudit.md

## Umsetzungsauftrag

Erzeuge `AzureSqlConnectionPolicyAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Dokumentiert Connection Policies und netzwerknahe Azure-SQL-Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
