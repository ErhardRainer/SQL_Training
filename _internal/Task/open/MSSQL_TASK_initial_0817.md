---
task_id: MSSQL_TASK_initial_0817
repository: SQL_Training
domain: MSSQL
title: "Script TvpMergePatternTemplate.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 184
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0817"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpMergePatternTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpMergePatternTemplate.md"
...
# MSSQL_TASK_initial_0817 - Script TvpMergePatternTemplate.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Vorlage fuer Upserts oder Deltas auf Basis eines TVP.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpMergePatternTemplate.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpMergePatternTemplate.md

## Umsetzungsauftrag

Erzeuge `TvpMergePatternTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Upserts oder Deltas auf Basis eines TVP. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
