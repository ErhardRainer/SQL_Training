---
task_id: MSSQL_TASK_initial_0619
repository: SQL_Training
domain: MSSQL
title: "Script ParameterSensitivePlanWatch.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 382
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0619"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanWatch.md"
...
# MSSQL_TASK_initial_0619 - Script ParameterSensitivePlanWatch.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Sucht Anzeichen fuer parameter-sensitive Plans in Query Store oder Cache.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanWatch.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanWatch.md

## Umsetzungsauftrag

Erzeuge `ParameterSensitivePlanWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Sucht Anzeichen fuer parameter-sensitive Plans in Query Store oder Cache. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
