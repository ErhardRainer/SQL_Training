---
task_id: MSSQL_TASK_initial_0533
repository: SQL_Training
domain: MSSQL
title: "Script IsolationChangeSessionAudit.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 468
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0533"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationChangeSessionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationChangeSessionAudit.md"
...
# MSSQL_TASK_initial_0533 - Script IsolationChangeSessionAudit.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Audit ueber Sessions mit geaenderter Isolationsstufe.
...
- T-SQL/60_IsolationLevels/SQLScripts/IsolationChangeSessionAudit.sql
- T-SQL/60_IsolationLevels/SQLScripts/IsolationChangeSessionAudit.md

## Umsetzungsauftrag

Erzeuge `IsolationChangeSessionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Sessions mit geaenderter Isolationsstufe. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
