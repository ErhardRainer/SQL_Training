---
task_id: MSSQL_TASK_initial_0484
repository: SQL_Training
domain: MSSQL
title: "Script OpenJsonWithSchemaTemplate.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 517
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0484"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonWithSchemaTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonWithSchemaTemplate.md"
...
# MSSQL_TASK_initial_0484 - Script OpenJsonWithSchemaTemplate.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Vorlage fuer `OPENJSON ... WITH (...)` mit sauberem Spaltenmapping.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonWithSchemaTemplate.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonWithSchemaTemplate.md

## Umsetzungsauftrag

Erzeuge `OpenJsonWithSchemaTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer `OPENJSON ... WITH (...)` mit sauberem Spaltenmapping. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
