---
task_id: MSSQL_TASK_initial_0656
repository: SQL_Training
domain: MSSQL
title: "Script EffectivePermissionTrace.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 345
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0656"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionTrace.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionTrace.md"
...
# MSSQL_TASK_initial_0656 - Script EffectivePermissionTrace.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Loest direkte und indirekte Rechte eines Principals nachvollziehbar auf.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionTrace.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/EffectivePermissionTrace.md

## Umsetzungsauftrag

Erzeuge `EffectivePermissionTrace.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Loest direkte und indirekte Rechte eines Principals nachvollziehbar auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
