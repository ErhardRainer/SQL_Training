---
task_id: MSSQL_TASK_initial_0903
repository: SQL_Training
domain: MSSQL
title: "Script OpenJsonErrorCapture.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 98
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0903"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonErrorCapture.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonErrorCapture.md"
...
# MSSQL_TASK_initial_0903 - Script OpenJsonErrorCapture.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Faengt Fehler beim Parsen ueber `OPENJSON` in einem Standardformat ab.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonErrorCapture.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonErrorCapture.md

## Umsetzungsauftrag

Erzeuge `OpenJsonErrorCapture.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Faengt Fehler beim Parsen ueber `OPENJSON` in einem Standardformat ab. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
