---
task_id: MSSQL_TASK_initial_0901
repository: SQL_Training
domain: MSSQL
title: "Script JsonStagingErrorReplay.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 100
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0901"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonStagingErrorReplay.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonStagingErrorReplay.md"
...
# MSSQL_TASK_initial_0901 - Script JsonStagingErrorReplay.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Hilft beim gezielten Wiederanlauf fehlerhafter JSON-Staging-Datensaetze.
