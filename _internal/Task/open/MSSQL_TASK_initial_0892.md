---
task_id: MSSQL_TASK_initial_0892
repository: SQL_Training
domain: MSSQL
title: "Script JsonDuplicateKeyProbe.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 109
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0892"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDuplicateKeyProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDuplicateKeyProbe.md"
...
# MSSQL_TASK_initial_0892 - Script JsonDuplicateKeyProbe.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Prueft eingehende JSON-Dokumente auf potenziell problematische doppelte Keys.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDuplicateKeyProbe.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDuplicateKeyProbe.md

## Umsetzungsauftrag

Erzeuge `JsonDuplicateKeyProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Prueft eingehende JSON-Dokumente auf potenziell problematische doppelte Keys. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
