---
task_id: MSSQL_TASK_initial_0891
repository: SQL_Training
domain: MSSQL
title: "Script JsonDefaultValueApplier.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 110
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0891"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDefaultValueApplier.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDefaultValueApplier.md"
...
# MSSQL_TASK_initial_0891 - Script JsonDefaultValueApplier.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Wendet definierte Default-Werte auf fehlende Properties an.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDefaultValueApplier.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonDefaultValueApplier.md

## Umsetzungsauftrag

Erzeuge `JsonDefaultValueApplier.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Wendet definierte Default-Werte auf fehlende Properties an. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
