---
task_id: MSSQL_TASK_initial_0887
repository: SQL_Training
domain: MSSQL
title: "Script JsonArrayExplosionCostDemo.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 114
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0887"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonArrayExplosionCostDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonArrayExplosionCostDemo.md"
...
# MSSQL_TASK_initial_0887 - Script JsonArrayExplosionCostDemo.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Demonstriert Kosten tiefer Array-Explosionen.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonArrayExplosionCostDemo.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonArrayExplosionCostDemo.md

## Umsetzungsauftrag

Erzeuge `JsonArrayExplosionCostDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Kosten tiefer Array-Explosionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
