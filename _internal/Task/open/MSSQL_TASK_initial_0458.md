---
task_id: MSSQL_TASK_initial_0458
repository: SQL_Training
domain: MSSQL
title: "Script KeyLookupHotspotFinder.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 543
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0458"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotFinder.md"
...
# MSSQL_TASK_initial_0458 - Script KeyLookupHotspotFinder.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Hebt Plaene mit haeufigen Key Lookups und moeglichem Tuning-Bedarf hervor.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotFinder.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotFinder.md

## Umsetzungsauftrag

Erzeuge `KeyLookupHotspotFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Hebt Plaene mit haeufigen Key Lookups und moeglichem Tuning-Bedarf hervor. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
