---
task_id: MSSQL_TASK_initial_0464
repository: SQL_Training
domain: MSSQL
title: "Script PlanCacheParameterList.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 537
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0464"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/PlanCacheParameterList.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/PlanCacheParameterList.md"
...
# MSSQL_TASK_initial_0464 - Script PlanCacheParameterList.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Zeigt gecachte Plaene zusammen mit Parameterlisten und Kompilierungswerten.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/PlanCacheParameterList.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/PlanCacheParameterList.md

## Umsetzungsauftrag

Erzeuge `PlanCacheParameterList.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt gecachte Plaene zusammen mit Parameterlisten und Kompilierungswerten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
