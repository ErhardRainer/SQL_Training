---
task_id: MSSQL_TASK_initial_0683
repository: SQL_Training
domain: MSSQL
title: "Script LogShippingHealthCheck.sql fuer 67_HA_DR erstellen"
status: open
priority: 318
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0683"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/LogShippingHealthCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/LogShippingHealthCheck.md"
...
# MSSQL_TASK_initial_0683 - Script LogShippingHealthCheck.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Prueft Backup-, Copy- und Restore-Status fuer Log-Shipping-Konfigurationen.
...
- T-SQL/67_HA_DR/SQLScripts/LogShippingHealthCheck.sql
- T-SQL/67_HA_DR/SQLScripts/LogShippingHealthCheck.md

## Umsetzungsauftrag

Erzeuge `LogShippingHealthCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Backup-, Copy- und Restore-Status fuer Log-Shipping-Konfigurationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
