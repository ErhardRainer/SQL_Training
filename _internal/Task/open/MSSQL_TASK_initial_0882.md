---
task_id: MSSQL_TASK_initial_0882
repository: SQL_Training
domain: MSSQL
title: "Script SpatialCoordinateSwapDetector.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 119
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0882"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateSwapDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateSwapDetector.md"
...
# MSSQL_TASK_initial_0882 - Script SpatialCoordinateSwapDetector.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Erkennt vertauschte Laengen- und Breitengrade sowie unplausible Achsen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateSwapDetector.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialCoordinateSwapDetector.md

## Umsetzungsauftrag

Erzeuge `SpatialCoordinateSwapDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Erkennt vertauschte Laengen- und Breitengrade sowie unplausible Achsen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
