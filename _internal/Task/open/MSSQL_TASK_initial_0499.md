---
task_id: MSSQL_TASK_initial_0499
repository: SQL_Training
domain: MSSQL
title: "Script DateDimensionAttributeAudit.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 502
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0499"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateDimensionAttributeAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateDimensionAttributeAudit.md"
...
# MSSQL_TASK_initial_0499 - Script DateDimensionAttributeAudit.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Audit ueber Attribute einer Kalenderdimension.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/DateDimensionAttributeAudit.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/DateDimensionAttributeAudit.md

## Umsetzungsauftrag

Erzeuge `DateDimensionAttributeAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Attribute einer Kalenderdimension. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
