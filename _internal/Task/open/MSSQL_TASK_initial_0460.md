---
task_id: MSSQL_TASK_initial_0460
repository: SQL_Training
domain: MSSQL
title: "Script MissingJoinPredicatePlanScan.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 541
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0460"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/MissingJoinPredicatePlanScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/MissingJoinPredicatePlanScan.md"
...
# MSSQL_TASK_initial_0460 - Script MissingJoinPredicatePlanScan.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Sucht in Plaenen nach Hinweisen auf fehlende Join-Praedikate.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/MissingJoinPredicatePlanScan.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/MissingJoinPredicatePlanScan.md

## Umsetzungsauftrag

Erzeuge `MissingJoinPredicatePlanScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Sucht in Plaenen nach Hinweisen auf fehlende Join-Praedikate. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
