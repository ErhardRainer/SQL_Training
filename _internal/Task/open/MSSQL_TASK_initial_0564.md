---
task_id: MSSQL_TASK_initial_0564
repository: SQL_Training
domain: MSSQL
title: "Script TempTableCleanupGuard.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 437
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0564"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableCleanupGuard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableCleanupGuard.md"
...
# MSSQL_TASK_initial_0564 - Script TempTableCleanupGuard.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Guard fuer kontrolliertes Entfernen temporÃƒÂ¤rer Tabellen.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableCleanupGuard.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableCleanupGuard.md

## Umsetzungsauftrag

Erzeuge `TempTableCleanupGuard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Guard fuer kontrolliertes Entfernen temporÃƒÂ¤rer Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
