---
task_id: MSSQL_TASK_initial_0602
repository: SQL_Training
domain: MSSQL
title: "Script ColumnCollationInventory.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 399
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0602"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/ColumnCollationInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/ColumnCollationInventory.md"
...
# MSSQL_TASK_initial_0602 - Script ColumnCollationInventory.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Inventarisiert Kollationen auf Spaltenebene je Datenbank.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/ColumnCollationInventory.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/ColumnCollationInventory.md

## Umsetzungsauftrag

Erzeuge `ColumnCollationInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Kollationen auf Spaltenebene je Datenbank. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
