---
task_id: MSSQL_TASK_initial_0598
repository: SQL_Training
domain: MSSQL
title: "Script CollationIndexImpactDemo.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 403
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0598"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationIndexImpactDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationIndexImpactDemo.md"
...
# MSSQL_TASK_initial_0598 - Script CollationIndexImpactDemo.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Demonstriert den Einfluss von Kollationen auf Indexnutzung.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationIndexImpactDemo.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationIndexImpactDemo.md

## Umsetzungsauftrag

Erzeuge `CollationIndexImpactDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert den Einfluss von Kollationen auf Indexnutzung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
