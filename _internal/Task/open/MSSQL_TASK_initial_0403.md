---
task_id: MSSQL_TASK_initial_0403
repository: SQL_Training
domain: MSSQL
title: "Script ScalarFunctionComplexityScore.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 598
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0403"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionComplexityScore.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionComplexityScore.md"
...
# MSSQL_TASK_initial_0403 - Script ScalarFunctionComplexityScore.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Einfache Bewertungslogik fuer komplexe skalare Funktionen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionComplexityScore.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionComplexityScore.md

## Umsetzungsauftrag

Erzeuge `ScalarFunctionComplexityScore.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Einfache Bewertungslogik fuer komplexe skalare Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
