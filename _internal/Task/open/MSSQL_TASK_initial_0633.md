---
task_id: MSSQL_TASK_initial_0633
repository: SQL_Training
domain: MSSQL
title: "Script WaitStatsDeltaSample.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 368
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0633"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitStatsDeltaSample.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitStatsDeltaSample.md"
...
# MSSQL_TASK_initial_0633 - Script WaitStatsDeltaSample.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Sample fuer Wait-Stat-Deltas zwischen zwei Zeitpunkten.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitStatsDeltaSample.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/WaitStatsDeltaSample.md

## Umsetzungsauftrag

Erzeuge `WaitStatsDeltaSample.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Sample fuer Wait-Stat-Deltas zwischen zwei Zeitpunkten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
