---
task_id: MSSQL_TASK_initial_0880
repository: SQL_Training
domain: MSSQL
title: "Script PolygonSimplificationPreview.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 121
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0880"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonSimplificationPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonSimplificationPreview.md"
...
# MSSQL_TASK_initial_0880 - Script PolygonSimplificationPreview.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorschau moeglicher Vereinfachungen komplexer Polygone.
...
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonSimplificationPreview.sql
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonSimplificationPreview.md

## Umsetzungsauftrag

Erzeuge `PolygonSimplificationPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorschau moeglicher Vereinfachungen komplexer Polygone. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
