---
task_id: MSSQL_TASK_initial_0938
repository: SQL_Training
domain: MSSQL
title: "Script TestDataResetHarness.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 63
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0938"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestDataResetHarness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestDataResetHarness.md"
...
# MSSQL_TASK_initial_0938 - Script TestDataResetHarness.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Hilfsskript zum Ruecksetzen und Neuaufbau definierter Testdaten.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestDataResetHarness.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestDataResetHarness.md

## Umsetzungsauftrag

Erzeuge `TestDataResetHarness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Hilfsskript zum Ruecksetzen und Neuaufbau definierter Testdaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
