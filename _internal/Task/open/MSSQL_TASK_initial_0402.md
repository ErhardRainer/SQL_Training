---
task_id: MSSQL_TASK_initial_0402
repository: SQL_Training
domain: MSSQL
title: "Script MultiStatementTvfHotspots.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 599
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0402"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/MultiStatementTvfHotspots.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/MultiStatementTvfHotspots.md"
...
# MSSQL_TASK_initial_0402 - Script MultiStatementTvfHotspots.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Findet mehrstufige TVFs mit moeglichem Performance-Risiko.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/MultiStatementTvfHotspots.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/MultiStatementTvfHotspots.md

## Umsetzungsauftrag

Erzeuge `MultiStatementTvfHotspots.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Findet mehrstufige TVFs mit moeglichem Performance-Risiko. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
