---
task_id: MSSQL_TASK_initial_0730
repository: SQL_Training
domain: MSSQL
title: "Script QueueReaderLatencySample.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 271
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0730"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueReaderLatencySample.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueReaderLatencySample.md"
...
# MSSQL_TASK_initial_0730 - Script QueueReaderLatencySample.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Sample fuer Verzoegerungen zwischen Eingang und Verarbeitung von Nachrichten.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueReaderLatencySample.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueReaderLatencySample.md

## Umsetzungsauftrag

Erzeuge `QueueReaderLatencySample.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Sample fuer Verzoegerungen zwischen Eingang und Verarbeitung von Nachrichten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
