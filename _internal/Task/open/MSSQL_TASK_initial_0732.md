---
task_id: MSSQL_TASK_initial_0732
repository: SQL_Training
domain: MSSQL
title: "Script ServiceBrokerTransmissionErrors.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 269
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0732"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceBrokerTransmissionErrors.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceBrokerTransmissionErrors.md"
...
# MSSQL_TASK_initial_0732 - Script ServiceBrokerTransmissionErrors.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Zeigt Fehlerfaelle in der Transmission Queue.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceBrokerTransmissionErrors.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ServiceBrokerTransmissionErrors.md

## Umsetzungsauftrag

Erzeuge `ServiceBrokerTransmissionErrors.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Fehlerfaelle in der Transmission Queue. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
