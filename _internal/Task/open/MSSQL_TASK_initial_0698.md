---
task_id: MSSQL_TASK_initial_0698
repository: SQL_Training
domain: MSSQL
title: "Script CdcLatencyOverview.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 303
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0698"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLatencyOverview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLatencyOverview.md"
...
# MSSQL_TASK_initial_0698 - Script CdcLatencyOverview.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Zeigt CDC-Latenzen, letzte LSNs und moegliche Rueckstaende kompakt an.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLatencyOverview.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcLatencyOverview.md

## Umsetzungsauftrag

Erzeuge `CdcLatencyOverview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt CDC-Latenzen, letzte LSNs und moegliche Rueckstaende kompakt an. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
