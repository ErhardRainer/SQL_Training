---
task_id: MSSQL_TASK_initial_0885
repository: SQL_Training
domain: MSSQL
title: "Script SpatialIndexInventory.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 116
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0885"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialIndexInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialIndexInventory.md"
...
# MSSQL_TASK_initial_0885 - Script SpatialIndexInventory.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Inventarisiert Spatial-Indizes und ihre wichtigsten Einstellungen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialIndexInventory.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialIndexInventory.md

## Umsetzungsauftrag

Erzeuge `SpatialIndexInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Spatial-Indizes und ihre wichtigsten Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
