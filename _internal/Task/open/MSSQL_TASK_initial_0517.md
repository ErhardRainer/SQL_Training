---
task_id: MSSQL_TASK_initial_0517
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadBatchSizeTuner.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 484
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0517"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadBatchSizeTuner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadBatchSizeTuner.md"
...
# MSSQL_TASK_initial_0517 - Script BulkLoadBatchSizeTuner.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Tuning-Ansatz fuer sinnvolle Batchgroessen beim Laden.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadBatchSizeTuner.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadBatchSizeTuner.md

## Umsetzungsauftrag

Erzeuge `BulkLoadBatchSizeTuner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Tuning-Ansatz fuer sinnvolle Batchgroessen beim Laden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
