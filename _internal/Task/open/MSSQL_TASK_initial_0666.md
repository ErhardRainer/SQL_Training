---
task_id: MSSQL_TASK_initial_0666
repository: SQL_Training
domain: MSSQL
title: "Script PermissionDiffBetweenDatabases.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 335
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0666"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionDiffBetweenDatabases.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionDiffBetweenDatabases.md"
...
# MSSQL_TASK_initial_0666 - Script PermissionDiffBetweenDatabases.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Vergleicht Rechtebilder zwischen zwei Datenbanken.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionDiffBetweenDatabases.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionDiffBetweenDatabases.md

## Umsetzungsauftrag

Erzeuge `PermissionDiffBetweenDatabases.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Rechtebilder zwischen zwei Datenbanken. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
