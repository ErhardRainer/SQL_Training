---
task_id: MSSQL_TASK_initial_0711
repository: SQL_Training
domain: MSSQL
title: "Script TemporalRetentionCleanupPreview.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 290
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0711"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionCleanupPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionCleanupPreview.md"
...
# MSSQL_TASK_initial_0711 - Script TemporalRetentionCleanupPreview.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Zeigt, welche History-Daten bei einer bereinigenden Aufbewahrungsstrategie betroffen waeren.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionCleanupPreview.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalRetentionCleanupPreview.md

## Umsetzungsauftrag

Erzeuge `TemporalRetentionCleanupPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, welche History-Daten bei einer bereinigenden Aufbewahrungsstrategie betroffen waeren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
