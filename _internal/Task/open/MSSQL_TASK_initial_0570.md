---
task_id: MSSQL_TASK_initial_0570
repository: SQL_Training
domain: MSSQL
title: "Script PolicyDisableEnablePlaybook.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 431
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0570"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/PolicyDisableEnablePlaybook.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/PolicyDisableEnablePlaybook.md"
...
# MSSQL_TASK_initial_0570 - Script PolicyDisableEnablePlaybook.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Playbook zum sicheren Deaktivieren und Aktivieren von Policies.
...
- T-SQL/62_Row_Level_Security/SQLScripts/PolicyDisableEnablePlaybook.sql
- T-SQL/62_Row_Level_Security/SQLScripts/PolicyDisableEnablePlaybook.md

## Umsetzungsauftrag

Erzeuge `PolicyDisableEnablePlaybook.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Playbook zum sicheren Deaktivieren und Aktivieren von Policies. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
