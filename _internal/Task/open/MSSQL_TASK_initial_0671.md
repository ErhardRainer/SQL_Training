---
task_id: MSSQL_TASK_initial_0671
repository: SQL_Training
domain: MSSQL
title: "Script SchemaOwnerPrivilegeReview.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 330
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0671"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaOwnerPrivilegeReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaOwnerPrivilegeReview.md"
...
# MSSQL_TASK_initial_0671 - Script SchemaOwnerPrivilegeReview.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Review ueber Privilegien von Schema-Ownern.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaOwnerPrivilegeReview.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/SchemaOwnerPrivilegeReview.md

## Umsetzungsauftrag

Erzeuge `SchemaOwnerPrivilegeReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Privilegien von Schema-Ownern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
