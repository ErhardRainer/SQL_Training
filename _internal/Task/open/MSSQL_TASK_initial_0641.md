---
task_id: MSSQL_TASK_initial_0641
repository: SQL_Training
domain: MSSQL
title: "Script PartitionEliminationProof.sql fuer 65_Partitioning erstellen"
status: open
priority: 360
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0641"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionEliminationProof.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionEliminationProof.md"
...
# MSSQL_TASK_initial_0641 - Script PartitionEliminationProof.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Belegt per Beispiel, ob Partition Elimination greift.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionEliminationProof.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionEliminationProof.md

## Umsetzungsauftrag

Erzeuge `PartitionEliminationProof.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Belegt per Beispiel, ob Partition Elimination greift. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
