---
task_id: MSSQL_TASK_initial_0511
repository: SQL_Training
domain: MSSQL
title: "Script BcpCommandBuilder.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 490
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0511"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpCommandBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpCommandBuilder.md"
...
# MSSQL_TASK_initial_0511 - Script BcpCommandBuilder.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Erzeugt Beispiel-Kommandos fuer `bcp` aus Tabellennamen und Zielpfaden.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpCommandBuilder.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpCommandBuilder.md

## Umsetzungsauftrag

Erzeuge `BcpCommandBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Erzeugt Beispiel-Kommandos fuer `bcp` aus Tabellennamen und Zielpfaden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
