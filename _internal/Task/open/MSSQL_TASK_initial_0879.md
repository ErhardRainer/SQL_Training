---
task_id: MSSQL_TASK_initial_0879
repository: SQL_Training
domain: MSSQL
title: "Script PolygonContainsPointTemplate.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 122
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0879"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonContainsPointTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonContainsPointTemplate.md"
...
# MSSQL_TASK_initial_0879 - Script PolygonContainsPointTemplate.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorlage fuer Punkt-in-Polygon-Abfragen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonContainsPointTemplate.sql
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonContainsPointTemplate.md

## Umsetzungsauftrag

Erzeuge `PolygonContainsPointTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Punkt-in-Polygon-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
