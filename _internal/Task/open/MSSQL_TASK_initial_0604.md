---
task_id: MSSQL_TASK_initial_0604
repository: SQL_Training
domain: MSSQL
title: "Script CrossDatabaseCollationJoinFix.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 397
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0604"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CrossDatabaseCollationJoinFix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CrossDatabaseCollationJoinFix.md"
...
# MSSQL_TASK_initial_0604 - Script CrossDatabaseCollationJoinFix.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Zeigt robuste Loesungen fuer Join-Konflikte zwischen unterschiedlichen Kollationen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CrossDatabaseCollationJoinFix.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CrossDatabaseCollationJoinFix.md

## Umsetzungsauftrag

Erzeuge `CrossDatabaseCollationJoinFix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt robuste Loesungen fuer Join-Konflikte zwischen unterschiedlichen Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
