---
task_id: MSSQL_TASK_initial_0544
repository: SQL_Training
domain: MSSQL
title: "Script ReadPhenomenaDemoHarness.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 457
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0544"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/ReadPhenomenaDemoHarness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/ReadPhenomenaDemoHarness.md"
...
# MSSQL_TASK_initial_0544 - Script ReadPhenomenaDemoHarness.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Zeigt Dirty Reads, Non-Repeatable Reads und Phantoms in einer Demo-Strecke.
...
- T-SQL/60_IsolationLevels/SQLScripts/ReadPhenomenaDemoHarness.sql
- T-SQL/60_IsolationLevels/SQLScripts/ReadPhenomenaDemoHarness.md

## Umsetzungsauftrag

Erzeuge `ReadPhenomenaDemoHarness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Dirty Reads, Non-Repeatable Reads und Phantoms in einer Demo-Strecke. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
