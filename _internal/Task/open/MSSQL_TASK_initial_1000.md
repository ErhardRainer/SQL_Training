---
task_id: MSSQL_TASK_initial_1000
repository: SQL_Training
domain: MSSQL
title: "Script WaitStatsForActiveRequests.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 1
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-1000"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/WaitStatsForActiveRequests.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/WaitStatsForActiveRequests.md"
...
# MSSQL_TASK_initial_1000 - Script WaitStatsForActiveRequests.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Korreliert aktive Requests mit ihren aktuellen und letzten Wait-Typen.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/WaitStatsForActiveRequests.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/WaitStatsForActiveRequests.md

## Umsetzungsauftrag

Erzeuge `WaitStatsForActiveRequests.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Korreliert aktive Requests mit ihren aktuellen und letzten Wait-Typen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
