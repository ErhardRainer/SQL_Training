---
task_id: MSSQL_TASK_initial_0738
repository: SQL_Training
domain: MSSQL
title: "Script ExternalFormatUsageMap.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 263
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0738"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFormatUsageMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFormatUsageMap.md"
...
# MSSQL_TASK_initial_0738 - Script ExternalFormatUsageMap.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Inventarisiert externe File Formats und ihre Nutzung durch Tabellen oder Datenquellen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFormatUsageMap.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFormatUsageMap.md

## Umsetzungsauftrag

Erzeuge `ExternalFormatUsageMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert externe File Formats und ihre Nutzung durch Tabellen oder Datenquellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
