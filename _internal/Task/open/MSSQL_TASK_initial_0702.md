---
task_id: MSSQL_TASK_initial_0702
repository: SQL_Training
domain: MSSQL
title: "Script ChangeTrackingRetentionAudit.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 299
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0702"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingRetentionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingRetentionAudit.md"
...
# MSSQL_TASK_initial_0702 - Script ChangeTrackingRetentionAudit.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Audit ueber Retention-Einstellungen im Change Tracking.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingRetentionAudit.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingRetentionAudit.md

## Umsetzungsauftrag

Erzeuge `ChangeTrackingRetentionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Retention-Einstellungen im Change Tracking. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
