---
task_id: MSSQL_TASK_initial_0448
repository: SQL_Training
domain: MSSQL
title: "Script MissingIncludeSuggestion.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 553
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0448"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/MissingIncludeSuggestion.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/MissingIncludeSuggestion.md"
...
# MSSQL_TASK_initial_0448 - Script MissingIncludeSuggestion.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Leitet moegliche `INCLUDE`-Erweiterungen aus Abfrage- und Lookup-Mustern ab.
...
- T-SQL/26_Indexes_Basics/SQLScripts/MissingIncludeSuggestion.sql
- T-SQL/26_Indexes_Basics/SQLScripts/MissingIncludeSuggestion.md

## Umsetzungsauftrag

Erzeuge `MissingIncludeSuggestion.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Leitet moegliche `INCLUDE`-Erweiterungen aus Abfrage- und Lookup-Mustern ab. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
