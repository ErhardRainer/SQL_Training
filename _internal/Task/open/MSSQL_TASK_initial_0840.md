---
task_id: MSSQL_TASK_initial_0840
repository: SQL_Training
domain: MSSQL
title: "Script VersionStoreRetentionBudget.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 161
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0840"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreRetentionBudget.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreRetentionBudget.md"
...
# MSSQL_TASK_initial_0840 - Script VersionStoreRetentionBudget.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Budgetiert den erwarteten Version-Store-Bedarf.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreRetentionBudget.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreRetentionBudget.md

## Umsetzungsauftrag

Erzeuge `VersionStoreRetentionBudget.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Budgetiert den erwarteten Version-Store-Bedarf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
