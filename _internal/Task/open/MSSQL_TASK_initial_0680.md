---
task_id: MSSQL_TASK_initial_0680
repository: SQL_Training
domain: MSSQL
title: "Script HaDrDatabaseParticipation.sql fuer 67_HA_DR erstellen"
status: open
priority: 321
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0680"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/HaDrDatabaseParticipation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/HaDrDatabaseParticipation.md"
...
# MSSQL_TASK_initial_0680 - Script HaDrDatabaseParticipation.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Zeigt, welche Datenbanken an welchen HA/DR-Setups teilnehmen.
...
- T-SQL/67_HA_DR/SQLScripts/HaDrDatabaseParticipation.sql
- T-SQL/67_HA_DR/SQLScripts/HaDrDatabaseParticipation.md

## Umsetzungsauftrag

Erzeuge `HaDrDatabaseParticipation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, welche Datenbanken an welchen HA/DR-Setups teilnehmen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
