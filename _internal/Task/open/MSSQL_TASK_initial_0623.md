---
task_id: MSSQL_TASK_initial_0623
repository: SQL_Training
domain: MSSQL
title: "Script PlanCacheBloatOverview.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 378
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0623"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanCacheBloatOverview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanCacheBloatOverview.md"
...
# MSSQL_TASK_initial_0623 - Script PlanCacheBloatOverview.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Zeigt Hinweise auf Plan-Cache-Bloat und viele Einmalplaene.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanCacheBloatOverview.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/PlanCacheBloatOverview.md

## Umsetzungsauftrag

Erzeuge `PlanCacheBloatOverview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Hinweise auf Plan-Cache-Bloat und viele Einmalplaene. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
