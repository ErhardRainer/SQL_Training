---
task_id: MSSQL_TASK_initial_0767
repository: SQL_Training
domain: MSSQL
title: "Script FullBackupAgeByDatabase.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 234
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0767"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/FullBackupAgeByDatabase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/FullBackupAgeByDatabase.md"
...
# MSSQL_TASK_initial_0767 - Script FullBackupAgeByDatabase.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Zeigt das Alter des letzten Full Backups je Datenbank.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/FullBackupAgeByDatabase.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/FullBackupAgeByDatabase.md

## Umsetzungsauftrag

Erzeuge `FullBackupAgeByDatabase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt das Alter des letzten Full Backups je Datenbank. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
