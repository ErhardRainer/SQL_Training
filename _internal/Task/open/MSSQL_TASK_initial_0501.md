---
task_id: MSSQL_TASK_initial_0501
repository: SQL_Training
domain: MSSQL
title: "Script DateSeriesGenerator.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 500
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0501"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateSeriesGenerator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateSeriesGenerator.md"
...
# MSSQL_TASK_initial_0501 - Script DateSeriesGenerator.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Generiert Datumsreihen fuer Lueckenanalysen und Reporting-Szenarien.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/DateSeriesGenerator.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/DateSeriesGenerator.md

## Umsetzungsauftrag

Erzeuge `DateSeriesGenerator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Generiert Datumsreihen fuer Lueckenanalysen und Reporting-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
