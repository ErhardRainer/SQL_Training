---
task_id: MSSQL_TASK_initial_0894
repository: SQL_Training
domain: MSSQL
title: "Script JsonIngestionErrorBucket.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 107
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0894"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonIngestionErrorBucket.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonIngestionErrorBucket.md"
...
# MSSQL_TASK_initial_0894 - Script JsonIngestionErrorBucket.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Gruppiert JSON-Ingestion-Fehler nach Typ, Feld und betroffener Quelle.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonIngestionErrorBucket.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonIngestionErrorBucket.md

## Umsetzungsauftrag

Erzeuge `JsonIngestionErrorBucket.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Gruppiert JSON-Ingestion-Fehler nach Typ, Feld und betroffener Quelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
