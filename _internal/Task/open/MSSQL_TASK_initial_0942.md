---
task_id: MSSQL_TASK_initial_0942
repository: SQL_Training
domain: MSSQL
title: "Script TestResultExportTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 59
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0942"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestResultExportTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestResultExportTemplate.md"
...
# MSSQL_TASK_initial_0942 - Script TestResultExportTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer den Export von Testergebnissen.
