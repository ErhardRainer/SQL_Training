---
task_id: MSSQL_TASK_initial_0704
repository: SQL_Training
domain: MSSQL
title: "Script HistoryTableSizeDrift.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 297
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0704"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/HistoryTableSizeDrift.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/HistoryTableSizeDrift.md"
...
# MSSQL_TASK_initial_0704 - Script HistoryTableSizeDrift.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Beobachtet Groessendrift zwischen Basis- und History-Tabellen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/HistoryTableSizeDrift.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/HistoryTableSizeDrift.md

## Umsetzungsauftrag

Erzeuge `HistoryTableSizeDrift.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet Groessendrift zwischen Basis- und History-Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
