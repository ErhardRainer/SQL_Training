---
task_id: MSSQL_TASK_initial_0558
repository: SQL_Training
domain: MSSQL
title: "Script RecursiveCteCycleGuard.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 443
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0558"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteCycleGuard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteCycleGuard.md"
...
# MSSQL_TASK_initial_0558 - Script RecursiveCteCycleGuard.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Einstiegsmuster fuer rekursive CTEs mit Zyklus-Schutz.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteCycleGuard.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteCycleGuard.md

## Umsetzungsauftrag

Erzeuge `RecursiveCteCycleGuard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Einstiegsmuster fuer rekursive CTEs mit Zyklus-Schutz. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
