---
task_id: MSSQL_TASK_initial_0647
repository: SQL_Training
domain: MSSQL
title: "Script PartitionSplitMergeChecklist.sql fuer 65_Partitioning erstellen"
status: open
priority: 354
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0647"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSplitMergeChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionSplitMergeChecklist.md"
...
# MSSQL_TASK_initial_0647 - Script PartitionSplitMergeChecklist.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Checkliste fuer SPLIT- und MERGE-Operationen.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionSplitMergeChecklist.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionSplitMergeChecklist.md

## Umsetzungsauftrag

Erzeuge `PartitionSplitMergeChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer SPLIT- und MERGE-Operationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
