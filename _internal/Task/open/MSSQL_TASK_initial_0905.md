---
task_id: MSSQL_TASK_initial_0905
repository: SQL_Training
domain: MSSQL
title: "Script SchemaDriftAlertTemplate.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 96
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0905"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaDriftAlertTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaDriftAlertTemplate.md"
...
# MSSQL_TASK_initial_0905 - Script SchemaDriftAlertTemplate.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Vorlage fuer Alarmierung bei unerwarteter JSON-Schema-Drift.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaDriftAlertTemplate.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/SchemaDriftAlertTemplate.md

## Umsetzungsauftrag

Erzeuge `SchemaDriftAlertTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Alarmierung bei unerwarteter JSON-Schema-Drift. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
