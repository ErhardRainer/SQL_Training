---
task_id: MSSQL_TASK_initial_0401
repository: SQL_Training
domain: MSSQL
title: "Script InlineTvfCandidateFinder.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 600
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0401"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/InlineTvfCandidateFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/InlineTvfCandidateFinder.md"
...
# MSSQL_TASK_initial_0401 - Script InlineTvfCandidateFinder.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Markiert skalare oder mehrstufige Funktionen, die Kandidaten fuer iTVFs sein koennten.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/InlineTvfCandidateFinder.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/InlineTvfCandidateFinder.md

## Umsetzungsauftrag

Erzeuge `InlineTvfCandidateFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Markiert skalare oder mehrstufige Funktionen, die Kandidaten fuer iTVFs sein koennten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
