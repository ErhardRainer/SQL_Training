---
task_id: MSSQL_TASK_initial_0878
repository: SQL_Training
domain: MSSQL
title: "Script PolygonAreaComparison.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 123
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0878"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonAreaComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PolygonAreaComparison.md"
...
# MSSQL_TASK_initial_0878 - Script PolygonAreaComparison.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vergleicht Flaechenwerte mehrerer Polygonvarianten.
...
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonAreaComparison.sql
- T-SQL/76_Spatial_Geography/SQLScripts/PolygonAreaComparison.md

## Umsetzungsauftrag

Erzeuge `PolygonAreaComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Flaechenwerte mehrerer Polygonvarianten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
