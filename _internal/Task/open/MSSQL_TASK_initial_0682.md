---
task_id: MSSQL_TASK_initial_0682
repository: SQL_Training
domain: MSSQL
title: "Script LogShippingCopyLatency.sql fuer 67_HA_DR erstellen"
status: open
priority: 319
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0682"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/LogShippingCopyLatency.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/LogShippingCopyLatency.md"
...
# MSSQL_TASK_initial_0682 - Script LogShippingCopyLatency.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Zeigt Latenzen der Copy-Phase im Log Shipping.
...
- T-SQL/67_HA_DR/SQLScripts/LogShippingCopyLatency.sql
- T-SQL/67_HA_DR/SQLScripts/LogShippingCopyLatency.md

## Umsetzungsauftrag

Erzeuge `LogShippingCopyLatency.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Latenzen der Copy-Phase im Log Shipping. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
