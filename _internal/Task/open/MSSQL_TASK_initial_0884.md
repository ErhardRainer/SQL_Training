---
task_id: MSSQL_TASK_initial_0884
repository: SQL_Training
domain: MSSQL
title: "Script SpatialDistanceJoinTemplate.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 117
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0884"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialDistanceJoinTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialDistanceJoinTemplate.md"
...
# MSSQL_TASK_initial_0884 - Script SpatialDistanceJoinTemplate.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorlage fuer Distance-Joins zwischen Punktmengen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialDistanceJoinTemplate.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialDistanceJoinTemplate.md

## Umsetzungsauftrag

Erzeuge `SpatialDistanceJoinTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Distance-Joins zwischen Punktmengen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
