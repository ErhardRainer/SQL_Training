---
task_id: MSSQL_TASK_initial_0496
repository: SQL_Training
domain: MSSQL
title: "Script CalendarTableGenerator.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 505
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0496"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/CalendarTableGenerator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/CalendarTableGenerator.md"
...
# MSSQL_TASK_initial_0496 - Script CalendarTableGenerator.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Erzeugt eine Kalenderdimension mit Feiertags-, Monats- und Wochenmerkmalen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/CalendarTableGenerator.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/CalendarTableGenerator.md

## Umsetzungsauftrag

Erzeuge `CalendarTableGenerator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Erzeugt eine Kalenderdimension mit Feiertags-, Monats- und Wochenmerkmalen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
