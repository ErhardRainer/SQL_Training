---
task_id: MSSQL_TASK_initial_0612
repository: SQL_Training
domain: MSSQL
title: "Script HighCpuStatementRadar.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 389
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0612"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/HighCpuStatementRadar.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/HighCpuStatementRadar.md"
...
# MSSQL_TASK_initial_0612 - Script HighCpuStatementRadar.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Radar fuer aktuell CPU-intensive Statements.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/HighCpuStatementRadar.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/HighCpuStatementRadar.md

## Umsetzungsauftrag

Erzeuge `HighCpuStatementRadar.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Radar fuer aktuell CPU-intensive Statements. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
