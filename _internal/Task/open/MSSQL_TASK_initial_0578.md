---
task_id: MSSQL_TASK_initial_0578
repository: SQL_Training
domain: MSSQL
title: "Script RlsPredicatePerformanceCheck.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 423
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0578"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicatePerformanceCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicatePerformanceCheck.md"
...
# MSSQL_TASK_initial_0578 - Script RlsPredicatePerformanceCheck.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Bewertet die Performance-Auswirkung von Security-Predicate-Funktionen.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicatePerformanceCheck.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsPredicatePerformanceCheck.md

## Umsetzungsauftrag

Erzeuge `RlsPredicatePerformanceCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Bewertet die Performance-Auswirkung von Security-Predicate-Funktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
