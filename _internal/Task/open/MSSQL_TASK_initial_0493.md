---
task_id: MSSQL_TASK_initial_0493
repository: SQL_Training
domain: MSSQL
title: "Script BusinessDayOffsetCalendar.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 508
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0493"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayOffsetCalendar.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayOffsetCalendar.md"
...
# MSSQL_TASK_initial_0493 - Script BusinessDayOffsetCalendar.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Berechnet Arbeitstag-Verschiebungen mit Kalender- und Feiertagstabelle.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayOffsetCalendar.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessDayOffsetCalendar.md

## Umsetzungsauftrag

Erzeuge `BusinessDayOffsetCalendar.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Berechnet Arbeitstag-Verschiebungen mit Kalender- und Feiertagstabelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
