---
task_id: MSSQL_TASK_initial_0794
repository: SQL_Training
domain: MSSQL
title: "Script LongRunningJobsNow.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 207
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0794"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/LongRunningJobsNow.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/LongRunningJobsNow.md"
...
# MSSQL_TASK_initial_0794 - Script LongRunningJobsNow.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Zeigt aktuell lange laufende Jobs inklusive Schritt und Startzeit.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/LongRunningJobsNow.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/LongRunningJobsNow.md

## Umsetzungsauftrag

Erzeuge `LongRunningJobsNow.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt aktuell lange laufende Jobs inklusive Schritt und Startzeit. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
