---
task_id: MSSQL_TASK_initial_0562
repository: SQL_Training
domain: MSSQL
title: "Script SubqueryToApplyRefactorDemo.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 439
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0562"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryToApplyRefactorDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryToApplyRefactorDemo.md"
...
# MSSQL_TASK_initial_0562 - Script SubqueryToApplyRefactorDemo.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Refactoring-Beispiel von Unterabfrage zu APPLY.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryToApplyRefactorDemo.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryToApplyRefactorDemo.md

## Umsetzungsauftrag

Erzeuge `SubqueryToApplyRefactorDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Refactoring-Beispiel von Unterabfrage zu APPLY. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
