---
task_id: MSSQL_TASK_initial_0697
repository: SQL_Training
domain: MSSQL
title: "Script CdcJobHeartbeatCheck.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 304
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0697"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcJobHeartbeatCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcJobHeartbeatCheck.md"
...
# MSSQL_TASK_initial_0697 - Script CdcJobHeartbeatCheck.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Checkt, ob CDC-Jobs noch regelmaessig Heartbeats liefern.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcJobHeartbeatCheck.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/CdcJobHeartbeatCheck.md

## Umsetzungsauftrag

Erzeuge `CdcJobHeartbeatCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Checkt, ob CDC-Jobs noch regelmaessig Heartbeats liefern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
