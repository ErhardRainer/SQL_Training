---
task_id: MSSQL_TASK_initial_0520
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadErrorReplayer.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 481
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0520"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorReplayer.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorReplayer.md"
...
# MSSQL_TASK_initial_0520 - Script BulkLoadErrorReplayer.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Replay-Hilfe fuer problematische Datensaetze aus Fehlerdateien.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorReplayer.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorReplayer.md

## Umsetzungsauftrag

Erzeuge `BulkLoadErrorReplayer.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Replay-Hilfe fuer problematische Datensaetze aus Fehlerdateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
