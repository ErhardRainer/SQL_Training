---
task_id: MSSQL_TASK_initial_0483
repository: SQL_Training
domain: MSSQL
title: "Script OpenJsonSchemaProjection.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 518
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0483"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonSchemaProjection.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonSchemaProjection.md"
...
# MSSQL_TASK_initial_0483 - Script OpenJsonSchemaProjection.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Zeigt saubere Projektion von JSON-Feldern mit explizitem Schema.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonSchemaProjection.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/OpenJsonSchemaProjection.md

## Umsetzungsauftrag

Erzeuge `OpenJsonSchemaProjection.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt saubere Projektion von JSON-Feldern mit explizitem Schema. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
