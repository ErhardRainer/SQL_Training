---
task_id: MSSQL_TASK_initial_0900
repository: SQL_Training
domain: MSSQL
title: "Script JsonReplayQueueBuilder.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 101
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0900"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonReplayQueueBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonReplayQueueBuilder.md"
...
# MSSQL_TASK_initial_0900 - Script JsonReplayQueueBuilder.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Baut eine Replay-Queue fuer problematische JSON-Dokumente auf.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonReplayQueueBuilder.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonReplayQueueBuilder.md

## Umsetzungsauftrag

Erzeuge `JsonReplayQueueBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Baut eine Replay-Queue fuer problematische JSON-Dokumente auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
