---
task_id: MSSQL_TASK_initial_0748
repository: SQL_Training
domain: MSSQL
title: "Script FileFormatCompatibilityMatrix.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 253
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0748"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/FileFormatCompatibilityMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/FileFormatCompatibilityMatrix.md"
...
# MSSQL_TASK_initial_0748 - Script FileFormatCompatibilityMatrix.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Matrix ueber Dateiformate und deren Eignung.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/FileFormatCompatibilityMatrix.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/FileFormatCompatibilityMatrix.md

## Umsetzungsauftrag

Erzeuge `FileFormatCompatibilityMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber Dateiformate und deren Eignung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
