---
task_id: MSSQL_TASK_initial_0657
repository: SQL_Training
domain: MSSQL
title: "Script ElevatedPermissionHotspots.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 344
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0657"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedPermissionHotspots.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedPermissionHotspots.md"
...
# MSSQL_TASK_initial_0657 - Script ElevatedPermissionHotspots.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Markiert Benutzer oder Rollen mit besonders weitreichenden Rechten.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedPermissionHotspots.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedPermissionHotspots.md

## Umsetzungsauftrag

Erzeuge `ElevatedPermissionHotspots.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Benutzer oder Rollen mit besonders weitreichenden Rechten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
