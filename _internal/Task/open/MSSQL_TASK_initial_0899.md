---
task_id: MSSQL_TASK_initial_0899
repository: SQL_Training
domain: MSSQL
title: "Script JsonPropertyNullRateProfile.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 102
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0899"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonPropertyNullRateProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonPropertyNullRateProfile.md"
...
# MSSQL_TASK_initial_0899 - Script JsonPropertyNullRateProfile.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Profiling ueber `NULL`-Raten einzelner JSON-Properties.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonPropertyNullRateProfile.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonPropertyNullRateProfile.md

## Umsetzungsauftrag

Erzeuge `JsonPropertyNullRateProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Profiling ueber `NULL`-Raten einzelner JSON-Properties. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
