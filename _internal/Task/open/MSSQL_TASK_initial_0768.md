---
task_id: MSSQL_TASK_initial_0768
repository: SQL_Training
domain: MSSQL
title: "Script LastSuccessfulLogBackupPerDb.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 233
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0768"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/LastSuccessfulLogBackupPerDb.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/LastSuccessfulLogBackupPerDb.md"
...
# MSSQL_TASK_initial_0768 - Script LastSuccessfulLogBackupPerDb.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Zeigt je Datenbank den letzten erfolgreichen Log-Backup-Zeitpunkt.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/LastSuccessfulLogBackupPerDb.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/LastSuccessfulLogBackupPerDb.md

## Umsetzungsauftrag

Erzeuge `LastSuccessfulLogBackupPerDb.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt je Datenbank den letzten erfolgreichen Log-Backup-Zeitpunkt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
