---
task_id: MSSQL_TASK_initial_0552
repository: SQL_Training
domain: MSSQL
title: "Script ApplyVsCorrelatedSubquery.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 449
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0552"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsCorrelatedSubquery.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsCorrelatedSubquery.md"
...
# MSSQL_TASK_initial_0552 - Script ApplyVsCorrelatedSubquery.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Vergleicht korrelierte Subqueries mit `APPLY` hinsichtlich Lesbarkeit und Planform.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsCorrelatedSubquery.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyVsCorrelatedSubquery.md

## Umsetzungsauftrag

Erzeuge `ApplyVsCorrelatedSubquery.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht korrelierte Subqueries mit `APPLY` hinsichtlich Lesbarkeit und Planform. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
