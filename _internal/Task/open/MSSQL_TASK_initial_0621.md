---
task_id: MSSQL_TASK_initial_0621
repository: SQL_Training
domain: MSSQL
title: "Script ParameterSniffingPlanHistory.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 380
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0621"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingPlanHistory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingPlanHistory.md"
...
# MSSQL_TASK_initial_0621 - Script ParameterSniffingPlanHistory.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Historisiert verschiedene Planformen fuer dieselbe parameterisierte Abfrage.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingPlanHistory.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSniffingPlanHistory.md

## Umsetzungsauftrag

Erzeuge `ParameterSniffingPlanHistory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Historisiert verschiedene Planformen fuer dieselbe parameterisierte Abfrage. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
