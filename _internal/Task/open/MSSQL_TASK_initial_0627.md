---
task_id: MSSQL_TASK_initial_0627
repository: SQL_Training
domain: MSSQL
title: "Script QueryStoreRuntimeVariance.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 374
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0627"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreRuntimeVariance.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreRuntimeVariance.md"
...
# MSSQL_TASK_initial_0627 - Script QueryStoreRuntimeVariance.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Zeigt Laufzeitvarianzen derselben Abfrage im Query Store.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreRuntimeVariance.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreRuntimeVariance.md

## Umsetzungsauftrag

Erzeuge `QueryStoreRuntimeVariance.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Laufzeitvarianzen derselben Abfrage im Query Store. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
