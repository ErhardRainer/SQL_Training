---
task_id: MSSQL_TASK_initial_0962
repository: SQL_Training
domain: MSSQL
title: "Script UnsupportedFeatureScanner.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 39
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0962"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/UnsupportedFeatureScanner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/UnsupportedFeatureScanner.md"
...
# MSSQL_TASK_initial_0962 - Script UnsupportedFeatureScanner.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Scannt eine DB nach Features, die in Azure SQL Database oder MI problematisch sind.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/UnsupportedFeatureScanner.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/UnsupportedFeatureScanner.md

## Umsetzungsauftrag

Erzeuge `UnsupportedFeatureScanner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Scannt eine DB nach Features, die in Azure SQL Database oder MI problematisch sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
