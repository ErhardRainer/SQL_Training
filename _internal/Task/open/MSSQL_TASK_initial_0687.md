---
task_id: MSSQL_TASK_initial_0687
repository: SQL_Training
domain: MSSQL
title: "Script ReplicaEndpointAudit.sql fuer 67_HA_DR erstellen"
status: open
priority: 314
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0687"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaEndpointAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaEndpointAudit.md"
...
# MSSQL_TASK_initial_0687 - Script ReplicaEndpointAudit.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Audit ueber Endpunkte in HA/DR-Szenarien.
...
- T-SQL/67_HA_DR/SQLScripts/ReplicaEndpointAudit.sql
- T-SQL/67_HA_DR/SQLScripts/ReplicaEndpointAudit.md

## Umsetzungsauftrag

Erzeuge `ReplicaEndpointAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Endpunkte in HA/DR-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
