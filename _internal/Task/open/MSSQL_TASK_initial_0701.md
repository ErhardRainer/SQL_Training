---
task_id: MSSQL_TASK_initial_0701
repository: SQL_Training
domain: MSSQL
title: "Script ChangeTrackingMetadataSnapshot.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 300
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0701"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingMetadataSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingMetadataSnapshot.md"
...
# MSSQL_TASK_initial_0701 - Script ChangeTrackingMetadataSnapshot.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Schnappschuss wichtiger Metadaten rund um Change Tracking.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingMetadataSnapshot.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingMetadataSnapshot.md

## Umsetzungsauftrag

Erzeuge `ChangeTrackingMetadataSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss wichtiger Metadaten rund um Change Tracking. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
