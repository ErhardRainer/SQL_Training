---
task_id: MSSQL_TASK_initial_0936
repository: SQL_Training
domain: MSSQL
title: "Script TestClassDependencyMap.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 65
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0936"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestClassDependencyMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestClassDependencyMap.md"
...
# MSSQL_TASK_initial_0936 - Script TestClassDependencyMap.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Zeigt Abhaengigkeiten zwischen Testklassen und getesteten Objekten.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestClassDependencyMap.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestClassDependencyMap.md

## Umsetzungsauftrag

Erzeuge `TestClassDependencyMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Abhaengigkeiten zwischen Testklassen und getesteten Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
