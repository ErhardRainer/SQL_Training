---
task_id: MSSQL_TASK_initial_0631
repository: SQL_Training
domain: MSSQL
title: "Script TopWaitingQueriesNow.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 370
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0631"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TopWaitingQueriesNow.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TopWaitingQueriesNow.md"
...
# MSSQL_TASK_initial_0631 - Script TopWaitingQueriesNow.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Listet aktuell am staerksten wartende Abfragen.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TopWaitingQueriesNow.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/TopWaitingQueriesNow.md

## Umsetzungsauftrag

Erzeuge `TopWaitingQueriesNow.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Listet aktuell am staerksten wartende Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
