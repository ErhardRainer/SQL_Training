---
task_id: MSSQL_TASK_initial_0996
repository: SQL_Training
domain: MSSQL
title: "Script SessionWaitChainMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 5
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0996"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionWaitChainMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionWaitChainMatrix.md"
...
# MSSQL_TASK_initial_0996 - Script SessionWaitChainMatrix.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Matrix ueber Sessions, Wait-Typen und Blockierungsketten.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionWaitChainMatrix.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionWaitChainMatrix.md

## Umsetzungsauftrag

Erzeuge `SessionWaitChainMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber Sessions, Wait-Typen und Blockierungsketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
