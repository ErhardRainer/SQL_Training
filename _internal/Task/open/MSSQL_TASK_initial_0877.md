---
task_id: MSSQL_TASK_initial_0877
repository: SQL_Training
domain: MSSQL
title: "Script PointClusteringPreview.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 124
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0877"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PointClusteringPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/PointClusteringPreview.md"
...
# MSSQL_TASK_initial_0877 - Script PointClusteringPreview.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Preview moeglicher Punktcluster in raeumlichen Daten.
...
- T-SQL/76_Spatial_Geography/SQLScripts/PointClusteringPreview.sql
- T-SQL/76_Spatial_Geography/SQLScripts/PointClusteringPreview.md

## Umsetzungsauftrag

Erzeuge `PointClusteringPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Preview moeglicher Punktcluster in raeumlichen Daten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
