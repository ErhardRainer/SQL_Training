---
task_id: MSSQL_TASK_initial_0955
repository: SQL_Training
domain: MSSQL
title: "Script ElasticPoolSizingReview.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 46
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0955"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticPoolSizingReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticPoolSizingReview.md"
...
# MSSQL_TASK_initial_0955 - Script ElasticPoolSizingReview.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Review fuer Groessen- und Lastannahmen bei Elastic Pools.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticPoolSizingReview.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ElasticPoolSizingReview.md

## Umsetzungsauftrag

Erzeuge `ElasticPoolSizingReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Review fuer Groessen- und Lastannahmen bei Elastic Pools. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
