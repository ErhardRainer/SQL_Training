---
task_id: MSSQL_TASK_initial_0737
repository: SQL_Training
domain: MSSQL
title: "Script ExternalFileFormatInventory.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 264
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0737"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFileFormatInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFileFormatInventory.md"
...
# MSSQL_TASK_initial_0737 - Script ExternalFileFormatInventory.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Inventarisiert Dateiformate fuer externe Tabellen und OPENROWSET-Szenarien.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFileFormatInventory.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalFileFormatInventory.md

## Umsetzungsauftrag

Erzeuge `ExternalFileFormatInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Dateiformate fuer externe Tabellen und OPENROWSET-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
