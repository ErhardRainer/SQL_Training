---
task_id: MSSQL_TASK_initial_0537
repository: SQL_Training
domain: MSSQL
title: "Script LockFootprintSnapshot.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 464
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0537"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/LockFootprintSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/LockFootprintSnapshot.md"
...
# MSSQL_TASK_initial_0537 - Script LockFootprintSnapshot.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Erstellt einen Snapshot aktueller Locks fuer das Erklaeren von Isolation und Blocking.
...
- T-SQL/60_IsolationLevels/SQLScripts/LockFootprintSnapshot.sql
- T-SQL/60_IsolationLevels/SQLScripts/LockFootprintSnapshot.md

## Umsetzungsauftrag

Erzeuge `LockFootprintSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt einen Snapshot aktueller Locks fuer das Erklaeren von Isolation und Blocking. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
