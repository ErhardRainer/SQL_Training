---
task_id: MSSQL_TASK_initial_0709
repository: SQL_Training
domain: MSSQL
title: "Script TemporalPointInTimeQueryTemplate.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 292
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0709"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalPointInTimeQueryTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalPointInTimeQueryTemplate.md"
...
# MSSQL_TASK_initial_0709 - Script TemporalPointInTimeQueryTemplate.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Vorlage fuer Point-in-Time-Abfragen gegen systemversionierte Tabellen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalPointInTimeQueryTemplate.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalPointInTimeQueryTemplate.md

## Umsetzungsauftrag

Erzeuge `TemporalPointInTimeQueryTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Point-in-Time-Abfragen gegen systemversionierte Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
