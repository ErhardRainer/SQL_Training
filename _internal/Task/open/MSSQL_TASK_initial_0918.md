---
task_id: MSSQL_TASK_initial_0918
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreSegmentSkewReport.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 83
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0918"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentSkewReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentSkewReport.md"
...
# MSSQL_TASK_initial_0918 - Script ColumnstoreSegmentSkewReport.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Zeigt ungleich verteilte Segmentgroessen in Columnstore-Indizes.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentSkewReport.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentSkewReport.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreSegmentSkewReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt ungleich verteilte Segmentgroessen in Columnstore-Indizes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
