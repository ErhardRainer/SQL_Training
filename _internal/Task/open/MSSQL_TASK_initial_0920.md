---
task_id: MSSQL_TASK_initial_0920
repository: SQL_Training
domain: MSSQL
title: "Script DeletedRowsPressureCheck.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 81
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0920"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/DeletedRowsPressureCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/DeletedRowsPressureCheck.md"
...
# MSSQL_TASK_initial_0920 - Script DeletedRowsPressureCheck.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Zeigt Rowgroups mit hohem Anteil geloeschter Zeilen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/DeletedRowsPressureCheck.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/DeletedRowsPressureCheck.md

## Umsetzungsauftrag

Erzeuge `DeletedRowsPressureCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Rowgroups mit hohem Anteil geloeschter Zeilen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
