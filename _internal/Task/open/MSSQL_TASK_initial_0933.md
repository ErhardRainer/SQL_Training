---
task_id: MSSQL_TASK_initial_0933
repository: SQL_Training
domain: MSSQL
title: "Script SchemaFakeObjectTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 68
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0933"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/SchemaFakeObjectTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/SchemaFakeObjectTemplate.md"
...
# MSSQL_TASK_initial_0933 - Script SchemaFakeObjectTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer Fake-Objekte in Test-Schemas.
...
- T-SQL/79_TSQL_Testing/SQLScripts/SchemaFakeObjectTemplate.sql
- T-SQL/79_TSQL_Testing/SQLScripts/SchemaFakeObjectTemplate.md

## Umsetzungsauftrag

Erzeuge `SchemaFakeObjectTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Fake-Objekte in Test-Schemas. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
