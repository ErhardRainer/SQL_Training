---
task_id: MSSQL_TASK_initial_0886
repository: SQL_Training
domain: MSSQL
title: "Script SpatialReferenceValidation.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 115
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0886"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialReferenceValidation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialReferenceValidation.md"
...
# MSSQL_TASK_initial_0886 - Script SpatialReferenceValidation.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Prueft Referenzsysteme und typische SRID-Probleme.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialReferenceValidation.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialReferenceValidation.md

## Umsetzungsauftrag

Erzeuge `SpatialReferenceValidation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Referenzsysteme und typische SRID-Probleme. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
