---
task_id: MSSQL_TASK_initial_0935
repository: SQL_Training
domain: MSSQL
title: "Script TestAssertionFailureCatalog.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 66
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0935"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestAssertionFailureCatalog.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestAssertionFailureCatalog.md"
...
# MSSQL_TASK_initial_0935 - Script TestAssertionFailureCatalog.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Katalog typischer Assertion-Fehler mit Beispielen.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestAssertionFailureCatalog.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestAssertionFailureCatalog.md

## Umsetzungsauftrag

Erzeuge `TestAssertionFailureCatalog.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Katalog typischer Assertion-Fehler mit Beispielen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
