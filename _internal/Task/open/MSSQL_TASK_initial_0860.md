---
task_id: MSSQL_TASK_initial_0860
repository: SQL_Training
domain: MSSQL
title: "Script StagePurgeSafetyCheck.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 141
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0860"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StagePurgeSafetyCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StagePurgeSafetyCheck.md"
...
# MSSQL_TASK_initial_0860 - Script StagePurgeSafetyCheck.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Sicherheitscheck vor dem Bereinigen alter Stage-Daten.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StagePurgeSafetyCheck.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/StagePurgeSafetyCheck.md

## Umsetzungsauftrag

Erzeuge `StagePurgeSafetyCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Sicherheitscheck vor dem Bereinigen alter Stage-Daten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
