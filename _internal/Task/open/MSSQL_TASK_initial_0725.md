---
task_id: MSSQL_TASK_initial_0725
repository: SQL_Training
domain: MSSQL
title: "Script QueueActivationStatus.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 276
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0725"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationStatus.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationStatus.md"
...
# MSSQL_TASK_initial_0725 - Script QueueActivationStatus.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Zeigt Aktivierungsstatus und Konfiguration der Queue Reader.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationStatus.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationStatus.md

## Umsetzungsauftrag

Erzeuge `QueueActivationStatus.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Aktivierungsstatus und Konfiguration der Queue Reader. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
