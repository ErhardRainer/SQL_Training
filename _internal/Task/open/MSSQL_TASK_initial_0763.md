---
task_id: MSSQL_TASK_initial_0763
repository: SQL_Training
domain: MSSQL
title: "Script BackupSetCompressionAudit.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 238
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0763"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupSetCompressionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupSetCompressionAudit.md"
...
# MSSQL_TASK_initial_0763 - Script BackupSetCompressionAudit.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Audit ueber Kompressionseigenschaften vorhandener Backups.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupSetCompressionAudit.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupSetCompressionAudit.md

## Umsetzungsauftrag

Erzeuge `BackupSetCompressionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Kompressionseigenschaften vorhandener Backups. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
