---
task_id: MSSQL_TASK_initial_0890
repository: SQL_Training
domain: MSSQL
title: "Script JsonContractRequiredFields.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 111
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0890"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractRequiredFields.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractRequiredFields.md"
...
# MSSQL_TASK_initial_0890 - Script JsonContractRequiredFields.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Prueft Pflichtfelder in JSON-Vertraegen vor dem Laden.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractRequiredFields.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/JsonContractRequiredFields.md

## Umsetzungsauftrag

Erzeuge `JsonContractRequiredFields.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Pflichtfelder in JSON-Vertraegen vor dem Laden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
