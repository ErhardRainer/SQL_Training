---
task_id: MSSQL_TASK_initial_0573
repository: SQL_Training
domain: MSSQL
title: "Script RlsCoverageByTable.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 428
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0573"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsCoverageByTable.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsCoverageByTable.md"
...
# MSSQL_TASK_initial_0573 - Script RlsCoverageByTable.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Zeigt, welche Tabellen bereits durch RLS abgesichert sind und welche nicht.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsCoverageByTable.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsCoverageByTable.md

## Umsetzungsauftrag

Erzeuge `RlsCoverageByTable.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, welche Tabellen bereits durch RLS abgesichert sind und welche nicht. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
