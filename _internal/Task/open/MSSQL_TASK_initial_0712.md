---
task_id: MSSQL_TASK_initial_0712
repository: SQL_Training
domain: MSSQL
title: "Script TemporalSystemTimeValidation.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 289
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0712"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalSystemTimeValidation.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalSystemTimeValidation.md"
...
# MSSQL_TASK_initial_0712 - Script TemporalSystemTimeValidation.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Validiert typische SYSTEM_TIME-Szenarien.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalSystemTimeValidation.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalSystemTimeValidation.md

## Umsetzungsauftrag

Erzeuge `TemporalSystemTimeValidation.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Validiert typische SYSTEM_TIME-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
