---
task_id: MSSQL_TASK_initial_0782
repository: SQL_Training
domain: MSSQL
title: "Script AgentScheduleOverlapCheck.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 219
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0782"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleOverlapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleOverlapCheck.md"
...
# MSSQL_TASK_initial_0782 - Script AgentScheduleOverlapCheck.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Findet Jobs, deren Zeitplaene sich unguenstig ueberschneiden.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleOverlapCheck.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleOverlapCheck.md

## Umsetzungsauftrag

Erzeuge `AgentScheduleOverlapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Findet Jobs, deren Zeitplaene sich unguenstig ueberschneiden. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
