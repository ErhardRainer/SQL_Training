---
task_id: MSSQL_TASK_initial_0746
repository: SQL_Training
domain: MSSQL
title: "Script ExternalTableMetadataAudit.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 255
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0746"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableMetadataAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableMetadataAudit.md"
...
# MSSQL_TASK_initial_0746 - Script ExternalTableMetadataAudit.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Inventarisiert externe Tabellen, Datenquellen, Dateiformate und Credentials.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableMetadataAudit.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalTableMetadataAudit.md

## Umsetzungsauftrag

Erzeuge `ExternalTableMetadataAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert externe Tabellen, Datenquellen, Dateiformate und Credentials. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
