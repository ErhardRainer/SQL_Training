---
task_id: MSSQL_TASK_initial_0472
repository: SQL_Training
domain: MSSQL
title: "Script TopExpensiveCachedPlans.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 529
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0472"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/TopExpensiveCachedPlans.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/TopExpensiveCachedPlans.md"
...
# MSSQL_TASK_initial_0472 - Script TopExpensiveCachedPlans.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Zeigt teure gecachte Ausfuehrungsplaene nach CPU, Reads und Ausfuehrungsanzahl.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/TopExpensiveCachedPlans.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/TopExpensiveCachedPlans.md

## Umsetzungsauftrag

Erzeuge `TopExpensiveCachedPlans.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt teure gecachte Ausfuehrungsplaene nach CPU, Reads und Ausfuehrungsanzahl. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
