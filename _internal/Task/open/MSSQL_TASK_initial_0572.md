---
task_id: MSSQL_TASK_initial_0572
repository: SQL_Training
domain: MSSQL
title: "Script RlsBypassSurfaceChecklist.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 429
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0572"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsBypassSurfaceChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsBypassSurfaceChecklist.md"
...
# MSSQL_TASK_initial_0572 - Script RlsBypassSurfaceChecklist.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Checkliste potenzieller Angriffs- und Bypass-Oberflaechen.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsBypassSurfaceChecklist.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsBypassSurfaceChecklist.md

## Umsetzungsauftrag

Erzeuge `RlsBypassSurfaceChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste potenzieller Angriffs- und Bypass-Oberflaechen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
