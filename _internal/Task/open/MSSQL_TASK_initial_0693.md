---
task_id: MSSQL_TASK_initial_0693
repository: SQL_Training
domain: MSSQL
title: "Script SeedingModeInventory.sql fuer 67_HA_DR erstellen"
status: open
priority: 308
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0693"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/SeedingModeInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/SeedingModeInventory.md"
...
# MSSQL_TASK_initial_0693 - Script SeedingModeInventory.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Inventarisiert automatische und manuelle Seeding-Konfigurationen je Replica.
...
- T-SQL/67_HA_DR/SQLScripts/SeedingModeInventory.sql
- T-SQL/67_HA_DR/SQLScripts/SeedingModeInventory.md

## Umsetzungsauftrag

Erzeuge `SeedingModeInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert automatische und manuelle Seeding-Konfigurationen je Replica. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
