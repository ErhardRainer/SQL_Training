---
task_id: MSSQL_TASK_initial_0491
repository: SQL_Training
domain: MSSQL
title: "Script XmlShreddingNodesWalkthrough.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 510
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0491"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlShreddingNodesWalkthrough.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlShreddingNodesWalkthrough.md"
...
# MSSQL_TASK_initial_0491 - Script XmlShreddingNodesWalkthrough.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Demonstriert das Zerlegen von XML-Dokumenten mit `nodes()` und `value()`.
