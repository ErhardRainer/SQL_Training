---
task_id: MSSQL_TASK_initial_0559
repository: SQL_Training
domain: MSSQL
title: "Script RecursiveCteDepthLimiter.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 442
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0559"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteDepthLimiter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteDepthLimiter.md"
...
# MSSQL_TASK_initial_0559 - Script RecursiveCteDepthLimiter.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Begrenzungstemplate fuer die Rekursionstiefe in CTEs.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteDepthLimiter.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/RecursiveCteDepthLimiter.md

## Umsetzungsauftrag

Erzeuge `RecursiveCteDepthLimiter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Begrenzungstemplate fuer die Rekursionstiefe in CTEs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
