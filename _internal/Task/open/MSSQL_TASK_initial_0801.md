---
task_id: MSSQL_TASK_initial_0801
repository: SQL_Training
domain: MSSQL
title: "Script StepCommandLengthReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 200
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0801"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/StepCommandLengthReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/StepCommandLengthReview.md"
...
# MSSQL_TASK_initial_0801 - Script StepCommandLengthReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Review ueber sehr lange oder unuebersichtliche Step-Kommandos.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/StepCommandLengthReview.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/StepCommandLengthReview.md

## Umsetzungsauftrag

Erzeuge `StepCommandLengthReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber sehr lange oder unuebersichtliche Step-Kommandos. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
