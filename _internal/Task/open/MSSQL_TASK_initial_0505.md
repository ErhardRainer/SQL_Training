---
task_id: MSSQL_TASK_initial_0505
repository: SQL_Training
domain: MSSQL
title: "Script MonthEndCarryoverDemo.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 496
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0505"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/MonthEndCarryoverDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/MonthEndCarryoverDemo.md"
...
# MSSQL_TASK_initial_0505 - Script MonthEndCarryoverDemo.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Zeigt Randfaelle rund um Monatsenden und Uebertraege.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/MonthEndCarryoverDemo.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/MonthEndCarryoverDemo.md

## Umsetzungsauftrag

Erzeuge `MonthEndCarryoverDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Randfaelle rund um Monatsenden und Uebertraege. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
