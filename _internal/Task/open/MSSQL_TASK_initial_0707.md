---
task_id: MSSQL_TASK_initial_0707
repository: SQL_Training
domain: MSSQL
title: "Script TemporalHistoryIndexAlignment.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 294
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0707"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAlignment.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAlignment.md"
...
# MSSQL_TASK_initial_0707 - Script TemporalHistoryIndexAlignment.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Prueft, ob aktuelle und History-Tabelle fuer typische Temporal-Abfragen passend ausgerichtet sind.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAlignment.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryIndexAlignment.md

## Umsetzungsauftrag

Erzeuge `TemporalHistoryIndexAlignment.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, ob aktuelle und History-Tabelle fuer typische Temporal-Abfragen passend ausgerichtet sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
