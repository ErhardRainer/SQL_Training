---
task_id: MSSQL_TASK_initial_0703
repository: SQL_Training
domain: MSSQL
title: "Script ChangeTrackingVersionDrift.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 298
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0703"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingVersionDrift.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingVersionDrift.md"
...
# MSSQL_TASK_initial_0703 - Script ChangeTrackingVersionDrift.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Vergleicht Change-Tracking-Versionen und moegliche Rueckstaende zwischen Tabellen.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingVersionDrift.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/ChangeTrackingVersionDrift.md

## Umsetzungsauftrag

Erzeuge `ChangeTrackingVersionDrift.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Change-Tracking-Versionen und moegliche Rueckstaende zwischen Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
