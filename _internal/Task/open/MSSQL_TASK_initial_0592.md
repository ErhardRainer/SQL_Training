---
task_id: MSSQL_TASK_initial_0592
repository: SQL_Training
domain: MSSQL
title: "Script BinaryCollationSortDemo.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 409
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0592"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationSortDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationSortDemo.md"
...
# MSSQL_TASK_initial_0592 - Script BinaryCollationSortDemo.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Vergleicht sprachliche und binaere Sortierreihenfolgen an Praxisdaten.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationSortDemo.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationSortDemo.md

## Umsetzungsauftrag

Erzeuge `BinaryCollationSortDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht sprachliche und binaere Sortierreihenfolgen an Praxisdaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
