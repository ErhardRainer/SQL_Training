---
task_id: MSSQL_TASK_initial_0479
repository: SQL_Training
domain: MSSQL
title: "Script JsonPropertyTypeProfile.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 522
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0479"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyTypeProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyTypeProfile.md"
...
# MSSQL_TASK_initial_0479 - Script JsonPropertyTypeProfile.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Profiling der Wertetypen einzelner JSON-Properties.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyTypeProfile.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyTypeProfile.md

## Umsetzungsauftrag

Erzeuge `JsonPropertyTypeProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Profiling der Wertetypen einzelner JSON-Properties. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
