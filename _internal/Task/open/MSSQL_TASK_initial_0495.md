---
task_id: MSSQL_TASK_initial_0495
repository: SQL_Training
domain: MSSQL
title: "Script CalendarGapFinder.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 506
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0495"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/CalendarGapFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/CalendarGapFinder.md"
...
# MSSQL_TASK_initial_0495 - Script CalendarGapFinder.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Findet Luecken in Datumsreihen fuer Kalender- oder Faktentabellen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/CalendarGapFinder.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/CalendarGapFinder.md

## Umsetzungsauftrag

Erzeuge `CalendarGapFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Findet Luecken in Datumsreihen fuer Kalender- oder Faktentabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
