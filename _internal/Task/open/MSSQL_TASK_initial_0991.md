---
task_id: MSSQL_TASK_initial_0991
repository: SQL_Training
domain: MSSQL
title: "Script RequestMemoryGrantHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 10
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0991"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/RequestMemoryGrantHotspots.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/RequestMemoryGrantHotspots.md"
...
# MSSQL_TASK_initial_0991 - Script RequestMemoryGrantHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Zeigt laufende Requests mit auffaelligen Memory-Grants.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/RequestMemoryGrantHotspots.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/RequestMemoryGrantHotspots.md

## Umsetzungsauftrag

Erzeuge `RequestMemoryGrantHotspots.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt laufende Requests mit auffaelligen Memory-Grants. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
