---
task_id: MSSQL_TASK_initial_0994
repository: SQL_Training
domain: MSSQL
title: "Script SessionInputBufferSnapshot.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 7
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0994"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SessionInputBufferSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SessionInputBufferSnapshot.md"
...
# MSSQL_TASK_initial_0994 - Script SessionInputBufferSnapshot.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Liest den aktuellen Input Buffer aktiver Sessions zur Schnellanalyse aus.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SessionInputBufferSnapshot.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SessionInputBufferSnapshot.md

## Umsetzungsauftrag

Erzeuge `SessionInputBufferSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Liest den aktuellen Input Buffer aktiver Sessions zur Schnellanalyse aus. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
