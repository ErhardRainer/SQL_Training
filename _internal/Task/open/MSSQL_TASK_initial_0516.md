---
task_id: MSSQL_TASK_initial_0516
repository: SQL_Training
domain: MSSQL
title: "Script BulkInsertFormatMismatchProbe.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 485
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0516"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFormatMismatchProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFormatMismatchProbe.md"
...
# MSSQL_TASK_initial_0516 - Script BulkInsertFormatMismatchProbe.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Hilft beim Erkennen von Delimiter- und Formatfehlern in Eingabedateien.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFormatMismatchProbe.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkInsertFormatMismatchProbe.md

## Umsetzungsauftrag

Erzeuge `BulkInsertFormatMismatchProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Hilft beim Erkennen von Delimiter- und Formatfehlern in Eingabedateien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
