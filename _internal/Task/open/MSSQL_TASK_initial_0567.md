---
task_id: MSSQL_TASK_initial_0567
repository: SQL_Training
domain: MSSQL
title: "Script TempTableStatisticsRefreshDemo.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 434
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0567"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableStatisticsRefreshDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableStatisticsRefreshDemo.md"
...
# MSSQL_TASK_initial_0567 - Script TempTableStatisticsRefreshDemo.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Macht Statistikverhalten auf Temp-Tabellen sichtbar.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableStatisticsRefreshDemo.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableStatisticsRefreshDemo.md

## Umsetzungsauftrag

Erzeuge `TempTableStatisticsRefreshDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Macht Statistikverhalten auf Temp-Tabellen sichtbar. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
