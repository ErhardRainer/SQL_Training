---
task_id: MSSQL_TASK_initial_0959
repository: SQL_Training
domain: MSSQL
title: "Script ManagedInstanceFeatureCheck.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 42
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0959"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceFeatureCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceFeatureCheck.md"
...
# MSSQL_TASK_initial_0959 - Script ManagedInstanceFeatureCheck.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Checkt Features, die speziell auf Managed Instance verfuegbar oder eingeschraenkt sind.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceFeatureCheck.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceFeatureCheck.md

## Umsetzungsauftrag

Erzeuge `ManagedInstanceFeatureCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Checkt Features, die speziell auf Managed Instance verfuegbar oder eingeschraenkt sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
