---
task_id: MSSQL_TASK_initial_0676
repository: SQL_Training
domain: MSSQL
title: "Script AvailabilityGroupBackupPreferenceReport.sql fuer 67_HA_DR erstellen"
status: open
priority: 325
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0676"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/AvailabilityGroupBackupPreferenceReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/AvailabilityGroupBackupPreferenceReport.md"
...
# MSSQL_TASK_initial_0676 - Script AvailabilityGroupBackupPreferenceReport.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Bericht ueber konfigurierte Backup Preferences von AGs.
...
- T-SQL/67_HA_DR/SQLScripts/AvailabilityGroupBackupPreferenceReport.sql
- T-SQL/67_HA_DR/SQLScripts/AvailabilityGroupBackupPreferenceReport.md

## Umsetzungsauftrag

Erzeuge `AvailabilityGroupBackupPreferenceReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Bericht ueber konfigurierte Backup Preferences von AGs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
