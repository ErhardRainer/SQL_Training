---
task_id: MSSQL_TASK_initial_0705
repository: SQL_Training
domain: MSSQL
title: "Script TemporalCleanupOpportunityScan.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 296
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0705"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalCleanupOpportunityScan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalCleanupOpportunityScan.md"
...
# MSSQL_TASK_initial_0705 - Script TemporalCleanupOpportunityScan.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Scan fuer potenzielle Bereinigungschancen in History-Daten.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalCleanupOpportunityScan.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalCleanupOpportunityScan.md

## Umsetzungsauftrag

Erzeuge `TemporalCleanupOpportunityScan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Scan fuer potenzielle Bereinigungschancen in History-Daten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
