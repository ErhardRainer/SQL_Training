---
task_id: MSSQL_TASK_initial_0750
repository: SQL_Training
domain: MSSQL
title: "Script OpenrowsetCredentialTemplate.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 251
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0750"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCredentialTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCredentialTemplate.md"
...
# MSSQL_TASK_initial_0750 - Script OpenrowsetCredentialTemplate.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Vorlage fuer Credentials in OPENROWSET- und External-Table-Szenarien.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCredentialTemplate.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCredentialTemplate.md

## Umsetzungsauftrag

Erzeuge `OpenrowsetCredentialTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Credentials in OPENROWSET- und External-Table-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
