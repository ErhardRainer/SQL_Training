---
task_id: MSSQL_TASK_initial_0932
repository: SQL_Training
domain: MSSQL
title: "Script ResultSetAssertionTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 69
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0932"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/ResultSetAssertionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/ResultSetAssertionTemplate.md"
...
# MSSQL_TASK_initial_0932 - Script ResultSetAssertionTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer Resultset-Vergleiche und erwartete Testdaten in tSQLt.
...
- T-SQL/79_TSQL_Testing/SQLScripts/ResultSetAssertionTemplate.sql
- T-SQL/79_TSQL_Testing/SQLScripts/ResultSetAssertionTemplate.md

## Umsetzungsauftrag

Erzeuge `ResultSetAssertionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Resultset-Vergleiche und erwartete Testdaten in tSQLt. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
