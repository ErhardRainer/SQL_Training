---
task_id: MSSQL_TASK_initial_0518
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadErrorFilePattern.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 483
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0518"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorFilePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorFilePattern.md"
...
# MSSQL_TASK_initial_0518 - Script BulkLoadErrorFilePattern.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Zeigt den Einsatz von Error Files fuer fehlertolerante Importlaeufe.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorFilePattern.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadErrorFilePattern.md

## Umsetzungsauftrag

Erzeuge `BulkLoadErrorFilePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Einsatz von Error Files fuer fehlertolerante Importlaeufe. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
