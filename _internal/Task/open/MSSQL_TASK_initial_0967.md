---
task_id: MSSQL_TASK_initial_0967
repository: SQL_Training
domain: MSSQL
title: "Script MemoryOptimizedDurabilityCompare.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 34
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0967"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedDurabilityCompare.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedDurabilityCompare.md"
...
# MSSQL_TASK_initial_0967 - Script MemoryOptimizedDurabilityCompare.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Vergleicht durable und non-durable Tabellenoptionen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedDurabilityCompare.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedDurabilityCompare.md

## Umsetzungsauftrag

Erzeuge `MemoryOptimizedDurabilityCompare.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht durable und non-durable Tabellenoptionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
