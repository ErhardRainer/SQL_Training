---
task_id: MSSQL_TASK_initial_0975
repository: SQL_Training
domain: MSSQL
title: "Script RangeIndexSelectivityLab.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 26
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0975"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/RangeIndexSelectivityLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/RangeIndexSelectivityLab.md"
...
# MSSQL_TASK_initial_0975 - Script RangeIndexSelectivityLab.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Labor fuer Selektivitaet von Range-Indizes in In-Memory-Szenarien.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/RangeIndexSelectivityLab.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/RangeIndexSelectivityLab.md

## Umsetzungsauftrag

Erzeuge `RangeIndexSelectivityLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer Selektivitaet von Range-Indizes in In-Memory-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
