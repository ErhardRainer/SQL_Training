---
task_id: MSSQL_TASK_initial_0823
repository: SQL_Training
domain: MSSQL
title: "Script LongReaderImpactCheck.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 178
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0823"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/LongReaderImpactCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/LongReaderImpactCheck.md"
...
# MSSQL_TASK_initial_0823 - Script LongReaderImpactCheck.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Findet lange Leser, die Version-Store-Aufraeumung bremsen koennen.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/LongReaderImpactCheck.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/LongReaderImpactCheck.md

## Umsetzungsauftrag

Erzeuge `LongReaderImpactCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Findet lange Leser, die Version-Store-Aufraeumung bremsen koennen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
