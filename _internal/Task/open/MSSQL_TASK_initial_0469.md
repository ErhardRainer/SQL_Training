---
task_id: MSSQL_TASK_initial_0469
repository: SQL_Training
domain: MSSQL
title: "Script ResidualPredicateFinder.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 532
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0469"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/ResidualPredicateFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/ResidualPredicateFinder.md"
...
# MSSQL_TASK_initial_0469 - Script ResidualPredicateFinder.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Markiert Plaene mit Residual Predicates und moeglichen Seek-/Scan-Abweichungen.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/ResidualPredicateFinder.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/ResidualPredicateFinder.md

## Umsetzungsauftrag

Erzeuge `ResidualPredicateFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Plaene mit Residual Predicates und moeglichen Seek-/Scan-Abweichungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
