---
task_id: MSSQL_TASK_initial_0751
repository: SQL_Training
domain: MSSQL
title: "Script OpenrowsetPredicatePushdownDemo.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 250
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0751"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetPredicatePushdownDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetPredicatePushdownDemo.md"
...
# MSSQL_TASK_initial_0751 - Script OpenrowsetPredicatePushdownDemo.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Demo fuer moeglichen Filter-Pushdown in OPENROWSET-Abfragen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetPredicatePushdownDemo.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetPredicatePushdownDemo.md

## Umsetzungsauftrag

Erzeuge `OpenrowsetPredicatePushdownDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Demo fuer moeglichen Filter-Pushdown in OPENROWSET-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
