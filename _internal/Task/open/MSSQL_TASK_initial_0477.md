---
task_id: MSSQL_TASK_initial_0477
repository: SQL_Training
domain: MSSQL
title: "Script JsonPathExtractionTemplate.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 524
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0477"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathExtractionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathExtractionTemplate.md"
...
# MSSQL_TASK_initial_0477 - Script JsonPathExtractionTemplate.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Vorlage fuer das Extrahieren ueber mehrere JSON-Pfade.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathExtractionTemplate.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathExtractionTemplate.md

## Umsetzungsauftrag

Erzeuge `JsonPathExtractionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer das Extrahieren ueber mehrere JSON-Pfade. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
