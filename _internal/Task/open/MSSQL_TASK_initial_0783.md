---
task_id: MSSQL_TASK_initial_0783
repository: SQL_Training
domain: MSSQL
title: "Script AlertDefinitionInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 218
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0783"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AlertDefinitionInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AlertDefinitionInventory.md"
...
# MSSQL_TASK_initial_0783 - Script AlertDefinitionInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Inventarisiert definierte Alerts, Operatoren und Benachrichtigungswege.
