---
task_id: MSSQL_TASK_initial_0405
repository: SQL_Training
domain: MSSQL
title: "Script ScalarUdfHotspotFinder.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 596
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0405"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfHotspotFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfHotspotFinder.md"
...
# MSSQL_TASK_initial_0405 - Script ScalarUdfHotspotFinder.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Sucht nach skalaren UDFs, die in Performance-kritischen Abfragen haeufig auftauchen.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfHotspotFinder.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfHotspotFinder.md

## Umsetzungsauftrag

Erzeuge `ScalarUdfHotspotFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Sucht nach skalaren UDFs, die in Performance-kritischen Abfragen haeufig auftauchen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
