---
task_id: MSSQL_TASK_initial_0984
repository: SQL_Training
domain: MSSQL
title: "Script BlockingSessionHistorySampler.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 17
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0984"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingSessionHistorySampler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingSessionHistorySampler.md"
...
# MSSQL_TASK_initial_0984 - Script BlockingSessionHistorySampler.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Sampelt Blocker und Opfer ueber mehrere Zeitpunkte.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingSessionHistorySampler.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingSessionHistorySampler.md

## Umsetzungsauftrag

Erzeuge `BlockingSessionHistorySampler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Sampelt Blocker und Opfer ueber mehrere Zeitpunkte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
