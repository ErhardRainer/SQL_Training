---
task_id: MSSQL_TASK_initial_0652
repository: SQL_Training
domain: MSSQL
title: "Script SwitchReadinessCheck.sql fuer 65_Partitioning erstellen"
status: open
priority: 349
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0652"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/SwitchReadinessCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/SwitchReadinessCheck.md"
...
# MSSQL_TASK_initial_0652 - Script SwitchReadinessCheck.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Validiert, ob Tabelle und Staging-Tabelle fuer `SWITCH IN/OUT` kompatibel sind.
...
- T-SQL/65_Partitioning/SQLScripts/SwitchReadinessCheck.sql
- T-SQL/65_Partitioning/SQLScripts/SwitchReadinessCheck.md

## Umsetzungsauftrag

Erzeuge `SwitchReadinessCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Validiert, ob Tabelle und Staging-Tabelle fuer `SWITCH IN/OUT` kompatibel sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
