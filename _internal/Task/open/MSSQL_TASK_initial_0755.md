---
task_id: MSSQL_TASK_initial_0755
repository: SQL_Training
domain: MSSQL
title: "Script BackupAgeThresholdAlert.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 246
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0755"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupAgeThresholdAlert.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupAgeThresholdAlert.md"
...
# MSSQL_TASK_initial_0755 - Script BackupAgeThresholdAlert.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Alert-orientierter Check fuer zu alte Backups.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupAgeThresholdAlert.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupAgeThresholdAlert.md

## Umsetzungsauftrag

Erzeuge `BackupAgeThresholdAlert.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Alert-orientierter Check fuer zu alte Backups. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
