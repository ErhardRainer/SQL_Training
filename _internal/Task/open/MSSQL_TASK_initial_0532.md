---
task_id: MSSQL_TASK_initial_0532
repository: SQL_Training
domain: MSSQL
title: "Script HoldLockPatternDemo.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 469
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0532"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/HoldLockPatternDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/HoldLockPatternDemo.md"
...
# MSSQL_TASK_initial_0532 - Script HoldLockPatternDemo.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Demonstriert `HOLDLOCK` und dessen Auswirkungen auf Konkurrenzzugriffe.
...
- T-SQL/60_IsolationLevels/SQLScripts/HoldLockPatternDemo.sql
- T-SQL/60_IsolationLevels/SQLScripts/HoldLockPatternDemo.md

## Umsetzungsauftrag

Erzeuge `HoldLockPatternDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert `HOLDLOCK` und dessen Auswirkungen auf Konkurrenzzugriffe. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
