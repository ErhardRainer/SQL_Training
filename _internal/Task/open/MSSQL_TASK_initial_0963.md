---
task_id: MSSQL_TASK_initial_0963
repository: SQL_Training
domain: MSSQL
title: "Script HashBucketCollisionSampler.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 38
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0963"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashBucketCollisionSampler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashBucketCollisionSampler.md"
...
# MSSQL_TASK_initial_0963 - Script HashBucketCollisionSampler.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Sampler fuer Kollisionen in Hash-Buckets.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/HashBucketCollisionSampler.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/HashBucketCollisionSampler.md

## Umsetzungsauftrag

Erzeuge `HashBucketCollisionSampler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Sampler fuer Kollisionen in Hash-Buckets. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
