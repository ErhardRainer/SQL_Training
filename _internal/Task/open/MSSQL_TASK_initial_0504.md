---
task_id: MSSQL_TASK_initial_0504
repository: SQL_Training
domain: MSSQL
title: "Script HolidayCoverageCheck.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 497
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0504"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/HolidayCoverageCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/HolidayCoverageCheck.md"
...
# MSSQL_TASK_initial_0504 - Script HolidayCoverageCheck.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Prueft Feiertagsabdeckung in Kalenderdaten.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/HolidayCoverageCheck.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/HolidayCoverageCheck.md

## Umsetzungsauftrag

Erzeuge `HolidayCoverageCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Feiertagsabdeckung in Kalenderdaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
