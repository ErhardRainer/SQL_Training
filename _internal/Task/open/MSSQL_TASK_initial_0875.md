---
task_id: MSSQL_TASK_initial_0875
repository: SQL_Training
domain: MSSQL
title: "Script NearestNeighborTemplate.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 126
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0875"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/NearestNeighborTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/NearestNeighborTemplate.md"
...
# MSSQL_TASK_initial_0875 - Script NearestNeighborTemplate.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorlage fuer Radius- und Naechster-Nachbar-Abfragen mit `geography` oder `geometry`.
...
- T-SQL/76_Spatial_Geography/SQLScripts/NearestNeighborTemplate.sql
- T-SQL/76_Spatial_Geography/SQLScripts/NearestNeighborTemplate.md

## Umsetzungsauftrag

Erzeuge `NearestNeighborTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Radius- und Naechster-Nachbar-Abfragen mit `geography` oder `geometry`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
