---
task_id: MSSQL_TASK_initial_0992
repository: SQL_Training
domain: MSSQL
title: "Script RequestTempdbUsageHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 9
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0992"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestTempdbUsageHotspots.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestTempdbUsageHotspots.md"
...
# MSSQL_TASK_initial_0992 - Script RequestTempdbUsageHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Zeigt Requests mit auffaelligem TempDB-Verbrauch.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestTempdbUsageHotspots.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestTempdbUsageHotspots.md

## Umsetzungsauftrag

Erzeuge `RequestTempdbUsageHotspots.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Requests mit auffaelligem TempDB-Verbrauch. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
