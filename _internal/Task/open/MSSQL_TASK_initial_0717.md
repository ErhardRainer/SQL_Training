---
task_id: MSSQL_TASK_initial_0717
repository: SQL_Training
domain: MSSQL
title: "Script BrokerPriorityReview.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 284
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0717"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerPriorityReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerPriorityReview.md"
...
# MSSQL_TASK_initial_0717 - Script BrokerPriorityReview.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Review ueber gesetzte Broker-Prioritaeten.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerPriorityReview.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerPriorityReview.md

## Umsetzungsauftrag

Erzeuge `BrokerPriorityReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber gesetzte Broker-Prioritaeten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
