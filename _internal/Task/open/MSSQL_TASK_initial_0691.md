---
task_id: MSSQL_TASK_initial_0691
repository: SQL_Training
domain: MSSQL
title: "Script SeedingDurationSample.sql fuer 67_HA_DR erstellen"
status: open
priority: 310
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0691"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/SeedingDurationSample.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/SeedingDurationSample.md"
...
# MSSQL_TASK_initial_0691 - Script SeedingDurationSample.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Sample fuer die Dauer von Seeding-Vorgaengen.
...
- T-SQL/67_HA_DR/SQLScripts/SeedingDurationSample.sql
- T-SQL/67_HA_DR/SQLScripts/SeedingDurationSample.md

## Umsetzungsauftrag

Erzeuge `SeedingDurationSample.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Sample fuer die Dauer von Seeding-Vorgaengen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
