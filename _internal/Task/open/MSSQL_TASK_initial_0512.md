---
task_id: MSSQL_TASK_initial_0512
repository: SQL_Training
domain: MSSQL
title: "Script BcpExportCommandBuilder.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 489
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0512"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpExportCommandBuilder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpExportCommandBuilder.md"
...
# MSSQL_TASK_initial_0512 - Script BcpExportCommandBuilder.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Baut Beispiel-Kommandos fuer BCP-Exporte.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpExportCommandBuilder.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BcpExportCommandBuilder.md

## Umsetzungsauftrag

Erzeuge `BcpExportCommandBuilder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Baut Beispiel-Kommandos fuer BCP-Exporte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
