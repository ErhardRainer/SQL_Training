---
task_id: MSSQL_TASK_initial_0744
repository: SQL_Training
domain: MSSQL
title: "Script ExternalSourceTypeAudit.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 257
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0744"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSourceTypeAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSourceTypeAudit.md"
...
# MSSQL_TASK_initial_0744 - Script ExternalSourceTypeAudit.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Audit ueber Typen und Arten externer Datenquellen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSourceTypeAudit.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSourceTypeAudit.md

## Umsetzungsauftrag

Erzeuge `ExternalSourceTypeAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Typen und Arten externer Datenquellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
