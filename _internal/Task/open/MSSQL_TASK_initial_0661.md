---
task_id: MSSQL_TASK_initial_0661
repository: SQL_Training
domain: MSSQL
title: "Script LeastPrivilegeChecklist.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 340
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0661"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/LeastPrivilegeChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/LeastPrivilegeChecklist.md"
...
# MSSQL_TASK_initial_0661 - Script LeastPrivilegeChecklist.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Checkliste fuer Least-Privilege-Reviews.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/LeastPrivilegeChecklist.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/LeastPrivilegeChecklist.md

## Umsetzungsauftrag

Erzeuge `LeastPrivilegeChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Least-Privilege-Reviews. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
