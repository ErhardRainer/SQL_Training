---
task_id: MSSQL_TASK_initial_0684
repository: SQL_Training
domain: MSSQL
title: "Script ReadOnlyRoutingUrlAudit.sql fuer 67_HA_DR erstellen"
status: open
priority: 317
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0684"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReadOnlyRoutingUrlAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReadOnlyRoutingUrlAudit.md"
...
# MSSQL_TASK_initial_0684 - Script ReadOnlyRoutingUrlAudit.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Audit fuer Read-Only-Routing-URLs und deren Konsistenz.
...
- T-SQL/67_HA_DR/SQLScripts/ReadOnlyRoutingUrlAudit.sql
- T-SQL/67_HA_DR/SQLScripts/ReadOnlyRoutingUrlAudit.md

## Umsetzungsauftrag

Erzeuge `ReadOnlyRoutingUrlAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Read-Only-Routing-URLs und deren Konsistenz. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
