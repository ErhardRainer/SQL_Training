---
task_id: MSSQL_TASK_initial_0949
repository: SQL_Training
domain: MSSQL
title: "Script AzureMigrationBlockerInventory.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 52
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0949"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureMigrationBlockerInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureMigrationBlockerInventory.md"
...
# MSSQL_TASK_initial_0949 - Script AzureMigrationBlockerInventory.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Inventarisiert moegliche Blocker fuer Azure-Migrationen.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureMigrationBlockerInventory.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureMigrationBlockerInventory.md

## Umsetzungsauftrag

Erzeuge `AzureMigrationBlockerInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert moegliche Blocker fuer Azure-Migrationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
