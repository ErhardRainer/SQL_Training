---
task_id: MSSQL_TASK_initial_0820
repository: SQL_Training
domain: MSSQL
title: "Script TvpTypeVersionReview.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 181
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0820"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpTypeVersionReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpTypeVersionReview.md"
...
# MSSQL_TASK_initial_0820 - Script TvpTypeVersionReview.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Review ueber Versionen und Aenderungen von Table Types.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpTypeVersionReview.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpTypeVersionReview.md

## Umsetzungsauftrag

Erzeuge `TvpTypeVersionReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Versionen und Aenderungen von Table Types. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
