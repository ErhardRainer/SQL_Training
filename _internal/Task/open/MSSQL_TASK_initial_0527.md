---
task_id: MSSQL_TASK_initial_0527
repository: SQL_Training
domain: MSSQL
title: "Script FormatFileVersionAudit.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 474
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0527"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileVersionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileVersionAudit.md"
...
# MSSQL_TASK_initial_0527 - Script FormatFileVersionAudit.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Prueft, ob Format Files und Tabellendefinitionen zusammenpassen.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileVersionAudit.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileVersionAudit.md

## Umsetzungsauftrag

Erzeuge `FormatFileVersionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, ob Format Files und Tabellendefinitionen zusammenpassen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
