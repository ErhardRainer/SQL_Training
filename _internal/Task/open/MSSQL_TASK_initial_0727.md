---
task_id: MSSQL_TASK_initial_0727
repository: SQL_Training
domain: MSSQL
title: "Script QueueDisabledReasonChecklist.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 274
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0727"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueDisabledReasonChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueDisabledReasonChecklist.md"
...
# MSSQL_TASK_initial_0727 - Script QueueDisabledReasonChecklist.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Checkliste fuer deaktivierte Queues und moegliche Ursachen.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueDisabledReasonChecklist.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueDisabledReasonChecklist.md

## Umsetzungsauftrag

Erzeuge `QueueDisabledReasonChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer deaktivierte Queues und moegliche Ursachen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
