---
task_id: MSSQL_TASK_initial_0545
repository: SQL_Training
domain: MSSQL
title: "Script SerializableHotspotFinder.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 456
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0545"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/SerializableHotspotFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/SerializableHotspotFinder.md"
...
# MSSQL_TASK_initial_0545 - Script SerializableHotspotFinder.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Findet Hotspots unter SERIALIZABLE-Isolation.
...
- T-SQL/60_IsolationLevels/SQLScripts/SerializableHotspotFinder.sql
- T-SQL/60_IsolationLevels/SQLScripts/SerializableHotspotFinder.md

## Umsetzungsauftrag

Erzeuge `SerializableHotspotFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Findet Hotspots unter SERIALIZABLE-Isolation. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
