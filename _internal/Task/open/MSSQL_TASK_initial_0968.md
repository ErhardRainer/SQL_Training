---
task_id: MSSQL_TASK_initial_0968
repository: SQL_Training
domain: MSSQL
title: "Script MemoryOptimizedGarbageCollectionReview.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 33
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0968"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedGarbageCollectionReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedGarbageCollectionReview.md"
...
# MSSQL_TASK_initial_0968 - Script MemoryOptimizedGarbageCollectionReview.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Review ueber Garbage Collection in XTP-Szenarien.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedGarbageCollectionReview.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedGarbageCollectionReview.md

## Umsetzungsauftrag

Erzeuge `MemoryOptimizedGarbageCollectionReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Garbage Collection in XTP-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
