---
task_id: MSSQL_TASK_initial_0597
repository: SQL_Training
domain: MSSQL
title: "Script CollationConflictJoinDemo.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 404
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0597"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationConflictJoinDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationConflictJoinDemo.md"
...
# MSSQL_TASK_initial_0597 - Script CollationConflictJoinDemo.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Demonstriert Join-Fehler und Loesungswege bei Kollationskonflikten.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationConflictJoinDemo.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationConflictJoinDemo.md

## Umsetzungsauftrag

Erzeuge `CollationConflictJoinDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Join-Fehler und Loesungswege bei Kollationskonflikten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
