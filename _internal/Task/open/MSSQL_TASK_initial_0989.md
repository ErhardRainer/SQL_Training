---
task_id: MSSQL_TASK_initial_0989
repository: SQL_Training
domain: MSSQL
title: "Script ParallelRequestWaitMap.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 12
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0989"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ParallelRequestWaitMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ParallelRequestWaitMap.md"
...
# MSSQL_TASK_initial_0989 - Script ParallelRequestWaitMap.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Map fuer Waits paralleler Requests.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ParallelRequestWaitMap.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/ParallelRequestWaitMap.md

## Umsetzungsauftrag

Erzeuge `ParallelRequestWaitMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Map fuer Waits paralleler Requests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
