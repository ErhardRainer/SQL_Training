---
task_id: MSSQL_TASK_initial_0756
repository: SQL_Training
domain: MSSQL
title: "Script BackupChainGapCheck.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 245
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0756"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/BackupChainGapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/BackupChainGapCheck.md"
...
# MSSQL_TASK_initial_0756 - Script BackupChainGapCheck.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Sucht in `msdb` nach Luecken oder Inkonsistenzen in Full-, Diff- und Log-Backup-Ketten.
...
- T-SQL/71_BackupRestore_Strategies/BackupChainGapCheck.sql
- T-SQL/71_BackupRestore_Strategies/BackupChainGapCheck.md

## Umsetzungsauftrag

Erzeuge `BackupChainGapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Sucht in `msdb` nach Luecken oder Inkonsistenzen in Full-, Diff- und Log-Backup-Ketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
