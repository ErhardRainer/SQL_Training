---
task_id: MSSQL_TASK_initial_0455
repository: SQL_Training
domain: MSSQL
title: "Script EstimateVsActualRowGap.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 546
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0455"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/EstimateVsActualRowGap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/EstimateVsActualRowGap.md"
...
# MSSQL_TASK_initial_0455 - Script EstimateVsActualRowGap.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Vergleicht geschaetzte und tatsaechliche Zeilen fuer typische Fehlerschaetzungen.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/EstimateVsActualRowGap.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/EstimateVsActualRowGap.md

## Umsetzungsauftrag

Erzeuge `EstimateVsActualRowGap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht geschaetzte und tatsaechliche Zeilen fuer typische Fehlerschaetzungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
