---
task_id: MSSQL_TASK_initial_0667
repository: SQL_Training
domain: MSSQL
title: "Script PermissionInheritanceTrace.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 334
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0667"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionInheritanceTrace.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionInheritanceTrace.md"
...
# MSSQL_TASK_initial_0667 - Script PermissionInheritanceTrace.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Verfolgt die Herkunft effektiver Rechte.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionInheritanceTrace.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/PermissionInheritanceTrace.md

## Umsetzungsauftrag

Erzeuge `PermissionInheritanceTrace.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Verfolgt die Herkunft effektiver Rechte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
