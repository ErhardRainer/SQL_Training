---
task_id: MSSQL_TASK_initial_0723
repository: SQL_Training
domain: MSSQL
title: "Script PoisonMessageDetector.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 278
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0723"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/PoisonMessageDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/PoisonMessageDetector.md"
...
# MSSQL_TASK_initial_0723 - Script PoisonMessageDetector.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Sucht nach Indikatoren fuer Poison Messages und deaktivierte Queues.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/PoisonMessageDetector.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/PoisonMessageDetector.md

## Umsetzungsauftrag

Erzeuge `PoisonMessageDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Sucht nach Indikatoren fuer Poison Messages und deaktivierte Queues. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
