---
task_id: MSSQL_TASK_initial_0839
repository: SQL_Training
domain: MSSQL
title: "Script VersionStoreConsumers.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 162
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0839"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreConsumers.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreConsumers.md"
...
# MSSQL_TASK_initial_0839 - Script VersionStoreConsumers.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Identifiziert Sessions und Datenbanken mit hohem Version-Store-Verbrauch.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreConsumers.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreConsumers.md

## Umsetzungsauftrag

Erzeuge `VersionStoreConsumers.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Identifiziert Sessions und Datenbanken mit hohem Version-Store-Verbrauch. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
