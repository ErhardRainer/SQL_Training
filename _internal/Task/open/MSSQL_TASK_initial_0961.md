---
task_id: MSSQL_TASK_initial_0961
repository: SQL_Training
domain: MSSQL
title: "Script ServiceTierChangeImpactDemo.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 40
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0961"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ServiceTierChangeImpactDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ServiceTierChangeImpactDemo.md"
...
# MSSQL_TASK_initial_0961 - Script ServiceTierChangeImpactDemo.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Demo moeglicher Auswirkungen eines Tier-Wechsels.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ServiceTierChangeImpactDemo.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ServiceTierChangeImpactDemo.md

## Umsetzungsauftrag

Erzeuge `ServiceTierChangeImpactDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Demo moeglicher Auswirkungen eines Tier-Wechsels. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
