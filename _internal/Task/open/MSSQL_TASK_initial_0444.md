---
task_id: MSSQL_TASK_initial_0444
repository: SQL_Training
domain: MSSQL
title: "Script IndexOverlapSimilarityReport.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 557
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0444"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexOverlapSimilarityReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexOverlapSimilarityReport.md"
...
# MSSQL_TASK_initial_0444 - Script IndexOverlapSimilarityReport.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Bericht ueber aehnliche oder ueberlappende Indexdefinitionen.
...
- T-SQL/26_Indexes_Basics/SQLScripts/IndexOverlapSimilarityReport.sql
- T-SQL/26_Indexes_Basics/SQLScripts/IndexOverlapSimilarityReport.md

## Umsetzungsauftrag

Erzeuge `IndexOverlapSimilarityReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Bericht ueber aehnliche oder ueberlappende Indexdefinitionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
