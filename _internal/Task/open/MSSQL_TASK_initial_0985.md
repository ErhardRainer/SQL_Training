---
task_id: MSSQL_TASK_initial_0985
repository: SQL_Training
domain: MSSQL
title: "Script BlockingVictimImpactReport.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 16
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0985"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/BlockingVictimImpactReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/BlockingVictimImpactReport.md"
...
# MSSQL_TASK_initial_0985 - Script BlockingVictimImpactReport.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Zeigt, welche Requests und Sessions von einem Blocker abhaengig sind.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/BlockingVictimImpactReport.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/BlockingVictimImpactReport.md

## Umsetzungsauftrag

Erzeuge `BlockingVictimImpactReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, welche Requests und Sessions von einem Blocker abhaengig sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
