---
task_id: MSSQL_TASK_initial_0618
repository: SQL_Training
domain: MSSQL
title: "Script ParameterSensitivePlanCandidates.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 383
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0618"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanCandidates.md"
...
# MSSQL_TASK_initial_0618 - Script ParameterSensitivePlanCandidates.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Markiert Kandidaten fuer parameter-sensitive Plaene.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanCandidates.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParameterSensitivePlanCandidates.md

## Umsetzungsauftrag

Erzeuge `ParameterSensitivePlanCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Kandidaten fuer parameter-sensitive Plaene. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
