---
task_id: MSSQL_TASK_initial_0594
repository: SQL_Training
domain: MSSQL
title: "Script CaseAccentMatrixDemo.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 407
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0594"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseAccentMatrixDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseAccentMatrixDemo.md"
...
# MSSQL_TASK_initial_0594 - Script CaseAccentMatrixDemo.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Matrix fuer Case- und Accent-Sensitivity in Vergleichen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseAccentMatrixDemo.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseAccentMatrixDemo.md

## Umsetzungsauftrag

Erzeuge `CaseAccentMatrixDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Matrix fuer Case- und Accent-Sensitivity in Vergleichen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
