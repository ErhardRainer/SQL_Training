---
task_id: MSSQL_TASK_initial_0758
repository: SQL_Training
domain: MSSQL
title: "Script BackupCompressionSavingsReport.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 243
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0758"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCompressionSavingsReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCompressionSavingsReport.md"
...
# MSSQL_TASK_initial_0758 - Script BackupCompressionSavingsReport.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Vergleicht komprimierte und unkomprimierte Backup-Groessen und Einsparungen.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCompressionSavingsReport.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCompressionSavingsReport.md

## Umsetzungsauftrag

Erzeuge `BackupCompressionSavingsReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht komprimierte und unkomprimierte Backup-Groessen und Einsparungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
