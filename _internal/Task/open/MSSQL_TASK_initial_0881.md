---
task_id: MSSQL_TASK_initial_0881
repository: SQL_Training
domain: MSSQL
title: "Script SpatialBoundingBoxProfiler.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 120
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0881"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialBoundingBoxProfiler.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/SpatialBoundingBoxProfiler.md"
...
# MSSQL_TASK_initial_0881 - Script SpatialBoundingBoxProfiler.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Profiliert Bounding Boxes fuer Spatial-Objekte.
...
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialBoundingBoxProfiler.sql
- T-SQL/76_Spatial_Geography/SQLScripts/SpatialBoundingBoxProfiler.md

## Umsetzungsauftrag

Erzeuge `SpatialBoundingBoxProfiler.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Profiliert Bounding Boxes fuer Spatial-Objekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
