---
task_id: MSSQL_TASK_initial_0719
repository: SQL_Training
domain: MSSQL
title: "Script BrokerServiceInventory.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 282
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0719"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerServiceInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerServiceInventory.md"
...
# MSSQL_TASK_initial_0719 - Script BrokerServiceInventory.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Inventarisiert Services, Queues, Contracts und Message Types.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerServiceInventory.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/BrokerServiceInventory.md

## Umsetzungsauftrag

Erzeuge `BrokerServiceInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Services, Queues, Contracts und Message Types. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
