---
task_id: MSSQL_TASK_initial_0993
repository: SQL_Training
domain: MSSQL
title: "Script RequestWaitClassSummary.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 8
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0993"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestWaitClassSummary.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestWaitClassSummary.md"
...
# MSSQL_TASK_initial_0993 - Script RequestWaitClassSummary.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Fasst aktive Requests nach Wait-Klassen zusammen.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestWaitClassSummary.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/RequestWaitClassSummary.md

## Umsetzungsauftrag

Erzeuge `RequestWaitClassSummary.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Fasst aktive Requests nach Wait-Klassen zusammen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
