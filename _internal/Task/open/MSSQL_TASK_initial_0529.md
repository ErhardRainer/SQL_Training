---
task_id: MSSQL_TASK_initial_0529
repository: SQL_Training
domain: MSSQL
title: "Script OpenrowsetJsonImportTemplate.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 472
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0529"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetJsonImportTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetJsonImportTemplate.md"
...
# MSSQL_TASK_initial_0529 - Script OpenrowsetJsonImportTemplate.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Vorlage fuer JSON-Importe ueber OPENROWSET.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetJsonImportTemplate.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/OpenrowsetJsonImportTemplate.md

## Umsetzungsauftrag

Erzeuge `OpenrowsetJsonImportTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer JSON-Importe ueber OPENROWSET. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
