---
task_id: MSSQL_TASK_initial_0565
repository: SQL_Training
domain: MSSQL
title: "Script TempTableIndexingDemo.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 436
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0565"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableIndexingDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableIndexingDemo.md"
...
# MSSQL_TASK_initial_0565 - Script TempTableIndexingDemo.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Demonstriert, wann Indizes auf Temp-Tabellen helfen oder eher nur Overhead erzeugen.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableIndexingDemo.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableIndexingDemo.md

## Umsetzungsauftrag

Erzeuge `TempTableIndexingDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert, wann Indizes auf Temp-Tabellen helfen oder eher nur Overhead erzeugen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
