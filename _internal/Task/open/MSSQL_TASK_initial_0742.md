---
task_id: MSSQL_TASK_initial_0742
repository: SQL_Training
domain: MSSQL
title: "Script ExternalQueryPushdownDemo.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 259
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0742"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalQueryPushdownDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalQueryPushdownDemo.md"
...
# MSSQL_TASK_initial_0742 - Script ExternalQueryPushdownDemo.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Demonstriert moegliche und fehlende Pushdowns in externen Abfragen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalQueryPushdownDemo.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalQueryPushdownDemo.md

## Umsetzungsauftrag

Erzeuge `ExternalQueryPushdownDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert moegliche und fehlende Pushdowns in externen Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
