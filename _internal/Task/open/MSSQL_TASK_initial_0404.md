---
task_id: MSSQL_TASK_initial_0404
repository: SQL_Training
domain: MSSQL
title: "Script ScalarFunctionInliningCandidates.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 597
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0404"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionInliningCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionInliningCandidates.md"
...
# MSSQL_TASK_initial_0404 - Script ScalarFunctionInliningCandidates.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Markiert skalare Funktionen, die sich fuer Inlining eignen koennten.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionInliningCandidates.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarFunctionInliningCandidates.md

## Umsetzungsauftrag

Erzeuge `ScalarFunctionInliningCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Markiert skalare Funktionen, die sich fuer Inlining eignen koennten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
