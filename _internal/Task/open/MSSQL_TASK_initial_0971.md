---
task_id: MSSQL_TASK_initial_0971
repository: SQL_Training
domain: MSSQL
title: "Script MemoryOptimizedTableDurabilityAudit.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 30
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0971"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedTableDurabilityAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedTableDurabilityAudit.md"
...
# MSSQL_TASK_initial_0971 - Script MemoryOptimizedTableDurabilityAudit.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Audit fuer Durability-Einstellungen speicheroptimierter Tabellen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedTableDurabilityAudit.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedTableDurabilityAudit.md

## Umsetzungsauftrag

Erzeuge `MemoryOptimizedTableDurabilityAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Durability-Einstellungen speicheroptimierter Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
