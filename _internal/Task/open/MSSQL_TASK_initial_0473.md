---
task_id: MSSQL_TASK_initial_0473
repository: SQL_Training
domain: MSSQL
title: "Script JsonArrayLengthProfile.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 528
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0473"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonArrayLengthProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonArrayLengthProfile.md"
...
# MSSQL_TASK_initial_0473 - Script JsonArrayLengthProfile.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Profiling der Laengen von Arrays in JSON-Dokumenten.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonArrayLengthProfile.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonArrayLengthProfile.md

## Umsetzungsauftrag

Erzeuge `JsonArrayLengthProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Profiling der Laengen von Arrays in JSON-Dokumenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
