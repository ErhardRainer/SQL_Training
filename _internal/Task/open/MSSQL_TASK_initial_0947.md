---
task_id: MSSQL_TASK_initial_0947
repository: SQL_Training
domain: MSSQL
title: "Script AzureFeatureGapMatrix.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 54
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0947"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureGapMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureGapMatrix.md"
...
# MSSQL_TASK_initial_0947 - Script AzureFeatureGapMatrix.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Matrix ueber Feature-Luecken zwischen Zielplattformen.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureGapMatrix.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureFeatureGapMatrix.md

## Umsetzungsauftrag

Erzeuge `AzureFeatureGapMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber Feature-Luecken zwischen Zielplattformen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
