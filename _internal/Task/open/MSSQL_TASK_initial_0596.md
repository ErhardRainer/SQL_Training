---
task_id: MSSQL_TASK_initial_0596
repository: SQL_Training
domain: MSSQL
title: "Script CollationAwareSearchPatterns.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 405
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0596"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationAwareSearchPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationAwareSearchPatterns.md"
...
# MSSQL_TASK_initial_0596 - Script CollationAwareSearchPatterns.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Suchmuster mit bewusst gesetzten Kollationen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationAwareSearchPatterns.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationAwareSearchPatterns.md

## Umsetzungsauftrag

Erzeuge `CollationAwareSearchPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Suchmuster mit bewusst gesetzten Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
