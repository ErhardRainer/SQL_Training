---
task_id: MSSQL_TASK_initial_0788
repository: SQL_Training
domain: MSSQL
title: "Script JobDisabledSinceAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 213
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0788"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobDisabledSinceAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobDisabledSinceAudit.md"
...
# MSSQL_TASK_initial_0788 - Script JobDisabledSinceAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Audit ueber laenger deaktivierte Jobs.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobDisabledSinceAudit.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobDisabledSinceAudit.md

## Umsetzungsauftrag

Erzeuge `JobDisabledSinceAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber laenger deaktivierte Jobs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
