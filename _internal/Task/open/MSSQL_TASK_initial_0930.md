---
task_id: MSSQL_TASK_initial_0930
repository: SQL_Training
domain: MSSQL
title: "Script ProcedureBehaviorRegressionTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 71
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0930"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/ProcedureBehaviorRegressionTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/ProcedureBehaviorRegressionTemplate.md"
...
# MSSQL_TASK_initial_0930 - Script ProcedureBehaviorRegressionTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer Verhaltensregressionen bei Prozeduren.
...
- T-SQL/79_TSQL_Testing/SQLScripts/ProcedureBehaviorRegressionTemplate.sql
- T-SQL/79_TSQL_Testing/SQLScripts/ProcedureBehaviorRegressionTemplate.md

## Umsetzungsauftrag

Erzeuge `ProcedureBehaviorRegressionTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Verhaltensregressionen bei Prozeduren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
