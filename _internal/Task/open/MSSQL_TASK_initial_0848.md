---
task_id: MSSQL_TASK_initial_0848
repository: SQL_Training
domain: MSSQL
title: "Script EtlBatchControlTableTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 153
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0848"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchControlTableTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchControlTableTemplate.md"
...
# MSSQL_TASK_initial_0848 - Script EtlBatchControlTableTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Vorlage fuer eine Steuerungstabelle von ETL-Batches.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchControlTableTemplate.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchControlTableTemplate.md

## Umsetzungsauftrag

Erzeuge `EtlBatchControlTableTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer eine Steuerungstabelle von ETL-Batches. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
