---
task_id: MSSQL_TASK_initial_0425
repository: SQL_Training
domain: MSSQL
title: "Script TransientErrorDecisionMatrix.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: open
priority: 576
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0425"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransientErrorDecisionMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransientErrorDecisionMatrix.md"
...
# MSSQL_TASK_initial_0425 - Script TransientErrorDecisionMatrix.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Klassifiziert typische SQL-Fehler in retrybar, transient oder fachlich final.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransientErrorDecisionMatrix.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/TransientErrorDecisionMatrix.md

## Umsetzungsauftrag

Erzeuge `TransientErrorDecisionMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Klassifiziert typische SQL-Fehler in retrybar, transient oder fachlich final. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
