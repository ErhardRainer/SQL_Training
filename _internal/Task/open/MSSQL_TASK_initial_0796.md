---
task_id: MSSQL_TASK_initial_0796
repository: SQL_Training
domain: MSSQL
title: "Script OperatorNotificationMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 205
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0796"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/OperatorNotificationMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/OperatorNotificationMatrix.md"
...
# MSSQL_TASK_initial_0796 - Script OperatorNotificationMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Matrix von Operatoren, Jobs und Benachrichtigungsregeln.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/OperatorNotificationMatrix.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/OperatorNotificationMatrix.md

## Umsetzungsauftrag

Erzeuge `OperatorNotificationMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Matrix von Operatoren, Jobs und Benachrichtigungsregeln. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
