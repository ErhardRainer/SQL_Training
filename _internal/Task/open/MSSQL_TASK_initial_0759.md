---
task_id: MSSQL_TASK_initial_0759
repository: SQL_Training
domain: MSSQL
title: "Script BackupCopyOnlyInventory.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 242
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0759"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCopyOnlyInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCopyOnlyInventory.md"
...
# MSSQL_TASK_initial_0759 - Script BackupCopyOnlyInventory.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Inventarisiert Copy-Only-Backups in `msdb`.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCopyOnlyInventory.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupCopyOnlyInventory.md

## Umsetzungsauftrag

Erzeuge `BackupCopyOnlyInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Copy-Only-Backups in `msdb`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
