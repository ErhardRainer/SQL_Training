---
task_id: MSSQL_TASK_initial_0428
repository: SQL_Training
domain: MSSQL
title: "Script XactStateRecoveryDemo.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: open
priority: 573
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0428"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/XactStateRecoveryDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/XactStateRecoveryDemo.md"
...
# MSSQL_TASK_initial_0428 - Script XactStateRecoveryDemo.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Demonstriert den Einsatz von `XACT_STATE()` bei Fehlern in Transaktionen.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/XactStateRecoveryDemo.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/XactStateRecoveryDemo.md

## Umsetzungsauftrag

Erzeuge `XactStateRecoveryDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert den Einsatz von `XACT_STATE()` bei Fehlern in Transaktionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
