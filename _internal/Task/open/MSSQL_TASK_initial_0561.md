---
task_id: MSSQL_TASK_initial_0561
repository: SQL_Training
domain: MSSQL
title: "Script SubqueryFlatteningPreview.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 440
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0561"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryFlatteningPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryFlatteningPreview.md"
...
# MSSQL_TASK_initial_0561 - Script SubqueryFlatteningPreview.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Preview fuer moegliche Vereinfachungen geschachtelter Unterabfragen.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryFlatteningPreview.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/SubqueryFlatteningPreview.md

## Umsetzungsauftrag

Erzeuge `SubqueryFlatteningPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Preview fuer moegliche Vereinfachungen geschachtelter Unterabfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
