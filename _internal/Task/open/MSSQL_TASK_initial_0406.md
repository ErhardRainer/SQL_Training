---
task_id: MSSQL_TASK_initial_0406
repository: SQL_Training
domain: MSSQL
title: "Script ScalarUdfInliningCheck.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 595
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0406"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfInliningCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfInliningCheck.md"
...
# MSSQL_TASK_initial_0406 - Script ScalarUdfInliningCheck.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Prueft, welche Scalar UDFs fuer Inlining in Frage kommen oder ausgeschlossen sind.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfInliningCheck.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/ScalarUdfInliningCheck.md

## Umsetzungsauftrag

Erzeuge `ScalarUdfInliningCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, welche Scalar UDFs fuer Inlining in Frage kommen oder ausgeschlossen sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
