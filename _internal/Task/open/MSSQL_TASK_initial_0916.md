---
task_id: MSSQL_TASK_initial_0916
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreSegmentEliminationCheck.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 85
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0916"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentEliminationCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentEliminationCheck.md"
...
# MSSQL_TASK_initial_0916 - Script ColumnstoreSegmentEliminationCheck.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Prueft, ob Segment Elimination in typischen Filterabfragen greift.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentEliminationCheck.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentEliminationCheck.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreSegmentEliminationCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, ob Segment Elimination in typischen Filterabfragen greift. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
