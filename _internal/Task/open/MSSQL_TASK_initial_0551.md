---
task_id: MSSQL_TASK_initial_0551
repository: SQL_Training
domain: MSSQL
title: "Script ApplyTopOnePattern.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 450
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0551"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyTopOnePattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyTopOnePattern.md"
...
# MSSQL_TASK_initial_0551 - Script ApplyTopOnePattern.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Typisches `APPLY TOP (1)`-Pattern fuer den letzten passenden Satz.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyTopOnePattern.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ApplyTopOnePattern.md

## Umsetzungsauftrag

Erzeuge `ApplyTopOnePattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Typisches `APPLY TOP (1)`-Pattern fuer den letzten passenden Satz. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
