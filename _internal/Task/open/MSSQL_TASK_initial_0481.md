---
task_id: MSSQL_TASK_initial_0481
repository: SQL_Training
domain: MSSQL
title: "Script JsonSchemaValidationStarter.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 520
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0481"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaValidationStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaValidationStarter.md"
...
# MSSQL_TASK_initial_0481 - Script JsonSchemaValidationStarter.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Einstiegsvorlage fuer einfache JSON-Strukturpruefungen und Pflichtfelder.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaValidationStarter.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonSchemaValidationStarter.md

## Umsetzungsauftrag

Erzeuge `JsonSchemaValidationStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Einstiegsvorlage fuer einfache JSON-Strukturpruefungen und Pflichtfelder. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
