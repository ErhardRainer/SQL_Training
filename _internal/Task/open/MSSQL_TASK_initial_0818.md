---
task_id: MSSQL_TASK_initial_0818
repository: SQL_Training
domain: MSSQL
title: "Script TvpNullabilityCheck.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 183
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0818"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpNullabilityCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpNullabilityCheck.md"
...
# MSSQL_TASK_initial_0818 - Script TvpNullabilityCheck.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Vergleicht Nullability-Regeln zwischen Table Type und konsumierender Logik.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpNullabilityCheck.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpNullabilityCheck.md

## Umsetzungsauftrag

Erzeuge `TvpNullabilityCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Nullability-Regeln zwischen Table Type und konsumierender Logik. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
