---
task_id: MSSQL_TASK_initial_0761
repository: SQL_Training
domain: MSSQL
title: "Script BackupMediaFamilyInventory.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 240
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0761"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupMediaFamilyInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupMediaFamilyInventory.md"
...
# MSSQL_TASK_initial_0761 - Script BackupMediaFamilyInventory.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Inventarisiert Backup-Dateien und Medienfamilien aus `msdb`.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupMediaFamilyInventory.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupMediaFamilyInventory.md

## Umsetzungsauftrag

Erzeuge `BackupMediaFamilyInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Backup-Dateien und Medienfamilien aus `msdb`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
