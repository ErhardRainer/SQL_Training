---
task_id: MSSQL_TASK_initial_0487
repository: SQL_Training
domain: MSSQL
title: "Script XmlElementExistenceMatrix.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 514
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0487"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlElementExistenceMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlElementExistenceMatrix.md"
...
# MSSQL_TASK_initial_0487 - Script XmlElementExistenceMatrix.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Matrix ueber das Vorkommen relevanter XML-Elemente.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlElementExistenceMatrix.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlElementExistenceMatrix.md

## Umsetzungsauftrag

Erzeuge `XmlElementExistenceMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Matrix ueber das Vorkommen relevanter XML-Elemente. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
