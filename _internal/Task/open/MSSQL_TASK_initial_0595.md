---
task_id: MSSQL_TASK_initial_0595
repository: SQL_Training
domain: MSSQL
title: "Script CaseSensitiveComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 406
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0595"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseSensitiveComparisonLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseSensitiveComparisonLab.md"
...
# MSSQL_TASK_initial_0595 - Script CaseSensitiveComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Demonstriert Vergleiche und Sortierung unter CI- und CS-Kollationen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseSensitiveComparisonLab.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CaseSensitiveComparisonLab.md

## Umsetzungsauftrag

Erzeuge `CaseSensitiveComparisonLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Vergleiche und Sortierung unter CI- und CS-Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
