---
task_id: MSSQL_TASK_initial_0911
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreInsertBatchAdvisor.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 90
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0911"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreInsertBatchAdvisor.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreInsertBatchAdvisor.md"
...
# MSSQL_TASK_initial_0911 - Script ColumnstoreInsertBatchAdvisor.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Gibt Hinweise auf passende Insert-Batchgroessen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreInsertBatchAdvisor.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreInsertBatchAdvisor.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreInsertBatchAdvisor.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Gibt Hinweise auf passende Insert-Batchgroessen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
