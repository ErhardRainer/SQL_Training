---
task_id: MSSQL_TASK_initial_0536
repository: SQL_Training
domain: MSSQL
title: "Script LockEscalationWatch.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 465
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0536"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/LockEscalationWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/LockEscalationWatch.md"
...
# MSSQL_TASK_initial_0536 - Script LockEscalationWatch.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Beobachtet moegliche Lock Escalations in aktiven Workloads.
...
- T-SQL/60_IsolationLevels/SQLScripts/LockEscalationWatch.sql
- T-SQL/60_IsolationLevels/SQLScripts/LockEscalationWatch.md

## Umsetzungsauftrag

Erzeuge `LockEscalationWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet moegliche Lock Escalations in aktiven Workloads. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
