---
task_id: MSSQL_TASK_initial_0642
repository: SQL_Training
domain: MSSQL
title: "Script PartitionFunctionBoundaryMap.sql fuer 65_Partitioning erstellen"
status: open
priority: 359
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0642"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionFunctionBoundaryMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionFunctionBoundaryMap.md"
...
# MSSQL_TASK_initial_0642 - Script PartitionFunctionBoundaryMap.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Zeichnet Grenzwerte und Partitionsnummern einer Partition Function nach.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionFunctionBoundaryMap.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionFunctionBoundaryMap.md

## Umsetzungsauftrag

Erzeuge `PartitionFunctionBoundaryMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Zeichnet Grenzwerte und Partitionsnummern einer Partition Function nach. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
