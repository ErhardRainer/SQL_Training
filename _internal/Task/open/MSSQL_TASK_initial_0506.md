---
task_id: MSSQL_TASK_initial_0506
repository: SQL_Training
domain: MSSQL
title: "Script PeriodBoundaryTemplate.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 495
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0506"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/PeriodBoundaryTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/PeriodBoundaryTemplate.md"
...
# MSSQL_TASK_initial_0506 - Script PeriodBoundaryTemplate.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Vorlage fuer Monats-, Quartals- und Jahresgrenzen in Reporting-Abfragen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/PeriodBoundaryTemplate.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/PeriodBoundaryTemplate.md

## Umsetzungsauftrag

Erzeuge `PeriodBoundaryTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Monats-, Quartals- und Jahresgrenzen in Reporting-Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
