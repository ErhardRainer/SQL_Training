---
task_id: MSSQL_TASK_initial_0519
repository: SQL_Training
domain: MSSQL
title: "Script BulkLoadRejectRowLogDemo.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 482
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0519"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectRowLogDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectRowLogDemo.md"
...
# MSSQL_TASK_initial_0519 - Script BulkLoadRejectRowLogDemo.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Demonstriert Reject-Logging und Fehlernachverfolgung bei Bulk-Importen.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectRowLogDemo.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkLoadRejectRowLogDemo.md

## Umsetzungsauftrag

Erzeuge `BulkLoadRejectRowLogDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert Reject-Logging und Fehlernachverfolgung bei Bulk-Importen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
