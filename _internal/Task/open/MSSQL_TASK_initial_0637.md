---
task_id: MSSQL_TASK_initial_0637
repository: SQL_Training
domain: MSSQL
title: "Script NonAlignedIndexFinder.sql fuer 65_Partitioning erstellen"
status: open
priority: 364
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0637"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/NonAlignedIndexFinder.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/NonAlignedIndexFinder.md"
...
# MSSQL_TASK_initial_0637 - Script NonAlignedIndexFinder.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Findet nicht ausgerichtete Indizes auf partitionierten Tabellen.
...
- T-SQL/65_Partitioning/SQLScripts/NonAlignedIndexFinder.sql
- T-SQL/65_Partitioning/SQLScripts/NonAlignedIndexFinder.md

## Umsetzungsauftrag

Erzeuge `NonAlignedIndexFinder.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Findet nicht ausgerichtete Indizes auf partitionierten Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
