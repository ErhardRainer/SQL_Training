---
task_id: MSSQL_TASK_initial_0757
repository: SQL_Training
domain: MSSQL
title: "Script BackupChainGapDetector.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 244
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0757"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupChainGapDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupChainGapDetector.md"
...
# MSSQL_TASK_initial_0757 - Script BackupChainGapDetector.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Findet Luecken in Full-, Diff- und Log-Backup-Ketten.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupChainGapDetector.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupChainGapDetector.md

## Umsetzungsauftrag

Erzeuge `BackupChainGapDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Findet Luecken in Full-, Diff- und Log-Backup-Ketten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
