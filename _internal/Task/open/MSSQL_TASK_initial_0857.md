---
task_id: MSSQL_TASK_initial_0857
repository: SQL_Training
domain: MSSQL
title: "Script ReplayWindowSizingGuide.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 144
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0857"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ReplayWindowSizingGuide.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ReplayWindowSizingGuide.md"
...
# MSSQL_TASK_initial_0857 - Script ReplayWindowSizingGuide.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Leitfaden fuer das Groessendesign von Replay-Fenstern.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ReplayWindowSizingGuide.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/ReplayWindowSizingGuide.md

## Umsetzungsauftrag

Erzeuge `ReplayWindowSizingGuide.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Leitfaden fuer das Groessendesign von Replay-Fenstern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
