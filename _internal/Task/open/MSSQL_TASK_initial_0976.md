---
task_id: MSSQL_TASK_initial_0976
repository: SQL_Training
domain: MSSQL
title: "Script XtpCheckpointFileInventory.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 25
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0976"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/XtpCheckpointFileInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/XtpCheckpointFileInventory.md"
...
# MSSQL_TASK_initial_0976 - Script XtpCheckpointFileInventory.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Inventarisiert XTP-Checkpoint-Dateien und Dateigruppen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/XtpCheckpointFileInventory.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/XtpCheckpointFileInventory.md

## Umsetzungsauftrag

Erzeuge `XtpCheckpointFileInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert XTP-Checkpoint-Dateien und Dateigruppen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
