---
task_id: MSSQL_TASK_initial_0925
repository: SQL_Training
domain: MSSQL
title: "Script SegmentPruningPreview.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 76
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0925"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/SegmentPruningPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/SegmentPruningPreview.md"
...
# MSSQL_TASK_initial_0925 - Script SegmentPruningPreview.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Preview fuer Segment-Pruning in typischen Filterabfragen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/SegmentPruningPreview.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/SegmentPruningPreview.md

## Umsetzungsauftrag

Erzeuge `SegmentPruningPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Preview fuer Segment-Pruning in typischen Filterabfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
