---
task_id: MSSQL_TASK_initial_0500
repository: SQL_Training
domain: MSSQL
title: "Script DateKeyGenerationPatterns.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 501
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0500"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateKeyGenerationPatterns.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/DateKeyGenerationPatterns.md"
...
# MSSQL_TASK_initial_0500 - Script DateKeyGenerationPatterns.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Muster fuer Date Keys in Dimensions- und Faktentabellen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/DateKeyGenerationPatterns.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/DateKeyGenerationPatterns.md

## Umsetzungsauftrag

Erzeuge `DateKeyGenerationPatterns.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Muster fuer Date Keys in Dimensions- und Faktentabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
