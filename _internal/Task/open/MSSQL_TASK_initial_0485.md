---
task_id: MSSQL_TASK_initial_0485
repository: SQL_Training
domain: MSSQL
title: "Script XmlAttributeInventory.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 516
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0485"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeInventory.md"
...
# MSSQL_TASK_initial_0485 - Script XmlAttributeInventory.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Inventarisiert Attribute in XML-Strukturen fuer Mapping und Doku.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeInventory.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeInventory.md

## Umsetzungsauftrag

Erzeuge `XmlAttributeInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert Attribute in XML-Strukturen fuer Mapping und Doku. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
