---
task_id: MSSQL_TASK_initial_0787
repository: SQL_Training
domain: MSSQL
title: "Script JobCategoryInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 214
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0787"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobCategoryInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobCategoryInventory.md"
...
# MSSQL_TASK_initial_0787 - Script JobCategoryInventory.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Inventar ueber Job-Kategorien und deren Nutzung.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobCategoryInventory.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobCategoryInventory.md

## Umsetzungsauftrag

Erzeuge `JobCategoryInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Inventar ueber Job-Kategorien und deren Nutzung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
