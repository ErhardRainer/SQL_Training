---
task_id: MSSQL_TASK_initial_0445
repository: SQL_Training
domain: MSSQL
title: "Script IndexUsageTrendSnapshot.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 556
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0445"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexUsageTrendSnapshot.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexUsageTrendSnapshot.md"
...
# MSSQL_TASK_initial_0445 - Script IndexUsageTrendSnapshot.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Schnappschuss fuer spaetere Trendvergleiche von Indexnutzung.
...
- T-SQL/26_Indexes_Basics/SQLScripts/IndexUsageTrendSnapshot.sql
- T-SQL/26_Indexes_Basics/SQLScripts/IndexUsageTrendSnapshot.md

## Umsetzungsauftrag

Erzeuge `IndexUsageTrendSnapshot.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Schnappschuss fuer spaetere Trendvergleiche von Indexnutzung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
