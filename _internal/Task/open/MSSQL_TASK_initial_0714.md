---
task_id: MSSQL_TASK_initial_0714
repository: SQL_Training
domain: MSSQL
title: "Script TemporalVersionOverlapProbe.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 287
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0714"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalVersionOverlapProbe.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalVersionOverlapProbe.md"
...
# MSSQL_TASK_initial_0714 - Script TemporalVersionOverlapProbe.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Probe auf ueberlappende Versionierungsintervalle.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalVersionOverlapProbe.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalVersionOverlapProbe.md

## Umsetzungsauftrag

Erzeuge `TemporalVersionOverlapProbe.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Probe auf ueberlappende Versionierungsintervalle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
