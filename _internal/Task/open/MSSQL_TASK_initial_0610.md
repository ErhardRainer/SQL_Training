---
task_id: MSSQL_TASK_initial_0610
repository: SQL_Training
domain: MSSQL
title: "Script CachedPlanCompileStormCheck.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 391
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0610"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CachedPlanCompileStormCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CachedPlanCompileStormCheck.md"
...
# MSSQL_TASK_initial_0610 - Script CachedPlanCompileStormCheck.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Sucht Hinweise auf haeufige Neukompilierung und Plan-Sturm.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CachedPlanCompileStormCheck.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/CachedPlanCompileStormCheck.md

## Umsetzungsauftrag

Erzeuge `CachedPlanCompileStormCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Sucht Hinweise auf haeufige Neukompilierung und Plan-Sturm. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
