---
task_id: MSSQL_TASK_initial_0841
repository: SQL_Training
domain: MSSQL
title: "Script VersionStoreSpaceByDatabase.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 160
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0841"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreSpaceByDatabase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreSpaceByDatabase.md"
...
# MSSQL_TASK_initial_0841 - Script VersionStoreSpaceByDatabase.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Zeigt den Version-Store-Verbrauch je Datenbank.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreSpaceByDatabase.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreSpaceByDatabase.md

## Umsetzungsauftrag

Erzeuge `VersionStoreSpaceByDatabase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt den Version-Store-Verbrauch je Datenbank. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
