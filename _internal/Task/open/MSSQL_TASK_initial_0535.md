---
task_id: MSSQL_TASK_initial_0535
repository: SQL_Training
domain: MSSQL
title: "Script IsolationLevelTestMatrix.sql fuer 60_IsolationLevels erstellen"
status: open
priority: 466
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0535"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelTestMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelTestMatrix.md"
...
# MSSQL_TASK_initial_0535 - Script IsolationLevelTestMatrix.sql fuer 60_IsolationLevels erstellen

## Anlass und Relevanz

Testmatrix fuer mehrere Isolation-Level-Szenarien.
...
- T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelTestMatrix.sql
- T-SQL/60_IsolationLevels/SQLScripts/IsolationLevelTestMatrix.md

## Umsetzungsauftrag

Erzeuge `IsolationLevelTestMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `60_IsolationLevels` und diese fachliche Kurzbeschreibung als Rahmen: Testmatrix fuer mehrere Isolation-Level-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
