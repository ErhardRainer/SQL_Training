---
task_id: MSSQL_TASK_initial_0508
repository: SQL_Training
domain: MSSQL
title: "Script SlidingWindowDateFilterDemo.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 493
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0508"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/SlidingWindowDateFilterDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/SlidingWindowDateFilterDemo.md"
...
# MSSQL_TASK_initial_0508 - Script SlidingWindowDateFilterDemo.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Demonstriert gleitende Zeitfenster fuer Reports und Prozesse.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/SlidingWindowDateFilterDemo.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/SlidingWindowDateFilterDemo.md

## Umsetzungsauftrag

Erzeuge `SlidingWindowDateFilterDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Demonstriert gleitende Zeitfenster fuer Reports und Prozesse. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
