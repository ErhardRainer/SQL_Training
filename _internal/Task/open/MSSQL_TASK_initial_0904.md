---
task_id: MSSQL_TASK_initial_0904
repository: SQL_Training
domain: MSSQL
title: "Script OpenJsonSchemaDriftCheck.sql fuer 77_JSON_ETL_Practices erstellen"
status: open
priority: 97
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0904"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonSchemaDriftCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonSchemaDriftCheck.md"
...
# MSSQL_TASK_initial_0904 - Script OpenJsonSchemaDriftCheck.sql fuer 77_JSON_ETL_Practices erstellen

## Anlass und Relevanz

Vergleicht erwartete und gelieferte JSON-Strukturen zur Drift-Erkennung.
...
- T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonSchemaDriftCheck.sql
- T-SQL/77_JSON_ETL_Practices/SQLScripts/OpenJsonSchemaDriftCheck.md

## Umsetzungsauftrag

Erzeuge `OpenJsonSchemaDriftCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `77_JSON_ETL_Practices` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht erwartete und gelieferte JSON-Strukturen zur Drift-Erkennung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
