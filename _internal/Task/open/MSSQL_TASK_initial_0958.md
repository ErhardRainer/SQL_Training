---
task_id: MSSQL_TASK_initial_0958
repository: SQL_Training
domain: MSSQL
title: "Script ManagedInstanceAgentGapCheck.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 43
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0958"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceAgentGapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceAgentGapCheck.md"
...
# MSSQL_TASK_initial_0958 - Script ManagedInstanceAgentGapCheck.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Check fuer Unterschiede rund um Agent-Funktionalitaet auf MI.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceAgentGapCheck.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ManagedInstanceAgentGapCheck.md

## Umsetzungsauftrag

Erzeuge `ManagedInstanceAgentGapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Check fuer Unterschiede rund um Agent-Funktionalitaet auf MI. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
