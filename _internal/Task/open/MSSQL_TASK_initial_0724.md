---
task_id: MSSQL_TASK_initial_0724
repository: SQL_Training
domain: MSSQL
title: "Script QueueActivationHealthCheck.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 277
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0724"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationHealthCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationHealthCheck.md"
...
# MSSQL_TASK_initial_0724 - Script QueueActivationHealthCheck.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Prueft Aktivierungsstatus, Reader-Prozeduren und potenzielle Engpaesse.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationHealthCheck.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueActivationHealthCheck.md

## Umsetzungsauftrag

Erzeuge `QueueActivationHealthCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Aktivierungsstatus, Reader-Prozeduren und potenzielle Engpaesse. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
