---
task_id: MSSQL_TASK_initial_0638
repository: SQL_Training
domain: MSSQL
title: "Script PartitionBoundaryGapCheck.sql fuer 65_Partitioning erstellen"
status: open
priority: 363
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0638"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryGapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryGapCheck.md"
...
# MSSQL_TASK_initial_0638 - Script PartitionBoundaryGapCheck.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Prueft, ob neue Zeit- oder ID-Bereiche rechtzeitig in der Partition Function angelegt sind.
...
- T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryGapCheck.sql
- T-SQL/65_Partitioning/SQLScripts/PartitionBoundaryGapCheck.md

## Umsetzungsauftrag

Erzeuge `PartitionBoundaryGapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, ob neue Zeit- oder ID-Bereiche rechtzeitig in der Partition Function angelegt sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
