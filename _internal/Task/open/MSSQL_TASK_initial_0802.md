---
task_id: MSSQL_TASK_initial_0802
repository: SQL_Training
domain: MSSQL
title: "Script UnusedScheduleCleanupCandidates.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 199
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0802"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/UnusedScheduleCleanupCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/UnusedScheduleCleanupCandidates.md"
...
# MSSQL_TASK_initial_0802 - Script UnusedScheduleCleanupCandidates.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Zeigt ungenutzte Schedules als Cleanup-Kandidaten.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/UnusedScheduleCleanupCandidates.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/UnusedScheduleCleanupCandidates.md

## Umsetzungsauftrag

Erzeuge `UnusedScheduleCleanupCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt ungenutzte Schedules als Cleanup-Kandidaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
