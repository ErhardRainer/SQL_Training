---
task_id: MSSQL_TASK_initial_0734
repository: SQL_Training
domain: MSSQL
title: "Script TransmissionQueueBacklog.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 267
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0734"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/TransmissionQueueBacklog.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/TransmissionQueueBacklog.md"
...
# MSSQL_TASK_initial_0734 - Script TransmissionQueueBacklog.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Uebersicht ueber Rueckstaende in der Transmission Queue.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/TransmissionQueueBacklog.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/TransmissionQueueBacklog.md

## Umsetzungsauftrag

Erzeuge `TransmissionQueueBacklog.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber Rueckstaende in der Transmission Queue. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
