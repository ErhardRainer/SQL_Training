---
task_id: MSSQL_TASK_initial_0728
repository: SQL_Training
domain: MSSQL
title: "Script QueueMonitorDashboard.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 273
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0728"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueMonitorDashboard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueMonitorDashboard.md"
...
# MSSQL_TASK_initial_0728 - Script QueueMonitorDashboard.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Dashboard-artige Uebersicht fuer Queue-Zustaende.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueMonitorDashboard.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueMonitorDashboard.md

## Umsetzungsauftrag

Erzeuge `QueueMonitorDashboard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Dashboard-artige Uebersicht fuer Queue-Zustaende. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
