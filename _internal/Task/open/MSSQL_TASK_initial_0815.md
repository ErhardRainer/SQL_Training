---
task_id: MSSQL_TASK_initial_0815
repository: SQL_Training
domain: MSSQL
title: "Script TvpIndexHintReview.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 186
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0815"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpIndexHintReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpIndexHintReview.md"
...
# MSSQL_TASK_initial_0815 - Script TvpIndexHintReview.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Review moeglicher Indexstrategien fuer TVP-Konsumenten.
