---
task_id: MSSQL_TASK_initial_0929
repository: SQL_Training
domain: MSSQL
title: "Script FakeTableSetupTemplate.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 72
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0929"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/FakeTableSetupTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/FakeTableSetupTemplate.md"
...
# MSSQL_TASK_initial_0929 - Script FakeTableSetupTemplate.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Vorlage fuer `FakeTable`-basierte Unit-Tests mit vorbereitetem Testgeruest.
...
- T-SQL/79_TSQL_Testing/SQLScripts/FakeTableSetupTemplate.sql
- T-SQL/79_TSQL_Testing/SQLScripts/FakeTableSetupTemplate.md

## Umsetzungsauftrag

Erzeuge `FakeTableSetupTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer `FakeTable`-basierte Unit-Tests mit vorbereitetem Testgeruest. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
