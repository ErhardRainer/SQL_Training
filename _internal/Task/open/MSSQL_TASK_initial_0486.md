---
task_id: MSSQL_TASK_initial_0486
repository: SQL_Training
domain: MSSQL
title: "Script XmlAttributeNullRate.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 515
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0486"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeNullRate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeNullRate.md"
...
# MSSQL_TASK_initial_0486 - Script XmlAttributeNullRate.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Zeigt Null- und Fehlraten bei XML-Attributen.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeNullRate.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlAttributeNullRate.md

## Umsetzungsauftrag

Erzeuge `XmlAttributeNullRate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Null- und Fehlraten bei XML-Attributen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
