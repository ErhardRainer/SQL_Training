---
task_id: MSSQL_TASK_initial_0510
repository: SQL_Training
domain: MSSQL
title: "Script TimezoneShiftImpactLab.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 491
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0510"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/TimezoneShiftImpactLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/TimezoneShiftImpactLab.md"
...
# MSSQL_TASK_initial_0510 - Script TimezoneShiftImpactLab.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Labor fuer Zeitzonenverschiebungen und deren Auswirkungen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/TimezoneShiftImpactLab.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/TimezoneShiftImpactLab.md

## Umsetzungsauftrag

Erzeuge `TimezoneShiftImpactLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Labor fuer Zeitzonenverschiebungen und deren Auswirkungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
