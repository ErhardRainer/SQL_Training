---
task_id: MSSQL_TASK_initial_0864
repository: SQL_Training
domain: MSSQL
title: "Script WatermarkLagHeatmap.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 137
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0864"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkLagHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkLagHeatmap.md"
...
# MSSQL_TASK_initial_0864 - Script WatermarkLagHeatmap.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Heatmap fuer Verzoegerungen relativ zu ETL-Wasserzeichen.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkLagHeatmap.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkLagHeatmap.md

## Umsetzungsauftrag

Erzeuge `WatermarkLagHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap fuer Verzoegerungen relativ zu ETL-Wasserzeichen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
