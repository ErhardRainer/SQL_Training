---
task_id: MSSQL_TASK_initial_0824
repository: SQL_Training
domain: MSSQL
title: "Script ReaderVersionRetentionWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 177
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0824"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/ReaderVersionRetentionWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/ReaderVersionRetentionWatch.md"
...
# MSSQL_TASK_initial_0824 - Script ReaderVersionRetentionWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Beobachtet Leser, die alte Versionen lange festhalten.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/ReaderVersionRetentionWatch.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/ReaderVersionRetentionWatch.md

## Umsetzungsauftrag

Erzeuge `ReaderVersionRetentionWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet Leser, die alte Versionen lange festhalten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
