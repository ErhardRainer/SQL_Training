---
task_id: MSSQL_TASK_initial_0995
repository: SQL_Training
domain: MSSQL
title: "Script SessionProgramSkewReport.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 6
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0995"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionProgramSkewReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionProgramSkewReport.md"
...
# MSSQL_TASK_initial_0995 - Script SessionProgramSkewReport.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Bericht ueber Lastverteilung nach Client-Programm.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionProgramSkewReport.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/SessionProgramSkewReport.md

## Umsetzungsauftrag

Erzeuge `SessionProgramSkewReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Bericht ueber Lastverteilung nach Client-Programm. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
