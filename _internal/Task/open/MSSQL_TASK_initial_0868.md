---
task_id: MSSQL_TASK_initial_0868
repository: SQL_Training
domain: MSSQL
title: "Script GeographyBoundingBoxApprox.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 133
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0868"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyBoundingBoxApprox.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyBoundingBoxApprox.md"
...
# MSSQL_TASK_initial_0868 - Script GeographyBoundingBoxApprox.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Nutzt Bounding-Box-Vorfilter fuer effizientere Geo-Suchen.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyBoundingBoxApprox.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyBoundingBoxApprox.md

## Umsetzungsauftrag

Erzeuge `GeographyBoundingBoxApprox.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Nutzt Bounding-Box-Vorfilter fuer effizientere Geo-Suchen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
