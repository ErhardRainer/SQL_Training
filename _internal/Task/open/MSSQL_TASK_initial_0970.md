---
task_id: MSSQL_TASK_initial_0970
repository: SQL_Training
domain: MSSQL
title: "Script MemoryOptimizedObjectInventory.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 31
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0970"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedObjectInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedObjectInventory.md"
...
# MSSQL_TASK_initial_0970 - Script MemoryOptimizedObjectInventory.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Inventarisiert speicheroptimierte Tabellen, Typen und nativ kompilierte Module.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedObjectInventory.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedObjectInventory.md

## Umsetzungsauftrag

Erzeuge `MemoryOptimizedObjectInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert speicheroptimierte Tabellen, Typen und nativ kompilierte Module. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
