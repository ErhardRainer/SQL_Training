---
task_id: MSSQL_TASK_initial_0972
repository: SQL_Training
domain: MSSQL
title: "Script NativeCompilationUnsupportedConstructs.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 29
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0972"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/NativeCompilationUnsupportedConstructs.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/NativeCompilationUnsupportedConstructs.md"
...
# MSSQL_TASK_initial_0972 - Script NativeCompilationUnsupportedConstructs.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Hilft beim Finden von Konstrukten, die native Kompilierung blockieren koennen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/NativeCompilationUnsupportedConstructs.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/NativeCompilationUnsupportedConstructs.md

## Umsetzungsauftrag

Erzeuge `NativeCompilationUnsupportedConstructs.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Hilft beim Finden von Konstrukten, die native Kompilierung blockieren koennen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
