---
task_id: MSSQL_TASK_initial_0838
repository: SQL_Training
domain: MSSQL
title: "Script VersionStoreCleanupWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 163
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0838"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreCleanupWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreCleanupWatch.md"
...
# MSSQL_TASK_initial_0838 - Script VersionStoreCleanupWatch.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Beobachtet den Abbau von Version-Store-Daten im Zeitverlauf.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreCleanupWatch.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/VersionStoreCleanupWatch.md

## Umsetzungsauftrag

Erzeuge `VersionStoreCleanupWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet den Abbau von Version-Store-Daten im Zeitverlauf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
