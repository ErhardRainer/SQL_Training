---
task_id: MSSQL_TASK_initial_0706
repository: SQL_Training
domain: MSSQL
title: "Script TemporalHistoryGrowthTrend.sql fuer 68_TemporalTables_CDC_CT erstellen"
status: open
priority: 295
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0706"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryGrowthTrend.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryGrowthTrend.md"
...
# MSSQL_TASK_initial_0706 - Script TemporalHistoryGrowthTrend.sql fuer 68_TemporalTables_CDC_CT erstellen

## Anlass und Relevanz

Schaetzt Wachstum und Volumen historischer Tabellen ueber Zeitpunkte.
...
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryGrowthTrend.sql
- T-SQL/68_TemporalTables_CDC_CT/SQLScript/TemporalHistoryGrowthTrend.md

## Umsetzungsauftrag

Erzeuge `TemporalHistoryGrowthTrend.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `68_TemporalTables_CDC_CT` und diese fachliche Kurzbeschreibung als Rahmen: Schaetzt Wachstum und Volumen historischer Tabellen ueber Zeitpunkte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
