---
task_id: MSSQL_TASK_initial_0502
repository: SQL_Training
domain: MSSQL
title: "Script EndOfMonthReportingTemplate.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 499
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0502"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/EndOfMonthReportingTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/EndOfMonthReportingTemplate.md"
...
# MSSQL_TASK_initial_0502 - Script EndOfMonthReportingTemplate.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Vorlage fuer Monatsultimo-Reporting mit sicheren Datumsgrenzen.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/EndOfMonthReportingTemplate.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/EndOfMonthReportingTemplate.md

## Umsetzungsauftrag

Erzeuge `EndOfMonthReportingTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Monatsultimo-Reporting mit sicheren Datumsgrenzen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
