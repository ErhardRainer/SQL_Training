---
task_id: MSSQL_TASK_initial_0650
repository: SQL_Training
domain: MSSQL
title: "Script SlidingWindowSwitchPlan.sql fuer 65_Partitioning erstellen"
status: open
priority: 351
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0650"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/SlidingWindowSwitchPlan.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/SlidingWindowSwitchPlan.md"
...
# MSSQL_TASK_initial_0650 - Script SlidingWindowSwitchPlan.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Vorlage fuer einen sauberen Sliding-Window-Wechsel mit `SWITCH` und Cleanup.
...
- T-SQL/65_Partitioning/SQLScripts/SlidingWindowSwitchPlan.sql
- T-SQL/65_Partitioning/SQLScripts/SlidingWindowSwitchPlan.md

## Umsetzungsauftrag

Erzeuge `SlidingWindowSwitchPlan.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer einen sauberen Sliding-Window-Wechsel mit `SWITCH` und Cleanup. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
