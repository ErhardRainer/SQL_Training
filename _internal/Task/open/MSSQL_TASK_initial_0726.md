---
task_id: MSSQL_TASK_initial_0726
repository: SQL_Training
domain: MSSQL
title: "Script QueueBacklogOverview.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 275
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0726"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueBacklogOverview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueBacklogOverview.md"
...
# MSSQL_TASK_initial_0726 - Script QueueBacklogOverview.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Liefert einen Ueberblick ueber Queue-Laengen, Aktivierungsstatus und Rueckstaende.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueBacklogOverview.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/QueueBacklogOverview.md

## Umsetzungsauftrag

Erzeuge `QueueBacklogOverview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Liefert einen Ueberblick ueber Queue-Laengen, Aktivierungsstatus und Rueckstaende. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
