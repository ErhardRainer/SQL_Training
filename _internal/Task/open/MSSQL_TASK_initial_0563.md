---
task_id: MSSQL_TASK_initial_0563
repository: SQL_Training
domain: MSSQL
title: "Script TempObjectNamingConvention.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 438
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0563"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempObjectNamingConvention.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempObjectNamingConvention.md"
...
# MSSQL_TASK_initial_0563 - Script TempObjectNamingConvention.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Konventionsbeispiele fuer benannte Temp-Objekte.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempObjectNamingConvention.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempObjectNamingConvention.md

## Umsetzungsauftrag

Erzeuge `TempObjectNamingConvention.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Konventionsbeispiele fuer benannte Temp-Objekte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
