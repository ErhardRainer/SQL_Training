---
task_id: MSSQL_TASK_initial_0478
repository: SQL_Training
domain: MSSQL
title: "Script JsonPropertyInventory.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 523
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0478"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyInventory.md"
...
# MSSQL_TASK_initial_0478 - Script JsonPropertyInventory.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Inventarisiert vorkommende JSON-Properties in Stichproben oder Payload-Tabellen.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyInventory.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPropertyInventory.md

## Umsetzungsauftrag

Erzeuge `JsonPropertyInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Inventarisiert vorkommende JSON-Properties in Stichproben oder Payload-Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
