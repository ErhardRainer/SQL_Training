---
task_id: MSSQL_TASK_initial_0921
repository: SQL_Training
domain: MSSQL
title: "Script DeltaStoreBacklogCheck.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 80
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0921"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/DeltaStoreBacklogCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/DeltaStoreBacklogCheck.md"
...
# MSSQL_TASK_initial_0921 - Script DeltaStoreBacklogCheck.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Findet Rueckstaende im Delta Store vor der Komprimierung.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/DeltaStoreBacklogCheck.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/DeltaStoreBacklogCheck.md

## Umsetzungsauftrag

Erzeuge `DeltaStoreBacklogCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Findet Rueckstaende im Delta Store vor der Komprimierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
