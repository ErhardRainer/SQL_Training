---
task_id: MSSQL_TASK_initial_0426
repository: SQL_Training
domain: MSSQL
title: "Script UserErrorCatalogTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen"
status: open
priority: 575
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0426"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/UserErrorCatalogTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/25_ErrorHandling_TryCatch/SQLScripts/UserErrorCatalogTemplate.md"
...
# MSSQL_TASK_initial_0426 - Script UserErrorCatalogTemplate.sql fuer 25_ErrorHandling_TryCatch erstellen

## Anlass und Relevanz

Vorlage fuer einen fachlichen Fehlerkatalog.
...
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/UserErrorCatalogTemplate.sql
- T-SQL/25_ErrorHandling_TryCatch/SQLScripts/UserErrorCatalogTemplate.md

## Umsetzungsauftrag

Erzeuge `UserErrorCatalogTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `25_ErrorHandling_TryCatch` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer einen fachlichen Fehlerkatalog. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
