---
task_id: MSSQL_TASK_initial_0876
repository: SQL_Training
domain: MSSQL
title: "Script NearestStoreDemo.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 125
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0876"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/NearestStoreDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/NearestStoreDemo.md"
...
# MSSQL_TASK_initial_0876 - Script NearestStoreDemo.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Demo fuer naechstgelegene Standortsuche.
...
- T-SQL/76_Spatial_Geography/SQLScripts/NearestStoreDemo.sql
- T-SQL/76_Spatial_Geography/SQLScripts/NearestStoreDemo.md

## Umsetzungsauftrag

Erzeuge `NearestStoreDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Demo fuer naechstgelegene Standortsuche. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
