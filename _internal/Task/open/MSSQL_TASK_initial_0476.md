---
task_id: MSSQL_TASK_initial_0476
repository: SQL_Training
domain: MSSQL
title: "Script JsonPathCoverageCheck.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 525
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0476"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathCoverageCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathCoverageCheck.md"
...
# MSSQL_TASK_initial_0476 - Script JsonPathCoverageCheck.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Prueft, welche erwarteten JSON-Pfade in einer Payload wirklich befuellt sind.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathCoverageCheck.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/JsonPathCoverageCheck.md

## Umsetzungsauftrag

Erzeuge `JsonPathCoverageCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Prueft, welche erwarteten JSON-Pfade in einer Payload wirklich befuellt sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
