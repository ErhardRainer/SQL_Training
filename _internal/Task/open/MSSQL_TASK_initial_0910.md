---
task_id: MSSQL_TASK_initial_0910
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreCompressionOverview.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 91
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0910"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreCompressionOverview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreCompressionOverview.md"
...
# MSSQL_TASK_initial_0910 - Script ColumnstoreCompressionOverview.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Zeigt Segmentgroessen, Kompression und Delete-Bitmaps fuer Columnstore-Strukturen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreCompressionOverview.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreCompressionOverview.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreCompressionOverview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Segmentgroessen, Kompression und Delete-Bitmaps fuer Columnstore-Strukturen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
