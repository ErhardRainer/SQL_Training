---
task_id: MSSQL_TASK_initial_0659
repository: SQL_Training
domain: MSSQL
title: "Script GrantDenyConflictAudit.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 342
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0659"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/GrantDenyConflictAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/GrantDenyConflictAudit.md"
...
# MSSQL_TASK_initial_0659 - Script GrantDenyConflictAudit.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Audit ueber Konflikte zwischen GRANT und DENY.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/GrantDenyConflictAudit.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/GrantDenyConflictAudit.md

## Umsetzungsauftrag

Erzeuge `GrantDenyConflictAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Konflikte zwischen GRANT und DENY. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
