---
task_id: MSSQL_TASK_initial_0983
repository: SQL_Training
domain: MSSQL
title: "Script BlockingRootCauseStarter.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 18
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0983"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingRootCauseStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingRootCauseStarter.md"
...
# MSSQL_TASK_initial_0983 - Script BlockingRootCauseStarter.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Startpunkt fuer die Ursachenanalyse von Blocking-Situationen.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingRootCauseStarter.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/SQLScripts/BlockingRootCauseStarter.md

## Umsetzungsauftrag

Erzeuge `BlockingRootCauseStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Startpunkt fuer die Ursachenanalyse von Blocking-Situationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
