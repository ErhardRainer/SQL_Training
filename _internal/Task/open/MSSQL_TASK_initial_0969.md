---
task_id: MSSQL_TASK_initial_0969
repository: SQL_Training
domain: MSSQL
title: "Script MemoryOptimizedIndexUsageReview.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 32
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0969"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedIndexUsageReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedIndexUsageReview.md"
...
# MSSQL_TASK_initial_0969 - Script MemoryOptimizedIndexUsageReview.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Review ueber die Nutzung von Indizes auf memory-optimized Tabellen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedIndexUsageReview.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/MemoryOptimizedIndexUsageReview.md

## Umsetzungsauftrag

Erzeuge `MemoryOptimizedIndexUsageReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber die Nutzung von Indizes auf memory-optimized Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
