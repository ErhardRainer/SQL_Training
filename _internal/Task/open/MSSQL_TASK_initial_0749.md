---
task_id: MSSQL_TASK_initial_0749
repository: SQL_Training
domain: MSSQL
title: "Script OpenrowsetCapabilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 252
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0749"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCapabilityCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCapabilityCheck.md"
...
# MSSQL_TASK_initial_0749 - Script OpenrowsetCapabilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Checklistenskript fuer `OPENROWSET`-Faehigkeit und benoetigte Settings.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCapabilityCheck.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/OpenrowsetCapabilityCheck.md

## Umsetzungsauftrag

Erzeuge `OpenrowsetCapabilityCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Checklistenskript fuer `OPENROWSET`-Faehigkeit und benoetigte Settings. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
