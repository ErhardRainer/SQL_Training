---
task_id: MSSQL_TASK_initial_0779
repository: SQL_Training
domain: MSSQL
title: "Script AgentHistoryRetentionReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 222
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0779"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentHistoryRetentionReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentHistoryRetentionReview.md"
...
# MSSQL_TASK_initial_0779 - Script AgentHistoryRetentionReview.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Review der Aufbewahrung von Agent-Historien.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentHistoryRetentionReview.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentHistoryRetentionReview.md

## Umsetzungsauftrag

Erzeuge `AgentHistoryRetentionReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Review der Aufbewahrung von Agent-Historien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
