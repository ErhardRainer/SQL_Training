---
task_id: MSSQL_TASK_initial_0590
repository: SQL_Training
domain: MSSQL
title: "Script AccentSensitivityComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 411
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0590"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/AccentSensitivityComparisonLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/AccentSensitivityComparisonLab.md"
...
# MSSQL_TASK_initial_0590 - Script AccentSensitivityComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Zeigt Unterschiede zwischen accent-sensitive und accent-insensitive Vergleichen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/AccentSensitivityComparisonLab.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/AccentSensitivityComparisonLab.md

## Umsetzungsauftrag

Erzeuge `AccentSensitivityComparisonLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Unterschiede zwischen accent-sensitive und accent-insensitive Vergleichen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
