---
task_id: MSSQL_TASK_initial_0679
repository: SQL_Training
domain: MSSQL
title: "Script FailoverWindowPlanner.sql fuer 67_HA_DR erstellen"
status: open
priority: 322
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0679"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/FailoverWindowPlanner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/FailoverWindowPlanner.md"
...
# MSSQL_TASK_initial_0679 - Script FailoverWindowPlanner.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Plant moegliche Wartungs- und Failover-Fenster.
...
- T-SQL/67_HA_DR/SQLScripts/FailoverWindowPlanner.sql
- T-SQL/67_HA_DR/SQLScripts/FailoverWindowPlanner.md

## Umsetzungsauftrag

Erzeuge `FailoverWindowPlanner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Plant moegliche Wartungs- und Failover-Fenster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
