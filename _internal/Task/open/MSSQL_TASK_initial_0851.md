---
task_id: MSSQL_TASK_initial_0851
repository: SQL_Training
domain: MSSQL
title: "Script EtlRunAuditSummary.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 150
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0851"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlRunAuditSummary.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlRunAuditSummary.md"
...
# MSSQL_TASK_initial_0851 - Script EtlRunAuditSummary.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Erstellt eine Zusammenfassung einzelner ETL-Laeufe.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlRunAuditSummary.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlRunAuditSummary.md

## Umsetzungsauftrag

Erzeuge `EtlRunAuditSummary.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine Zusammenfassung einzelner ETL-Laeufe. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
