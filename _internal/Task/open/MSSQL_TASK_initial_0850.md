---
task_id: MSSQL_TASK_initial_0850
repository: SQL_Training
domain: MSSQL
title: "Script EtlCheckpointRecoveryTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 151
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0850"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlCheckpointRecoveryTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlCheckpointRecoveryTemplate.md"
...
# MSSQL_TASK_initial_0850 - Script EtlCheckpointRecoveryTemplate.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Vorlage fuer den Wiederanlauf ab ETL-Checkpoints.
