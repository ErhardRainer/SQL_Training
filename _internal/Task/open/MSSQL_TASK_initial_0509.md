---
task_id: MSSQL_TASK_initial_0509
repository: SQL_Training
domain: MSSQL
title: "Script TimeZoneOffsetExamples.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 492
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0509"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/TimeZoneOffsetExamples.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/TimeZoneOffsetExamples.md"
...
# MSSQL_TASK_initial_0509 - Script TimeZoneOffsetExamples.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Zeigt Zeitverschiebungen und Offset-Beispiele mit `datetimeoffset`.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/TimeZoneOffsetExamples.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/TimeZoneOffsetExamples.md

## Umsetzungsauftrag

Erzeuge `TimeZoneOffsetExamples.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Zeitverschiebungen und Offset-Beispiele mit `datetimeoffset`. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
