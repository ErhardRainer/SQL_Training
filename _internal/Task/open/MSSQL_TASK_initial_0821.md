---
task_id: MSSQL_TASK_initial_0821
repository: SQL_Training
domain: MSSQL
title: "Script TvpUsageTemplate.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 180
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0821"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpUsageTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TvpUsageTemplate.md"
...
# MSSQL_TASK_initial_0821 - Script TvpUsageTemplate.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Startskript fuer Prozeduren mit Table-Valued Parameters inklusive Call-Beispiel.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpUsageTemplate.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TvpUsageTemplate.md

## Umsetzungsauftrag

Erzeuge `TvpUsageTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Startskript fuer Prozeduren mit Table-Valued Parameters inklusive Call-Beispiel. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
