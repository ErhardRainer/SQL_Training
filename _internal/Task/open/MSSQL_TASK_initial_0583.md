---
task_id: MSSQL_TASK_initial_0583
repository: SQL_Training
domain: MSSQL
title: "Script RlsRoleSimulationHarness.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 418
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0583"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsRoleSimulationHarness.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/RlsRoleSimulationHarness.md"
...
# MSSQL_TASK_initial_0583 - Script RlsRoleSimulationHarness.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Testharness fuer Rollen- und Benutzerwechsel bei RLS-Szenarien.
...
- T-SQL/62_Row_Level_Security/SQLScripts/RlsRoleSimulationHarness.sql
- T-SQL/62_Row_Level_Security/SQLScripts/RlsRoleSimulationHarness.md

## Umsetzungsauftrag

Erzeuge `RlsRoleSimulationHarness.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Testharness fuer Rollen- und Benutzerwechsel bei RLS-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
