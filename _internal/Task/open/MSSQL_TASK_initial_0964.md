---
task_id: MSSQL_TASK_initial_0964
repository: SQL_Training
domain: MSSQL
title: "Script HashIndexBucketSizingCheck.sql fuer 81_InMemory_OLTP erstellen"
status: open
priority: 37
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0964"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashIndexBucketSizingCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/81_InMemory_OLTP/SQLScripts/HashIndexBucketSizingCheck.md"
...
# MSSQL_TASK_initial_0964 - Script HashIndexBucketSizingCheck.sql fuer 81_InMemory_OLTP erstellen

## Anlass und Relevanz

Bewertet Hash-Indizes hinsichtlich Bucket-Anzahl und moeglicher Kollisionen.
...
- T-SQL/81_InMemory_OLTP/SQLScripts/HashIndexBucketSizingCheck.sql
- T-SQL/81_InMemory_OLTP/SQLScripts/HashIndexBucketSizingCheck.md

## Umsetzungsauftrag

Erzeuge `HashIndexBucketSizingCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `81_InMemory_OLTP` und diese fachliche Kurzbeschreibung als Rahmen: Bewertet Hash-Indizes hinsichtlich Bucket-Anzahl und moeglicher Kollisionen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
