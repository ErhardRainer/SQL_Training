---
task_id: MSSQL_TASK_initial_0774
repository: SQL_Training
domain: MSSQL
title: "Script RestoreSequenceGenerator.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 227
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0774"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/RestoreSequenceGenerator.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/RestoreSequenceGenerator.md"
...
# MSSQL_TASK_initial_0774 - Script RestoreSequenceGenerator.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Generiert aus der Backup-Historie eine moegliche Restore-Sequenz fuer Tests oder Desasterfaelle.
...
- T-SQL/71_BackupRestore_Strategies/RestoreSequenceGenerator.sql
- T-SQL/71_BackupRestore_Strategies/RestoreSequenceGenerator.md

## Umsetzungsauftrag

Erzeuge `RestoreSequenceGenerator.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Generiert aus der Backup-Historie eine moegliche Restore-Sequenz fuer Tests oder Desasterfaelle. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
