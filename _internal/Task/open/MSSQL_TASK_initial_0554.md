---
task_id: MSSQL_TASK_initial_0554
repository: SQL_Training
domain: MSSQL
title: "Script CorrelatedSubqueryCostDemo.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 447
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0554"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/CorrelatedSubqueryCostDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/CorrelatedSubqueryCostDemo.md"
...
# MSSQL_TASK_initial_0554 - Script CorrelatedSubqueryCostDemo.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Zeigt Kosten und Planformen korrelierter Unterabfragen.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/CorrelatedSubqueryCostDemo.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/CorrelatedSubqueryCostDemo.md

## Umsetzungsauftrag

Erzeuge `CorrelatedSubqueryCostDemo.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Kosten und Planformen korrelierter Unterabfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
