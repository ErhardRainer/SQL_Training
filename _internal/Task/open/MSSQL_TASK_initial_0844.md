---
task_id: MSSQL_TASK_initial_0844
repository: SQL_Training
domain: MSSQL
title: "Script BatchRestartMarkerAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 157
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0844"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/BatchRestartMarkerAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/BatchRestartMarkerAudit.md"
...
# MSSQL_TASK_initial_0844 - Script BatchRestartMarkerAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Audit ueber Restart-Marker fuer ETL-Batches.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/BatchRestartMarkerAudit.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/BatchRestartMarkerAudit.md

## Umsetzungsauftrag

Erzeuge `BatchRestartMarkerAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Restart-Marker fuer ETL-Batches. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
