---
task_id: MSSQL_TASK_initial_0741
repository: SQL_Training
domain: MSSQL
title: "Script ExternalPushdownCapabilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 260
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0741"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalPushdownCapabilityCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalPushdownCapabilityCheck.md"
...
# MSSQL_TASK_initial_0741 - Script ExternalPushdownCapabilityCheck.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Bewertet, welche Filter und Projektionen voraussichtlich pushdown-faehig sind.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalPushdownCapabilityCheck.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalPushdownCapabilityCheck.md

## Umsetzungsauftrag

Erzeuge `ExternalPushdownCapabilityCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Bewertet, welche Filter und Projektionen voraussichtlich pushdown-faehig sind. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
