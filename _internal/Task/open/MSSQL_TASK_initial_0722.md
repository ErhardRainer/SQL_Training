---
task_id: MSSQL_TASK_initial_0722
repository: SQL_Training
domain: MSSQL
title: "Script ConversationLifetimeReview.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 279
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0722"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationLifetimeReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationLifetimeReview.md"
...
# MSSQL_TASK_initial_0722 - Script ConversationLifetimeReview.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Analysiert Dialog-Lebensdauern und Altlasten in bestehenden Conversations.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationLifetimeReview.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationLifetimeReview.md

## Umsetzungsauftrag

Erzeuge `ConversationLifetimeReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Analysiert Dialog-Lebensdauern und Altlasten in bestehenden Conversations. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
