---
task_id: MSSQL_TASK_initial_0806
repository: SQL_Training
domain: MSSQL
title: "Script TableTypeDeploymentDiff.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 195
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0806"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDeploymentDiff.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDeploymentDiff.md"
...
# MSSQL_TASK_initial_0806 - Script TableTypeDeploymentDiff.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Zeigt Unterschiede zwischen zwei Deployment-Staenden von Table Types.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDeploymentDiff.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDeploymentDiff.md

## Umsetzungsauftrag

Erzeuge `TableTypeDeploymentDiff.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Unterschiede zwischen zwei Deployment-Staenden von Table Types. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
