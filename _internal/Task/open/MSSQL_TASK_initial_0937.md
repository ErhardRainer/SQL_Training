---
task_id: MSSQL_TASK_initial_0937
repository: SQL_Training
domain: MSSQL
title: "Script TestCleanupTransactionPattern.sql fuer 79_TSQL_Testing erstellen"
status: open
priority: 64
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0937"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestCleanupTransactionPattern.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/79_TSQL_Testing/SQLScripts/TestCleanupTransactionPattern.md"
...
# MSSQL_TASK_initial_0937 - Script TestCleanupTransactionPattern.sql fuer 79_TSQL_Testing erstellen

## Anlass und Relevanz

Muster fuer Cleanup per Transaktionsrollback in Tests.
...
- T-SQL/79_TSQL_Testing/SQLScripts/TestCleanupTransactionPattern.sql
- T-SQL/79_TSQL_Testing/SQLScripts/TestCleanupTransactionPattern.md

## Umsetzungsauftrag

Erzeuge `TestCleanupTransactionPattern.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `79_TSQL_Testing` und diese fachliche Kurzbeschreibung als Rahmen: Muster fuer Cleanup per Transaktionsrollback in Tests. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
