---
task_id: MSSQL_TASK_initial_0600
repository: SQL_Training
domain: MSSQL
title: "Script CollationMismatchDetector.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 401
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0600"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationMismatchDetector.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationMismatchDetector.md"
...
# MSSQL_TASK_initial_0600 - Script CollationMismatchDetector.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Findet Kollationskonflikte zwischen Datenbanken, Spalten und Temp-Objekten.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationMismatchDetector.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationMismatchDetector.md

## Umsetzungsauftrag

Erzeuge `CollationMismatchDetector.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Findet Kollationskonflikte zwischen Datenbanken, Spalten und Temp-Objekten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
