---
task_id: MSSQL_TASK_initial_0494
repository: SQL_Training
domain: MSSQL
title: "Script BusinessHoursFilterTemplate.sql fuer 29_DateTime_Calendar erstellen"
status: open
priority: 507
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0494"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessHoursFilterTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/29_DateTime_Calendar/SQLScripts/BusinessHoursFilterTemplate.md"
...
# MSSQL_TASK_initial_0494 - Script BusinessHoursFilterTemplate.sql fuer 29_DateTime_Calendar erstellen

## Anlass und Relevanz

Vorlage fuer Filter auf Geschaeftszeiten.
...
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessHoursFilterTemplate.sql
- T-SQL/29_DateTime_Calendar/SQLScripts/BusinessHoursFilterTemplate.md

## Umsetzungsauftrag

Erzeuge `BusinessHoursFilterTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `29_DateTime_Calendar` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Filter auf Geschaeftszeiten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
