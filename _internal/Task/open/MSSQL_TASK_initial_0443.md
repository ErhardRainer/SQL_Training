---
task_id: MSSQL_TASK_initial_0443
repository: SQL_Training
domain: MSSQL
title: "Script IndexNameConventionAudit.sql fuer 26_Indexes_Basics erstellen"
status: open
priority: 558
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0443"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexNameConventionAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/26_Indexes_Basics/SQLScripts/IndexNameConventionAudit.md"
...
# MSSQL_TASK_initial_0443 - Script IndexNameConventionAudit.sql fuer 26_Indexes_Basics erstellen

## Anlass und Relevanz

Audit fuer Benennungskonventionen von Indizes.
...
- T-SQL/26_Indexes_Basics/SQLScripts/IndexNameConventionAudit.sql
- T-SQL/26_Indexes_Basics/SQLScripts/IndexNameConventionAudit.md

## Umsetzungsauftrag

Erzeuge `IndexNameConventionAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `26_Indexes_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Audit fuer Benennungskonventionen von Indizes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
