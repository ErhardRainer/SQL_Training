---
task_id: MSSQL_TASK_initial_0917
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreSegmentQualityAudit.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 84
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0917"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentQualityAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentQualityAudit.md"
...
# MSSQL_TASK_initial_0917 - Script ColumnstoreSegmentQualityAudit.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Audit ueber Qualitaet und Dichte von Segmenten.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentQualityAudit.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreSegmentQualityAudit.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreSegmentQualityAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Qualitaet und Dichte von Segmenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
