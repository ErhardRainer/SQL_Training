---
task_id: MSSQL_TASK_initial_0669
repository: SQL_Training
domain: MSSQL
title: "Script RoleToObjectAccessMap.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 332
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0669"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleToObjectAccessMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleToObjectAccessMap.md"
...
# MSSQL_TASK_initial_0669 - Script RoleToObjectAccessMap.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Map von Rollen zu den Objekten, auf die sie zugreifen duerfen.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleToObjectAccessMap.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/RoleToObjectAccessMap.md

## Umsetzungsauftrag

Erzeuge `RoleToObjectAccessMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Map von Rollen zu den Objekten, auf die sie zugreifen duerfen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
