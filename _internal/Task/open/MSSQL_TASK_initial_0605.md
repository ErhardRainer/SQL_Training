---
task_id: MSSQL_TASK_initial_0605
repository: SQL_Training
domain: MSSQL
title: "Script SortOrderDifferenceLab.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 396
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0605"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/SortOrderDifferenceLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/SortOrderDifferenceLab.md"
...
# MSSQL_TASK_initial_0605 - Script SortOrderDifferenceLab.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Zeigt Unterschiede in Sortierfolgen bei wechselnden Kollationen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/SortOrderDifferenceLab.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/SortOrderDifferenceLab.md

## Umsetzungsauftrag

Erzeuge `SortOrderDifferenceLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Unterschiede in Sortierfolgen bei wechselnden Kollationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
