---
task_id: MSSQL_TASK_initial_0832
repository: SQL_Training
domain: MSSQL
title: "Script SnapshotSettingDriftAudit.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 169
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0832"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotSettingDriftAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotSettingDriftAudit.md"
...
# MSSQL_TASK_initial_0832 - Script SnapshotSettingDriftAudit.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Audit ueber Drift in Snapshot- und RCSI-Einstellungen.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotSettingDriftAudit.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/SnapshotSettingDriftAudit.md

## Umsetzungsauftrag

Erzeuge `SnapshotSettingDriftAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Drift in Snapshot- und RCSI-Einstellungen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
