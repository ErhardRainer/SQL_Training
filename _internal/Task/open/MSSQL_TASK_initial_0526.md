---
task_id: MSSQL_TASK_initial_0526
repository: SQL_Training
domain: MSSQL
title: "Script FormatFileStarter.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 475
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0526"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileStarter.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileStarter.md"
...
# MSSQL_TASK_initial_0526 - Script FormatFileStarter.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Vorlage fuer Bulk-Load-Szenarien mit zugehoeriger Formatdatei und Mapping-Ideen.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileStarter.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/FormatFileStarter.md

## Umsetzungsauftrag

Erzeuge `FormatFileStarter.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Bulk-Load-Szenarien mit zugehoeriger Formatdatei und Mapping-Ideen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
