---
task_id: MSSQL_TASK_initial_0720
repository: SQL_Training
domain: MSSQL
title: "Script ConversationEndpointCleanupCandidates.sql fuer 69_ServiceBroker_Queues erstellen"
status: open
priority: 281
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0720"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationEndpointCleanupCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationEndpointCleanupCandidates.md"
...
# MSSQL_TASK_initial_0720 - Script ConversationEndpointCleanupCandidates.sql fuer 69_ServiceBroker_Queues erstellen

## Anlass und Relevanz

Findet alte oder haengende Conversation Endpoints als Cleanup-Kandidaten.
...
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationEndpointCleanupCandidates.sql
- T-SQL/69_ServiceBroker_Queues/SQLScripts/ConversationEndpointCleanupCandidates.md

## Umsetzungsauftrag

Erzeuge `ConversationEndpointCleanupCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `69_ServiceBroker_Queues` und diese fachliche Kurzbeschreibung als Rahmen: Findet alte oder haengende Conversation Endpoints als Cleanup-Kandidaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
