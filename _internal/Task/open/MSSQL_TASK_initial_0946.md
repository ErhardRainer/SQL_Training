---
task_id: MSSQL_TASK_initial_0946
repository: SQL_Training
domain: MSSQL
title: "Script AzureCompatibilityLevelAudit.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 55
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0946"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityLevelAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityLevelAudit.md"
...
# MSSQL_TASK_initial_0946 - Script AzureCompatibilityLevelAudit.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Prueft Kompatibilitaetslevel und migrationstypische DB-Einstellungen fuer Azure.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityLevelAudit.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureCompatibilityLevelAudit.md

## Umsetzungsauftrag

Erzeuge `AzureCompatibilityLevelAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Prueft Kompatibilitaetslevel und migrationstypische DB-Einstellungen fuer Azure. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
