---
task_id: MSSQL_TASK_initial_0870
repository: SQL_Training
domain: MSSQL
title: "Script GeographyPointFactoryTemplate.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 131
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0870"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyPointFactoryTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeographyPointFactoryTemplate.md"
...
# MSSQL_TASK_initial_0870 - Script GeographyPointFactoryTemplate.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorlage fuer das Erzeugen von Punkten aus Koordinatenwerten.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyPointFactoryTemplate.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeographyPointFactoryTemplate.md

## Umsetzungsauftrag

Erzeuge `GeographyPointFactoryTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer das Erzeugen von Punkten aus Koordinatenwerten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
