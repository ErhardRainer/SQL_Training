---
task_id: MSSQL_TASK_initial_0636
repository: SQL_Training
domain: MSSQL
title: "Script IncrementalStatsCoverage.sql fuer 65_Partitioning erstellen"
status: open
priority: 365
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0636"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/65_Partitioning/SQLScripts/IncrementalStatsCoverage.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/65_Partitioning/SQLScripts/IncrementalStatsCoverage.md"
...
# MSSQL_TASK_initial_0636 - Script IncrementalStatsCoverage.sql fuer 65_Partitioning erstellen

## Anlass und Relevanz

Zeigt, wo inkrementelle Statistiken auf partitionierten Tabellen fehlen.
...
- T-SQL/65_Partitioning/SQLScripts/IncrementalStatsCoverage.sql
- T-SQL/65_Partitioning/SQLScripts/IncrementalStatsCoverage.md

## Umsetzungsauftrag

Erzeuge `IncrementalStatsCoverage.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `65_Partitioning` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wo inkrementelle Statistiken auf partitionierten Tabellen fehlen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
