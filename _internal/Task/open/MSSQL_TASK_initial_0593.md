---
task_id: MSSQL_TASK_initial_0593
repository: SQL_Training
domain: MSSQL
title: "Script BinarySortBehaviorShowcase.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 408
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0593"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinarySortBehaviorShowcase.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinarySortBehaviorShowcase.md"
...
# MSSQL_TASK_initial_0593 - Script BinarySortBehaviorShowcase.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Showcase fuer binÃƒÂ¤re Sortierlogik.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinarySortBehaviorShowcase.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinarySortBehaviorShowcase.md

## Umsetzungsauftrag

Erzeuge `BinarySortBehaviorShowcase.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Showcase fuer binÃƒÂ¤re Sortierlogik. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
