---
task_id: MSSQL_TASK_initial_0685
repository: SQL_Training
domain: MSSQL
title: "Script ReplicaBackupPreferenceAudit.sql fuer 67_HA_DR erstellen"
status: open
priority: 316
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0685"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaBackupPreferenceAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaBackupPreferenceAudit.md"
...
# MSSQL_TASK_initial_0685 - Script ReplicaBackupPreferenceAudit.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Prueft Konfiguration und praktische Wirkung von Backup Preferences in AGs.
