---
task_id: MSSQL_TASK_initial_0766
repository: SQL_Training
domain: MSSQL
title: "Script DifferentialBaseAgeReport.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 235
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0766"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/DifferentialBaseAgeReport.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/DifferentialBaseAgeReport.md"
...
# MSSQL_TASK_initial_0766 - Script DifferentialBaseAgeReport.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Zeigt, wie alt die Differential-Basis je Datenbank ist.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/DifferentialBaseAgeReport.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/DifferentialBaseAgeReport.md

## Umsetzungsauftrag

Erzeuge `DifferentialBaseAgeReport.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt, wie alt die Differential-Basis je Datenbank ist. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
