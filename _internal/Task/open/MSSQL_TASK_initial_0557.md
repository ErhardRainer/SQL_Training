---
task_id: MSSQL_TASK_initial_0557
repository: SQL_Training
domain: MSSQL
title: "Script ExistsVsInComparison.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 444
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0557"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ExistsVsInComparison.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ExistsVsInComparison.md"
...
# MSSQL_TASK_initial_0557 - Script ExistsVsInComparison.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Vergleicht `EXISTS`, `IN` und verwandte Subquery-Muster.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ExistsVsInComparison.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/ExistsVsInComparison.md

## Umsetzungsauftrag

Erzeuge `ExistsVsInComparison.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht `EXISTS`, `IN` und verwandte Subquery-Muster. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
