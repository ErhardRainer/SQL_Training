---
task_id: MSSQL_TASK_initial_0736
repository: SQL_Training
domain: MSSQL
title: "Script ExternalDataSourceCredentialAudit.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 265
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0736"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalDataSourceCredentialAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalDataSourceCredentialAudit.md"
...
# MSSQL_TASK_initial_0736 - Script ExternalDataSourceCredentialAudit.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Uebersicht ueber externe Datenquellen, Credentials und ihre Zuordnung.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalDataSourceCredentialAudit.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalDataSourceCredentialAudit.md

## Umsetzungsauftrag

Erzeuge `ExternalDataSourceCredentialAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber externe Datenquellen, Credentials und ihre Zuordnung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
