---
task_id: MSSQL_TASK_initial_0789
repository: SQL_Training
domain: MSSQL
title: "Script JobFailurePatternHeatmap.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 212
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0789"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobFailurePatternHeatmap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobFailurePatternHeatmap.md"
...
# MSSQL_TASK_initial_0789 - Script JobFailurePatternHeatmap.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Heatmap ueber wiederkehrende Fehlermuster in Jobs.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobFailurePatternHeatmap.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobFailurePatternHeatmap.md

## Umsetzungsauftrag

Erzeuge `JobFailurePatternHeatmap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Heatmap ueber wiederkehrende Fehlermuster in Jobs. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
