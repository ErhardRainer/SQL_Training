---
task_id: MSSQL_TASK_initial_0804
repository: SQL_Training
domain: MSSQL
title: "Script TableTypeConsumerMap.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 197
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0804"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeConsumerMap.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeConsumerMap.md"
...
# MSSQL_TASK_initial_0804 - Script TableTypeConsumerMap.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Mappt Table Types auf konsumierende Module.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeConsumerMap.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeConsumerMap.md

## Umsetzungsauftrag

Erzeuge `TableTypeConsumerMap.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Mappt Table Types auf konsumierende Module. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
