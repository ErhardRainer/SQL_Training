---
task_id: MSSQL_TASK_initial_0513
repository: SQL_Training
domain: MSSQL
title: "Script BulkImportLandingZoneChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen"
status: open
priority: 488
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0513"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkImportLandingZoneChecklist.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkImportLandingZoneChecklist.md"
...
# MSSQL_TASK_initial_0513 - Script BulkImportLandingZoneChecklist.sql fuer 30_BulkLoad_BCP_BULKINSERT erstellen

## Anlass und Relevanz

Checkliste fuer Landing-Zones vor Importlaeufen.
...
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkImportLandingZoneChecklist.sql
- T-SQL/30_BulkLoad_BCP_BULKINSERT/SQLScripts/BulkImportLandingZoneChecklist.md

## Umsetzungsauftrag

Erzeuge `BulkImportLandingZoneChecklist.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `30_BulkLoad_BCP_BULKINSERT` und diese fachliche Kurzbeschreibung als Rahmen: Checkliste fuer Landing-Zones vor Importlaeufen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
