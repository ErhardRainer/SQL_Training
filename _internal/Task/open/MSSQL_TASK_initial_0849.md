---
task_id: MSSQL_TASK_initial_0849
repository: SQL_Training
domain: MSSQL
title: "Script EtlBatchSlaMonitor.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 152
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0849"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchSlaMonitor.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchSlaMonitor.md"
...
# MSSQL_TASK_initial_0849 - Script EtlBatchSlaMonitor.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Ueberwacht SLA-relevante Laufzeiten von ETL-Batches.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchSlaMonitor.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/EtlBatchSlaMonitor.md

## Umsetzungsauftrag

Erzeuge `EtlBatchSlaMonitor.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Ueberwacht SLA-relevante Laufzeiten von ETL-Batches. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
