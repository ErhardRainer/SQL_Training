---
task_id: MSSQL_TASK_initial_0617
repository: SQL_Training
domain: MSSQL
title: "Script ParallelWorkerImbalanceCheck.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 384
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0617"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelWorkerImbalanceCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelWorkerImbalanceCheck.md"
...
# MSSQL_TASK_initial_0617 - Script ParallelWorkerImbalanceCheck.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Check fuer ungleichmaessige Verteilung paralleler Worker.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelWorkerImbalanceCheck.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/ParallelWorkerImbalanceCheck.md

## Umsetzungsauftrag

Erzeuge `ParallelWorkerImbalanceCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Check fuer ungleichmaessige Verteilung paralleler Worker. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
