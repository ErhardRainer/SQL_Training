---
task_id: MSSQL_TASK_initial_0690
repository: SQL_Training
domain: MSSQL
title: "Script SecondaryReadableRoutingCheck.sql fuer 67_HA_DR erstellen"
status: open
priority: 311
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0690"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/SecondaryReadableRoutingCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/SecondaryReadableRoutingCheck.md"
...
# MSSQL_TASK_initial_0690 - Script SecondaryReadableRoutingCheck.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Testet und dokumentiert Read-Only-Routing auf Secondaries.
...
- T-SQL/67_HA_DR/SQLScripts/SecondaryReadableRoutingCheck.sql
- T-SQL/67_HA_DR/SQLScripts/SecondaryReadableRoutingCheck.md

## Umsetzungsauftrag

Erzeuge `SecondaryReadableRoutingCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Testet und dokumentiert Read-Only-Routing auf Secondaries. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
