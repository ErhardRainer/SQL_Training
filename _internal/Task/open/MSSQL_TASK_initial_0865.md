---
task_id: MSSQL_TASK_initial_0865
repository: SQL_Training
domain: MSSQL
title: "Script WatermarkProgressAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen"
status: open
priority: 136
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0865"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkProgressAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkProgressAudit.md"
...
# MSSQL_TASK_initial_0865 - Script WatermarkProgressAudit.sql fuer 75_SSVEPatterns_for_ETL erstellen

## Anlass und Relevanz

Prueft den Fortschritt watermark-basierter ETL-Strecken und markiert Rueckstaende.
...
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkProgressAudit.sql
- T-SQL/75_SSVEPatterns_for_ETL/SQLScripts/WatermarkProgressAudit.md

## Umsetzungsauftrag

Erzeuge `WatermarkProgressAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `75_SSVEPatterns_for_ETL` und diese fachliche Kurzbeschreibung als Rahmen: Prueft den Fortschritt watermark-basierter ETL-Strecken und markiert Rueckstaende. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
