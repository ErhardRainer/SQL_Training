---
task_id: MSSQL_TASK_initial_0591
repository: SQL_Training
domain: MSSQL
title: "Script BinaryCollationComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 410
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0591"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationComparisonLab.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationComparisonLab.md"
...
# MSSQL_TASK_initial_0591 - Script BinaryCollationComparisonLab.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Zeigt das Verhalten binaerer Kollationen bei Vergleich und Sortierung.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationComparisonLab.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/BinaryCollationComparisonLab.md

## Umsetzungsauftrag

Erzeuge `BinaryCollationComparisonLab.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt das Verhalten binaerer Kollationen bei Vergleich und Sortierung. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
