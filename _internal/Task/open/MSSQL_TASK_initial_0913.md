---
task_id: MSSQL_TASK_initial_0913
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreMaintenanceCandidates.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 88
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0913"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreMaintenanceCandidates.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreMaintenanceCandidates.md"
...
# MSSQL_TASK_initial_0913 - Script ColumnstoreMaintenanceCandidates.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Markiert Columnstore-Objekte als Kandidaten fuer Wartungsmassnahmen.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreMaintenanceCandidates.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreMaintenanceCandidates.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreMaintenanceCandidates.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Columnstore-Objekte als Kandidaten fuer Wartungsmassnahmen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
