---
task_id: MSSQL_TASK_initial_0781
repository: SQL_Training
domain: MSSQL
title: "Script AgentScheduleMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 220
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0781"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleMatrix.md"
...
# MSSQL_TASK_initial_0781 - Script AgentScheduleMatrix.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Erstellt eine Matrix von Jobs, Schedules, Aktiv-Status und naechsten Laufzeiten.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleMatrix.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/AgentScheduleMatrix.md

## Umsetzungsauftrag

Erzeuge `AgentScheduleMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Erstellt eine Matrix von Jobs, Schedules, Aktiv-Status und naechsten Laufzeiten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
