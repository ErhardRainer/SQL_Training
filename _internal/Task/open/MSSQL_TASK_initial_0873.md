---
task_id: MSSQL_TASK_initial_0873
repository: SQL_Training
domain: MSSQL
title: "Script GeometryValidityRepairPreview.sql fuer 76_Spatial_Geography erstellen"
status: open
priority: 128
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0873"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeometryValidityRepairPreview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/76_Spatial_Geography/SQLScripts/GeometryValidityRepairPreview.md"
...
# MSSQL_TASK_initial_0873 - Script GeometryValidityRepairPreview.sql fuer 76_Spatial_Geography erstellen

## Anlass und Relevanz

Vorschau moeglicher Reparaturen ungueltiger Geometrien.
...
- T-SQL/76_Spatial_Geography/SQLScripts/GeometryValidityRepairPreview.sql
- T-SQL/76_Spatial_Geography/SQLScripts/GeometryValidityRepairPreview.md

## Umsetzungsauftrag

Erzeuge `GeometryValidityRepairPreview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `76_Spatial_Geography` und diese fachliche Kurzbeschreibung als Rahmen: Vorschau moeglicher Reparaturen ungueltiger Geometrien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
