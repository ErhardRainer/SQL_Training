---
task_id: MSSQL_TASK_initial_0489
repository: SQL_Training
domain: MSSQL
title: "Script XmlNodeCountProfile.sql fuer 28_JSON_XML_Basics erstellen"
status: open
priority: 512
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0489"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNodeCountProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNodeCountProfile.md"
...
# MSSQL_TASK_initial_0489 - Script XmlNodeCountProfile.sql fuer 28_JSON_XML_Basics erstellen

## Anlass und Relevanz

Profiling ueber die Anzahl XML-Knoten in Dokumenten.
...
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNodeCountProfile.sql
- T-SQL/28_JSON_XML_Basics/SQLScripts/XmlNodeCountProfile.md

## Umsetzungsauftrag

Erzeuge `XmlNodeCountProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `28_JSON_XML_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Profiling ueber die Anzahl XML-Knoten in Dokumenten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
