---
task_id: MSSQL_TASK_initial_0754
repository: SQL_Training
domain: MSSQL
title: "Script RejectRowThresholdDemo.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 247
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0754"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowThresholdDemo.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/RejectRowThresholdDemo.md"
...
# MSSQL_TASK_initial_0754 - Script RejectRowThresholdDemo.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Zeigt, wie Reject-Optionen bei fehlerhaften externen Daten den Import beeinflussen.
