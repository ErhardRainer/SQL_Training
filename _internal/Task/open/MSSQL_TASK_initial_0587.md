---
task_id: MSSQL_TASK_initial_0587
repository: SQL_Training
domain: MSSQL
title: "Script SecurityPolicyNamingAudit.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 414
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0587"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/SecurityPolicyNamingAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/SecurityPolicyNamingAudit.md"
...
# MSSQL_TASK_initial_0587 - Script SecurityPolicyNamingAudit.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Audit ueber Benennungsstandards von Security Policies.
...
- T-SQL/62_Row_Level_Security/SQLScripts/SecurityPolicyNamingAudit.sql
- T-SQL/62_Row_Level_Security/SQLScripts/SecurityPolicyNamingAudit.md

## Umsetzungsauftrag

Erzeuge `SecurityPolicyNamingAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Audit ueber Benennungsstandards von Security Policies. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
