---
task_id: MSSQL_TASK_initial_0960
repository: SQL_Training
domain: MSSQL
title: "Script ServerlessPauseResumeReview.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 41
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0960"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ServerlessPauseResumeReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/ServerlessPauseResumeReview.md"
...
# MSSQL_TASK_initial_0960 - Script ServerlessPauseResumeReview.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Prueft typische Aspekte rund um Auto-Pause und Resume in Serverless-Szenarien.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/ServerlessPauseResumeReview.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/ServerlessPauseResumeReview.md

## Umsetzungsauftrag

Erzeuge `ServerlessPauseResumeReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Prueft typische Aspekte rund um Auto-Pause und Resume in Serverless-Szenarien. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
