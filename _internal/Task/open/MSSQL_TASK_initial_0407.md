---
task_id: MSSQL_TASK_initial_0407
repository: SQL_Training
domain: MSSQL
title: "Script TableValuedFunctionRowshapeProfile.sql fuer 24_UserDefinedFunctions erstellen"
status: open
priority: 594
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0407"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionRowshapeProfile.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionRowshapeProfile.md"
...
# MSSQL_TASK_initial_0407 - Script TableValuedFunctionRowshapeProfile.sql fuer 24_UserDefinedFunctions erstellen

## Anlass und Relevanz

Profiliert die Zeilenform table-valued Functions.
...
- T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionRowshapeProfile.sql
- T-SQL/24_UserDefinedFunctions/SQLScripts/TableValuedFunctionRowshapeProfile.md

## Umsetzungsauftrag

Erzeuge `TableValuedFunctionRowshapeProfile.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `24_UserDefinedFunctions` und diese fachliche Kurzbeschreibung als Rahmen: Profiliert die Zeilenform table-valued Functions. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
