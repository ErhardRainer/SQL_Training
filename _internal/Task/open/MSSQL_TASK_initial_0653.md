---
task_id: MSSQL_TASK_initial_0653
repository: SQL_Training
domain: MSSQL
title: "Script DbRolePermissionMatrix.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 348
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0653"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/DbRolePermissionMatrix.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/DbRolePermissionMatrix.md"
...
# MSSQL_TASK_initial_0653 - Script DbRolePermissionMatrix.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Matrix der Datenbankrollen und ihrer direkten Rechte.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/DbRolePermissionMatrix.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/DbRolePermissionMatrix.md

## Umsetzungsauftrag

Erzeuge `DbRolePermissionMatrix.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Matrix der Datenbankrollen und ihrer direkten Rechte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
