---
task_id: MSSQL_TASK_initial_0743
repository: SQL_Training
domain: MSSQL
title: "Script ExternalSchemaDriftScanner.sql fuer 70_ExternalTables_PolyBase erstellen"
status: open
priority: 258
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0743"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSchemaDriftScanner.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSchemaDriftScanner.md"
...
# MSSQL_TASK_initial_0743 - Script ExternalSchemaDriftScanner.sql fuer 70_ExternalTables_PolyBase erstellen

## Anlass und Relevanz

Scanner fuer Schema-Drift in externen Quellen.
...
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSchemaDriftScanner.sql
- T-SQL/70_ExternalTables_PolyBase/SQLScripts/ExternalSchemaDriftScanner.md

## Umsetzungsauftrag

Erzeuge `ExternalSchemaDriftScanner.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `70_ExternalTables_PolyBase` und diese fachliche Kurzbeschreibung als Rahmen: Scanner fuer Schema-Drift in externen Quellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
