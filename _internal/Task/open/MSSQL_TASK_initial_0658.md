---
task_id: MSSQL_TASK_initial_0658
repository: SQL_Training
domain: MSSQL
title: "Script ElevatedRoleMemberWatch.sql fuer 66_Security_Roles_Permissions erstellen"
status: open
priority: 343
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0658"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedRoleMemberWatch.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedRoleMemberWatch.md"
...
# MSSQL_TASK_initial_0658 - Script ElevatedRoleMemberWatch.sql fuer 66_Security_Roles_Permissions erstellen

## Anlass und Relevanz

Beobachtet Mitgliedschaften in besonders privilegierten Rollen.
...
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedRoleMemberWatch.sql
- T-SQL/66_Security_Roles_Permissions/SQLScripts/ElevatedRoleMemberWatch.md

## Umsetzungsauftrag

Erzeuge `ElevatedRoleMemberWatch.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `66_Security_Roles_Permissions` und diese fachliche Kurzbeschreibung als Rahmen: Beobachtet Mitgliedschaften in besonders privilegierten Rollen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
