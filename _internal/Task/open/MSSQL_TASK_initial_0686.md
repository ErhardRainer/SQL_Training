---
task_id: MSSQL_TASK_initial_0686
repository: SQL_Training
domain: MSSQL
title: "Script ReplicaConnectivityCheck.sql fuer 67_HA_DR erstellen"
status: open
priority: 315
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0686"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaConnectivityCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaConnectivityCheck.md"
...
# MSSQL_TASK_initial_0686 - Script ReplicaConnectivityCheck.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Checkt Erreichbarkeit und Basiszustand von Replikaten.
...
- T-SQL/67_HA_DR/SQLScripts/ReplicaConnectivityCheck.sql
- T-SQL/67_HA_DR/SQLScripts/ReplicaConnectivityCheck.md

## Umsetzungsauftrag

Erzeuge `ReplicaConnectivityCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Checkt Erreichbarkeit und Basiszustand von Replikaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
