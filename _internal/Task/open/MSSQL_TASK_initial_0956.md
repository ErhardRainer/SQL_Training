---
task_id: MSSQL_TASK_initial_0956
repository: SQL_Training
domain: MSSQL
title: "Script GeoReplicationConfigReview.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 45
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0956"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/GeoReplicationConfigReview.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/GeoReplicationConfigReview.md"
...
# MSSQL_TASK_initial_0956 - Script GeoReplicationConfigReview.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Review ueber Geo-Replication-Konfigurationen.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/GeoReplicationConfigReview.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/GeoReplicationConfigReview.md

## Umsetzungsauftrag

Erzeuge `GeoReplicationConfigReview.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Review ueber Geo-Replication-Konfigurationen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
