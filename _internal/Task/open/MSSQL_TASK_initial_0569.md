---
task_id: MSSQL_TASK_initial_0569
repository: SQL_Training
domain: MSSQL
title: "Script TempTableVsCteBenchmark.sql fuer 61_SubQuery_CTE_TMP erstellen"
status: open
priority: 432
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0569"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableVsCteBenchmark.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableVsCteBenchmark.md"
...
# MSSQL_TASK_initial_0569 - Script TempTableVsCteBenchmark.sql fuer 61_SubQuery_CTE_TMP erstellen

## Anlass und Relevanz

Vergleicht Laufzeit und Planform zwischen CTE, Temp-Tabelle und Tabellenvariable.
...
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableVsCteBenchmark.sql
- T-SQL/61_SubQuery_CTE_TMP/SQLScripts/TempTableVsCteBenchmark.md

## Umsetzungsauftrag

Erzeuge `TempTableVsCteBenchmark.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `61_SubQuery_CTE_TMP` und diese fachliche Kurzbeschreibung als Rahmen: Vergleicht Laufzeit und Planform zwischen CTE, Temp-Tabelle und Tabellenvariable. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
