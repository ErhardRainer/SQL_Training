---
task_id: MSSQL_TASK_initial_0629
repository: SQL_Training
domain: MSSQL
title: "Script QueryStoreVarianceDashboard.sql fuer 64_PerformanceTuning_Advanced erstellen"
status: open
priority: 372
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0629"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreVarianceDashboard.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreVarianceDashboard.md"
...
# MSSQL_TASK_initial_0629 - Script QueryStoreVarianceDashboard.sql fuer 64_PerformanceTuning_Advanced erstellen

## Anlass und Relevanz

Dashboard fuer Laufzeitvarianz im Query Store.
...
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreVarianceDashboard.sql
- T-SQL/64_PerformanceTuning_Advanced/SQLScripts/QueryStoreVarianceDashboard.md

## Umsetzungsauftrag

Erzeuge `QueryStoreVarianceDashboard.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `64_PerformanceTuning_Advanced` und diese fachliche Kurzbeschreibung als Rahmen: Dashboard fuer Laufzeitvarianz im Query Store. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
