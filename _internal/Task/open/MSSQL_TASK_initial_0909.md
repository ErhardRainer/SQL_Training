---
task_id: MSSQL_TASK_initial_0909
repository: SQL_Training
domain: MSSQL
title: "Script ColumnstoreRowgroupTransitionTrend.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 92
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0909"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTransitionTrend.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTransitionTrend.md"
...
# MSSQL_TASK_initial_0909 - Script ColumnstoreRowgroupTransitionTrend.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Verfolgt, wie Rowgroups zwischen Delta-, Closed- und Compressed-Zustaenden wechseln.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTransitionTrend.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/ColumnstoreRowgroupTransitionTrend.md

## Umsetzungsauftrag

Erzeuge `ColumnstoreRowgroupTransitionTrend.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Verfolgt, wie Rowgroups zwischen Delta-, Closed- und Compressed-Zustaenden wechseln. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
