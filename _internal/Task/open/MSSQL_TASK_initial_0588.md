---
task_id: MSSQL_TASK_initial_0588
repository: SQL_Training
domain: MSSQL
title: "Script SecurityPredicateDependencyCheck.sql fuer 62_Row_Level_Security erstellen"
status: open
priority: 413
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0588"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/SecurityPredicateDependencyCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/62_Row_Level_Security/SQLScripts/SecurityPredicateDependencyCheck.md"
...
# MSSQL_TASK_initial_0588 - Script SecurityPredicateDependencyCheck.sql fuer 62_Row_Level_Security erstellen

## Anlass und Relevanz

Zeigt Abhaengigkeiten zwischen Security-Predicates, Funktionen und Tabellen.
...
- T-SQL/62_Row_Level_Security/SQLScripts/SecurityPredicateDependencyCheck.sql
- T-SQL/62_Row_Level_Security/SQLScripts/SecurityPredicateDependencyCheck.md

## Umsetzungsauftrag

Erzeuge `SecurityPredicateDependencyCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `62_Row_Level_Security` und diese fachliche Kurzbeschreibung als Rahmen: Zeigt Abhaengigkeiten zwischen Security-Predicates, Funktionen und Tabellen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
