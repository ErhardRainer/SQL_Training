---
task_id: MSSQL_TASK_initial_0923
repository: SQL_Training
domain: MSSQL
title: "Script RowgroupHealthCheck.sql fuer 78_ColumnstoreIndexes erstellen"
status: open
priority: 78
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0923"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupHealthCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupHealthCheck.md"
...
# MSSQL_TASK_initial_0923 - Script RowgroupHealthCheck.sql fuer 78_ColumnstoreIndexes erstellen

## Anlass und Relevanz

Bewertet offene, komprimierte und problematische Rowgroups in Columnstore-Indizes.
...
- T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupHealthCheck.sql
- T-SQL/78_ColumnstoreIndexes/SQLScripts/RowgroupHealthCheck.md

## Umsetzungsauftrag

Erzeuge `RowgroupHealthCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `78_ColumnstoreIndexes` und diese fachliche Kurzbeschreibung als Rahmen: Bewertet offene, komprimierte und problematische Rowgroups in Columnstore-Indizes. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
