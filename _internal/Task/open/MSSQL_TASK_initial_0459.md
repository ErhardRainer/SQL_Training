---
task_id: MSSQL_TASK_initial_0459
repository: SQL_Training
domain: MSSQL
title: "Script KeyLookupHotspotsFromPlans.sql fuer 27_ExecutionPlans_Basics erstellen"
status: open
priority: 542
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0459"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotsFromPlans.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotsFromPlans.md"
...
# MSSQL_TASK_initial_0459 - Script KeyLookupHotspotsFromPlans.sql fuer 27_ExecutionPlans_Basics erstellen

## Anlass und Relevanz

Markiert Plaene mit auffaelligen Key-Lookup-Mustern.
...
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotsFromPlans.sql
- T-SQL/27_ExecutionPlans_Basics/SQLScripts/KeyLookupHotspotsFromPlans.md

## Umsetzungsauftrag

Erzeuge `KeyLookupHotspotsFromPlans.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `27_ExecutionPlans_Basics` und diese fachliche Kurzbeschreibung als Rahmen: Markiert Plaene mit auffaelligen Key-Lookup-Mustern. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
