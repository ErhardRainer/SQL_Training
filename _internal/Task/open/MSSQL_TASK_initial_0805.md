---
task_id: MSSQL_TASK_initial_0805
repository: SQL_Training
domain: MSSQL
title: "Script TableTypeDependencyInventory.sql fuer 73_TVPs_TableTypes erstellen"
status: open
priority: 196
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0805"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDependencyInventory.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDependencyInventory.md"
...
# MSSQL_TASK_initial_0805 - Script TableTypeDependencyInventory.sql fuer 73_TVPs_TableTypes erstellen

## Anlass und Relevanz

Listet Table Types und deren Verwendung in Prozeduren und Funktionen auf.
...
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDependencyInventory.sql
- T-SQL/73_TVPs_TableTypes/SQLScripts/TableTypeDependencyInventory.md

## Umsetzungsauftrag

Erzeuge `TableTypeDependencyInventory.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `73_TVPs_TableTypes` und diese fachliche Kurzbeschreibung als Rahmen: Listet Table Types und deren Verwendung in Prozeduren und Funktionen auf. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
