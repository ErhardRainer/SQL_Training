---
task_id: MSSQL_TASK_initial_0990
repository: SQL_Training
domain: MSSQL
title: "Script RequestCpuAndReadHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen"
status: open
priority: 11
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0990"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/RequestCpuAndReadHotspots.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/82_Troubleshooting_Sessions_Requests/RequestCpuAndReadHotspots.md"
...
# MSSQL_TASK_initial_0990 - Script RequestCpuAndReadHotspots.sql fuer 82_Troubleshooting_Sessions_Requests erstellen

## Anlass und Relevanz

Listet aktuell auffaellige Requests nach CPU und Reads.
...
- T-SQL/82_Troubleshooting_Sessions_Requests/RequestCpuAndReadHotspots.sql
- T-SQL/82_Troubleshooting_Sessions_Requests/RequestCpuAndReadHotspots.md

## Umsetzungsauftrag

Erzeuge `RequestCpuAndReadHotspots.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `82_Troubleshooting_Sessions_Requests` und diese fachliche Kurzbeschreibung als Rahmen: Listet aktuell auffaellige Requests nach CPU und Reads. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
