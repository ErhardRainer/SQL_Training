---
task_id: MSSQL_TASK_initial_0601
repository: SQL_Training
domain: MSSQL
title: "Script CollationOverrideTemplate.sql fuer 63_Collation_Case_Sensitive erstellen"
status: open
priority: 400
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0601"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationOverrideTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationOverrideTemplate.md"
...
# MSSQL_TASK_initial_0601 - Script CollationOverrideTemplate.sql fuer 63_Collation_Case_Sensitive erstellen

## Anlass und Relevanz

Template fuer gezielte Collation-Overrides in Abfragen.
...
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationOverrideTemplate.sql
- T-SQL/63_Collation_Case_Sensitive/SQLScripts/CollationOverrideTemplate.md

## Umsetzungsauftrag

Erzeuge `CollationOverrideTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `63_Collation_Case_Sensitive` und diese fachliche Kurzbeschreibung als Rahmen: Template fuer gezielte Collation-Overrides in Abfragen. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
