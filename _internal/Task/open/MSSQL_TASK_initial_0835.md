---
task_id: MSSQL_TASK_initial_0835
repository: SQL_Training
domain: MSSQL
title: "Script UpdateConflictRetryTemplate.sql fuer 74_SnapshotIsolation_Concurrency erstellen"
status: open
priority: 166
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0835"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/UpdateConflictRetryTemplate.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/UpdateConflictRetryTemplate.md"
...
# MSSQL_TASK_initial_0835 - Script UpdateConflictRetryTemplate.sql fuer 74_SnapshotIsolation_Concurrency erstellen

## Anlass und Relevanz

Vorlage fuer Retry-Logik nach Snapshot-Update-Konflikten.
...
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/UpdateConflictRetryTemplate.sql
- T-SQL/74_SnapshotIsolation_Concurrency/SQLScripts/UpdateConflictRetryTemplate.md

## Umsetzungsauftrag

Erzeuge `UpdateConflictRetryTemplate.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `74_SnapshotIsolation_Concurrency` und diese fachliche Kurzbeschreibung als Rahmen: Vorlage fuer Retry-Logik nach Snapshot-Update-Konflikten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
