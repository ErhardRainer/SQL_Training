---
task_id: MSSQL_TASK_initial_0950
repository: SQL_Training
domain: MSSQL
title: "Script AzureServerlessCostSignal.sql fuer 80_AzureSQL_Differences erstellen"
status: open
priority: 51
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0950"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureServerlessCostSignal.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/80_AzureSQL_Differences/SQLScripts/AzureServerlessCostSignal.md"
...
# MSSQL_TASK_initial_0950 - Script AzureServerlessCostSignal.sql fuer 80_AzureSQL_Differences erstellen

## Anlass und Relevanz

Signal-Skript fuer potenzielle Serverless-Kostenindikatoren.
...
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureServerlessCostSignal.sql
- T-SQL/80_AzureSQL_Differences/SQLScripts/AzureServerlessCostSignal.md

## Umsetzungsauftrag

Erzeuge `AzureServerlessCostSignal.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `80_AzureSQL_Differences` und diese fachliche Kurzbeschreibung als Rahmen: Signal-Skript fuer potenzielle Serverless-Kostenindikatoren. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
