---
task_id: MSSQL_TASK_initial_0792
repository: SQL_Training
domain: MSSQL
title: "Script JobRetryPolicyAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen"
status: open
priority: 209
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0792"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryPolicyAudit.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryPolicyAudit.md"
...
# MSSQL_TASK_initial_0792 - Script JobRetryPolicyAudit.sql fuer 72_SQLAgent_Jobs_Alerts erstellen

## Anlass und Relevanz

Uebersicht ueber Retry-Konfigurationen und potenziell riskante Job-Schritte.
...
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryPolicyAudit.sql
- T-SQL/72_SQLAgent_Jobs_Alerts/SQLScripts/JobRetryPolicyAudit.md

## Umsetzungsauftrag

Erzeuge `JobRetryPolicyAudit.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `72_SQLAgent_Jobs_Alerts` und diese fachliche Kurzbeschreibung als Rahmen: Uebersicht ueber Retry-Konfigurationen und potenziell riskante Job-Schritte. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
