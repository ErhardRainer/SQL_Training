---
task_id: MSSQL_TASK_initial_0688
repository: SQL_Training
domain: MSSQL
title: "Script ReplicaRoleTransitionLog.sql fuer 67_HA_DR erstellen"
status: open
priority: 313
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0688"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaRoleTransitionLog.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/67_HA_DR/SQLScripts/ReplicaRoleTransitionLog.md"
...
# MSSQL_TASK_initial_0688 - Script ReplicaRoleTransitionLog.sql fuer 67_HA_DR erstellen

## Anlass und Relevanz

Protokolliert Rollenwechsel von Replikaten.
...
- T-SQL/67_HA_DR/SQLScripts/ReplicaRoleTransitionLog.sql
- T-SQL/67_HA_DR/SQLScripts/ReplicaRoleTransitionLog.md

## Umsetzungsauftrag

Erzeuge `ReplicaRoleTransitionLog.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `67_HA_DR` und diese fachliche Kurzbeschreibung als Rahmen: Protokolliert Rollenwechsel von Replikaten. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
