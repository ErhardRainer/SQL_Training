---
task_id: MSSQL_TASK_initial_0762
repository: SQL_Training
domain: MSSQL
title: "Script BackupRetentionGapCheck.sql fuer 71_BackupRestore_Strategies erstellen"
status: open
priority: 239
priority_class: low
...
source:
  type: repository
  reference: "T-SQL/Script.md#upcomming-scripts; queue: sql-0762"
  url: null
  author: null
  published_at: null

affected_paths:
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupRetentionGapCheck.sql"
    change: "SQL-Skript erstellen oder pruefen"
  - path: "T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupRetentionGapCheck.md"
...
# MSSQL_TASK_initial_0762 - Script BackupRetentionGapCheck.sql fuer 71_BackupRestore_Strategies erstellen

## Anlass und Relevanz

Findet Luecken in der erwarteten Backup-Retention.
...
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupRetentionGapCheck.sql
- T-SQL/71_BackupRestore_Strategies/SQLScripts/BackupRetentionGapCheck.md

## Umsetzungsauftrag

Erzeuge `BackupRetentionGapCheck.sql` und die zugehoerige Markdown-Dokumentation gemaess `_internal/SQL-Script/instruction_SQL_Script.md`. Verwende Kapitel `71_BackupRestore_Strategies` und diese fachliche Kurzbeschreibung als Rahmen: Findet Luecken in der erwarteten Backup-Retention. Lege fehlende Ordner an, dokumentiere Annahmen neutral und halte YAML-Header, SQLDOC-Marker sowie Mermaid-Block ein.
