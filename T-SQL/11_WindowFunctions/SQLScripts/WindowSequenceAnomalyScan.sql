...
-- 1. Vorzeile und gleitende Baseline je Sensor berechnen.
SELECT
    sr.SensorCode,
    sr.ReadingTime,
    sr.SequenceNo,
...
-- 2. Sequenz- und Wertanomalien klassifizieren.
SELECT
    sd.SensorCode,
    sd.ReadingOrder,
    sd.ReadingTime,
...
-- 3. Anomalien pro Sensor verdichten.
SELECT
    a.SensorCode,
...
-- 4. Letzten bekannten Zustand je Sensor sichtbar machen.
