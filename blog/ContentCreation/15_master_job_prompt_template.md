...
Betriebsmodus:
- Standard: `full`
- Optionaler Bypass: `article_only`
...
Wenn `pipeline_mode = article_only`, ueberspringe diese Schritte und dokumentiere sie im Workflow:
- 03
- 04
- 05
- 07
...
- Codebeispiele nur generieren, nicht ausfuehren
- Micro-Beispiele mit Evidenz-Level erzeugen
...
Nicht Teil dieses Master-Jobs:
- `blog/ContentCreation/13_external_review.md` wird von einer separaten KI ausgefuehrt
- `blog/ContentCreation/14_finalize_article.md` ist ein manueller Schritt
```
